...
POOL_A = [
 ...
 dict(topic="Potassium hydroxide", io=IOC, slot="initial test",
   ...
   opts=[
     ["Direct microscopy for dermatophytes, covering Candida and tinea",
      "Correct — direct visualization of fungal elements."],
     ["Culture of dermatophytes on a selective medium",
      "Potassium hydroxide microscopy is a direct-visualization test, not a culture."],
 ...
 dict(topic="Potassium hydroxide", io=IOC, slot="initial test",
   ...
   opts=[
     ...
     ["Tinea versicolor, seborrheic dermatitis, psoriasis and eczema",
      "Only tinea versicolor is fungal here; seborrheic dermatitis, psoriasis and eczema are inflammatory conditions that a potassium hydroxide preparation cannot diagnose."]],
   c=0, cite=c(6)),
 ...
 dict(topic="Potassium hydroxide", io=IOC, slot="initial test",
   ...
   opts=[
     ["Twenty percent",
      "Correct — one drop of twenty percent potassium hydroxide is added to the specimen."],
     ["Ten percent",
      "Ten percent is a common alternative but is not the concentration in this procedure."],
     ["Five percent",
