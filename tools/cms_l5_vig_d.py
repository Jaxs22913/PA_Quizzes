 ...
 dict(topic="Scabies", io=IOA,
   ...
   opts=[
     ...
     ["Treat her with permethrin now, since all household contacts are treated regardless",
      "Contacts are normally treated, but in pregnancy the balance shifts: treatment is reserved for documented infestation rather than given presumptively."],
 ...
 dict(topic="Lyme disease", io=IOA,
   ...
   opts=[
     ...
     ["Testing is not indicated at all, since Lyme disease occurs only in the northeastern states",
      "Testing is not useless in a non-endemic area; a negative result is highly informative precisely because the pretest probability is so low."],
