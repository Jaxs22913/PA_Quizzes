...
TESTS = """    ent: [
      {q:"Rinne on the right is normal. Weber lateralizes to the right. Which ear has sensorineural loss?",
       o:["The LEFT","The right","Neither — this is normal","Both"],a:0,
       why:"A normal Rinne rules out conductive loss on the right, and Weber lateralizes AWAY from a sensorineural lesion — so hearing it on the right puts the damage on the left."},
      {q:"Which way does Weber lateralize in unilateral CONDUCTIVE loss?",
       ...
       why:"In unilateral conductive loss the sound lateralizes to the impaired ear, because room noise is not well heard there and detection of the vibrations improves; sensorineural loss sends it to the good ear."},
      {q:"Why is the Rinne \\u201cnormal\\u201d in sensorineural hearing loss?",
       o:["Rinne compares two routes to the SAME cochlea, and the damage degrades both equally",
          "The inner ear favors bone conduction when damaged",
      ...
      {q:"A patient's own voice is unusually LOUD. Which type of hearing loss does this suggest?",
      ...
      {q:"Which type of hearing loss usually shows a visible abnormality on otoscopy?",
      ...
      {q:"Insidious vertigo, hearing impaired on ONE side, tinnitus present, cranial nerves V and VII possibly involved. Which diagnosis fits?",
       o:["Acoustic neuroma","M\\u00e9ni\\u00e8re disease","Central vertigo","Drug toxicity"],a:0,
       why:"Unilateral hearing loss plus the neighboring cranial nerves is the signature — the tumor sits where V and VII run close by."},
      ...
      {q:"In the MODIFIED Centor score, how does age change the total?",
       ...
       why:"The modified score adds a point for ages 3 to 14, nothing for 15 to 44 and subtracts a point at 45 or older, so being older argues against streptococcal pharyngitis."},
      ...
      {q:"Why does a septal hematoma need urgent drainage?",
       ...
       why:"The cartilage has no blood supply of its own — it depends on the lining the hematoma has just stripped away."},
      {q:"The uvula deviates to one side and the palate fails to rise. Which cranial nerve is paralyzed?",
       o:["Cranial nerve X — the uvula deviates AWAY from the paralyzed side",
          "Cranial nerve XII — toward the paralyzed side",
