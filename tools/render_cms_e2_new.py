...
SPEC = {
 ...
 "l5vig": dict(sets="cms_e2l14_vig_sets.json",
   files=["ocular-trauma-vignettes.html", "ocular-trauma-vignettes-version-2.html"],
   title="Ocular Trauma Vignettes %d — CMS I Exam 2",
   h1="Ocular Trauma &mdash; Vignettes %d",
   sub="Clinical Medicine and Surgery I &middot; Exam 2 &middot; Lecture 14",
   chips=["Open globe", "Abrasion &amp; foreign body", "Hyphema",
          "Lids &amp; orbit", "Fractures"]),
 "l5io": dict(sets="cms_e2l14_sets.json",
   files=["ocular-trauma-quiz.html", "ocular-trauma-quiz-version-2.html"],
   title="Ocular Trauma Quiz %d — CMS I Exam 2",
   h1="Ocular Trauma &mdash; Quiz %d",
   sub="Clinical Medicine and Surgery I &middot; Exam 2 &middot; Lecture 14",
   chips=["The four do-nots", "Open globe", "Hyphema",
          "Retinal detachment", "Blowout &amp; basilar fracture"]),
