...
POOL_D = [
 ...
 dict(topic="Hounsfield units", io=IOD, slot="differential",
   ...
   opts=[
     ["It separates water from soft tissue, which a conventional radiograph cannot tell apart",
      "Correct — water and soft tissue attenuate x-rays almost identically on a plain film, but the Hounsfield scale assigns them distinct numerical values."],
 ...
 dict(topic="Positioning", io=IOE, slot="first-line",
   ...
   opts=[
     ["A posterior-anterior and a lateral chest radiograph, read together",
      "Correct — the frontal film gives no depth information, so the lateral is needed to place a lesion front to back, and the two are interpreted together."],
 ...
 dict(topic="Positioning", io=IOE, slot="manifestation",
   ...
   opts=[
     ...
     ["Towards the right",
      "By convention the patient faces left on the lateral view, so anterior structures appear on the left of the image."],
     ["Towards the viewer",
 ...
 dict(topic="Positioning", io=IOE, slot="education",
   ...
   opts=[
     ...
     ["They are rarely useful once a current study exists, and should be archived rather than displayed",
      "A previous study is often the most valuable information available, because stability over time is reassuring and change is what prompts action."],
