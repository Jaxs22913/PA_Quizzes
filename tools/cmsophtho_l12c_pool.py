...
Q("Amaurosis fugax", IO,
  ...
  [["Magnetic resonance angiography", "Correct — with carotid Doppler if a carotid source is "
   ...
   ["Color vision testing", "Part of the optic neuritis assessment."]],
  "two-step", D, 8),
...
Q("Amaurosis fugax", IO,
  ...
  [["Lasting hours argues against a transient ischemic attack",
    "Correct — the episodes are typically seconds to minutes."],
   ["Hours confirms a transient ischemic attack", "Duration of hours argues the other way."],
...
Q("Amaurosis fugax", IO,
  "A 66-year-old man has amaurosis fugax from carotid emboli. Which treatments are indicated?",
...
Q("Amaurosis fugax", IO,
  "A 58-year-old woman has transient monocular visual loss attributed to vasospasm. Which drug class treats that cause?",
...
Q("Chronic open-angle glaucoma", IO,
  ...
  [["Either normal or elevated", "Correct — pressure may be normal OR "
   ...
   ["Always below normal", "Pressure is not typically below normal; in chronic open-angle glaucoma it may be normal or elevated."],
   ["Elevated only in the morning", "Morning elevation is not the point; in chronic open-angle glaucoma the pressure may be normal or elevated."],
...
Q("Chronic open-angle glaucoma", IO,
  ...
  "splinter hemorrhages. Which condition do these indicate?",
  [["Chronic open-angle glaucoma", "Correct — with rim pitting and bayoneting on the same list."],
   ...
   ["Central retinal vein occlusion", "Produces widespread hemorrhage with venous engorgement."]],
  "diagnosis", D, 18),

Q("Chronic open-angle glaucoma", IO,
  "A 59-year-old woman with open-angle glaucoma is started on drops. Which agents are first-line?",
  [["Latanoprost, tafluprost or timolol", "Correct."],
   ...
   ["Olopatadine", "An antihistamine and mast cell stabilizer for allergic conjunctivitis."]],
  "treatment", D, 21),
...
Q("Optic neuritis", IO,
  ...
  [["Women aged 18 to 45", "Correct — about 75% are female."],
   ["Men over 60", "That fits the ischemic optic neuropathies."],
...
Q("Retinal detachment", IO,
  "A 62-year-old man reports a gray shadow in his peripheral vision that changes as he moves his "
  "head. What does that positional change indicate?",
  [["A retinal detachment", "Correct — the deficit shifts with head position."],
   ["A vitreous hemorrhage alone", "Floaters shift, but the described curtain is the detachment "
                                    "sign."],
...
Q("Retinal detachment", IO,
  "A 60-year-old man has a rhegmatogenous retinal detachment. Which immediate measures accompany the referral?",
...
Q("Retinal detachment", IO,
  "Which surgical options repair a retinal detachment?",
...
Q("Non-arteritic AION", IO,
  "What proportion of anterior ischemic optic neuropathy is the non-arteritic form?",
  [["Ninety to ninety-five percent", "Correct — it is by far the commoner form."],
   ["About half", "Roughly half the true share."],
   ["About ten percent", "That approximates the ARTERITIC share instead."],
   ["About twenty-five percent", "A quarter of cases, well below the true "
                                  "figure."]],
  "two-step", D, 48),

Q("Non-arteritic AION", IO,
  "A 54-year-old man has non-arteritic ischemic optic neuropathy. Which structural feature is "
  "associated with it?",
...
Q("Non-arteritic AION", IO,
  "A 57-year-old man has non-arteritic ischemic optic neuropathy. What is the management?",
...
Q("Non-arteritic AION", IO,
  "Why is the workup for non-arteritic ischemic optic neuropathy identical to the arteritic form?",
...
Q("Papilledema", IO,
  "Which of these can cause papilledema?",
  [["Tumor, trauma, intracranial infection, hemorrhage and vitamin A toxicity",
    "Correct."],
   ["Diabetes, hypertension and hyperlipidemia", "Those are vascular risk factors for other "
                                                  "conditions."],
   ["Contact lens wear and dry eye", "Surface conditions unrelated to intracranial pressure."],
   ["Giant cell arteritis alone", "That causes arteritic ischemic optic neuropathy."]],
  "two-step", D, 43),
...
Q("Papilledema", IO,
  ...
  [["Treat the underlying disorder", "Correct — the disc swelling is a sign, not the disease."],
   ...
   ["Immediate optic nerve surgery", "Surgery on the nerve is not the treatment; papilledema is managed by treating the underlying disorder."],
...
Q("Branch retinal artery occlusion", IO,
  ...
  [["The blockage is in a branch, so only part of the retina is affected",
    "Correct — the field loss is partial and localized, and management does not change."],
...
Q("Branch retinal vein occlusion", IO,
  ...
  [["The clot is in a smaller branch vein, affecting only part of the retina",
    "Correct — hemorrhage is confined to that territory."],
