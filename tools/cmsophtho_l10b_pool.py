...
Q("Dacryoadenitis", IO,
  ...
  [["Contrast computed tomography is used when indicated, not automatically",
    "Correct. Contrast computed tomography of the orbits and paranasal sinuses is used when indicated, not automatically on presentation."],
   ...
   ["Only magnetic resonance imaging is acceptable",
    "Magnetic resonance imaging is not the study used; contrast computed tomography of the orbits and paranasal sinuses is."],
