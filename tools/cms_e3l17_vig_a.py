...
QUESTIONS = [
 ...
 dict(topic="Acute sinusitis", io=IO_A, lead="defining feature", cite=D % 18,
  ...
  opts=[["Sinus involvement", "Correct. Sinusitis pain localizes to the sinus and worsens bending over or lying flat."],
 ...
 dict(topic="Bacterial sinusitis", io=IO_A, lead="diagnostic technique", cite=D % 19,
  ...
  opts=[["Yellow or green is the least helpful color", "Correct. Color barely helps; only black, rust or pure clear carry any signal."],
        ["Green always means viral infection", "Color does not establish that either."],
        ["Green means a fungal cause", "Black is the color that suggests fungus."],
 ...
 dict(topic="Acute sinusitis", io=IO_A, lead="etiology", cite=D % 12,
  ...
  opts=[["A fungal infection", "Correct. Immunocompromised patients get Rhizopus, Mucor and occasionally Aspergillus &mdash; and black discharge suggests fungus."],
        ["Ordinary viral rhinosinusitis", "The color and his immune status point elsewhere."],
 ...
 dict(topic="Perforated septum", io=IO_A, lead="etiology", cite=D % 37,
  ...
  opts=[["Chronic ischemia", "Correct &mdash; the same mechanism as cocaine use."],
 ...
 dict(topic="Perforated septum", io=IO_A, lead="next step", cite=D % 37,
  q="A 46-year-old man has a septal perforation, and also reports hemoptysis and blood in his urine. Which diagnosis should be considered?",
  opts=[["Granulomatosis with polyangiitis", "Correct &mdash; a vascular autoimmune disease named as a rare cause of nasal deformity."],
        ...
        ["Allergic rhinitis", "It causes rhinorrhea, not perforation or systemic disease."]]),

 dict(topic="Septal hematoma", io=IO_A, lead="next step", cite=D % 41,
  ...
  opts=[["Drain it via intranasal incision under general anesthesia", "Correct."],
 ...
 dict(topic="Nasal fracture", io=IO_A, lead="next step", cite=D % 57,
  q="A 24-year-old woman has swelling and tenderness confined to the bony bridge after a fall. She breathes freely through each nostril, the nose is straight, and there is no septal hematoma. What imaging is required?",
 ...
 dict(topic="Epistaxis", io=IO_A, lead="diagnosis", cite=D % 46,
  ...
  opts=[["Kiesselbach's plexus", "Correct &mdash; the anterior septal watershed, and the source of about ninety percent of nosebleeds."],
 ...
 dict(topic="Epistaxis", io=IO_A, lead="next step", cite=D % 49,
  ...
  opts=[["Prothrombin time with international normalized ratio, hematocrit, and type and crossmatch",
        ...
        ["A full blood count only", "Insufficient in prolonged hemorrhage."],
