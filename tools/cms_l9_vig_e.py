...
VIG_E = [
 dict(topic="Actinic keratosis", io=IOA, lead="next step",
   ...
   opts=[
     ["Take a shave or punch biopsy, because persistence or recurrence after therapy is a biopsy trigger",
      "Correct — recurrence after treatment, plus induration, is exactly what should prompt sampling."],
 ...
 dict(topic="Actinic keratosis", io=IOA, lead="treatment",
   ...
   opts=[
     ...
     ["Excision of each lesion with a two-millimeter margin",
 ...
 dict(topic="Actinic keratosis", io=IOA, lead="education",
   ...
   opts=[
     ...
     ["Clearance means the surrounding field is no longer at risk and routine follow-up can stop",
      "The opposite holds: the surrounding field remains at risk."],
 ...
 dict(topic="Squamous cell carcinoma", io=IOA, lead="test",
   ...
   opts=[
     ...
     ["The Breslow thickness in millimeters, to assign a T category",
 ...
 dict(topic="Squamous cell carcinoma", io=IOA, lead="next step",
   ...
   opts=[
     ["Refer for Mohs micrographic surgery, since the site, size and perineural invasion all meet the criteria",
      "Correct — high-risk site, over one centimeter on the face, and aggressive histology each independently qualify."],
     ["Excise it with a four-millimeter margin in the clinic today and review the pathology report",
 ...
 dict(topic="Squamous cell carcinoma", io=IOA, lead="education",
   ...
   opts=[
     ["Nicotinamide five hundred milligrams twice daily reduces new squamous cell carcinoma by about thirty percent in high-risk patients",
      "Correct — and it is specifically described as a strategy for transplant recipients."],
     ["Niacin five hundred milligrams twice daily reduces new squamous cell carcinoma by about thirty percent",
      "It is nicotinamide that does this; niacin is a different form of vitamin B3."],
     ["Nicotinamide five hundred milligrams twice daily reduces new squamous cell carcinoma by about twenty percent overall",
      "Twenty percent is the figure for basal cell carcinoma."],
 ...
 dict(topic="Basal cell carcinoma", io=IOA, lead="treatment",
   ...
   opts=[
     ...
     ["Imiquimod five nights weekly for six to ten weeks, with no further review needed if the lesion disappears",
      "Visible resolution is not clearance, which must be confirmed."],
 ...
 dict(topic="Basal cell carcinoma", io=IOA, lead="education",
   ...
   opts=[
     ["At least an annual full-skin examination, because a second basal cell carcinoma develops in up to half of patients",
      "Correct — the up-to-fifty-percent second-primary rate is what makes annual review mandatory."],
