 ...
 dict(topic="Azoles", io=IO9C,
   ...
   opts=[
     ...
     ["Ketoconazole and posaconazole only",
      "The teratogenic group is itraconazole, fluconazole and voriconazole; ketoconazole's main concern is hepatotoxicity."],
 ...
 dict(topic="Griseofulvin", io=IO9E,
   ...
   opts=[
     ...
     ["It is concentrated in sebum and delivered through the sebaceous glands",
      "Sebum delivery is not the route; griseofulvin is deposited in keratin precursor cells, which is why the infected nail or hair must grow out before cure."],
