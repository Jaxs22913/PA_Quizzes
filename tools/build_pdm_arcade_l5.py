...
DECK = dict(
  ...
  ["What is the normal anion gap?", "8 to 12 milliequivalents per liter."],
  ...
  ["What causes a NORMAL anion gap acidosis?", "Bicarbonate loss from the gut or the kidney — hyperchloremic acidosis."],
  ...
  ["Transaminases in the thousands narrow to which three causes?", "Viral hepatitis, ischemia and toxins."],
  ["A raised aspartate aminotransferase with a normal alanine transaminase points where?", "Cardiac or skeletal muscle, not liver."],
  ["What causes isolated hyperbilirubinemia?", "Gilbert syndrome and hemolysis."],
  ["Which syndrome shows liver and kidney failure together?", "Hepatorenal syndrome."],
  ["What does serum osmolality let you distinguish?", "True hypotonic hyponatremia from the pseudo- and hypertonic forms."],
  ...
  ["What does hyperglycemia do to the measured sodium?", "Lowers it by dilution — use a corrected sodium."],
  ["What causes pseudohyponatremia, and what gives it away?", "Severe hyperlipidemia or hyperproteinemia — the osmolality is normal."],
  ["Why does a normal result not exclude disease?", "A normal range is the mean plus or minus two standard deviations, so about 2.5 percent of healthy people fall outside it."],
  ...
  ["In the vomiting case, what does the panel show?", "Low sodium, low potassium, low chloride, a raised bicarbonate and alkalemia."],
