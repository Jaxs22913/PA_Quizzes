...
DECKS = [
 dict(id="cms-viral-fungal", name="Cutaneous Viral & Fungal Infections", color="accent2",
  ...
  ["From where do you sample a suspected tinea lesion?", "The active border, never the cleared center."],
  ...
  ["How far beyond the border should topical treatment for tinea corporis go?", "One to two centimeters."],
  ...
  ["Which toe web spaces does interdigital tinea pedis favor?", "The third and fourth interspaces."],
  ...
  ["Which dermatome group is involved most often in zoster?", "Thoracic, in about fifty-five percent."],
  ...
  ["Which molluscum treatment is applied at home, and from what age?", "Berdazimer ten point three percent gel, from age one year."],
  ["Which molluscum treatment is applied by a clinician, and from what age?", "Cantharidin zero point seven percent, from age two years."],
