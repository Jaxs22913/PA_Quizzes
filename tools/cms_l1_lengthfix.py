...
FIXES = {
 ...
 18: (3, "Pretest probability applies to screening programs only, while posttest probability applies to diagnostic testing"),
 19: (1, "The sensitivity and specificity of the test will differ between the two patients being evaluated"),
 22: (0, "Generate the hypotheses first, then organize and interpret the clinical information gathered from the patient"),
 ...
 28: (3, "Endocrine — traumatic brain injury and traumatic subdural hematoma"),
 ...
 63: (0, "Apply the same standardized intervention regardless of where the patient sits on that continuum"),
