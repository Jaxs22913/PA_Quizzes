...
INTRO = (
  ...
  "<b>One idea organizes most of the arterial half.</b> Each artery type is built for a different "
  ...
  "the disease. "
  "<b>The neointimal response is the second organizing idea.</b> Injure the endothelium anywhere, "
