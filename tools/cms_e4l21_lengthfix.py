#!/usr/bin/env python3
"""Lecture 21 length fixes -- and a standalone before/after report.

    python3 cms_e4l21_lengthfix.py          # per-pool gameable%, raw and fixed
...
if __name__ == "__main__":
    mods = sorted(os.path.basename(p)[:-3] for pat in ("cms_e4l21_pool_*.py", "cms_e4l21_vig_*.py")
