...
QUESTIONS = [
 ...
 dict(topic="Trauma first principles", io=IO_A, lead="management", cite=D % 6,
  ...
  opts=[["Leave it in place", "Correct. It may be tamponading the wound, and removal can extrude intraocular contents."],
        ...
        ["Remove it under topical anesthetic", "Anesthesia does not make removal safe here."]]),
 ...
 dict(topic="Trauma first principles", io=IO_A, lead="next step", cite=D % 6,
  ...
  opts=[["Loss of consciousness", "Correct. It sits alongside alcohol, confusion, tachypnea, apneic breathing, anticoagulants and eye penetration."],
        ["Subconjunctival hemorrhage alone", "That alone does not mandate imaging."],
 ...
 dict(topic="Assessment", io=IO_A, lead="history", cite=D % 8,
  ...
  opts=[["When the patient last ate and drank", "Correct. Nil-by-mouth status shapes the anesthetic plan."],
 ...
 dict(topic="Open globe injury", io=IO_A, lead="diagnosis", cite=D % 14,
  ...
  opts=[["Open globe injury", "Correct. Those three findings together define a full-thickness defect."],
        ...
        ["Subconjunctival hemorrhage", "That is confined to the surface."],
 ...
 dict(topic="Full-thickness eye wall laceration", io=IO_A, lead="management", cite=D % 16,
  ...
  opts=[["Leave it alone for now", "Correct. Retrieving it early risks more damage to ocular structures."],
        ["Remove it under topical anesthetic", "Anesthesia does not reduce the structural risk."],
 ...
 dict(topic="Full-thickness eye wall laceration", io=IO_A, lead="diagnosis", cite=D % 16,
  ...
  opts=[["It becomes hydrated, edematous and opaque", "Correct. Aqueous entering the capsule clouds it."],
 ...
 dict(topic="Corneal abrasion", io=IO_A, lead="patient education", cite=D % 18,
  ...
  opts=[["Take home topical anesthetic drops for pain", "Correct. They delay healing, mask worsening symptoms and can cause a corneal ulcer."],
 ...
 dict(topic="Hyphema", io=IO_A, lead="diagnosis", cite=D % 24,
  ...
  opts=[["Hyphema, which can itself be a sign of open globe", "Correct. It is not always an isolated injury."],
        ["Subconjunctival hemorrhage over the iris", "That sits on the surface, not within the chamber."],
 ...
 dict(topic="Hyphema", io=IO_A, lead="prognosis", cite=D % 25,
  ...
  opts=[["The first 72 hours", "Correct. That is when a secondary hemorrhage is most likely."],
        ["The first 24 hours only", "The window is longer than a day."],
        ["After the first month", "Well outside the peak risk."],
        ["Rebleeding is not a recognized complication", "It is the complication management aims to prevent."]]),
 ...
 dict(topic="Hyphema", io=IO_A, lead="risk factor", cite=D % 25,
  ...
  opts=[["Sickle cell disease", "Correct. Sickle cell anemia increases the risk in hyphema, which already carries a high risk of secondary hemorrhage."],
        ...
        ["Iron deficiency anemia", "It is not the condition that raises the risk."]]),

 dict(topic="Hyphema", io=IO_A, lead="management", cite=D % 25,
  q="Which drugs should be avoided in a patient with hyphema?",
  opts=[["Aspirin and antiplatelet agents", "Correct. They raise the risk of a secondary hemorrhage."],
