...
POOL_D = [
 ...
 dict(topic="Nystagmus", io=IO, lead="next step",
   q="A 22-year-old woman has new asymmetric nystagmus in one eye only. What is the next step?",
   opts=[
     ["Refer for work-up", "Correct. Monocular or asymmetric nystagmus is a concerning, non-physiologic pattern that needs referral and work-up."],
     ["Reassure, it is physiologic", "Physiologic gaze-evoked nystagmus is symmetric."],
     ["Repeat in one year", "Waiting is wrong for a concerning pattern; monocular or asymmetric nystagmus is referred for work-up now."],
