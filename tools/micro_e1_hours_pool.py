...
weighting signal, not a license to leave the deck.
...
dict(topic="Microbe-Human Interactions", io="3.7 — Nosocomial infections",
  ...
  opts=[["Mouth, esophagus and stomach lining", "The upper digestive tract is not among the commonest sites, which are the urinary tract, the airway and surgical wounds."],
...
dict(topic="Specific Immunity", io="6.9 — Passive immunization",
