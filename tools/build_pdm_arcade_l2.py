...
memorized reference value, and none asks for a calculation. The Hounsfield cards
...
DECKS = [
 dict(id="pdm-medical-imaging", name="Principles of Medical Imaging", color="accent2",
  ...
  ["What is a window in computed tomography?", "A pre-selected range of Hounsfield numbers spread across the available gray scale."],
  ...
  ["What is computed tomography's place among imaging modalities?", "The cornerstone of cross-sectional imaging."],
  ...
  ["Which gives the highest organ dose: dental or chest radiography, mammography, barium enema, or adult or neonatal abdominal computed tomography?", "Neonatal abdominal computed tomography, at twice the adult figure."],
  ["Which gives the lowest organ dose: dental or chest radiography, mammography, barium enema, or abdominal computed tomography?", "Dental radiography."],
  ...
  ["Why does positron emission tomography use a glucose analog?", "Because tumors have a higher metabolic rate and consume more glucose."],
  ...
  ["What does color Doppler add?", "Direction of flow and velocity."],
  ["Name two structures ultrasound cannot see through.", "Bone, and large gas-filled structures."],
  ["In which patients is ultrasound often the first study of choice?", "Female pelvis and pediatric patients."],
  ...
  ["Which tissues follow water on T1 and T2?", "Fat, edema, infection, blood, and cerebrospinal fluid."],
  ...
  ["Where is magnetic resonance most widely used?", "Neuro-imaging, and the soft tissues of orthopedics."],
  ...
  ["Besides the heart, what else does the posterior-anterior view improve?", "Lung visualization, the apices, and the posterior ribs; it also lowers dose."],
  ...
  ["Which agent is used for intravenous contrast in computed tomography?", "Omnipaque, or iohexol, a radioactive form of iodine. Note that iodinated and gadolinium agents are not themselves radioactive; only nuclear medicine tracers such as technetium-99 are."],
  ...
  ["What is given to protect the kidneys with iodinated contrast?", "One liter of normal saline."],
  ...
  ["What should always be done before giving contrast?", "Always ask about allergies and assess kidney function."],
  ["Why is cancer a risk factor for all contrast material?", "Because the dyes are technically radioactive, as are the imaging techniques. Iodinated and gadolinium agents are not themselves radioactive; only nuclear medicine tracers are."],
  ["What are the risks of fluorodeoxyglucose-18?", "No contraindications and no known nephrotoxicity, though it may cause hyperglycemia."],
  ...
  ["Color Doppler", "Flow direction and velocity"],
