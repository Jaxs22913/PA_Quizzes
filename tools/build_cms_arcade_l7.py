...
DECKS = [
 dict(id="cms-benign-lesions", name="Benign Skin Lesions", color="accent3",
      icon=ICON, cards=[
  ["What creates a corn, and what is at its center?", "Focal mechanical trauma, creating a cone-shaped central core of hard keratin."],
  ...
  ["Which keratolytic agent is in every over-the-counter corn product?", "Salicylic acid, between about twelve and forty percent."],
  ...
  ["Which scar is associated with dark skin color?", "The keloid. The hypertrophic scar has no such association."],
  ...
  ["What is the recurrence rate after excising a keloid alone?", "Fifty to one hundred percent, and often larger than the original."],
  ...
  ["What pressure and duration are used for keloid compression therapy?", "Twenty-five millimeters of mercury, twenty-four hours a day, for six to twelve months."],
  ...
  ["How common are skin tags by age seventy?", "Present in sixty percent of people."],
  ...
  ["What defines a stage 1 pressure injury?", "A localized area of non-blanchable erythema of intact skin."],
  ...
  ["What defines a deep tissue pressure injury?", "Persistent non-blanchable deep red or purple discoloration; skin intact or not."],
  ...
  ["Which is the most common painful skin tumor?", "Dermatofibroma."],
  ...
  ["What margin is used to excise a keratoacanthoma?", "Five millimeters."],
  ...
  ["Which unusual risk factors are linked to keratoacanthoma?", "Tattoos with red ink, and skin trauma such as lasers, surgery or cryotherapy."],
  ...
  ["By what ages do infantile hemangiomas involute?", "Fifty percent by five, seventy by seven, ninety by nine."],
  ...
  ["What is a telangiectasia?", "A permanently dilated capillary under one millimeter, which blanches."],
  ...
  ["What size defines a cafe au lait spot?", "Over five millimeters prepubertal, over fifteen millimeters postpubertal."],
  ["What is Crowe's sign?", "Intertriginous freckling in the axillary and inguinal regions, with freckles under five millimeters."],
  ...
  ["What is the most common soft tissue tumor?", "The lipoma."],
