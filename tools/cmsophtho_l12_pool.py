...
Q("Acute vision loss approach", IO,
  ...
  "on?",
  [["One or both eyes, duration, pain, and a description",
    "Correct. Ask whether one or both eyes were affected, how long it lasted, whether there was pain, and for a specific description of the symptoms."],
   ...
   ["Onset, duration, severity and relieving factors",
    "That is a generic pain history; it leaves out which eye was affected and a specific description of the visual symptoms."]],
  "two-step", D, 4),
]
