...
CRAM_ROWS = [
 ...
 ("L5 · First Line — Barriers", "#3f8a55", [
   ...
   ("NORMAL FLORA — BOTH barriers", "COMPETES for space and nutrients (PHYSICAL) <b>and</b> makes ANTIMICROBIAL SUBSTANCES (CHEMICAL). Colonization begins AFTER BIRTH."),
   ("SKIN FLORA", "STAPH EPIDERMIDIS, other COAGULASE-NEGATIVE staphs, CORYNEFORM bacteria."),
   ("★ ATOPIC DERMATITIS", "DYSBIOSIS with LESS antimicrobial peptide. Colonizing with COAGULASE-NEGATIVE STAPHS <b>DIMINISHED</b> STAPH AUREUS."),
 ...
 ("L5 · Plasma Proteins & Defensins", "#3f8a55", [
   ...
   ("★ THE GENETIC DEFENSE", "GENE COPY NUMBER varies: <b>2–14</b> alpha, <b>2–12</b> beta. COPY NUMBER DETERMINES HOW MUCH PROTEIN."),
 ...
 ("L5 · Inflammation & Fever", "#3f8a55", [
   ...
   ("★ FEVER — THE 5 BENEFITS", "(1) DECREASES viral and bacterial replication — in BACTERIA by <b>STARVING THEM OF IRON</b>. (2) MORE NEUTROPHILS. (3) MORE T CELL PROLIFERATION. (4) BETTER IMMUNE SIGNALING. (5) <b>ENHANCES TISSUE RESISTANCE TO TNF-α DAMAGE.</b>"),
 ...
 ("L5 · NK Cells & Coordination", "#3f8a55", [
   ...
   ("WHICH STIMULUS, WHICH FUNCTION", "IFN-α/β → favors <b>CYTOTOXICITY</b>. IL-12 → favors <b>CYTOKINE PRODUCTION</b>."),
...
CARDS = [
  ...
  ["What chemical defense do tears carry?", "Lysozyme."],
  ...
  ["What did colonizing atopic skin with coagulase-negative staphylococci do?", "It diminished colonization by Staphylococcus aureus."],
  ...
  ["Which chemical defenses does SEMEN contain?", "Spermine, lysozyme, lactoferrin and phospholipase."],
  ["Which chemical defenses do VAGINAL secretions contain?", "Lactic acid, beta defensin and hydrogen peroxide."],
  ...
  ["Why are defensins called antichaperones?", "They neutralize a broad range of microbial toxins by unfolding them."],
  ["Why is defensin production a GENETIC defense?", "Gene copy number varies between individuals — 2 to 14 alpha, 2 to 12 beta — and sets how much protein is made."],
  ...
  ["Why can a limited set of receptors cover so many organisms?", "Each recognizes a pattern shared by a whole pathogen family."],
  ...
  ["Which cytokine dilates vessels to give heat, swelling, redness and pain?", "Tumor necrosis factor alpha."],
  ...
  ["Which three cytokines cause fever?", "Interleukin 1 beta, interleukin 6 and tumor necrosis factor alpha."],
  ["How does fever act against bacteria specifically?", "It starves them of iron."],
  ["Name three benefits of fever besides slowing replication.", "More neutrophils, more T cell proliferation, better immune signaling — and resistance to tumor necrosis factor damage."],
  ["What does LOCAL tumor necrosis factor alpha achieve?", "It clots blood in the venules, preventing spread of infection to the blood."],
  ["What does SYSTEMIC tumor necrosis factor alpha cause?", "Shock, organ failure and death."],
  ...
  ["What percentage of white cells are neutrophils?", "55 to 90 percent."],
  ["What percentage are eosinophils, and what do they kill?", "1 to 3 percent; eukaryotic pathogens."],
  ["What percentage are basophils?", "0.5 percent."],
  ["What percentage are monocytes and macrophages?", "3 to 7 percent — and they are the largest white cells."],
  ["What percentage are lymphocytes?", "20 to 35 percent."],
  ...
  ["Name three uses of the differential white count.", "Infection types, inflammation and allergies — plus immune disorders, leukemia and myelodysplastic syndrome."],
  ...
  ["Which stimulus favors NK cytotoxicity, and which favors cytokine release?", "Interferons alpha and beta favor killing; interleukin 12 favors cytokines."],
