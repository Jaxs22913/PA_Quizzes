...
CARDS = [
  ...
  ["Which chemical defences does SEMEN contain?", "Spermine, lysozyme, lactoferrin and phospholipase."],
  ["Which chemical defences do VAGINAL secretions contain?", "Lactic acid, beta defensin and hydrogen peroxide."],
