#!/usr/bin/env python3
"""Partition CMS I Lecture 3 Set 1 (Dermatology II) into two 30s.
...
Length-bias remediation runs first. It needed far less work here than on
Lecture 2 -- 24% raw against that pool's 66% -- because this pool was drafted
with MATCHED OPTION LENGTHS as it was written rather than repaired afterwards.
That is the real fix; remediation is for the residue.
...
from cms_l3_pool_d import POOL_D
from cms_l3_pool_e import POOL_E
from cms_l3_lengthfix import SLOT_FIXES
...
if __name__ == "__main__":
    ...
    json.dump({"set1": s1, "set2": s2},
              open(os.path.join(HERE, "cms_l3_set1.json"), "w"), ensure_ascii=False, indent=1)
    print("wrote cms_l3_set1.json")
