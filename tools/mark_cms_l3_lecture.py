...
BLOCK = OPEN + '''
  ...
  <table>
    ...
    <tr><td><em>&ldquo;Dapsone&hellip; we also want to check the glucose-6-phosphate dehydrogenase deficiency. This is a condition you cannot take dapsone in.&rdquo;</em> [13:45]</td><td>The full dermatitis herpetiformis package, and the deck does not spell all of it out: <b>dapsone acutely</b>, but <b>check for glucose-6-phosphate dehydrogenase deficiency first</b> because it is a contraindication; <b>strict gluten-free diet</b> long term; <b>refer to gastroenterology for colonoscopy</b>, because there is a high chance of celiac disease; and <b>refer to a registered dietitian</b>.</td></tr>
...
CARDS = [
 ...
 ["What proportion of toxic epidermal necrolysis is drug induced?", "Eighty percent."],
 ["What causes epidermolysis bullosa?", "A mutation in structural proteins."],
 ["What size are erythema nodosum lesions, and where?", "One to five centimeters, on the anterior shins or tibial surface."],
