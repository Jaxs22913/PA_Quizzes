...
BLOCK = OPEN + '''
  ...
  <table>
    ...
    <tr><td><em>&ldquo;Allopurinol is the most common cause worldwide of this&hellip; it&rsquo;s drug induced in 80% of cases.&rdquo;</em> [57:15]</td><td>On toxic epidermal necrolysis. The proportion and the single commonest agent, both stated plainly.</td></tr>
...
CRAM_ROWS = [
 ...
 ("Toxic epidermal necrolysis", "DRUG INDUCED IN 80% OF CASES. ALLOPURINOL is the MOST COMMON CAUSE WORLDWIDE."),
