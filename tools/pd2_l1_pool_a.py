...
POOL_A = [
 ...
 dict(topic="Oral presentation", io=IOC,
   ...
   opts=[
     ["It leads the listener to the same differential the presenter reached",
     ...
     ["It avoids all medical terminology in favor of plain language",
 ...
 dict(topic="Oral presentation", io=IOC,
   ...
   opts=[
     ["To help the listeners visualize the patient and understand the problem",
      "Correct, which is why it should be a well-organized vignette describing the patient and the clinical problem."],
 ...
 dict(topic="Oral presentation", io=IOC,
   ...
   opts=[
     ["Try not to read from them",
      "Correct — reading works directly against helping the listener visualize the patient."],
 ...
 dict(topic="Documentation", io=IOG,
   ...
   opts=[
     ...
     ["Only widely recognized medical abbreviations may be used",
