...
POOL_A = [
 ...
 dict(topic="Focused encounter", io=IOE,
   ...
   opts=[
     ["History of present illness",
      "Correct — all four are narrowed, alongside family history, medications and allergies. Review of systems, past medical history and social history."],
 ...
 dict(topic="Focused encounter", io=IOE,
   ...
   opts=[
     ["Differentials, laboratory and imaging studies, a diagnosis",
      "Correct. The encounter tests the whole reasoning chain rather than data gathering alone. A treatment plan including patient education."],
 ...
 dict(topic="Documentation", io=IOG,
   ...
   opts=[
     ["Work is not original when it has already been submitted for academic credit",
      "Correct — which is why reusing a template from a previous assignment carries a warning. Whether by you or anyone else."],
 ...
 dict(topic="Communication", io=IOH,
   ...
   opts=[
     ["Accept the constructive feedback and modify behaviour",
      "Correct — the variation is anticipated rather than treated as a contradiction to be resolved. Recognising that different facilitators give different feedback."],
 ...
 dict(topic="Documentation", io=IOG,
   ...
   opts=[
     ["The grading rubric",
      "Correct — prior feedback is the most direct guide to what still needs improving. The comments left on previous assignments."],
