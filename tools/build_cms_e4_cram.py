...
{"id": "l25-dx", "label": "Heart Failure: Diagnosis & Therapy", "color": "#2f5d6b", "rows": [
 ...
 ["&#9733; Natriuretic peptide cut-offs", "<b>BNP (B-type natriuretic peptide)</b>: &lt;100 rules out acute failure; 100&ndash;400 grey zone; &gt;400 likely; <b>&gt;900 likely acute</b>. <b>NT-proBNP (N-terminal pro-B-type)</b>: &lt;300 rules out; &gt;125 likely if &lt;75 years, <b>&gt;450 if &gt;75</b>. BNP is degraded by neprilysin, so sacubitril-valsartan alters it."],
