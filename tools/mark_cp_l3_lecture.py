...
worth keeping: Barrett's esophagus for metaplasia, cervical dysplasia for
...
falling differentiation means a MORE AGGRESSIVE tumor.
...
BLOCK = OPEN + '''
  ...
  <table>
    ...
    <tr><td><em>&ldquo;Someone with chronic gastroesophageal reflux&hellip; that acid that comes up, what do you think it does to the lower esophagus?&hellip; it goes through a metaplasia. It turns from squamous to columnar cells. And that has a name. <mark class="prof-highlight">It&rsquo;s called Barrett&rsquo;s esophagus</mark>&hellip; increased risk of esophageal carcinoma.&rdquo;</em> [7:45]</td><td><b>The metaplasia example, and it is not on the slide.</b> The lower esophagus is squamous and cannot resist acid, so chronic reflux drives it to columnar. Then the corollary he draws, which is the genuinely useful bit: in an esophageal carcinoma, <b>squamous cells on the sample means a primary cancer; columnar cells means it is secondary to reflux.</b></td></tr>
    ...
    <tr><td><em>&ldquo;<mark class="prof-highlight">Stop taking notes, just listen to me. Record me, and at home you can listen to me and pause.</mark>&rdquo;</em> [3:56]</td><td>His stated advice on how to take his lecture. Worth honoring &mdash; this guide exists partly so that is a workable strategy.</td></tr>
  </table>
