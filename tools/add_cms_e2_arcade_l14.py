...
DECKS = [
 dict(id="cms-ocular-trauma", name="Ocular Trauma", color="accent3", icon=SHIELD, cards=[
  ...
  ["Which findings make CT without contrast automatic?", "Loss of consciousness, alcohol, confusion, tachypnea, apnea, anticoagulants, eye penetration."],
  ...
  ["What happens to a lens whose capsule is cut?", "It becomes hydrated, edematous and opaque."],
  ...
  ["How is a corneal foreign body removed?", "Sterile 27-gauge needle after topical anesthetic."],
  ...
  ["What is an orbital contusion?", "Soft tissue swelling within the orbit without hemorrhage."],
  ["What keeps contusion blood in front of the eye?", "The tarsal plate and septal margin."],
  ["What is a periorbital hematoma?", "Bleeding within the bony orbit."],
  ["How is a periorbital hematoma treated?", "Canthotomy with cantholysis."],
  ["Name non-traumatic causes of periorbital hematoma.", "Eye surgery, peribulbar injections, orbital varices, malformations, anticoagulants, sickle cell, pseudotumour."],
  ...
  ["What shape is a traction detachment?", "Localized and concave."],
 ...
 dict(id="cms-orbital-fractures", name="Orbital &amp; Skull Fractures", color="accent2", icon=BONE, cards=[
  ...
  ["Name the indirect signs of a basilar skull fracture.", "Raccoon eyes, Battle sign, hemotympanum, CSF leak, bleeding into the middle ear or sphenoid sinus."],
  ...
  ["What is hemotympanum?", "Blood behind the tympanic membrane."],
