...
DECKS = [
 dict(id="pdm-derm-ent-ophtho", name="Derm, Ophtho &amp; ENT Testing", color="accent4",
  ...
  ["What rule governs the choice of diagnostic test?", "Always choose the least invasive test that answers the clinical question."],
  ["Which test answers abscess versus cellulitis?", "Point-of-care ultrasound."],
  ["Which three tests make up dermatologic bedside testing?", "Potassium hydroxide preparation, Tzanck smear and Gram stain."],
  ...
  ["What concentration of potassium hydroxide does the procedure use?", "Twenty percent, one drop."],
  ...
  ["What margin does the melanoma rule specify for the diagnostic biopsy?", "One to three millimeters, a narrow excisional biopsy."],
  ...
  ["What does the T category measure in melanoma?", "How deeply the primary tumor has grown, in millimeters."],
  ["Which Breslow depth is T2?", "More than one millimeter and up to two millimeters."],
  ...
  ["Which lesion should not be cultured?", "An inflamed epidermoid cyst."],
  ["With what is a wound cleaned before the Levine method?", "Sterile water or saline, never an antimicrobial solution."],
  ["How is the swab used in the Levine method?", "Rotated for five seconds over one to two centimeters of clean tissue, with enough pressure to express fluid."],
  ...
  ["Unilateral visual loss localizes where?", "To the optic nerve or the eye itself."],
  ["Bilateral visual loss suggests what?", "A systemic or intracranial cause."],
  ["A central scotoma localizes where?", "To the macula or the optic nerve."],
  ["Which field pattern goes with glaucoma?", "Peripheral loss."],
  ["Bitemporal hemianopia localizes where?", "To the chiasm, classically a pituitary lesion."],
  ["Homonymous hemianopia localizes where?", "To a retrochiasmal lesion, possibly a stroke."],
  ...
  ["What is the normal intraocular pressure?", "Ten to twenty-one millimeters of mercury."],
  ...
  ["What is the sensitivity of the rapid streptococcal antigen test?", "About seventy to ninety percent, so false negatives occur."],
  ...
  ["Where does a normal tympanogram peak?", "At fifty millimeters of water."],
  ...
  ["Below what pressure is negative middle-ear pressure significant for treatment?", "More negative than minus two hundred millimeters of water."],
  ...
  ["What is the clinical pearl for magnetic resonance?", "Think magnetic resonance for soft tissue, nerves, and tumor or intracranial extension."],
  ...
  ["Which syndrome is an example of vascular thrombosis in the neck?", "Lemierre syndrome."],
  ...
  ["Soft tissue, nerves and tumor", "Magnetic resonance imaging"],
 ...
 dict(id="pdm-cbc-hematology", name="Complete Blood Count &amp; Hematology", color="accent",
  ...
  ["What is the normal white blood cell count?", "Four thousand five hundred to eleven thousand cells per microliter."],
  ...
  ["What is the normal neutrophil percentage?", "Fifty-four to sixty-two percent, the most abundant white cell."],
  ["How is the neutrophil nucleus described?", "Three to four lobes, with granular cytoplasm."],
  ["What are bands, and what is their normal proportion?", "Immature neutrophils, normally five percent or less."],
  ...
  ["Which toxic chemical is a cause of neutropenia?", "Benzene."],
  ["Which three viruses suppress bone marrow function?", "Mononucleosis, human immunodeficiency virus and hepatitis."],
  ["What is the normal eosinophil percentage, and what do its granules hold?", "One to three percent, with granules containing histamines."],
  ...
  ["What is the monocyte's rank and normal percentage?", "The largest white blood cell, three to seven percent."],
  ...
  ["A count of six thousand with forty percent neutrophils and five percent bands gives what?", "Two thousand seven hundred per microliter."],
  ["How is mild neutropenia defined?", "One thousand to under one thousand five hundred cells per microliter."],
  ["How is moderate neutropenia defined?", "Five hundred to under one thousand cells per microliter."],
  ["How is severe neutropenia defined?", "Under five hundred cells per microliter."],
  ["Where do platelets come from?", "Megakaryocytes in the bone marrow, which break into fragments."],
  ["Why are platelets not really cells?", "They are fragments of megakaryocytes rather than whole cells."],
  ...
  ["Name three causes of chronic hypoxia.", "Chronic obstructive pulmonary disease, sleep apnea and high altitude."],
  ...
  ["What is the normal mean corpuscular volume?", "Eighty to one hundred femtoliters."],
  ...
  ["What does mean corpuscular hemoglobin concentration measure?", "The average hemoglobin concentration in packed red cells, thirty-two to thirty-six grams per deciliter."],
  ...
  ["Name four types of schistocyte.", "Triangular cell, horn cell, helmet cell and microspherocyte."],
  ...
  ["What is a teardrop cell associated with?", "Bone marrow disease, from marrow infiltrated by scar tissue or tumor."],
  ...
  ["What is rouleaux formation, and why does it happen?", "Red cells stacked like rows of coins, because raised serum proteins neutralize their negative charge."],
  ...
  ["What are the three mean corpuscular volume bands?", "Microcytic under eighty, normocytic eighty to one hundred, macrocytic over one hundred femtoliters."],
  ...
  ["Which condition has a low cell size with all other iron studies normal?", "Thalassemia minor."],
  ...
  ["Immature neutrophils above five percent", "Left shift"],
 ]),
]
