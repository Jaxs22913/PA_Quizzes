...
BLOCK = '''%s
  ...
  <table>
    ...
    <tr><td><em>Nasal mupirocin <mark class="prof-highlight">twice a day for five days</mark> &ldquo;will kill the colonization within their nose&rdquo;</em> [22:56]</td><td>For <b>recurrent</b> folliculitis, check whether the patient is a <em>Staphylococcus aureus</em> carrier and decolonize the nares. She notes the pre-filled swabs were discontinued, so it is applied manually now.</td></tr>
