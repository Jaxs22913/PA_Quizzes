#!/usr/bin/env python3
"""Render CMS I Lecture 3 Set 2 — the two Dermatology II vignette quizzes."""
import sys, os, json
HERE = os.path.dirname(os.path.abspath(__file__))
sys.path.insert(0, os.path.join(HERE, "quiz-template"))
from render import render
OUT = os.path.join(os.path.dirname(HERE), "Clinical Medicine and Surgery I Exam 1")
S = json.load(open(os.path.join(HERE, "cms_l3_set2.json"), encoding="utf-8"))
...
INTRO = ("Thirty clinical vignettes on Dermatology II. Each case carries a presentation, the clues "
         ...
         "maligna on dermoscopy. Every question cites its slide.")
for n, key in ((1, "set1"), (2, "set2")):
    fn = "dermatology-ii-vignettes.html" if n == 1 else "dermatology-ii-vignettes-version-2.html"
    html = render(title=f"Dermatology II Vignettes {n} &mdash; CMS I Exam 1",
                  h1="Dermatology II &mdash; Vignettes",
                  sub="Clinical Medicine and Surgery I &middot; Exam 1 &middot; Lecture 3 &middot; Vignette set",
