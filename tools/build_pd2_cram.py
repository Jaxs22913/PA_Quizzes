...
exact numbers and names verbatim (the one-centimeter hinges, the ulcer stages,
...
topics = [
 {"id": "encounter", "label": "The Encounter, Presentation & Documentation", "color": "#4a5c24",
  "rows": [
    ...
    ["Oral presentation — the test",
     "A good presentation leads your facilitator to the same differential you formulated. It is a well-organized vignette, not the written note read aloud; the goal is to help listeners visualize the patient."],
    ...
    ["Communication",
     "Adapt style and content for each patient. When someone else supplies the answers, ALWAYS look at and interact with the patient, not the person answering. Accept feedback and modify behavior; different facilitators give different feedback, and that is expected."],
  ]},
 ...
 {"id": "vocabulary", "label": "Descriptive Vocabulary — Distribution & Configuration", "color": "#8a7526",
  "rows": [
    ["Five features of any lesion",
     "Distribution (location) · configuration (shape) · morphology (form and structure) · color · texture."],
    ["Distribution → diagnosis",
     "Generalized/diffuse = allergic reactions. Regional = tinea capitis. Sun-exposed (photodistribution) = skin cancers. Dermatome = herpes zoster. Extensor = psoriasis. Flexor = intertrigo. Intertriginous = skin creases and folds."],
    ["Configuration terms",
 ...
 {"id": "abnormal", "label": "Abnormal Findings — Skin, Hair & Nails", "color": "#7d3f52",
  "rows": [
    ["Diascopy",
     "Press clear glass or plastic against the skin and look at the lesion under pressure. Color FADES = vascular engorgement. Does NOT fade = hemorrhage in the skin."],
    ...
    ["Pressure ulcer stages",
     "I: INTACT skin, erythema failing to blanch, plus change in temperature, consistency, sensation, color. II: PARTIAL thickness loss (epidermis, dermis or both). III: FULL thickness, subcutaneous necrosis, may extend to but NOT through muscle. IV: full thickness with destruction of tissue, muscle and/or bone."],
    ["Tinea by site",
    ...
    ["Skin malignancies",
     "Basal cell carcinoma: face; translucent PEARLY nodule, depressed center, raised borders; may ulcerate; non-healing ulcer. Squamous cell carcinoma: face and sun-exposed; red scaling, crusting nodule or plaque that ulcerates and bleeds. Melanoma: irregularly colored plaque with sharp notches and pigment variation."],
    ["Melanoma warning letters",
     "A asymmetry or shape · B border irregularity · C color variation · D diameter larger than 6 mm · E evolving, elevation · F family history · G growing."],
    ["Kaposi's sarcoma",
     "The most frequent neoplasm in patients with acquired immunodeficiency syndrome. Light-colored lesions coalescing into darker ones; dark blue-purple macules, papules, nodules and plaques; widely disseminated on legs, trunk, arms, neck and head."],
 ...
 {"id": "technique", "label": "Performing the Skin Examination", "color": "#3f5b6b",
  "rows": [
    ...
    ["Six characteristics assessed",
     "Color · moisture (dryness, sweating, oiliness) · temperature (warmth, coolness) · texture (roughness, smoothness) · mobility and turgor · lesions."],
    ...
    ["Central vs peripheral cyanosis",
     "Central: often inadequate oxygenation IN THE LUNGS. Peripheral: usually inadequate CIRCULATION. Same color, different organ."],
    ["Hair & scalp",
     "Inspect color, distribution and quantity; palpate for texture. Separate the hair into sections to see the scalp, and inspect BEHIND THE EARS and the OCCIPUT. Should be clean — no lesions, discolorations, flaking or parasites. A magnifying glass aids inspection for lice (nits are tiny white ovoid granules adherent to hairs)."],
    ["Pruritus is not a diagnosis",
     "It is the sensation causing the desire to scratch. Generalized itching with no obvious reason: dry skin, aging, pregnancy, uremia, jaundice, lymphomas, leukemias, drug reaction, lice."],
