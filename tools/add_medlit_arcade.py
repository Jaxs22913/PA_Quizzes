...
DECKS = [
 ("medlit-bias", "Bias &amp; Validity", "accent1", SCALE_ICON, [
  ...
  ("Classic measurement bias example?", "Blood pressure taken without a standardized procedure every time."),
  ...
  ("Procedural bias example?", "A post-operative questionnaire given while anesthesia is still wearing off."),
  ...
  ("Two forces driving publication bias?", "Journal editor preference, and sponsors unwilling to support unfavorable research."),
  ...
  ("What is the Behavioral Risk Factor Surveillance Survey?", "A telephone survey of risk behaviors, chronic conditions and preventive service use."),
 ...
 ("medlit-evidence", "Evidence", "accent2", BOOK_ICON, [
  ...
  ("What did Dr Archie Cochrane advocate?", "Randomized controlled trials and systematic reviews to verify treatment effectiveness."),
  ...
  ("Three properties of higher-level evidence?", "Least vulnerable to bias, more generalizable, outcomes attributable to the construct studied."),
  ("What sits at the base of the pyramid?", "Background information and expert opinion."),
  ("What sits at the apex?", "Systematic reviews."),
  ("What sits immediately below randomized trials?", "Cohort studies."),
 ...
 ("medlit-design", "Study Design", "accent3", FLASK_ICON, [
  ...
  ("Define study design.", "The organization and plan for data collection and analysis."),
  ...
  ("Three analytic examples?", "Randomized controlled trials, cohort, case control."),
  ...
  ("Policy research determines?", "Whether a program works or a policy is helpful."),
  ...
  ("Four things a good design allows?", "Group comparison, quantifying risk difference, determining temporal sequence, minimizing bias."),
  ("Typical study sequence?", "Clinical observations, available data, case-control, cohort, randomized trials."),
  ...
  ("A randomized controlled trial is what kind of design?", "Experimental, for testing hypotheses."),
 ...
 ("medlit-rates", "Rates &amp; Measurement", "accent4", CHART_ICON, [
  ...
  ("What must proportionate mortality sum to?", "One hundred percent."),
  ...
  ("Two clinical uses of prevalence?", "Prioritizing the differential, and setting the pretest probability."),
  ...
  ("Why does surveillance need a baseline?", "Without it, a rise in cases cannot be recognized as a rise."),
  ("Which designs let surveillance test etiology?", "Case-control or cohort studies."),
 ...
 ("medlit-data", "Data &amp; Variation", "accent5", RULER_ICON, [
  ...
  ("Nominal examples?", "Blood group, eye color."),
  ...
  ("Ordinal examples?", "Cancer staging I&ndash;IV, pitting edema 1+ to 4+."),
  ...
  ("What falls within 2 standard deviations?", "About 95 percent of the values."),
  ...
  ("What caution applies to normal/abnormal cutoffs?", "They are often arbitrary &mdash; be careful of labeling."),
 ]),
 ...
 ("medlit-tests", "Diagnostic Tests", "accent1", GRID_ICON, [
  ...
  ("Four gold standard examples?", "Culture for strep throat, biopsy for cancer, catheterization for coronary disease, endoscopy for peptic ulcer."),
  ...
  ("When does a very high LR rule disease in?", "When the pretest probability lies between 30 and 70 percent."),
  ...
  ("Serial testing example?", "Exercise tolerance test, then cardiac catheterization if positive."),
