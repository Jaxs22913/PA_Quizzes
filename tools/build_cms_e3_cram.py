...
topics = [
 ...
 dict(id="oral", label="Mouth, throat and jaw", color="#8c4a5f", tag="Lecture 19", rows=[
  ...
  ["MONONUCLEOSIS", "<b>Fever + tonsillar pharyngitis + cervical adenopathy</b>, ages 15&ndash;24, <b>EBV 90%</b>. <b>MONOSPOT falsely negative in WEEK 1</b> (heterophile antibodies take a week to appear) &mdash; <b>slide 84 prints &ldquo;falsely positive&rdquo;; a student caught it in class on 9 September and Prof. Shah confirmed the slide is wrong and is sending a corrected one.</b> <b>NO CONTACT SPORTS ~1 MONTH</b> &mdash; splenic rupture. <b>GIVING PENICILLIN CAUSES A RASH</b> &mdash; that rash is often how the diagnosis gets made."],
