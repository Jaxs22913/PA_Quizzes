...
AUDIO: both halves of the 18 September recording (46 + 51 minutes) were read
in BOTH transcripts -- Notability's own and the local faster-whisper run -- and
cross-examined 2026-09-25. Every quote and aside in the box appears in both,
cited by the whisper timestamp. The two "slips" (type 2 for immune complexes,
"IgA mediated") are in both, so they are what was said, not ASR noise.
"""
...
<!--MICROL7AUDIO-->
  ...
  <p>About 97 minutes with Dr. Webster, in two parts. <b>Both transcripts read and compared</b>
  (Notability&rsquo;s own and an independent local transcription); <b>every quote below appears in
  both</b>, with the same wording and timing. Every factual claim was checked against the deck, and
  where the two differ the slide is what this guide teaches.</p>
  <p><b>Unlike Lecture 1, this lecture signposts.</b> It names one chart to learn, one mechanism
  that matters most, one pairing she said outright you need to know, and <b>six slides not to
  memorize</b>.</p>
  <table>
    ...
    hypersensitivities.&rdquo;</em> [part 1, 10:14]</td>
    ...
    all</mark>.&rdquo;</em> [part 2, 13:13] &mdash; and of autoimmunity, <em>&ldquo;type one is not
    involved in either of these.&rdquo;</em> [part 2, 21:50]</td>
    <td>Type I plays no part in graft rejection or in autoimmunity. Both lists run II, III and IV.</td></tr>
    <tr><td><em>&ldquo;B cell defect is agammaglobulinemia&hellip; this we associate with more bacterial
    infections. And <mark class="prof-highlight">yes, you need to know that. That&rsquo;s why it is
    bold and italicized</mark>.&rdquo;</em> [part 2, 32:34] She repeated the pairing a minute and a
    half later: <em>&ldquo;remember the T cell deficiency, you get more of fungal, viral, protozoan
    infections; B cell deficiency, more of the bacterial infections.&rdquo;</em> [part 2, 34:12]</td>
    <td>B cell deficiency &rarr; recurrent <b>bacterial</b> infections; T cell deficiency &rarr;
    fungal, viral and protozoan (slides 63&ndash;64). The only thing in the lecture said twice
    and called &ldquo;need to know&rdquo;.</td></tr>
    <tr><td><em>&ldquo;This is not a chart you need to memorize.&rdquo;</em> [part 1, 4:07]</td>
    ...
    <tr><td><em>&ldquo;You don&rsquo;t need to memorize this chart.&rdquo;</em> [part 2, 19:57]</td>
    ...
    those charts.&rdquo;</em> [part 2, 29:48&ndash;30:11]</td>
    ...
    the sequence.&rdquo;</em> [part 2, 37:03]</td>
    ...
    cell leukemia virus as well as HIV and some herpes viruses.&rdquo;</em> [part 2, 39:27&ndash;39:45]</td>
  ...
  <p><b>Things said that are not on a slide</b> &mdash; consistent with the deck, useful as hooks, and
  each present in both transcripts:</p>
  <ul>
    <li><b>Immunoglobulin G is the only antibody that crosses the placenta</b>, which is why a
    sensitized Rh-negative mother&rsquo;s <em>next</em> Rh-positive baby is the one at risk. [part 1, 43:22]</li>
    ...
    that is not always enough to prevent graft versus host disease. [part 2, 18:43]</li>
    <li>&ldquo;Nobody actually dies of HIV. They die of the things you catch because of the suppressed
    immune system.&rdquo; [part 2, 35:30]</li>
  </ul>
  <p class="muted"><b>Two slips to ignore</b>, both now heard in <em>both</em> transcripts, so they are
  what was said rather than transcription errors. She opens part 2 by calling immune complexes
  &ldquo;a type 2 reaction&rdquo; [part 2, 0:07], straight after closing part 1 with &ldquo;before we
  start with type three&rdquo;; slide 38 says type III, and it is type III. And she calls allergy
  &ldquo;IgA mediated&rdquo; [part 1, 25:47] in the late-phase sentence, then says &ldquo;those new
  IgE&rdquo; eight seconds later; slide 23 says immunoglobulin E. (IgE and IgA sound alike, so a
  shared mishearing cannot be ruled out; either way the answer is IgE.) Go by the slides.</p>
  </div>
<!--/MICROL7AUDIO-->
