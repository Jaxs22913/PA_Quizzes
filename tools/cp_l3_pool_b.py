 ...
 dict(topic="Benign vs malignant", io=IOC,
   ...
   opts=[
     ...
     ["Always poorly differentiated",
      "Malignant tumours range from well to poorly differentiated, and that grade is part of what predicts behaviour."],
     ["Always anaplastic",
      "Anaplasia is the extreme end, not the rule."],
     ["Always well differentiated",
      "Uniformly good differentiation characterises benign tumours; malignant ones span the whole range."]],
   c=0, cite=c(13)),
 ...
 dict(topic="Haematogenous spread", io=IOD,
   ...
   opts=[
     ...
     ["Arteries, especially the aorta and its major branches",
      "Arteries have thick muscular walls that tumour rarely penetrates; thin-walled veins are the usual route into the circulation."],
 ...
 dict(topic="Haematogenous spread", io=IOD,
   ...
   opts=[
     ...
     ["Because liver and lung tissue are uniquely receptive to any tumour cell",
      "Tissue receptivity plays a part in where cells survive, but this particular pairing follows simply from where each vein delivers its blood."],
 ...
 dict(topic="Seeding", io=IOD,
   ...
   opts=[
     ...
     ["The subarachnoid space",
      "Seeding does occur in the subarachnoid space, but the peritoneal cavity is much the commonest site, given how many abdominal organs abut it."]],
   c=0, cite=c(15)),
 ...
 dict(topic="Invasion cascade", io=IOD,
   ...
   opts=[
     ...
     ["Penetration of the vasculature, evasion of apoptosis, and induction of angiogenesis",
      "Evading apoptosis and inducing angiogenesis are steps in becoming a tumour; the hurdles to metastasis are entering the circulation, surviving in it, and surviving at the destination."],
 ...
 dict(topic="Metastatic pattern", io=IOD,
   ...
   opts=[
     ["Venous blood flow, tumour and endothelial receptors, and genetic fitness",
      "Correct — anatomy sets where cells are carried, receptor matching determines where they can adhere, and only genetically capable cells survive to establish a deposit."],
     ["Chance alone, since circulating tumour cells lodge wherever the vessel first narrows",
      "Spread is not random: venous drainage, receptor matching between tumour and endothelium, and the genetic fitness of the cell all shape where deposits form."],
 ...
 dict(topic="Metastatic pattern", io=IOD,
   ...
   opts=[
     ["No — it is determined by blood flow, receptors, and genetically determined fitness",
      "Correct — the pattern is reproducible enough to predict, because blood flow, adhesion receptors and cell fitness each constrain where a deposit can form."],
     ["Yes — circulating cells lodge in whichever capillary bed they reach first",
      "If spread were purely mechanical, every tumour would metastasise to the same first capillary bed, which is not what is observed."],
     ["Yes for haematogenous spread, no for lymphatic spread",
      "Neither route is random; both are constrained by anatomy and by which cells can adhere and survive at the destination."],
     ["No — but only because lymphatic drainage is anatomically fixed",
      "Lymphatic anatomy is one constraint, but the non-randomness also reflects venous drainage, receptor matching and genetic fitness."]],
   c=0, cite=c(27)),
