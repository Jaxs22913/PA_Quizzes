...
POOL_E = [
 ...
 dict(topic="Suspected urinary tract infection", io=IOC, slot="limitation",
   ...
   opts=[
     ...
     ["Pediatric specimens must be refrigerated first",
 ...
 dict(topic="Nephrotic syndrome", io=IOC, slot="interpretation",
   ...
   opts=[
     ...
     ["The color",
      "Color points to concentration, bilirubin, or blood."],
     ["The odor",
      "Odor points to infection or ketones."],
     ["The transparency",
 ...
 dict(topic="Specimen quality", io=IOC, slot="limitation",
   ...
   opts=[
     ["Colonization of the catheter rather than acute infection",
      "Correct — long-term catheters are colonized."],
