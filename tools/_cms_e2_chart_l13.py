...
ROWS_L13 = [
 ...
 ("Myopia", REF,
  ...
  "<b>Concave (negative diopter) lens</b> &mdash; scatters light and moves focus back onto the retina.",
  "Routine",
 ...
 ("Hyperopia", REF,
  ...
  "<b>Convex (positive diopter) lens</b> &mdash; converges light forward onto the retina.",
  "Routine",
