...
{"topic": "Epidemiology", "io": IOA, "slot": "purpose",
 ...
 "opts": [
  ["Discovering agent, host and environmental factors that affect health",
   "Correct, and two more complete the set: identifying the population segments at greatest risk, and evaluating whether health programs and services actually improve population health. Ranking the relative importance of causes of illness, disability and death belongs to it too."],
  ...
  ["Determining the appropriate dose of a medication for a given patient",
   "Dosing is a pharmacological question. The purposes named for epidemiology concern causes, risk segments and program evaluation across populations."],
  ["Setting the reimbursement rates paid to hospitals and clinics",
   "Payment policy is not among the named purposes, which center on identifying causes, risks and the effectiveness of health programs."]],
 "c": 0, "cite": c(11)},
...
{"topic": "Epidemiology", "io": IOA, "slot": "contribution",
 ...
 "opts": [
  ...
  ["Synthesizing new pharmaceutical compounds",
  ...
  ["Writing the medical record for an individual encounter",
   "Documentation is a clinical task. The contributions named are population-level: transmission, preventable causes, natural history and program evaluation."]],
 "c": 0, "cite": c(12)},
...
{"topic": "Data sources", "io": IOA, "slot": "data source",
 ...
 "opts": [
  ...
  ["Self-reported health behaviors gathered by telephone",
...
{"topic": "Data sources", "io": IOA, "slot": "data source",
 ...
 "opts": [
  ["A telephone survey of health-related risk behaviors",
   "Correct, and it also captures chronic health conditions among United States residents, which makes it a behavioral and chronic-disease instrument rather than a registration system. It covers preventive service use as well."],
  ["A registry of cancer cases maintained by state government",
   "That describes a disease registry such as the Connecticut tumor registry or the Florida Cancer Data System."],
...
{"topic": "Data sources", "io": IOA, "slot": "data source",
 ...
 "opts": [
  ...
  ["It measures self-reported behavior in a representative sample",
   "Self-reported behavior in a sample describes a survey instrument such as the Behavioral Risk Factor Surveillance Survey."],
...
{"topic": "Clinical epidemiology", "io": IOA, "slot": "definition",
 ...
 "opts": [
  ...
  ["Replaces the history and physical examination with statistical reasoning",
   "It informs clinical judgment rather than replacing examination, and good decisions still rest on history, examination and provider knowledge."],
...
{"topic": "Evidence-based medicine", "io": IOB, "slot": "definition",
 ...
 "opts": [
  ["Applying clinical epidemiology to patient care",
   "Correct, and it has three moves: using clinical judgment to assess available research for validity and applicability, then applying that evidence to decisions about care."],
  ["Following national guidelines without individual judgment",
   "Clinical judgment is built into the definition: the research must be assessed for validity and applicability before it is applied."],
...
{"topic": "Other influences", "io": IOB, "slot": "definition",
 "q": "What characterizes nervousness-based medicine?",
 "opts": [
  ["Fear of litigation driving over-investigation",
...
{"topic": "Finding evidence", "io": IOA, "slot": "resource",
 ...
 "opts": [
  ["Hospital or clinic, national, and professional bodies",
   "Correct, with the Centers for Disease Control and Prevention among the national sources and bodies such as the American Academy of Pediatrics among the professional organizations."],
  ["Only by national government agencies",
   "Guidelines also exist at hospital or clinic level and are issued by professional organizations."],
  ["Only by the individual treating clinician",
   "Guidelines are produced by institutions, national bodies and professional organizations rather than by individual practitioners."],
  ["Only by the journals that publish original research",
   "Journals publish research and reviews; guidelines come from clinical institutions, national agencies and professional organizations."]],
 "c": 0, "cite": c(30)},
...
{"topic": "The five As", "io": IOB, "slot": "framework",
 ...
 "opts": [
  ...
  ["Assess validity and applicability",
   "That is Appraise, the third step, where clinical judgment is brought to bear on what was retrieved."],
...
{"topic": "Purposes of research", "io": IOB, "slot": "purpose",
 ...
 "opts": [
  ...
  ["To analyze data that another researcher has already collected",
...
{"topic": "Primary and secondary research", "io": IOB, "slot": "definition",
 ...
 "opts": [
  ...
  ["Primary research is always a randomized trial",
...
{"topic": "Primary and secondary research", "io": IOB, "slot": "definition",
 ...
 "opts": [
  ["Meta-analyses and systematic review articles",
   "Correct, because both analyze data that already exists rather than collecting new data. Original research articles are the example of primary research."],
...
{"topic": "Data sources", "io": IOA, "slot": "data source",
 ...
 "opts": [
  ...
  ["Practice guidelines issued by professional organizations",
   "Guidelines synthesize evidence into recommendations rather than serving as a source of epidemiologic data."],
  ["Textbooks of clinical epidemiology",
   "A textbook is a teaching resource rather than a source of epidemiologic data."]],
 "c": 0, "cite": c(16)},

{"topic": "Data sources", "io": IOA, "slot": "data source",
 "q": "What characterizes a state list of reportable diseases?",
 "opts": [
...
{"topic": "Making decisions", "io": IOB, "slot": "principle",
 ...
 "opts": [
  ["By critically analyzing it and distinguishing strong from weak",
