...
Q("Conjunctivitis differential", IO,
  ...
  "base. Which two diagnoses does this favor?",
...
Q("Hordeolum", IO,
  "A 27-year-old man with a hordeolum has developed spreading lid erythema and edema with fever. "
...
Q("Blepharitis", IO,
  ...
  [["Rosacea and seborrheic dermatitis", "Correct, alongside Staphylococcus aureus colonization."],
...
Q("Chemosis", IO,
  ...
  [["Swelling of the conjunctiva itself", "Correct — a sign rather than a diagnosis."],
   ["Blood underneath the conjunctiva", "That is a subconjunctival hemorrhage."],
...
Q("Fluorescein angiography", IO,
  "A 63-year-old man is having fluorescein angiography. Which pairing of dye transit time and safety point is correct?",
  [["Ten to fifteen seconds, and it contains no iodine",
   ...
   ["Immediately, and it requires general anesthesia",
    "It is an outpatient procedure without anesthesia."]],
  "two-step", D, 10),
...
Q("Post-septal cellulitis", IO,
  ...
  [["The paranasal sinuses", "Correct — which is why imaging covers the sinuses as well as the "
                             "orbits."],
   ["The lacrimal sac", "A cause of localized infection rather than the usual orbital source."],
...
Q("Ophthalmoscopy", IO,
  "Which form of ophthalmoscopy is most commonly used?",
  [["Slit-lamp ophthalmoscopy", "Correct — alongside direct and indirect methods."],
   ["Indirect ophthalmoscopy", "Indirect ophthalmoscopy is one of the methods, but slit-lamp ophthalmoscopy is the form most commonly used."],
...
Q("Referral urgency", IO,
  ...
  [["Gonococcal conjunctivitis in a newborn", "Correct — untreated it risks corneal perforation."],
   ...
   ["A resolving subconjunctival hemorrhage", "Routine, and it settles in two to four weeks."]],
  "two-step", D, 66),
