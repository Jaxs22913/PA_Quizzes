 ...
 dict(topic="Hidradenitis suppurativa", io=IOA,
   ...
   opts=[
     ...
     ["Cutaneous Crohn's disease of the groin",
      "Cutaneous Crohn's does not produce this axillary and groin pattern."],
 ...
 dict(topic="Impetigo", io=IOD,
   ...
   opts=[
     ...
     ["He may return after ten full days from the appearance of the very first lesion",
      "Longer than the interval required."]],
   c=0, cite=c(96)),
 ...
 dict(topic="Impetigo", io=IOB,
   ...
   opts=[
     ["Obtain a culture, because her occupation places her at high risk for resistant organisms",
      "Correct — teachers and health-care workers are at high risk for methicillin-resistant Staphylococcus aureus, so their impetigo is cultured rather than diagnosed on appearance alone."],
     ...
     ["Treat empirically with oral doxycycline, because adult impetigo is usually staphylococcal",
      "Empiric doxycycline skips the culture that her high risk for methicillin-resistant Staphylococcus aureus calls for; impetigo is otherwise a clinical diagnosis."],
