...
POOL_B = [
 ...
 dict(topic="Squamous cell carcinoma", io=IOA, slot="etiology",
   q="What is the usual etiology of squamous cell carcinoma, and which premalignant lesion may it arise from?",
   opts=[
 ...
 dict(topic="Squamous cell carcinoma", io=IOB, slot="risk factors",
   q="How does organ transplantation affect squamous cell carcinoma risk, and when do multiple tumors typically appear?",
   opts=[
     ["It is common and often aggressive in transplant recipients, with multiple tumors typically emerging about 5 years after transplant",
      "Correct — chronic lymphocytic leukemia and human immunodeficiency virus also raise risk."],
     ["It is uncommon and usually indolent in transplant recipients, with single tumors typically emerging about 5 years after transplant",
      "It is common and often aggressive, not uncommon and indolent."],
     ["It is common and often aggressive in transplant recipients, with multiple tumors typically emerging within 6 weeks of transplant",
 ...
 dict(topic="Squamous cell carcinoma", io=IOA, slot="agent/regimen",
   ...
   opts=[
     ...
     ["Nicotinamide 500 mg orally twice daily, reducing new squamous cell carcinoma development by approximately 20% in high-risk patients",
      "Twenty percent is the reduction reported for basal cell carcinoma; the figure for squamous cell carcinoma with nicotinamide differs."],
 ...
 dict(topic="Squamous cell carcinoma", io=IOA, slot="manifestation",
   ...
   opts=[
     ["A small red, conical, hard nodule that may ulcerate; also a non-healing ulcer, a warty nodule, or an irregular pink plaque with hemorrhagic crust",
      "Correct — four presentations to recognize."],
     ...
     ["An asymmetric pigmented macule with irregular borders and color variegation; also an amelanotic nodule lacking classic features",
 ...
 dict(topic="Squamous cell carcinoma", io=IOA, slot="test finding",
   ...
   opts=[
     ...
     ["Sandpaper texture, tenderness on palpation, flesh-colored hue, and a size under 6 mm",
      "Those describe a typical actinic keratosis."]],
   c=0, cite=c(22)),

 dict(topic="Squamous cell carcinoma", io=IOA, slot="risk factors",
   q="Which sites are called high-risk for squamous cell carcinoma, and what does having more than ten tumors imply?",
   opts=[
     ["Mucosal surfaces, lip, ear, scalp, temple, nose and genitalia; more than ten tumors means higher rates of local recurrence and nodal metastasis",
      "Correct — site and tumor count both drive risk."],
     ["The trunk, back, chest and shoulders; more than ten tumors means higher rates of local recurrence and distant nodal metastasis",
      "Trunk and chest are the superficial basal cell sites."],
     ["Mucosal surfaces, lip, ear, scalp, temple and nose; more than ten tumors indicates indolent disease with a lower rate of recurrence and metastasis",
      "A high tumor count raises risk rather than lowering it."],
     ["The palms, soles, nail units and periungual skin; more than ten tumors means higher rates of local recurrence and distant spread",
 ...
 dict(topic="Squamous cell carcinoma", io=IOA, slot="differential",
   ...
   opts=[
     ...
     ["Color variegation, symmetry, border regularity, diameter and evolution alone",
 ...
 dict(topic="Squamous cell carcinoma", io=IOA, slot="escalation",
   ...
   opts=[
     ["High-risk sites (lips, temples, ears, nose, genitalia), recurrent tumors, aggressive histology with perineural or perivascular invasion, lesions over 1 cm on the face or over 2 cm on trunk or extremities, immunosuppression, tumors within scars, and genetic disease-associated tumors",
      "Correct — note the two different size thresholds by site."],
     ["High-risk sites (lips, temples, ears, nose, genitalia), recurrent tumors, aggressive histology with perineural or perivascular invasion, lesions over 2 cm on the face or over 1 cm on trunk or extremities, immunosuppression, and tumors within scars",
     ...
     ["Any lesion on the trunk, any lesion in a patient over 65, any lesion present more than a year, any pigmented lesion, and any lesion the patient finds unsightly",
      "None of these predicts subclinical spread; Mohs is selected for high-risk sites, recurrent or aggressive histology, and where tissue must be conserved."],
     ["Only recurrent tumors and only after two failed courses of topical therapy, since site, size and immune status do not alter the surgical choice",
 ...
 dict(topic="Squamous cell carcinoma", io=IOB, slot="referral",
   ...
   opts=[
     ...
     ["Examination every five years, at closer intervals only for patients who have had more than ten tumors",
 ...
 dict(topic="Squamous cell carcinoma", io=IOA, slot="prognosis",
   ...
   opts=[
     ...
     ["An estimated 0.1 to 0.5%",
      "That is the lifetime melanoma risk figure in people of color."],
     ["An estimated 15 to 20%",
      "Fifteen to twenty percent greatly overstates it; actinically induced squamous cell carcinoma metastasises in about 3 to 7 percent of cases."]],
   c=0, cite=c(26)),
]
