 ...
 dict(topic="Squamous cell carcinoma", io=IOA, slot="agent/regimen",
   ...
   opts=[
     ...
     ["Nicotinamide 500 mg orally twice daily, reducing new squamous cell carcinoma development by approximately 20% in high-risk patients",
      "Twenty per cent is the reduction reported for basal cell carcinoma; the figure for squamous cell carcinoma with nicotinamide differs."],
 ...
 dict(topic="Squamous cell carcinoma", io=IOA, slot="prognosis",
   ...
   opts=[
     ...
     ["An estimated 15 to 20%",
      "Fifteen to twenty per cent greatly overstates it; actinically induced squamous cell carcinoma metastasises in about 3 to 7 per cent of cases."]],
   c=0, cite=c(26)),
]
