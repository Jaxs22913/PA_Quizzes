...
DECKS = [
 dict(id="cms-malignant-lesions", name="Pre-Malignant & Malignant Lesions", color="accent1",
  ...
  ["What does Clark level one mean?", "Confined to the epidermis."],
  ["What does Clark level four mean?", "Invasion into the reticular dermis."],
  ["What does Clark level five mean?", "Invasion into the subcutaneous tissue."],
  ["What is the difference between Clark level and Breslow thickness?", "Clark is an anatomic layer; Breslow is a measurement, and Breslow dominates prognosis."],
  ...
  ["Invasion into the subcutaneous tissue", "Clark level five"],
