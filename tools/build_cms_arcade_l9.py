...
DECKS = [
 dict(id="cms-malignant-lesions", name="Pre-Malignant & Malignant Lesions", color="accent1",
  ...
  ["How large is a typical actinic keratosis?", "Zero point two to zero point six centimeters."],
  ...
  ["How many squamous cell carcinomas predict higher recurrence and nodal spread?", "More than ten tumors."],
  ["How soon after transplant do multiple squamous cell carcinomas typically appear?", "At about five years."],
  ["Which chemopreventive agent reduces new squamous cell carcinoma, and by how much?", "Nicotinamide, five hundred milligrams twice daily, by about thirty percent."],
  ...
  ["Which tumor sizes meet the Mohs threshold?", "Over one centimeter on the face, or over two centimeters on trunk or extremities."],
  ["What must the follow-up examination include besides the skin?", "The lymph nodes, at least annually."],
  ["What is the metastatic rate of actinically induced squamous cell carcinoma?", "Three to seven percent."],
  # --- basal cell carcinoma
  ["What is the most common form of cancer?", "Basal cell carcinoma."],
  ["What determines basal cell carcinoma's behavior and treatment?", "The histologic subtype, not the clinical appearance."],
  ...
  ["How often does a second basal cell carcinoma develop?", "In up to fifty percent of patients."],
  ["By how much does nicotinamide reduce basal cell carcinoma?", "About twenty percent, on five hundred milligrams twice daily."],
  ["What is the Mohs cure rate for basal cell carcinoma?", "About ninety-eight percent."],
  ["What is the recurrence rate after excision of basal cell carcinoma?", "Five percent or less."],
  ...
  ["What is the lifetime melanoma risk in white individuals?", "About two percent."],
  ["What is the lifetime melanoma risk in persons of color?", "Zero point one to zero point five percent. Low, but not zero."],
  ...
  ["What does the D in ABCDE stand for, and what is its caveat?", "Diameter over six millimeters, though smaller lesions can still be melanoma."],
  ["Level I of invasion means what?", "Confined to the epidermis."],
  ...
  ["What do T, N and M measure in melanoma staging?", "Tumor thickness, number of involved regional nodes, and number of distant metastases."],
  ["At what Breslow thickness is sentinel lymph node biopsy offered?", "One millimeter or greater."],
  ["When is sentinel node biopsy offered below one millimeter?", "At zero point eight millimeters with ulceration, high mitotic rate or lymphovascular invasion."],
  ...
  ["What is the re-excision margin for melanoma in situ?", "Zero point five to one centimeter."],
  ["What is the re-excision margin for melanoma under one millimeter thick?", "One centimeter."],
  ["What is the re-excision margin for melanoma over one millimeter thick?", "One to two centimeters."],
  ["Which melanomas go to an expert center?", "Those deeper than one millimeter, or with lymph-node or other-site spread."],
  ...
  ["What is the first move in epidemic Kaposi sarcoma?", "Begin or optimize antiretroviral therapy. Immune restoration is the cornerstone."],
  ...
  ["Can Kaposi sarcoma cause edema without visible skin lesions?", "Yes. Marked edema may occur with few or none."],
  ...
  ["Which digits does nail unit melanoma favor?", "The thumb and the great toe."],
  ...
  ["What is the most common malignant nail tumor?", "Nail unit squamous cell carcinoma."],
  ["What is nail unit squamous cell carcinoma repeatedly mistaken for?", "A wart, paronychia or fungal infection."],
  ["Which triad suggests a glomus tumor?", "Severe paroxysmal pain, exquisite point tenderness and cold sensitivity."],
  ...
  ["When is amputation reserved for nail unit tumors?", "For deep, extensive or bone-involving disease."],
  ...
  ["Paroxysmal pain, cold sensitivity, normal nail", "Glomus tumor"],
