#!/usr/bin/env python3
"""Partition the Pharmacology I Lecture 1 Dermatology pool into two 30s.
...
import difflib
from cp_l2_lengthfix import FIXES
...
# SCOPE GUARD: Clinical Pathophysiology is mechanism, never management.
# The same Dermatology material is taught in Clinical Medicine and Surgery I
# this term, so the line has to be enforced rather than trusted.
import re as _re
_MGMT = _re.compile(r"first[- ]line|drug of choice|treatment of choice|next step|prescrib|manage(d|ment) with", _re.I)
...
if __name__ == "__main__":
    ...
    json.dump({"set1": s1, "set2": s2},
              open(os.path.join(HERE, "cp_l2_sets.json"), "w"),
              ensure_ascii=False, indent=1)
    print("wrote cp_l2_sets.json")
