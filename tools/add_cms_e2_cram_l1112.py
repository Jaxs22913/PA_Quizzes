...
SECTIONS = "".join([
 ...
 sec("glaucoma-avl", "Glaucoma &mdash; Acute vs Chronic", "#a4502a", "#f2e6e1", "#f9f3f0", "#803e21", [
  ...
  ("THE CLASSIC SIGN", "OPTIC NERVE CUPPING &mdash; increased CUP-TO-DISC RATIO. Also RIM PITTING, BAYONETING (vessels with narrow angulations), SPLINTER HEMORRHAGES, rim thinning."),
 ...
 sec("detachment", "Retinal Detachment", "#7a2f5f", "#ece2e9", "#f6f0f4", "#5f254a", [
  ...
  ("Then", "GRAY OR BLACK SHADOWS peripherally, may cover the WHOLE EYE WITHIN DAYS. &ldquo;CURTAIN or DARK CLOUD.&rdquo; PAINLESS."),
 ...
 sec("occlusions", "The Four Vascular Occlusions", "#8f5aa8", "#efe8f3", "#f7f3f9", "#704683", [
  ...
  ("CRVO fundus", "&ldquo;BLOOD AND THUNDER&rdquo; &mdash; DISC SWELLING, VENOUS DILATION, COTTON WOOL SPOTS, RETINAL HEMORRHAGES."),
  ("CRVO treatment", "URGENT OPHTHALMOLOGY REFERRAL TO RESTORE BLOOD FLOW. Evaluate and treat the underlying disorders."),
  ("Shared risks", "HTN · DM · HLD (hyperlipidemia) · RAYNAUD&rsquo;S · AGE &gt;50 · HYPERCOAGULABLE · GIANT CELL ARTERITIS · ENDOCARDITIS · ATRIAL MYXOMA · OBESITY. CRAO adds ATRIAL FIBRILLATION."),
 ...
 sec("papilledema", "Papilledema", "#7a5a2e", "#ece8e2", "#f6f3f0", "#5f4624", [
  ...
  ("Fundus", "ENGORGED RETINAL VEINS · SWOLLEN OPTIC DISC · &plusmn; retinal hemorrhages. BILATERAL."),
 ...
 sec("aion", "Anterior Ischemic Optic Neuropathy", "#2f7d76", "#e2edec", "#f0f6f5", "#25625c", [
  ...
  ("NAION workup", "A DIAGNOSIS OF EXCLUSION. WORKUP IS IDENTICAL TO ARTERITIC &mdash; make sure there is no GCA. Then evaluate HTN, DM, ANEMIA; neuroimaging if unclear."),
 ...
 sec("neuro-nerves", "Neuro-Ophthalmology &mdash; Nerves, Ptosis, Fields", "#8a5a2b", "#efe8e1", "#f7f3f0", "#6c4622", [
  ...
  ("CN VI", "LATERAL RECTUS &mdash; ABDUCTS. HORIZONTAL BINOCULAR DIPLOPIA. CHILDREN: INTRACRANIAL TUMORS. ADULTS: MICROVASCULAR, or major trauma/skull base fracture."),
  ("CN IV / VI workup", "Isolated atraumatic &rarr; MRI BRAIN WITH AND WITHOUT CONTRAST + HbA1C (hemoglobin A1C) if at risk. TRAUMATIC &rarr; OBSERVE ~6 MONTHS, PATCH ONE EYE meanwhile."),
