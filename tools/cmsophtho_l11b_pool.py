...
Q("Cranial nerve III palsy", IO,
  ...
  [["The unopposed lateral rectus and superior oblique pull it that way",
   ...
   ["The medial rectus overacts", "The medial rectus is paralyzed in a third nerve palsy."],
...
Q("Nystagmus", IO,
  ...
  [["An underlying neurological cause requiring investigation",
   ...
   ["Normal aging", "Nystagmus is not a normal age change."]],
  "two-step", D, 5),
...
Q("Visual fields", IO,
  ...
  [["A lesion at the optic chiasm",
   ...
   ["A cataract", "Causes generalized blur rather than a field cut."]],
  "diagnosis", D, 25),

Q("Visual fields", IO,
  "Which visual field defect localizes the lesion to the optic TRACT?",
  [["A homonymous hemianopia without macular sparing",
   ...
   ["An altitudinal defect", "That suggests ischemic optic neuropathy."]],
  "two-step", D, 25),
