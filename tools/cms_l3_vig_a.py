...
POOL_A = [
 dict(topic="Erythema multiforme", io=IOA,
   q="A 28-year-old man has a two-day history of a rash on his hands and forearms. Examination shows symmetric lesions on the palms and dorsal hands, each with a dusky center, a pale swollen ring and an outer red halo. He had a cold sore ten days ago. There is no mucosal involvement. Which is the most likely diagnosis?",
   opts=[
 ...
 dict(topic="Erythema multiforme", io=IOA,
   ...
   opts=[
     ...
     ["Serum immunoglobulin A anti-tissue transglutaminase antibodies",
      "That serology investigates dermatitis herpetiformis and celiac disease."]],
   c=0, cite=c(11)),
 ...
 dict(topic="Dermatitis herpetiformis", io=IOA,
   ...
   opts=[
     ...
     ["Atopic dermatitis of adult onset",
      "That favors a flexural distribution with raised immunoglobulin E and no immunoglobulin A deposition."],
 ...
 dict(topic="Dermatitis herpetiformis", io=IOA,
   ...
   opts=[
     ...
     ["Lesional skin for hematoxylin and eosin, seeking subepidermal blistering with neutrophils",
     ...
     ["Small bowel mucosa on endoscopy, seeking villous atrophy of the duodenum",
      "That confirms celiac disease rather than the skin diagnosis itself."],
 ...
 dict(topic="Dermatitis herpetiformis", io=IOA,
   ...
   opts=[
     ["Check glucose-6-phosphate dehydrogenase status before the first dose",
      "Correct, then monitor the blood count for hemolytic anemia and methemoglobinemia."],
 ...
 dict(topic="Dermatitis herpetiformis", io=IOA,
   q="A 40-year-old woman with dermatitis herpetiformis is doing well on dapsone and asks whether she really needs to change her diet. Which is the most appropriate counseling point?",
   opts=[
 ...
 dict(topic="Acanthosis nigricans", io=IOA,
   ...
   opts=[
     ["Fasting glucose, hemoglobin A1c, fasting insulin and a lipid panel",
 ...
 dict(topic="Acanthosis nigricans", io=IOA,
   q="A 17-year-old girl with acanthosis nigricans is embarrassed and has been scrubbing her neck daily, believing it is dirt. Which is the most appropriate counseling point?",
   opts=[
     ...
     ["The change is caused by friction from clothing and will settle with gentler fabrics",
      "Friction is not the mechanism; hyperinsulinemia drives keratinocyte proliferation."],
 ...
 dict(topic="Epidermolysis bullosa", io=IOA,
   ...
   opts=[
     ["Epidermolysis bullosa simplex",
      "Correct — localized to palms and soles, healing without scarring, and autosomal dominant."],
     ...
     ["Junctional epidermolysis bullosa of the Herlitz subtype",
      "That is generalized with poor wound healing, nail dystrophy and the highest mortality."],
     ["Bullous pemphigoid of the neonatal period",
      "Bullous pemphigoid is an acquired autoimmune disease of older adults."]],
   c=0, cite=c(30)),

 dict(topic="Epidermolysis bullosa", io=IOA,
   q="An infant has generalized blistering from minimal trauma and the subtype is unclear. Which test determines the level of cleavage?",
   opts=[
     ["Skin biopsy with transmission electron microscopy",
      "Correct — the gold standard, with immunofluorescence antigen mapping localizing the missing protein."],
 ...
 dict(topic="Epidermolysis bullosa", io=IOA,
   ...
   opts=[
     ...
     ["Annual colonoscopy to detect gastrointestinal involvement of the disease",
      "Endoscopy is performed if esophageal stricture is suspected rather than for surveillance."],
 ...
 dict(topic="Epidermolysis bullosa", io=IOA,
   ...
   opts=[
     ["Early palliative care integration is appropriate, alongside genetics counseling and family support resources",
      "Correct — goals-of-care discussion, pain optimization and psychosocial support are all indicated in this subtype."],
     ...
     ["Genetic counseling is unnecessary since the condition arises sporadically",
      "Counseling is described as mandatory for all families."]],
   c=0, cite=c(32)),
 ...
 dict(topic="Urticaria", io=IOA,
   ...
   opts=[
     ...
     ["Erythema multiforme in its early stage",
      "Target lesions are fixed, last more than twenty-four hours and favor acral surfaces."],
 ...
 dict(topic="Urticaria", io=IOA,
   ...
   opts=[
     ...
     ["Measure complement C4 and C1-esterase inhibitor level and function",
      "That is indicated for recurrent angioedema occurring without wheals."],
 ...
 dict(topic="Urticaria", io=IOA,
   ...
   opts=[
     ["Complement C4 with C1-esterase inhibitor level and function",
      "Correct — angioedema without wheals should raise hereditary angioedema."],
     ...
     ["Thyroid-stimulating hormone with anti-thyroid peroxidase antibodies",
      "Those form part of the chronic urticaria workup rather than isolated angioedema."]],
   c=0, cite=c(38)),
 ...
 dict(topic="Urticaria", io=IOA,
   ...
   opts=[
     ...
     ["Begin omalizumab at 300 mg subcutaneously every four weeks",
      "Right drug, wrong point: omalizumab is for refractory disease after antihistamine optimization."],
 ...
 dict(topic="Urticaria", io=IOA,
   ...
   opts=[
     ["Intramuscular epinephrine 0.3 mg",
      "Correct — bronchospasm with angioedema is anaphylaxis, and epinephrine comes before anything else."],
     ...
     ["Nebulized salbutamol with high-flow supplemental oxygen",
      "This addresses bronchospasm but not the underlying anaphylaxis."]],
   c=0, cite=c(39)),

 dict(topic="Urticaria", io=IOA,
   q="A 29-year-old woman has had chronic spontaneous urticaria for eight months and asks whether it will ever settle. Which is the most appropriate counseling point?",
   opts=[
