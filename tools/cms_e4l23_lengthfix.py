#!/usr/bin/env python3
"""Lecture 23 length fixes -- and a standalone before/after report.

    python3 cms_e4l23_lengthfix.py          # per-pool gameable%, raw and fixed

FIXES maps (module, index within that module's QUESTIONS, option index) to new
option TEXT. cms_e4_partition.py applies them before any guard runs. The key is
...
FIXES = {
 ("cms_e4l23_pool_c", 7, 0): "Balloon valvuloplasty",
 ("cms_e4l23_pool_c", 17, 0): "On echo or with right heart failure",
 ("cms_e4l23_pool_c", 26, 0): "Hepatic congestion risking cirrhosis",
 ("cms_e4l23_pool_c", 30, 0): "It grows louder on inspiration",
 ("cms_e4l23_pool_c", 35, 0): "On echo or with right heart failure",
}
...
if __name__ == "__main__":
    mods = sorted(os.path.basename(p)[:-3] for pat in ("cms_e4l23_pool_*.py", "cms_e4l23_vig_*.py")
