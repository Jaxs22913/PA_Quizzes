...
dict(q="Which class must be avoided in children under eight years old?",
     ans="Tetracyclines", src=("L1", 63),
     why="Under eight, because of tooth discoloration and depressed skeletal growth.",
...
dict(q="Which class is used with caution in patients under eighteen?",
     ...
     wrong=[("Macrolides", "No pediatric age restriction of this kind."),
...
dict(q="Gastrointestinal upset that is worst with erythromycin, especially in children and young adults, points to which class?",
     ...
     why="Nausea, diarrhea and abdominal pain, worse with erythromycin than with the newer members.",
     wrong=[("Penicillins", "Cause diarrhea, but without the erythromycin gradient."),
            ("Tetracyclines", "Cause esophageal irritation rather than this."),
            ("Aminoglycosides", "Given parenterally; the gut is not the issue.")]),

dict(q="Interstitial nephritis with hematuria and crystalluria belongs to which class?",
...
dict(q="Which class is used during orthopedic surgery for fracture alignment and dislocation correction?",
     ans="Nondepolarizing blockers", src=("L3", 63),
     why="Adjuvants in anesthesia — intubation, and relaxing muscle enough to reduce a fracture or dislocation.",
...
dict(q="Which class produces salivation, flushing, falling blood pressure, abdominal pain, diarrhea and bronchospasm?",
