...
EDITS = [
 ...
 ("a", '["Colored halos around lights", "Those belong to angle-closure glaucoma."],\n     ["A curtain across the field"',
       '["Colored halos seen around bright lights", "Those belong to angle-closure glaucoma."],\n     ["A curtain across the field"'),
 ("a", '["Nausea, vomiting and colored halos"', '["Severe eye pain, nausea, vomiting and colored halos"'),
 ("a", '["Gradual and painless over years"', '["Gradual and painless, developing over years"'),
 ("a", '["Cotton wool spots and venous dilation"', '["Cotton wool spots, venous dilation and hemorrhage"'),
 ("a", '["Disc swelling with cotton wool spots"', '["Disc swelling with cotton wool spots and hemorrhage"'),
