...
POOL_D = [
 ...
 dict(topic="Pharmacology", io=IOC,
   ...
   opts=[
     ...
     ["The formulation alone — cream preparations are moderate and ointment preparations are medium to high",
      "The table is organized by agent and strength, not by vehicle."],
 ...
 dict(topic="Diagnostic tools", io=IOC,
   ...
   opts=[
     ...
     ["Scabies infestation, by showing the mite, its eggs or its fecal pellets",
 ...
 dict(topic="Skin type recognition", io=IOC,
   ...
   opts=[
     ["Violaceous, gray or deep brown, so palpation is needed to find warmth and edema",
      "Correct — color becomes an unreliable signal and the examination has to change."],
     ...
     ["Completely absent, so the diagnosis cannot be made without a skin biopsy",
      "The changes are present but appear in different colors."],
 ...
 dict(topic="Skin type recognition", io=IOC,
   ...
   opts=[
     ["Palpation for warmth and edema, with attention to distribution and secondary change",
      "Correct — color stops being the primary signal, so the other findings carry the diagnosis."],
 ...
 dict(topic="Atopic dermatitis", io=IOC,
   ...
   opts=[
     ...
     ["Atopic dermatitis, psoriasis and seborrheic dermatitis",
 ...
 dict(topic="Lichen planus", io=IOC,
   ...
   opts=[
     ["A band-like infiltration of lymphocytes in the dermis",
      "Correct — a classic descriptive phrase worth recognizing on sight."],
