...
DECKS = [
 dict(id="pd2-clinical-reasoning", name="Clinical Reasoning & Documentation", color="accent",
  ...
  ["What is the provider's goal in an oral case presentation?", "To help the listeners visualize the patient and understand the problem."],
  ...
  ["How should a student handle feedback that differs between facilitators?", "Accept it and modify behavior; different facilitators give different feedback."],
 ...
 dict(id="pd2-derm-morphology", name="Skin Lesion Vocabulary", color="accent2",
  ...
  ["Which five features describe a skin lesion?", "Distribution, configuration, morphology, color and texture."],
  ["What is a macule?", "A circumscribed, flat discoloration under one centimeter."],
  ["What is a patch?", "A circumscribed, flat discoloration over one centimeter."],
  ["What is a papule?", "A palpable, elevated solid mass under one centimeter."],
  ["What is a plaque?", "A palpable, elevated, plateau-like solid mass over one centimeter."],
  ["What is a nodule?", "An elevated, firm, circumscribed lesion deeper in the dermis than a papule."],
  ["What is a tumor?", "A palpable, elevated solid mass greater than two centimeters."],
  ...
  ["What is a vesicle?", "A superficial elevation filled with fluid, under one centimeter."],
  ["What is a bulla?", "A superficial elevation filled with fluid, over one centimeter."],
  ["What is a pustule?", "A superficial elevation filled with purulent material, usually under one centimeter."],
  ...
  ["Which distribution suggests an allergic reaction?", "Generalized or diffuse."],
  ["What does intertriginous mean?", "Involving the skin creases and folds."],
 ], matchCards=[
  ["Macule", "Flat discoloration under one centimeter"],
  ["Patch", "Flat discoloration over one centimeter"],
  ["Papule", "Solid elevation under one centimeter"],
  ["Plaque", "Plateau-like elevation over one centimeter"],
  ["Nodule", "Firm lesion deeper than a papule"],
  ["Wheal", "Transient cutaneous edema, irregular shape"],
  ["Vesicle", "Fluid-filled elevation under one centimeter"],
  ["Bulla", "Fluid-filled elevation over one centimeter"],
 ...
 dict(id="pd2-derm-exam", name="Dermatological History, Exam & Findings", color="accent3",
  ...
  ["Which changes should you ask about in an existing skin lesion?", "Color, shape, size, pain, easy bleeding, and non-healing areas."],
  ...
  ["What does diascopy show when the color fades under pressure?", "Vascular engorgement."],
  ["What does diascopy show when the color does not fade?", "Hemorrhage in the skin."],
  ["How large are petechiae?", "Less than three millimeters, and they do not blanch."],
  ["How large is purpura?", "Three millimeters to one centimeter, and it does not blanch."],
  ["How large is an ecchymosis?", "Greater than one centimeter, fading over time, and it does not blanch."],
  ...
  ["What does basal cell carcinoma look like?", "A translucent, pearly nodule with a depressed center and raised borders."],
  ["What does squamous cell carcinoma look like?", "A red scaling, crusting nodule or plaque that can ulcerate and bleed."],
  ["What does D stand for in the melanoma warning signs?", "Diameter larger than six millimeters."],
  ...
  ["Petechiae", "Non-blanching macules under three millimeters"],
  ["Ecchymosis", "Non-blanching macules over one centimeter"],
  ...
  ["Basal cell carcinoma", "Pearly nodule, depressed center, raised borders"],
