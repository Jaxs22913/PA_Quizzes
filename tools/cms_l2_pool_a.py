 ...
 dict(topic="Primary morphology", io=IOA,
   ...
   opts=[
     ...
     ["A flat lesion less than five millimetres",
      "A macule is defined as under one centimetre."],
 ...
 dict(topic="Blood deposits", io=IOA,
   ...
   opts=[
     ["It is a medical emergency until proven otherwise",
      "Correct — purpura can signal meningococcaemia, disseminated intravascular coagulation or vasculitis, so it is worked up urgently rather than observed."],
