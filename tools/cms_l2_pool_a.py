...
POOL_A = [
 dict(topic="Describing a rash", io=IOA,
   ...
   opts=[
     ["Primary morphology, secondary morphology, demarcation, color, size and distribution",
      "Correct. Getting all six into a description is what lets another provider picture the lesion without seeing it."],
     ["Primary morphology, color and distribution only, since the rest are subjective",
 ...
 dict(topic="Primary morphology", io=IOA,
   ...
   opts=[
     ["A flat lesion less than one centimeter, without elevation or depression",
      "Correct. A patch is the same lesion larger than one centimeter."],
     ["A flat lesion less than five millimeters",
      "A macule is defined as under one centimeter."],
     ["An elevated solid lesion less than one centimeter",
      "That is a papule."],
     ["A flat elevated plateau lesion greater than one centimeter",
      "That is a plaque."]],
   c=0, cite=c(10)),
 ...
 dict(topic="Primary morphology", io=IOA,
   ...
   opts=[
     ["A plaque is elevated and plateau-like; a patch is flat with no elevation",
      "Correct — both exceed one centimeter, so elevation is the discriminator."],
     ["A plaque is larger than a patch",
      "Both are greater than one centimeter; size does not separate them."],
 ...
 dict(topic="Primary morphology", io=IOA,
   q="A solid elevated lesion measuring more than one centimeter is called what?",
   opts=[
     ["A nodule",
      "Correct. A papule is the same solid elevated lesion under one centimeter."],
     ["A papule",
      "A papule is under one centimeter."],
     ["A wheal",
      "A wheal is a firm edematous plaque from fluid infiltrating the dermis."],
     ["A bulla",
 ...
 dict(topic="Primary morphology", io=IOA,
   ...
   opts=[
     ["A firm edematous plaque produced by infiltration of fluid into the dermis",
     ...
     ["A fluid-filled lesion containing leukocytes",
      "That is a pustule."],
     ["A fluid-filled lesion under one centimeter",
      "That is a vesicle."],
     ["A deposit of blood measuring one to two millimeters",
      "That is a petechia."]],
   c=0, cite=c(13)),
 ...
 dict(topic="Primary morphology", io=IOA,
   ...
   opts=[
     ...
     ["A pustule is larger than one centimeter and a vesicle is smaller",
 ...
 dict(topic="Primary morphology", io=IOA,
   q="A fluid-filled lesion greater than one centimeter is called what?",
   opts=[
     ["A bulla",
      "Correct — a vesicle is the same lesion up to one centimeter."],
     ["A vesicle",
      "A vesicle is up to one centimeter."],
     ["A pustule",
 ...
 dict(topic="Blood deposits", io=IOA,
   ...
   opts=[
     ...
     ["Petechiae are under 3 mm and purpura are 3 mm to 1 cm",
      "Those figures come from the Clinical Pathophysiology convention; here petechiae are 1 to 2 mm and purpura 4 mm or greater."],
 ...
 dict(topic="Blood deposits", io=IOA,
   ...
   opts=[
     ["It is a medical emergency until proven otherwise",
      "Correct — purpura can signal meningococcemia, disseminated intravascular coagulation or vasculitis, so it is worked up urgently rather than observed."],
     ["It is a benign finding common in the elderly",
      "Senile purpura is common and benign, but purpura is treated as an emergency until the dangerous causes have been excluded."],
 ...
 dict(topic="Secondary morphology", io=IOA,
   ...
   opts=[
     ["Accumulation of loose or adherent cornified fragments of the epidermis, typically gray or white",
      "Correct."],
 ...
 dict(topic="Demarcation", io=IOA,
   ...
   opts=[
     ...
     ["Smaller than one centimeter in every dimension",
 ...
 dict(topic="Diagnostic tools", io=IOC,
   ...
   opts=[
     ...
     ["Incisional biopsy",
      "An incisional biopsy samples part of a lesion; taking the whole of it with deep and wide margins is an excisional biopsy."]],
   c=0, cite=c(26)),
 ...
 dict(topic="Diagnostic tools", io=IOC,
   ...
   opts=[
     ...
     ["Polarized white light, used to magnify pigmented lesions",
      "That describes a dermoscope."],
     ["Infrared light, used to assess perfusion",
      "This is not what a Wood's lamp does."],
     ["Short-wave ultraviolet light, used to sterilize the skin surface",
      "It is a diagnostic device, not a sterilizing one."]],
   c=0, cite=c(27)),
 ...
 dict(topic="Diagnostic tools", io=IOC,
   ...
   opts=[
     ...
     ["The scabies mite, its eggs or its fecal pellets",
 ...
 dict(topic="Diagnostic tools", io=IOC,
   ...
   opts=[
     ["Scabies infestation, by identifying the mite, its eggs or its fecal pellets",
