...
GIVEAWAY = {
 ...
 "Irritant contact dermatitis": "<b>Well demarcated and &ldquo;GLAZED APPEARING&rdquo;</b> &middot; <b>shaped like the exposure</b> &middot; hands and forearms &middot; frequent handwashing, gloves &middot; no sensitization needed",
 "Allergic contact dermatitis": "<b>LINEAR vesicles in MULTIPLE STAGES OF HEALING</b> (urushiol / poison ivy) &middot; well-demarcated <b>at the contact site</b> &middot; needs prior sensitization",
 ...
 "Stasis dermatitis": "<b>Gaiter region</b> &middot; bilateral &middot; edema and chronic venous change &middot; violaceous/gray/deep brown on darker skin",
 ...
 "Dermatitis herpetiformis": "<b>Intensely</b> pruritic &middot; <b>symmetrical</b> knees, elbows, buttocks, back &middot; <b>herpetiform grouping</b> &middot; bloating and diarrhea",
 ...
 "Urticaria": "<b>An individual wheal resolves within 24 hours</b> &middot; blanches fully &middot; <b>migrates</b> &middot; &plusmn; angioedema",
 ...
 "Granuloma annulare": "<b>Annular ring of papules with NO SCALE ANYWHERE</b> &mdash; that absence separates it from tinea &middot; dorsal hands and feet &middot; flesh-colored",
 ...
 "Hyperhidrosis": "<b>Absent during sleep</b> &amp; bilateral focal (palms, soles, axillae) = primary &middot; generalized, asymmetric or nocturnal = secondary",
 ...
 "Drug-induced photosensitivity": "<b>First exposure, dose-dependent, exaggerated sunburn on exposed skin</b> = phototoxic &middot; <b>needs sensitization, eczematous, may spread</b> = photoallergic",
 ...
 "Impetigo &mdash; non-bullous": "<b>Honey-colored adherent crust</b> &middot; face and extremities &middot; spreads by self-inoculation from scratching",
 ...
 "Ecthyma": "<b>Punched-out ulcer through the dermis</b> with a thick gray-yellow crust &middot; lower legs &middot; <b>heals with a scar</b>",
 ...
 "Acute paronychia": "<b>2&ndash;5 days after trauma</b> &middot; rapid onset &middot; erythematous edematous nail fold &middot; may become fluctuant",
 ...
 "Pediculosis pubis (crabs)": "<b>Maculae caerulae</b> &mdash; slate-gray/bluish 1&nbsp;cm macules &middot; periumbilical papular urticaria",
 ...
 "Hobo spider": "<b>Gray herringbone on the abdomen</b> &middot; <b>Pacific Northwest</b> &middot; mistaken for brown recluse",
 "Lyme disease": "<b>&gt;5&nbsp;cm ring EXPANDING over days after a tick</b>, central clearing, darker punctate center &middot; <b>NO scale on the border &mdash; unlike tinea</b>",
 ...
 "Molluscum contagiosum": "<b>Umbilicated PEARLY FLESH-COLORED dome</b>, 3&ndash;5&nbsp;mm &middot; poxvirus, children &middot; <b>vs sebaceous hyperplasia, which is YELLOW and in older adults</b>",
 "Verruca vulgaris (common warts)": "<b>Interrupts the skin lines</b> &middot; <b>blackened center</b> (thrombosed capillaries) &middot; <b>NO ROOTS</b> &mdash; underside round and smooth &middot; pain on SIDE pressure",
 ...
 "Malignant melanoma": "<b>ABCDE</b> &mdash; asymmetry, border, color variegation, diameter &gt;6&nbsp;mm, <b>evolution</b> &middot; <b>nodular may be amelanotic and LACK the classic features</b>",
 ...
 "Glomus tumor and the benign nail tumors": "<b>Severe paroxysmal pain + exquisite point tenderness + COLD SENSITIVITY, with a nearly normal-looking nail</b>",
 "Kaposi sarcoma": "<b>Red or purple macules, plaques or nodules &mdash; including the HARD PALATE</b> &middot; human herpesvirus 8 + immunosuppression &middot; <b>edema out of proportion to visible lesions</b>",
 ...
 "Blue naevus": "<b>BLUE, blue-gray or blue-black</b> &mdash; pigment deep in the DERMIS &middot; women, twenties &middot; dorsal hands and feet, scalp, buttocks",
 ...
 "Dermatofibroma": "<b>DIMPLE SIGN &mdash; retracts on lateral compression</b> &middot; firm 0.5&ndash;1&nbsp;cm nodule on the LEGS &middot; <b>most common painful skin tumor</b>",
 ...
 "Lipoma": "<b>Soft, painless, MOBILE subcutaneous mass</b> &middot; the most common soft tissue tumor",
 ...
 "Sebaceous hyperplasia": "<b>YELLOW umbilicated papule in an OLDER ADULT</b> &middot; face &middot; <b>vs molluscum, which is pearly flesh-colored and in children</b> &middot; no malignant potential",
}
