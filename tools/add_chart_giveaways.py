...
GIVEAWAY = {
 ...
 "Atopic dermatitis": "<b>Poorly</b> demarcated &middot; flexures in children/adults, cheeks and extensors in infants &middot; lichenification &middot; &ldquo;itches all the time, keeps coming back&rdquo;",
 "Dyshidrotic eczema": "<b>Tapioca-like</b> deep-seated vesicles &middot; palms, soles, sides of fingers",
 "Nummular eczema": "<b>Coin-shaped</b> discrete plaques &middot; extremities &middot; older adults",
 "Irritant contact dermatitis": "<b>Well demarcated, &ldquo;glazed appearing&rdquo;</b> &middot; shaped like the exposure &middot; hands and forearms &middot; frequent handwashing, gloves",
 "Allergic contact dermatitis": "<b>Well-demarcated</b> at the contact site &middot; <b>linear vesicles in multiple stages of healing</b> (urushiol/poison ivy)",
 ...
 "Diaper dermatitis": "<b>Convex surfaces</b> of the napkin area &middot; <b>fold involvement with satellite lesions</b> = candidal",
 ...
 "Bullous pemphigoid": "<b>TENSE</b> bullae that do not rupture &middot; <b>Nikolsky NEGATIVE</b> &middot; elderly &middot; mucosa uncommon",
 "Pemphigus (vulgaris)": "<b>FLACCID</b> bullae that rupture leaving erosions &middot; <b>Nikolsky POSITIVE</b> &middot; middle-aged &middot; <b>mucosa often first</b>",
 "Psoriasis &mdash; plaque": "<b>Well-demarcated</b> plaques &middot; <b>thick silvery scale</b> &middot; <b>Auspitz sign</b> &middot; extensors, scalp, nails",
 ...
 "Pityriasis rosea": "<b>Herald patch</b> first, alone for a week or two &middot; <b>collarette of scale</b> &middot; <b>Christmas-tree</b> pattern along skin lines",
 ...
 "Granuloma annulare": "Annular ring of papules with <b>NO SCALE on the border</b> &mdash; which separates it from tinea &middot; dorsal hands and feet",
 ...
 "Toxic epidermal necrolysis": "<b>&gt;30%</b> body surface detachment &middot; <b>Nikolsky positive</b> &middot; <b>&ldquo;wet parchment&rdquo;</b> &middot; stinging eyes, painful swallowing first",
 ...
 "Erysipelas": "<b>Sharply demarcated raised border</b> &middot; <b>upper</b> dermis &middot; sudden high fever within 48 hours &middot; group A streptococcus",
 "Cellulitis": "<b>Poorly demarcated</b> &middot; <b>deeper</b> dermis and subcutis &middot; all four cardinal signs &middot; lower leg",
 ...
 "Lyme disease": "<b>Erythema migrans &mdash; &gt;5&nbsp;cm expanding ring with CENTRAL CLEARING</b> &middot; often a darker punctate centre at the bite",
 ...
 "Tinea corporis (body) &mdash; &ldquo;ringworm&rdquo;": "<b>Sharply circumscribed with PROGRESSIVE CENTRAL CLEARING</b> &rarr; the annular outline &middot; <b>scale ON the border</b>",
 ...
 "Cutaneous candidiasis and intertrigo": "<b>SATELLITE lesions</b> beyond the main patch &middot; body folds, friction, moisture and heat &middot; <i>Candida albicans</i>",
 ...
 "Molluscum contagiosum": "<b>CENTRAL UMBILICATION</b> &middot; pearly dome-shaped flesh-coloured papules 3&ndash;5&nbsp;mm &middot; <b>poxvirus</b>",
 ...
 "Basal cell carcinoma &mdash; nodular": "<b>INTERMITTENT intense</b> exposure &middot; <b>PEARLY or translucent with telangiectasias accentuated by STRETCHING the skin</b> &middot; central erosion",
 "Basal cell carcinoma &mdash; superficial": "<b>Reddish shiny scaly thin plaque on the BACK or CHEST</b> &middot; thready pearly border, spotty edge pigment",
 ...
 "Seborrheic keratosis": "<b>&ldquo;STUCK ON&rdquo; or pasted-on</b> &middot; velvety or warty &middot; beige to black &middot; older adults",
 "Dermatosis papulosa nigrans": "<b>Multiple small dark papules on the FACE and NECK</b> &middot; identical to small seborrheic keratoses &middot; African American, dark-skinned Asian, Polynesian",
 ...
 "Pressure injury (pressure ulcer)": "<b>Over a bony prominence</b> &middot; <b>NON-BLANCHABLE erythema of intact skin</b> = stage 1 &middot; obscured by slough or eschar = unstageable",
 ...
 "Infantile hemangioma": "<b>Blanching first, then fine telangiectasias, then bright red</b> &middot; <b>INVOLUTES &mdash; 50% by 5, 70% by 7, 90% by 9</b> &middot; preterm, female 3:1",
 "Nevus flammeus (port-wine stain)": "<b>NEVER involutes</b> &mdash; dilation with NO endothelial proliferation &middot; present at birth, <b>darkens and thickens</b> &middot; sharp midline cutoff",
 ...
 "Cherry angioma": "<b>Increases with age</b> &middot; trunk &middot; &lt;5&nbsp;mm smooth firm deep red &middot; <b>BLANCHES</b> &middot; new ones keep coming and cannot be prevented",
 "Telangiectasia": "<b>Permanently dilated capillary &lt;1&nbsp;mm</b> &middot; blanchable &middot; single, grouped or with a central punctum",
 "Nevus araneus (spider angioma)": "<b>ESTROGEN EXCESS</b> &mdash; pregnancy, oral contraceptives (resolve after), <b>cirrhosis and liver failure</b> &middot; blanches &middot; dilation with NO proliferation",
 "Pyogenic granuloma": "<b>MISNAMED &mdash; neither infectious NOR granulomatous</b> &middot; moist bright red exophytic papule with an <b>EPITHELIAL COLLARETTE</b> that <b>BLEEDS</b> &middot; pregnancy, fingers",
 ...
 "Sebaceous hyperplasia": "<b>Yellowish papule with a CENTRAL UMBILICATION</b> &middot; face, older adults &middot; <b>no malignant potential</b> &middot; immunosuppression is high risk",
}
...
def main():
    ...
    print("data block and header written; %d giveaways" % len(GIVEAWAY))
