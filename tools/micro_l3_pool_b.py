...
POOL_B = [
 ...
 dict(topic="Nosocomial infection", io=IO7,
   ...
   c=0, cite=c(50)),
 dict(topic="Nosocomial infection", io=IO7,
   q="What consequence of nosocomial infection is emphasized?",
   opts=[
 ...
 dict(topic="Koch's postulates", io=IO5,
   ...
   opts=[
     ...
     ["Some pathogens are too small to see under a microscope", "Visualization is not the barrier."],
 ...
 dict(topic="Opportunists", io=IO5,
   ...
   c=0, cite=c(20)),
 dict(topic="Host defenses", io=IO5,
   ...
   opts=[
     ...
     ["Geographic location", "That relates to reservoirs rather than host defense."]],
   c=0, cite=c(22)),
 dict(topic="Nosocomial infection", io=IO7,
   q="Which patient group is flagged as weakened in defenses, and therefore at risk?",
   opts=[
     ["The elderly, young children and premature infants", "Correct, alongside those on immunosuppressants."],
     ["Healthy young adults", "Not a group with weakened defenses."],
