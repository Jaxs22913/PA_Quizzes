...
removing the object, not ordering an MRI, not sending anesthetic drops home.
"""
import io, os, re
...
SECTIONS = "".join([
 ...
 sec("tra-globe", "OPEN GLOBE", TRA, TRABG, TRAZ, TRAINK, [
  ...
  ("THE SIGNS", "PUPIL DISTORTED TOWARD THE WOUND &middot; FLAT anterior chamber &middot; uveal tissue protruding &middot; massive hemorrhagic CHEMOSIS &middot; SOFT EYE &middot; deep lid laceration &middot; hyphema or vitreous hemorrhage."),
  ...
  ("Globe rupture &mdash; suspect when", "Blunt trauma + MASSIVE HEMORRHAGIC CHEMOSIS or a SOFT EYE."),
 ...
 sec("tra-lids", "LIDS, CONTUSION &amp; PERIORBITAL HEMATOMA", TRA, TRABG, TRAZ, TRAINK, [
  ...
  ("ORBITAL CONTUSION", "Swelling WITHOUT hemorrhage. Held IN FRONT of the septum by the tarsal plate and septal margin &rarr; PRESEPTAL ecchymosis. Supportive to surgery. RULE OUT BRAIN TRAUMA."),
  ("PERIORBITAL HEMATOMA", "Bleeding WITHIN the orbit. NOT ALWAYS TRAUMATIC &mdash; eye surgery, peribulbar injections, orbital VARICES, lymphangiomas/AVM, ANTICOAGULANTS, SICKLE CELL, orbital pseudotumour, idiopathic."),
  ("Periorbital hematoma &mdash; treatment", "CANTHOTOMY with CANTHOLYSIS &mdash; expose the lateral canthal tendon, cut its INFERIOR branch, let the blood out."),
 ]),
 ...
 sec("tra-detach", "RETINAL &amp; VITREOUS DETACHMENT &mdash; THE THREE TYPES", FX, FXBG, FXZ, FXINK, [
  ...
  ("TRACTION", "Most commonly PROLIFERATIVE DIABETIC RETINOPATHY. More LOCALIZED and CONCAVE. &rarr; SURGICAL."),
  ("EXUDATIVE (serous)", "NO break, NO traction. Systemic vascular/inflammatory disease or INTRAOCULAR TUMOR. &rarr; TREAT THE UNDERLYING CONDITION."),
 ...
 sec("tra-fracture", "ORBITAL FLOOR (BLOWOUT) FRACTURE", FX, FXBG, FXZ, FXINK, [
  ...
  ("THE PEDIATRIC TRAP", "&ldquo;WHITE-EYED BLOWOUT&rdquo; &mdash; entrapment with NO orbital soft tissue signs at all. A quiet-looking eye does not exclude it."),
 ...
 sec("tra-basilar", "BASILAR SKULL FRACTURE", FX, FXBG, FXZ, FXINK, [
  ...
  ("INDIRECT SIGNS", "RACCOON EYES &middot; BATTLE SIGN &middot; HEMOTYMPANUM &middot; bleeding into middle ear or sphenoid sinus &middot; CSF LEAK with CLEAR or PINK RHINORRHEA."),
