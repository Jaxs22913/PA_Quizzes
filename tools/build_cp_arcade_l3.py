...
DECKS = [
 dict(id="cp-abnormal-cell-growth", name="Abnormal Cell Growth", color="accent4",
  ...
  ["Give an example of epithelial metaplasia.", "Bladder transitional epithelium becoming squamous epithelium."],
  ...
  ["From how many cells is a neoplasm derived?", "One cell, which underwent a genetic alteration. A tumor is a clone."],
  ...
  ["Name three features of a benign tumor's border and behavior.", "Well circumscribed border, compresses surrounding tissue, often has a fibrous capsule."],
  ["How does a malignant tumor relate to surrounding tissue?", "It has a ragged border and infiltrates and invades, rather than compressing."],
  ["How differentiated are malignant tumors?", "Various degrees of differentiation, not uniformly poor."],
  ["Which four histological features move a tumor towards malignancy?", "Pleomorphism, abnormal nuclei, mitoses, and abnormal differentiation."],
  ...
  ["Why does a tumor mass outgrow normal tissue?", "A higher proliferative fraction together with a lower rate of cell loss."],
  ["How should the cancer stem cell idea be regarded?", "As a conceptual framework rather than an absolute explanation."],
  ["Through which vessels does hematogenous spread typically occur?", "Veins, especially the portal vein and the inferior vena cava."],
  ...
  ["What is the first step of hematogenous spread?", "Tumor cells separate from each other and degrade intercellular tissue with enzymes."],
  ["Where do tumor cells enter the lymphatic system?", "At the tumor margin, then they follow the natural route of lymphatic drainage."],
  ["Which cavities can be seeded by tumor?", "Pericardial, pleural, peritoneal and joint cavities, and the subarachnoid space."],
  ...
  ["What tissues are mesenchymal tumors derived from?", "Supportive tissue: connective tissue, adipose, cartilage, smooth and striated muscle, bone."],
  ["What is a malignant tumor of mesenchymal origin called?", "A sarcoma."],
  ["What is a malignant tumor of epithelial origin called?", "A carcinoma."],
  ["What is an adenoma?", "A benign epithelial tumor with a glandular pattern, or derived from a gland."],
  ["What can an adenoma sometimes do?", "Secrete the hormone or hormones produced by its gland of origin."],
  ["What is a papilloma?", "A tumor producing visible finger-like or warty projections from an epithelial surface."],
  ...
  ["How is carcinogenesis characterized overall?", "A multistep process, resulting from damage to multiple normal regulatory genes."],
  ...
  ["What do tumor suppressor genes do?", "Inhibit cell growth."],
  ["Name four tumor suppressor genes.", "NF-1, NF-2, retinoblastoma, and adenomatous polyposis coli."],
  ...
  ["How many categories of gene alteration drive carcinogenesis?", "Four: protooncogenes, tumor suppressors, repair genes, and apoptosis genes."],
  ...
  ["Which chemicals are linked to occupational bladder cancer?", "Aromatic amines."],
  ...
  ["Which three processes link chronic hepatitis B infection to cancer?", "Chronic inflammation, regenerative hyperplasia, and genomic instability."],
  ...
  ["Which forms of radiation cause cancer?", "Ultraviolet B, and ionizing radiation."],
  ["Which tumors follow an inherited retinoblastoma protein alteration?", "Retinoblastoma, a rare childhood eye tumor, and osteosarcoma."],
  ...
  ["What do NF-1 and NF-2 alterations produce?", "Neurofibromatosis, with tumors of the central and peripheral nervous systems."],
  ...
  ["What caveat applies to TNM (tumor, nodes, metastases) definitions?", "They are cancer-specific; for some cancers depth of invasion matters more than size."],
 ], matchCards=[
