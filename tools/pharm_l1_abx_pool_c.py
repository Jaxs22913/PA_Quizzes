 ...
 dict(topic="Protein synthesis", io=IO2,
   ...
   opts=[
     ...
     ["The drug is metabolized to a reactive intermediate that damages hepatocytes",
      "Reactive metabolite injury explains paracetamol hepatotoxicity, not this class; here the selectivity is lost because the drug starts binding the host's own ribosomes."],
     ...
     ["Mammalian mitochondria use a 90S ribosome that binds these drugs preferentially",
      "There is no 90S ribosome; the contrast is between the bacterial 70S and the mammalian 80S, and selectivity fails when the drug reaches the latter."]],
   c=0, cite=c(53)),
 ...
 dict(topic="Macrolides", io=IO4E,
   ...
   opts=[
     ...
     ["Bacteroides fragilis and Clostridium perfringens",
      "Those are anaerobes; macrolides have no useful clinical anaerobic role, and their niche is the intracellular atypical organisms."],
 ...
 dict(topic="Macrolides", io=IO4E,
   ...
   opts=[
     ...
     ["Erythromycin with metronidazole and omeprazole",
      "The combination is clarithromycin with amoxicillin and lansoprazole; clarithromycin rather than erythromycin is the macrolide used."]],
   c=0, cite=c(56)),
 ...
 dict(topic="Tetracyclines", io=IO4H,
   ...
   opts=[
     ...
     ["Cations raise gastric pH enough to destroy the drug",
      "Gastric pH is not the issue; the drug binds divalent and trivalent cations directly, forming a complex too large to be absorbed."],
 ...
 dict(topic="Aminoglycosides", io=IO4I,
   ...
   opts=[
     ...
     ["All three at 5 milligrams per kilogram with a trough under 2",
      "Amikacin is dosed and monitored separately at 15 milligrams per kilogram with a trough under 5, while tobramycin and gentamicin take 7 with a trough under 1."],
 ...
 dict(topic="Fluoroquinolones", io=IO4K,
   ...
   opts=[
     ["Inhibition of bacterial DNA gyrase, also called topoisomerase II, forming a quinolone-DNA-gyrase complex with induced DNA cleavage, plus inhibition of topoisomerase IV",
      "Correct. Trapping gyrase on cleaved DNA converts a repair enzyme into a source of lethal double-strand breaks, and topoisomerase IV inhibition adds a second target, though that mechanism is less well understood."],
 ...
 dict(topic="Fluoroquinolones", io=IO4K,
   ...
   opts=[
     ...
     ["All three are equally suitable for urinary tract infection",
      "Moxifloxacin is the exception: it is cleared hepatically rather than renally, so it does not reach useful concentrations in urine."]],
   c=0, cite=c(78)),
 ...
 dict(topic="Lincosamides", io=IO4F,
   ...
   opts=[
     ...
     ["Broad coverage with no significant gaps",
      "The gap is specific and clinically important: clindamycin covers Gram-positive aerobes and anaerobes of both kinds, but no Gram-negative aerobes."]],
   c=0, cite=c(80)),
 ...
 dict(topic="Polypeptides", io=IO4M,
   ...
   opts=[
     ["Nephrotoxicity, neurotoxicity, and neuromuscular blockade",
      "Correct. These agents disrupt membranes without much selectivity, so they damage renal tubular and neuronal membranes as well as bacterial ones."],
     ["Tendon rupture, peripheral neuropathy, and central nervous system effects",
      "Tendon rupture and neuropathy are fluoroquinolone warnings; the polymyxin warnings are nephrotoxicity, neurotoxicity and neuromuscular blockade."],
