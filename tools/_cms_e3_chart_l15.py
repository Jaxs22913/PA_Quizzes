...
ROWS_L15 = [
 ("Eustachian tube dysfunction", ETD,
  ...
  "Edema of the tube lining after an <b>upper respiratory infection or allergy</b> stops the tube equalizing pressure. Fullness, mild to moderate hearing impairment, and <b>crackling or popping with yawning or swallowing</b>, which indicates the blockage is only partial. Usually <b>transient &mdash; days to weeks</b>.",
  ...
  "Systemic or intranasal <b>decongestants</b> and <b>intranasal corticosteroids</b>. Forced exhalation against resistance. <b>Caution with active nasal discharge</b> &mdash; that maneuver can force infected fluid into the middle ear and trigger acute otitis media.",
  "Routine",
 ...
 ("Barotrauma", PRESS,
  ...
  "Routine",
  "<b>Avoid pressure changes while a respiratory illness or allergy flare is active.</b> If flying is unavoidable, take a decongestant beforehand and equalize on descent.",
  "22&ndash;25", D15),
 ...
 ("Cholesteatoma", MASS,
  "<b>Keratin debris in a retraction pocket</b> &middot; <b>recurrent otorrhea with no otitis externa</b>",
  "A collection of <b>keratinized squamous epithelium</b> in the middle ear or mastoid. <b>No cholesterol in it and not a neoplasm</b>, despite the name. <b>Primary</b> is commonest and forms from <b>retraction of the tympanic membrane</b>, usually the <b>pars flaccida</b>; <b>secondary</b> follows epithelial migration or surgery; <b>congenital</b> is least common and forms with no retraction or perforation. Risk factors are <b>eustachian tube dysfunction</b> and chronic middle ear inflammation. May be asymptomatic; otherwise tinnitus, <b>recurrent otorrhea in the absence of otitis externa</b>, and hearing loss as a late finding.",
  "<b>Usually a clinical diagnosis.</b> Otoscopy: <b>retraction containing squamous epithelium and keratin debris</b>, debris behind the drum, sometimes purulent otorrhea, granulation tissue or visible <b>ossicular erosion</b>. <b>Audiometry</b> to assess hearing loss. <b>CT</b> for extent in severe cases, and useful in secondary acquired disease when the drum is opaque.",
 ...
 ("Hematoma of the external ear", TRAUMA,
  ...
  "Blood pooling in the <b>sub-perichondrial space</b>, usually after <b>blunt trauma</b>. The collection <b>keeps oxygen and nutrients from the cartilage</b>, which is what risks necrosis. <b>May develop hours after the injury</b>, so patients are re-checked at 12&ndash;24 hours. Examination: <b>edema and ecchymosis of the auricle with loss of the cartilaginous landmarks</b>.",
  "Clinical.",
  "<b>Drain it &mdash; incision or large-needle aspiration &mdash; and do it early.</b> After <b>7 days</b> granulation tissue makes drainage much harder. Follow with irrigation and topical and/or systemic antibiotics. <b>Ear splinting</b> improves the cosmetic result and prevents re-accumulation: cotton bolsters, plaster molds, silicone putty, thermoplastic splints.",
  "Urgent",
  "<b>Early diagnosis and drainage is what prevents cauliflower ear.</b> Come back at 12&ndash;24 hours even if it looks minor, because the hematoma can appear late.",
  "39&ndash;42", D15),
 ...
 ("Lacerations and avulsion", TRAUMA,
  ...
  "Clinical.",
  "Repair as above, then <b>cover with a pressure dressing to prevent a hematoma forming under the repair</b>.",
  "Urgent",
 ...
 ("Foreign body of the auricle", FB,
  ...
  "Piercings becoming <b>embedded in the earlobe</b> or elsewhere on the auricle. <b>Most common in girls and young adolescents with pierced ears.</b> Pain, erythema and edema; may have <b>purulent drainage from the piercing site</b>. Examination: pain on palpation, and the foreign body may be palpable.",
  "Clinical.",
  "Removal under <b>local anesthetic</b>; <b>younger or non-compliant patients may need sedation</b>.",
  "Urgent",
 ...
 ("Otitis externa", OE,
  ...
  "Inflammation and infection of the external canal, affecting <b>10% of people in their lifetime</b>, all ages but commonest in <b>children and early adolescence</b> and in <b>summer</b>. Organisms: <b>P. aeruginosa 38%</b>, S. epidermidis 9%, S. aureus 8%; other bacteria and fungi possible. Risk factors: <b>moisture and swimming</b>, epithelial damage from aggressive cleaning, foreign bodies such as cotton swab fibers, <b>occlusion by hearing aids or headphones</b>, dermatitis of the auricle, radiation. Symptoms: otalgia <b>exacerbated by touching or moving the auricle or tragus</b>, otorrhea, pruritus, fullness, reduced hearing.",
  "<b>Clinical diagnosis.</b> <b>Cultures reserved</b> for severe, chronic or recurrent infection, immunosuppression, post-operative infection and treatment failure. Examination: <b>tenderness to palpation</b>, visible discharge, erythema and edema of the canal, periauricular and anterior cervical <b>lymphadenopathy</b>, thickened canal skin in chronic disease. Differential: otomycosis, suppurative otitis media, contact dermatitis, psoriasis and the rare <b>carcinoma of the ear canal</b>.",
  "<b>Remove debris</b>, then otic drops: <b>antiseptic</b> (boric acid, ichthammol, phenol, aluminum acetate, gentian violet, thymol, cresylate, alcohol), <b>antibiotic</b> (ofloxacin, ciprofloxacin, colistin, polymyxin B, neomycin, chloramphenicol, gentamicin, tobramycin) or <b>acidifying</b> (acetic acid). <b>Combination drops with a steroid</b> reduce pain and inflammation. An <b>ear wick</b> if the canal is stenosed.",
  "Routine",
 ...
 ("Otomycosis", OE,
  ...
  "Fungal infection of the external canal, <b>9% of ear canal infections</b> and varying with climate. Commonest organisms <b>Aspergillus niger and Candida</b>. Pruritus, <b>discomfort that is less painful than bacterial otitis externa</b>, otorrhea, foreign body sensation.",
  "Otoscopy is the diagnosis. <b>Aspergillus: visible fungal spores and filaments, described as &ldquo;wet newspaper&rdquo;.</b> <b>Candida: white, fluffy, curd-like material.</b> Mild to moderate edema.",
 ...
 ("Carcinoma of the ear canal", NEO,
  "<b>Otitis externa that will not respond to treatment</b> &middot; <b>bloody otorrhea</b> &middot; friable canal",
  "<b>Very rare and aggressive.</b> Presents with an <b>abnormal growth in the ear canal</b>, <b>bloody otorrhea</b>, a <b>friable ear canal</b> and <b>failure to respond to treatment for external otitis</b>. Late findings are <b>hearing loss and facial paralysis</b>. <b>Often misdiagnosed as otitis externa.</b>",
...
DIFF_L15 = {
 ...
 "Otitis externa": ("<b>YES &mdash; worse on moving the tragus</b>", "<b>Conductive</b> if the canal closes", "<b>Canal erythematous and edematous</b>"),
 ...
 "Carcinoma of the ear canal": ("<b>YES</b>", "<b>Conductive</b>, late", "<b>Friable growth, bloody otorrhea</b>"),
}
