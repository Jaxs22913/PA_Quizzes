 ...
 dict(topic="Necrotizing fasciitis", io=IOA, slot="etiology",
   ...
   opts=[
     ...
     ["Always Pseudomonas aeruginosa from water exposure",
      "Pseudomonas aeruginosa causes hot tub folliculitis; necrotizing fasciitis is either polymicrobial from mixed flora or monomicrobial group A Streptococcus."],
