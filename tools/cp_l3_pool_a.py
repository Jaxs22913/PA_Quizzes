 ...
 dict(topic="Metaplasia", io=IOB,
   ...
   opts=[
     ["Change of one cell type to another under chronic irritation or injury",
      "Correct — a stem cell population switches to a differentiation programme better suited to the insult, so transitional epithelium under chronic irritation becomes tougher squamous epithelium."],
 ...
 dict(topic="Neoplasm", io=IOC,
   ...
   opts=[
     ...
     ["Many cells, each of which underwent an independent genetic alteration",
      "Independent transformation of many cells at once is vanishingly unlikely; the population is clonal, descended from one altered cell."],
     ...
     ["A variable number, depending on the tissue in which it arises",
      "The clonal origin holds across tissues: the whole proliferating population descends from a single genetically altered cell."]],
   c=0, cite=c(10)),
 ...
 dict(topic="Stem cells", io=IOA,
   ...
   opts=[
     ...
     ["It stays at the same relatively low rate as the stem cell",
      "Proliferation after commitment is in fact dramatic; it is the amplifying step that produces the bulk of the tissue, and those cells then die."],
 ...
 dict(topic="Stem cell kinetics", io=IOA,
   ...
   opts=[
     ...
     ["A higher proliferative fraction together with a higher rate of cell loss",
      "Growth is the balance of the two, so a higher loss rate would cancel the gain; tumours combine more proliferation with less loss."],
     ...
     ["An unchanged proliferative fraction with a shorter individual cell cycle",
      "Tumour cells do not cycle notably faster than normal ones; what changes is how many of them are cycling and how few die."]],
   c=0, cite=c(22)),
 ...
 dict(topic="Malignant histology", io=IOK,
   ...
   opts=[
     ["Pleomorphism, abnormal nuclei, mitoses, and abnormal differentiation",
      "Correct — each reflects loss of normal genomic and architectural control: variable cell size and shape, abnormal nuclei, frequent division, and failure to mature."],
     ...
     ["Initiation, promotion, progression, and metastasis",
      "Initiation, promotion, progression and metastasis describe how a cancer develops over time, not what the pathologist grades under the microscope."]],
   c=0, cite=c(23)),
 ...
 dict(topic="Abnormal growth", io=IOA,
   ...
   opts=[
     ...
     ["Abnormal apoptosis, and abnormal deoxyribonucleic acid repair",
      "Both matter in carcinogenesis, but the contrast drawn here is between uncontrolled growth and the loss of normal signalling between neighbouring cells."],
 ...
 dict(topic="Stem cells", io=IOA,
   ...
   opts=[
     ["As a conceptual framework rather than an absolute explanation",
      "Correct — it is a model that usefully explains why a tumour can regrow from a small surviving population, without being established for every cancer."],
     ["As a fully established mechanism proven for every solid tumour",
      "The concept is offered as a framework rather than a proven mechanism, precisely because the evidence differs between tumour types."],
