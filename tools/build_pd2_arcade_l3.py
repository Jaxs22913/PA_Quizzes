...
BECK'S SIX EXCLUSIONS ARE HONORED HERE TOO, and asserted -- a card on
...
DECK = dict(
  ...
  ["Multiple new flashes or floaters mean what? And a single floater?", "Multiple suggest a retinal tear or vitreous hemorrhage. A single floater is probably benign."],
  ["Rapid versus gradual visual deterioration?", "Rapid suggests vascular causes; gradual suggests cataract and the like."],
  ["Eye pain RELIEVED by a topical anesthetic means what?", "A surface problem such as corneal injury. Pain NOT relieved suggests a deeper source."],
  ["Itching plus excessive tearing suggests what?", "An allergic cause."],
  ["Deep eye pain suggests what?", "Acute narrow angle glaucoma."],
  ["Which immunization status matters in eye trauma?", "Tetanus."],
  ["After a chemical splash, what must you establish?", "Whether the fluid was acid or alkali."],
  ["Acute, unilateral, PAINLESS visual loss — think what?", "Retinal vascular occlusion, retinal detachment, vitreous hemorrhage, macular degeneration."],
  ["Acute, unilateral, PAINFUL visual loss — where and what?", "Usually cornea and anterior chamber: corneal abrasion or ulcer, uveitis, traumatic hyphema, acute narrow angle glaucoma."],
  ...
  ["Which cranial nerve appears in BOTH diplopia patterns?", "The third — it appears in both the horizontal and the vertical pattern."],
  ...
  ["What is known as the vital sign of the eye?", "Visual acuity."],
  ...
  ["Scaly eyebrows suggest what? Lateral sparseness?", "Scaliness suggests seborrheic dermatitis. Lateral sparseness suggests hypothyroidism."],
  ...
  ["Name four causes of proptosis.", "Retrobulbar hemorrhage, orbital cellulitis, orbital tumor, and Graves disease."],
  ...
  ["Which four findings make a subconjunctival hemorrhage benign?", "Pain absent, vision and pupil unaffected, no discharge, and a clear cornea."],
  ["When is globe rupture more likely with a subconjunctival hemorrhage?", "In trauma, and when the hemorrhage encircles the entire cornea."],
  ...
  ["RED-EYE CHART: which condition is negative on pain, vision, discharge, pupil and cornea?", "Subconjunctival hemorrhage."],
  ...
  ["Where is the blind spot, and what enlarges it?", "15 degrees temporal to the line of gaze — enlarged in glaucoma, optic neuritis and papilledema."],
  ...
  ["How much pupil difference is common, and when is anisocoria benign?", "Half to one millimeter is common, and it is benign if the reactions are normal."],
  ...
  ["What is the lesion in Adie's tonic pupil?", "Degeneration of the ciliary ganglia and the postganglionic parasympathetic fibers."],
  ...
  ["What is seen in CONGENITAL Horner syndrome?", "The involved iris is lighter in color — heterochromia."],
  ...
  ["Corneal scar versus cataract?", "The scar is a superficial grayish-white corneal opacity. The cataract lies deeper and is visible only through the pupil."],
  ...
  ["Describe PAPILLEDEMA on fundoscopy.", "Pink, swollen disc with blurred margins, cup not visible, loss of vessel pulsations — from raised intracranial pressure."],
  ...
  ["Which findings suggest an orbital blow-out fracture?", "A sunken eye, infraorbital hypoesthesia, diplopia particularly on upward gaze, decreased motility, and sometimes an ipsilateral nosebleed."],
  ["Which findings suggest a zygomatic fracture?", "Flattening of the malar eminence seen from behind the seated patient, edema and ecchymosis of the temple or infraorbital area, and a palpable step-off on the zygoma."],
  ...
  ["What is a hyphema, and what must be checked?", "Bleeding into the anterior chamber from blunt trauma. Check acuity, pupils, the red reflex, the intraocular pressure, and a slit lamp."],
