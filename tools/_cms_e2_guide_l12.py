...
<section class="deck" id="acute-vision-loss">
  ...
  <table class="tbl">
    ...
    <tr><td>Central, with color desaturation</td><td><b>Optic neuritis</b></td></tr>
  ...
  <table class="tbl">
    ...
    <tr><td><b>Symptoms</b></td><td>Decreased vision, <b>colored halos around lights</b>, headache, <b>nausea and vomiting</b></td><td><b>Asymptomatic in most patients.</b> Peripheral field goes first &mdash; patients say <b>&ldquo;tunnel vision&rdquo;</b> &mdash; then complete blindness</td></tr>
    <tr><td><b>Signs</b></td><td>Pupillary dilation, <b>hazy cornea</b>, bilateral narrow or occluded angle</td><td><b>Optic nerve cupping</b>, rim pitting, <b>bayoneting</b> (vessels with narrow angulations), splinter hemorrhages, rim thinning, field defects</td></tr>
    <tr><td><b>Pressure</b></td><td><b>40&ndash;80 mmHg</b> on tonometry or gonioscopy</td><td><b>May be normal OR elevated</b></td></tr>
    <tr><td><b>Other risks</b></td><td><b>Systemic anticholinergics</b> (atropine), <b>nebulized bronchodilators</b>, prior anterior uveitis, lens dislocation, <b>African American race</b>, obstruction from tumor or scarring</td><td><b>African American race</b>, Hispanic ethnicity, <b>adults over 40</b>, diabetes, age, family history, hypertension, myopia</td></tr>
  ...
  <figure class="fig"><img src="%(IMG)ss019_1.jpg" loading="lazy" alt="Two fundus photographs: a healthy optic nerve beside a glaucomatous one with a widened cup."><figcaption><b>Optic nerve cupping</b> &mdash; the widening and deepening of the central cup as nerve fibers are lost. Jaquith called it <b>the classic sign</b>, and the one a non-ophthalmologist can actually see. <span class="cite">Slide 19</span></figcaption></figure>
  <div class="prof-flag">
    ...
    chief complaint was a headache, and it was localized behind the eye.</strong> Glaucoma is also
  ...
  <table class="tbl">
    ...
    <tr><td><b>Symptoms</b></td><td><b>Unilateral</b> vision loss over <b>hours to several days</b>, with <b>PAINFUL EYE MOVEMENT</b>. Often central vision loss and <b>loss of color vision</b></td></tr>
    <tr><td><b>Signs</b></td><td>Often a <b>normal-appearing disc</b>. <b>Relative afferent pupillary defect (Marcus Gunn)</b></td></tr>
    <tr><td><b>Diagnosis</b></td><td><b>Refer to ophthalmology.</b> Complete ophthalmic exam &mdash; slit lamp, dilated fundoscopy, <b>color vision assessment</b> &mdash; plus a neurological exam. <b>MRI brain AND orbits, with and without contrast</b></td></tr>
  ...
  <table class="tbl">
    ...
    <tr><td><b>Risk factors</b></td><td><b>Myopia</b> (contracted ciliary muscle), <b>trauma</b>, <b>cataract extraction</b>, diabetes, tumor, <b>connective tissue disease</b>, family history</td></tr>
    ...
    <tr><td><b>Then</b></td><td><b>Gray or black shadows</b> in the peripheral field, which may cover the whole eye <b>within days</b>. A <b>&ldquo;curtain or dark cloud&rdquo;</b> across the field</td></tr>
    ...
    <tr><td><b>Diagnosis</b></td><td>Direct and dilated ophthalmoscopy: retina <b>elevated, gray cloud with folds</b>, a <b>pigmented well-demarcated area</b>, and tears that are <b>orange and crescent shaped</b>. <b>Ultrasound is MORE SENSITIVE than the fundoscopic exam</b> and determines the type</td></tr>
  ...
  <table class="tbl">
    ...
    <tr><td><b>Fundus</b></td><td><b>Pale swelling</b> of the posterior segment with a <b>CHERRY-RED SPOT at the fovea</b>; emboli visible in the central artery</td><td><b>&ldquo;BLOOD AND THUNDER&rdquo;</b> &mdash; disc swelling, venous dilation, <b>cotton wool spots</b>, retinal hemorrhages</td></tr>
    <tr><td><b>Risk factors</b></td><td colspan="2"><b>Shared:</b> hypertension, diabetes, hyperlipidemia, Raynaud's, <b>age over 50</b>, hypercoagulable disorders, giant cell arteritis, endocarditis, atrial myxoma, obesity. CRAO adds atrial fibrillation</td></tr>
    <tr><td><b>Later</b></td><td colspan="2"><b>Neovascularization occurs weeks to months after the occlusion</b> in both</td></tr>
    <tr><td><b>Confirmatory</b></td><td colspan="2"><b>Color fundus photography and fluorescein angiography</b></td></tr>
  ...
  the field loss is partial and localized rather than widespread. Everything else &mdash; risk
  ...
  <table class="tbl">
    ...
    <tr><td><b>Workup</b></td><td><b>ESR and CRP</b> &mdash; the tests used to rule giant cell arteritis in or out. <b>Temporal artery biopsy is the gold standard</b></td><td><b>A diagnosis of EXCLUSION.</b> The workup is <b>identical</b> &mdash; you are making sure there is no giant cell arteritis &mdash; then medical evaluation for hypertension, diabetes and anemia, with neuroimaging if unclear</td></tr>
...
TEST = """    avl: [
      ...
      {q:"Which fundus finding belongs to CRAO rather than CRVO?",
       choices:["Blood and thunder hemorrhage","A cherry-red spot at the fovea","Cotton wool spots","Venous dilation"],correct:1,
       explain:"Artery gives pale retina with a cherry-red fovea. Vein gives the hemorrhagic blood-and-thunder fundus. The other three are all venous."},
      ...
      {q:"A 24-year-old woman has vision loss over two days with pain on eye movement and washed-out colors. Which diagnosis?",
       choices:["NAION","Optic neuritis","Angle-closure glaucoma","CRVO"],correct:1,
       explain:"18-45 years, 75% female, painful eye movement, color desaturation, often a normal-looking disc. The ischemic optic neuropathies are painless and occur in an older group."},
      {q:"Which drug class is a RISK FACTOR for acute angle-closure glaucoma?",
       choices:["Beta-blocker drops","Systemic anticholinergics","Prostaglandin analogs","Carbonic anhydrase inhibitors"],correct:1,
