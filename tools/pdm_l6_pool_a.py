...
POOL_A = [
 ...
 dict(topic="Colour", io=IOA, slot="interpretation",
   ...
   opts=[
     ...
     ["Bilirubin in the urine",
      "Bilirubin gives a yellow-brown or green color."],
     ["Blood in the urine",
 ...
 dict(topic="Colour", io=IOA, slot="interpretation",
   ...
   opts=[
     ["Bilirubin",
      "Correct — a yellow-brown or green color points to bilirubin."],
     ["Hemoglobin",
      "Free hemoglobin gives a red to brown color rather than green."],
     ["Myoglobin",
 ...
 dict(topic="Colour", io=IOA, slot="patient education",
   ...
   opts=[
     ["Warn the patient in advance so the change does not alarm them",
      "Correct — telling them beforehand is the point of the counseling."],
     ["Stop the medication if the color changes",
      "The color change is an expected effect rather than a reason to stop."],
     ["Repeat the urinalysis once the color appears",
 ...
 dict(topic="Transparency", io=IOA, slot="interpretation",
   ...
   opts=[
     ...
     ["Ketonuria",
      "Ketones give a sweet odor rather than foam."],
     ["Bilirubinuria",
      "Bilirubin colors the urine rather than making it foam."]],
   c=0, cite=c(8)),
 ...
 dict(topic="Odour", io=IOA, slot="specimen handling",
   ...
   opts=[
     ...
     ["The patient is in ketoacidosis",
      "Ketoacidosis gives a fruity or sweet odor."],
     ["There is a connection between bowel and bladder",
      "That gives a fecal odor."],
 ...
 dict(topic="Odour", io=IOA, slot="interpretation",
   ...
   opts=[
     ["Ketones",
      "Correct — a sweet acetone odor means ketones."],
     ["Bilirubin",
      "Bilirubin changes the color rather than the odor."],
     ["Protein",
 ...
 dict(topic="Odour", io=IOA, slot="interpretation",
   ...
   opts=[
     ...
     ["A simple lower urinary tract infection",
      "Infection gives a foul odor rather than a fecal one."],
     ["Diabetic ketoacidosis",
      "That gives a sweet odor."],
     ["Dehydration",
      "Dehydration concentrates the urine without adding a fecal odor."]],
   c=0, cite=c(9)),
 ...
 dict(topic="Reagent strip technique", io=IOA, slot="limitation",
   ...
   opts=[
     ...
     ["Any color chart may be used, since the colors are standardized",
      "The colors and their order are not standardized across manufacturers."],
