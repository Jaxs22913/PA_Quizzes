...
CARDS = [
 ...
 ["Describe the red, white and blue sign in order from the center out.", "Blue center from ischemia, white ring from vasoconstriction, red outer from inflammation."],
 ...
 ["What color are viable lice eggs compared with hatched remains?", "Viable eggs are tan to brown; hatched remains are clear, white or light."],
]
