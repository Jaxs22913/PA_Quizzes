...
ROWS_L17 = [
 ("Acute sinusitis (rhinosinusitis)", SINUS,
  ...
  "Nasal drainage and congestion, rhinorrhea, postnasal drip, headache. <b>Pain localizes to the "
 ...
 ("Bacterial sinusitis &mdash; the features that suggest it", SINUS,
  ...
  "an antipyretic first</b>. <b>Discharge color is largely unhelpful</b>: yellow or green is the "
  "<i>least</i> useful; clear may be viral or allergic; yellow AND putrid suggests bacterial; "
  "<b>BLACK suggests fungus</b>; rust-colored may be S. pneumoniae.",
  "Symptomatic treatment <b>plus</b> antibiotics &mdash; <b>amoxicillin/clavulanate</b> first line.",
  "Routine",
  "The color of the discharge is the thing patients most expect to be diagnostic, and it is the "
 ...
 ("Chronic fungal sinusitis", SINUS,
  ...
  "dematiaceous molds. <b>Recurrence is common.</b> The <b>allergic</b> form is seen in patients "
 ...
 ("Deviated septum", SEPTUM,
  ...
  "&mdash; to <b>anosmia</b>. In severe forms: <b>obstructive sleep apnea, snoring, facial pain "
 ...
 ("Perforated septum", SEPTUM,
  "<b>Intranasal steroid or COCAINE use</b> &middot; chronic ischemia",
  "A perforation through the nasal septum. Congenital or traumatic, but <b>many are from "
  "intranasal steroid use or cocaine use</b>, both by <b>chronic ischemia</b>. Rarely "
 ...
 ("Septal hematoma", SEPTUM,
  "Blood <b>between septum and perichondrium</b> &middot; after trauma &middot; <b>drain it</b>",
  "A hematoma between the nasal septum and the perichondrium or mucosal epithelium. <b>Usually "
  ...
  "<b>Drainage via intranasal incision under general anesthesia.</b>",
  "Urgent",
  "The same lesson as the auricular hematoma in Lecture 15: cartilage separated from its blood "
 ...
 ("Epistaxis &mdash; anterior", BLEED,
  ...
  "vital signs and respiratory function is the reassuring picture. History: tumors, coagulation "
  ...
  "patient. Hematocrit and type and crossmatch in massive or prolonged hemorrhage, with "
  ...
  "Urgent",
  "<b>Teach these maneuvers for use at home.</b> And <b>DO NOT BLOW THE NOSE</b> afterwards.",
  "45&ndash;51", D17),

 ("Epistaxis &mdash; posterior", BLEED,
  "<b>Sphenopalatine artery</b> &middot; significant hemorrhage &middot; <b>ASPIRATION risk</b>",
  "Arises most commonly from the <b>posterolateral branches of the sphenopalatine artery</b>, but "
  "may arise from branches of the carotid. <b>Results in significant hemorrhage.</b>",
 ...
 ("Nasal foreign body", FB,
  ...
  "it.</b>",
  "<b>Visualization establishes the diagnosis.</b> Imaging is rarely needed.",
 ...
 ("Nasal fracture", TRAUMA,
  ...
  "with septal hematoma.</b> The <b>nasal bridge</b> is the commonest site. Examination: "
  ...
  "septal deviation</b>; and there is <b>no septal hematoma</b>. If any fails, plain films.",
 ...
 ("Nasal polyps", POLYP,
  "<b>Gray, glistening</b> masses &middot; <b>anosmia</b> &middot; asthma and <b>aspirin sensitivity</b>",
  "<b>Abnormal, gray, glistening masses filled with inflammatory material</b> in the nasal cavity "
 ...
 ("Allergic rhinitis", POLYP,
  ...
  "Rhinorrhea secondary to allergy: the body treats the allergen as foreign and releases "
  ...
  "a <b>bluish hue to the nasal mucosa</b>, <b>edematous mucosa</b>, and <b>with or without nasal "
  "polyps</b>.",
 ...
 ("Nasopharyngeal carcinoma", NEO,
  ...
  "The predominant tumor arising in the nasopharynx. <b>Rare in the United States and Western "
  ...
  "<b>Referral to ENT and endoscopic guided biopsy of the primary tumor.</b>",
 ...
 ("Benign nasal neoplasms", NEO,
  ...
  "The lecture defers to the dermatology block: <b>warts, freckles, hemangioma, port-wine "
...
DIFF_L17 = {
 ...
 "Septal hematoma": ("<b>YES</b>", "Obstruction", "<b>Swelling between septum and perichondrium</b>"),
 ...
 "Nasal polyps": ("No", "Thick discharge", "<b>Gray glistening masses</b>; <b>ANOSMIA</b>"),
...
IMGS_L17 = {
 ...
 "Septal hematoma": ("l17-s042_pos1.jpg", 42),
