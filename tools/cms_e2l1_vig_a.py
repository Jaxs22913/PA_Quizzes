...
VIG_A = [
 ...
 dict(topic="Allergic conjunctivitis", io=IOA, lead="first-line", slot="agent/regimen",
   ...
   opts=[
     ["Olopatadine", "Correct — olopatadine antagonises the histamine receptor for immediate relief while stabilising mast cells to prevent further release, covering both phases of the allergic response."],
