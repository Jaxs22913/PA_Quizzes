...
dict(q="Which glaucoma agent is BETA 1 SELECTIVE?",
     ...
     wrong=[("Timolol", "Nonselective, and the most widely used of the three."),
            ("Carteolol", "Also nonselective, so it blocks beta 2 as well."),
            ("Levobunolol", "Nonselective, with the same respiratory caution.")]),
...
dict(q="Why is a NONSELECTIVE beta blocker more efficacious in the eye but worse tolerated?",
     ...
     wrong=[("There are more beta 1 receptors in the eye", "It is the beta 2 receptors that predominate there."),
            ("It penetrates the cornea better", "Corneal penetration is not what separates selective from nonselective here."),
            ("It has a longer half-life", "Duration is not the explanation; receptor distribution in the eye is.")]),
...
dict(q="A pupil dilated with which agent stays MORE REACTIVE TO LIGHT?",
     ...
     wrong=[("Atropine", "An antimuscarinic, and the longest acting; the pupil is less reactive."),
            ("Cyclopentolate", "Another antimuscarinic, with the same reduced reactivity."),
            ("Tropicamide", "The shortest-acting antimuscarinic, but still less reactive than a sympathomimetic.")]),
