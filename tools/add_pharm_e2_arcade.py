...
DECKS = [
 ("pharm-oph-antiinfective", "Ocular Anti-infectives", "accent1", DROP_ICON, [
  ...
  ("Sulfacetamide blocks folate synthesis by antagonizing what?", "p-aminobenzoic acid."),
 ...
 ("pharm-oph-allergy", "Ocular Allergy &amp; Inflammation", "accent2", EYE_ICON, [
  ("What is rebound hyperemia?", "Worsening redness after stopping a vasoconstrictor, from alpha-1 receptor downregulation."),
  ...
  ("Why is imidazoline ingestion dangerous in a toddler?", "Central alpha-2 agonism causes depression, bradycardia and apnea."),
  ...
  ("Name the three mast cell stabilizers.", "Cromolyn, lodoxamide and nedocromil."),
  ("How long do mast cell stabilizers take for full effect?", "Five to fourteen days."),
  ("Are mast cell stabilizers useful for acute symptoms?", "No."),
  ("What do mast cell stabilizers inhibit?", "Mast cell degranulation."),
  ...
  ("What proportion get ocular burning on cyclosporine?", "About seventeen percent."),
 ...
 ("pharm-oph-glaucoma", "Glaucoma &amp; Diagnostics", "accent3", PRESS_ICON, [
  ("What is the normal range of intraocular pressure?", "Ten to twenty-one millimeters of mercury."),
  ...
  ("Which class is first line for glaucoma?", "The prostaglandin analogs."),
  ("How often are prostaglandin analogs given?", "Once daily."),
  ("What happens if prostaglandin dosing is exceeded?", "The pressure-lowering effect is inhibited."),
  ("Name the cosmetic adverse effects of prostaglandin analogs.", "Eyelash lengthening and iris color change."),
  ...
  ("Why are alpha-2 agonists contraindicated in young children?", "Central nervous system depression and apnea."),
  ("Why does apraclonidine have limited systemic effects?", "It is highly ionized, so it penetrates the blood-brain barrier poorly."),
  ...
  ("What proportion get bitter taste from a carbonic anhydrase inhibitor?", "About twenty-five percent."),
  ...
  ("Which two classes are reasonable places to start therapy?", "A prostaglandin analog or a beta blocker."),
  ("Why might therapy start in one eye only?", "To judge efficacy and tolerability against the untreated eye."),
  ("What is the general target for pressure reduction?", "Twenty to thirty percent."),
  ("Why are combination products synergistic?", "They target different routes, production and outflow."),
  ("How do ocular anesthetics work?", "They inhibit sodium influx into the neuron."),
  ("Name the two topical ocular anesthetics.", "Tetracaine and proparacaine."),
  ("How long does an ocular anesthetic last, and what is lost?", "Ten to twenty minutes, with no blink reflex."),
  ("Should ocular anesthetics be prescribed for home use?", "No."),
