...
TESTS = """    ent: [
      ...
      {q:"How long does the vertigo of labyrinthitis last?",
       o:["Days, improving over weeks","Hours at a time",
          "Under a minute, on head movement","Months, worsening steadily"],a:0,
       why:"Labyrinthitis vertigo is sudden, lasts days and improves over weeks. Hours-long episodes are M\\u00e9ni\\u00e8re disease, and vertigo under a minute with head position changes is benign paroxysmal positional vertigo."},
      {q:"Which frequency pattern of hearing loss separates M\\u00e9ni\\u00e8re disease from presbycusis?",
       ...
       why:"Endolymphatic hydrops gives a progressive low-tone sensorineural loss, whereas presbycusis begins with high-frequency tones and aminoglycosides destroy outer hair cells starting at the cochlear base (high pitch)."},
