...
QUESTIONS = [
 dict(topic="Open globe injury", io=IO_A, lead="next step", cite=D % 6,
  q="A 23-year-old has a laceration of the upper lid and a subconjunctival hemorrhage after being struck with a bottle. He is alert. Which is the most appropriate next step before any lid repair?",
  opts=[["Assess the globe beneath for a full-thickness injury", "Correct. Two thirds of full-thickness lid lacerations have a globe injury with them."],
        ["Close the lid and arrange follow-up", "Closing over an unrecognized open globe is the error to avoid."],
        ["Instill a mydriatic to see the retina", "The eye is not dilated in trauma."],
 ...
 dict(topic="Hyphema", io=IO_A, lead="patient education", cite=D % 25,
  ...
  opts=[["Avoid aspirin and antiplatelet drugs, and avoid straining", "Correct. Both raise the risk of a secondary hemorrhage."],
        ["Use topical anesthetic drops when the eye aches", "Never prescribed for home use."],
 ...
 dict(topic="Corneal abrasion", io=IO_A, lead="next step", cite=D % 18,
  ...
  opts=[["A corneal ulcer has developed", "Correct. This is why abrasions are re-examined, and why anesthetic drops are never sent home."],
 ...
 dict(topic="Orbital floor fracture", io=IO_A, lead="diagnosis", cite=D % 41,
  ...
  opts=[["Periorbital subcutaneous emphysema", "Correct. Air tracks from the sinus into the orbit through the fracture."],
        ...
        ["Chemosis", "That is conjunctival edema."],
 ...
 dict(topic="Retinal detachment", io=IO_A, lead="diagnosis", cite=D % 39,
  q="A 61-year-old with hypertension and a known intraocular tumor has subretinal fluid but no retinal break on dilated examination. Which type of detachment is this?",
  opts=[["Exudative", "Correct. No break and no traction, with an associated tumor."],
 ...
 dict(topic="Basilar skull fracture", io=IO_A, lead="initial and confirmatory test", cite=D % 44,
  q="A 44-year-old has clear rhinorrhea after a fall. Which two bedside findings would support cerebrospinal fluid rather than nasal secretions?",
  opts=[["A positive dextrose stick and a halo sign on filter paper", "Correct. Those are the two bedside tests described."],
        ...
        ["Purulent color and a foul smell", "That suggests infection instead."],
        ["Fluorescein uptake and photophobia", "Those relate to the cornea."]]),

 dict(topic="Periorbital hematoma", io=IO_A, lead="diagnosis", cite=D % 33,
  ...
  opts=[["Periorbital hematoma from anticoagulation", "Correct. Periorbital hematoma is not always traumatic, and anticoagulant medication is one of its causes."],
 ...
 dict(topic="Corneal foreign body", io=IO_A, lead="diagnosis", cite=D % 21,
  ...
  opts=[["Slit lamp examination, which can show a smaller foreign body", "Correct. Larger objects show on diffuse light; smaller ones need the slit lamp."],
        ...
        ["Prescribe topical anesthetic for comfort", "Never prescribed for home use."]]),
 ...
 dict(topic="Retinal detachment", io=IO_A, lead="mechanism", cite=D % 35,
  ...
  opts=[["Posterior vitreous detachment, then traction opening a retinal break", "Correct. That is the usual order of events."],
        ...
        ["Choroidal neovascularization with hemorrhage", "That is macular degeneration."],
        ["Optic nerve inflammation", "That gives painful loss with color desaturation."]]),
 ...
 dict(topic="Care by age", io=IO_B, lead="patient education", cite=D % 18,
  q="A 12-year-old scratched his cornea playing. His parent asks for anesthetic drops for the pain at home. Which is the most appropriate response?",
