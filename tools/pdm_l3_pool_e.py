...
POOL_E = [
 dict(topic="CT versus MRI", io=IOH, slot="first-line",
   ...
   opts=[
     ["Contrast-enhanced computed tomography",
      "Correct — fast, widely available, and it shows abscess, edema, gas and bone erosion."],
 ...
 dict(topic="CT versus MRI", io=IOH, slot="test finding",
   ...
   opts=[
     ["Abscesses, edema, gas and bone erosion",
      "Correct — the four findings listed as its advantage."],
     ["Perineural spread, skull base involvement and tumor extent",
 ...
 dict(topic="CT versus MRI", io=IOH, slot="first-line",
   ...
   opts=[
     ...
     ["Soft-tissue contrast, no ionizing radiation, orbital extension, perineural spread, and tumors",
     ...
     ["Bone, tumors, foreign bodies, vascular thrombosis, and osteomyelitis",
 ...
 dict(topic="CT versus MRI", io=IOH, slot="first-line",
   ...
   opts=[
     ["Superior soft-tissue contrast, no ionizing radiation, intracranial or orbital extension, perineural spread, skull base and tumors",
     ...
     ["Soft-tissue contrast, speed, bone erosion, gas and edema",
 ...
 dict(topic="CT versus MRI", io=IOH, slot="first-line",
   ...
   opts=[
     ["Think computed tomography for bone, trauma and speed; think magnetic resonance for soft tissue, nerves and tumor or intracranial extension",
     ...
     ["Think computed tomography for tumors; think magnetic resonance for foreign bodies",
      "Tumors go to magnetic resonance and foreign bodies to computed tomography."],
 ...
 dict(topic="CT versus MRI", io=IOH, slot="first-line",
   q="For which patients is computed tomography specifically favored?",
   opts=[
 ...
 dict(topic="Imaging selection", io=IOI, slot="escalation",
   ...
   opts=[
     ...
     ["For any mass larger than two centimeters",
 ...
 dict(topic="Imaging selection", io=IOI, slot="first-line",
   ...
   opts=[
     ["Magnetic resonance imaging with contrast",
      "Correct — the tumor arises in the internal auditory canal and is soft tissue surrounded by bone, which only contrast-enhanced magnetic resonance resolves."],
