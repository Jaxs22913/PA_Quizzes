...
{"topic": "Ear anatomy", "io": O1, "slot": "mechanism",
 "q": "Which structure separates the external ear from the middle ear, and what does it do?",
 "opts": [
  ...
  ["The round window, which relieves pressure",
   "It sits at the cochlear end and relieves pressure waves; it is not the external boundary."],
  ["The Eustachian tube, which equalises pressure",
   "The tube connects the middle ear to the nasopharynx rather than separating compartments."]],
...
{"topic": "Ear anatomy", "io": O1, "slot": "mechanism",
 ...
 "opts": [
  ...
  ["It has no blood supply",
   "The middle ear is perfused. Its vulnerability comes from being a sealed air space, not from any lack of blood supply."],
  ["It is lined by keratinised skin",
   "The canal is skin-lined; the middle ear is mucosa, which is what absorbs the gas."]],
 "c": 0, "cite": "%s, Slide 4" % D},
...
{"topic": "Ear anatomy", "io": O1, "slot": "mechanism",
 ...
 "opts": [
  ["Cerumen from ceruminous glands, and hair follicles",
   "Correct. Both sit in the outer third, which is why impaction and otitis externa are canal diseases."],
  ["Mucus from goblet cells",
   "The ear canal is lined by skin, not respiratory mucosa, so it has no goblet cells to produce mucus."],
  ["Ciliated epithelium sweeping debris outward",
   "Ciliated epithelium sweeps the respiratory tract; the ear canal clears itself by cerumen migration instead."],
...
{"topic": "Hearing loss patterns", "io": O5, "slot": "mechanism",
 ...
 "opts": [
  ...
  ["Both stiffen the ossicles",
   "Neither the cochlea nor the nerve has any mechanical connection to the ossicles, so neither stiffens them."],
...
{"topic": "Presbycusis", "io": O5, "slot": "mechanism",
 ...
 "opts": [
  ["Gradual, symmetrical and bilateral",
   "Correct, and it is sensorineural. Asymmetry would point away from ageing toward a focal lesion."],
  ["Sudden and unilateral",
   "Sudden unilateral loss points to labyrinthitis or a vascular event rather than to age-related change."],
  ...
  ["Gradual but strictly unilateral",
   "One-sided gradual loss raises acoustic neuroma rather than presbycusis."]],
...
{"topic": "Otitis externa", "io": O3, "slot": "mechanism",
 ...
 "opts": [
  ["It removes the bacterial competition that normally limits fungal growth",
   "Correct. The same logic as thrush: clear the residents and the fungus has the canal to itself."],
  ["It thins the canal skin directly",
   "Antibiotics do not thin the canal skin. What they remove is the bacterial competition."],
  ["It raises the canal pH to favour fungi",
  ...
  ["It damages the tympanic membrane",
   "Otitis externa is a canal disease and does not begin at the membrane."]],
...
{"topic": "Vertigo vs dizziness", "io": O4, "slot": "mechanism",
 ...
 "opts": [
  ...
  ["The otoliths dissolve",
   "Otoconia become dislodged in one condition, but they do not dissolve."]],
...
{"topic": "Meniere disease", "io": O3, "slot": "mechanism",
 ...
 "opts": [
  ["Pressure builds until micro-ruptures occur, then re-equilibrates",
   "Correct. The cycle of build-up and release is what makes it episodic."],
  ...
  ["Inflammation resolves and recurs",
   "Inflammation across canals and cochlea is labyrinthitis, and its vertigo is continuous."]],
 "c": 0, "cite": "%s, Slide 16" % D},

{"topic": "Nasal polyps", "io": O3, "slot": "mechanism",
 "q": "Why are nasal polyps described as non-neoplastic?",
 "opts": [
  ["No new tissue is grown; existing mucosa becomes oedematous",
   "Correct. They are waterlogged mucous membrane rather than a growth."],
  ...
  ["They regress without treatment in every case",
   "Non-neoplastic describes what the tissue IS, not how it behaves over time or whether it regresses."]],
 "c": 0, "cite": "%s, Slide 21" % D},

{"topic": "Epistaxis", "io": O3, "slot": "mechanism",
 "q": "Why does anticoagulation favour POSTERIOR rather than anterior epistaxis?",
 "opts": [
  ...
  ["Anticoagulants are concentrated posteriorly",
   "Anticoagulants act on clotting throughout the circulation and are not concentrated in any part of the nose."],
...
{"topic": "Cervical lymphadenopathy", "io": O2, "slot": "mechanism",
 ...
 "opts": [
  ["They have lost their individual capsules and move as one mass",
   "Correct. Tissue no longer respecting its own boundaries is why matting raises concern."],
