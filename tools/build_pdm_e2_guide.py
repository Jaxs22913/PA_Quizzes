...
recordings (Elwaya) and the 21 September recording (Reynolds, Lecture 9). The
Lecture 9 box was added 2026-09-25 after both transcripts (Notability's own and
the local faster-whisper run) were read and compared; quotes cite the whisper
timestamps and appear in both.
...
S9 = f'''<section class="deck" id="biomarkers-lipids">
  ...
  <p><strong>Numbers:</strong> every threshold below is here so you can read a result, not to memorize &mdash; reference ranges are supplied on her exams. One exception she drew in the recording: the adult LDL-C goal is not a lab range, so know its two ends (below).</p></div>

  <div class="prof-flag"><span class="prof-flag-label">&#9733; Professor emphasized &mdash; 21 September recording</span>
  <table>
    <tr><th>She said</th><th>So</th></tr>
    <tr><td>On slide 43&rsquo;s Friedewald and non-HDL-C practice: <em>&ldquo;there will be two things that you need to calculate &hellip; for our purposes, we&rsquo;re gonna practice this.&rdquo;</em> Then <em>&ldquo;You may use calculators,&rdquo;</em> and after the answers: <em>&ldquo;So we had to do two calculations, and then we have to interpret.&rdquo;</em> The newer equations are <em>&ldquo;more complicated. You can use a calculator for that.&rdquo;</em> [part 3, 6:03&ndash;9:48]</td><td><strong>These two calculations are examinable</strong>: LDL-C = total &minus; HDL-C &minus; triglycerides &divide; 5, and non-HDL-C = total &minus; HDL-C, then read each against the patient&rsquo;s risk tier. Martin/Hopkins and Sampson are calculator-only. Unlike filtration rate and corrected sodium, which she ruled out in Lecture 5.</td></tr>
    <tr><td>Asked whether a normal would always be given: there is no one normal, <em>&ldquo;so for this, you want to kind of have an idea of the difference between somebody who&rsquo;s low risk and &hellip; high risk. So for LDL, if they&rsquo;re low risk, less than 100 is our goal. If they&rsquo;re high risk, less than 55.&rdquo;</em> [part 3, 10:36&ndash;11:04]</td><td>Know the <strong>LDL-C goal at each end</strong>: under 100 mg/dL for an average-risk adult, under 55 at the highest risk. The deck&rsquo;s middle tier is under 70 (9.5). &ldquo;Golf, not bowling&rdquo;: the higher the risk, the lower the target.</td></tr>
    <tr><td><em>&ldquo;LDL is the big one that we care about &hellip; for risk stratification.&rdquo;</em> [part 3, 12:48] And for lipoprotein(a), which <em>&ldquo;is bolded for a reason&rdquo;</em> [part 2, 1:24]: <em>&ldquo;You can&rsquo;t fix this with diet&rdquo;</em>; once in a lifetime; if it is high, <em>&ldquo;all of their first-degree relatives should be screened&rdquo;</em> &mdash; <em>&ldquo;cascading screening.&rdquo;</em> [part 2, 2:23&ndash;5:15]</td><td>Lipoprotein(a): genetic, measured once, cascade-test first-degree relatives, lifestyle does not lower it (9.6).</td></tr>
    <tr><td><em>&ldquo;When you hear CRP, think inflammation, period.&rdquo;</em> [part 1, 0:40] <em>&ldquo;When you hear BNP &hellip; think stretch and therefore volume.&rdquo;</em> [part 1, 2:07] <em>&ldquo;Troponin is your friend. When you&rsquo;re worried about any kind of injury, any kind of ischemia to the heart, troponin is what you want to be ordering.&rdquo;</em> [part 1, 7:50]</td><td>The one-word frame for each marker: inflammation, stretch, injury.</td></tr>
    <tr><td><em>&ldquo;If you have troponin, don&rsquo;t even waste your time ordering a CK.&rdquo;</em> [part 1, 31:05] Creatine kinase-MB only if troponin is unavailable; <em>&ldquo;you will absolutely order it&rdquo;</em> for rhabdomyolysis. [part 1, 15:58&ndash;16:26]</td><td>Creatine kinase is a skeletal-muscle test (9.2).</td></tr>
    <tr><td><em>&ldquo;Make sure you know what troponin you&rsquo;re talking about when you&rsquo;re reading your labs.&rdquo;</em> A conventional troponin I of 22 would be alarming; a high-sensitivity value of 22 is on a different scale. [part 1, 8:41&ndash;9:18]</td><td>Read a troponin against <em>its own</em> assay&rsquo;s limit (slide 5 gives each).</td></tr>
    <tr><td>Type 1 versus type 2 infarction (slide 11): type 1 is an occluded vessel, <em>&ldquo;take them to the cath lab&rdquo;</em>; type 2 is global supply failure (sepsis, hypoxia, blood loss) with a much milder troponin rise, treated by treating the cause. [part 1, 12:39&ndash;15:50]</td><td>A small troponin rise in a septic, hypoxic patient is expected; the height of the rise separates the two.</td></tr>
    <tr><td>High-sensitivity C-reactive protein is <em>&ldquo;our risk stratifier &hellip; not part of your STEMI, acute coronary syndrome protocol. That&rsquo;s an office visit type lab.&rdquo;</em> [part 1, 31:41&ndash;31:56] Above 50 mg/dL <em>&ldquo;is unlikely to be like a chronic inflammatory process&rdquo;</em> &mdash; that patient is septic. [part 1, 24:41]</td><td>Never the answer for acute chest pain; the answer for a well visit with a family history.</td></tr>
    <tr><td>The chest-pain cases (slides 24&ndash;31): troponin and an EKG as soon as possible, plus a basic or comprehensive metabolic panel for kidney function, for <em>&ldquo;at least two reasons, probably three&rdquo;</em> &mdash; to interpret the troponin, because the catheter lab means contrast, and because diabetes and hypertension damage kidneys. Her milder, older patient: <em>&ldquo;do we think that just because her presenting symptoms are milder, that her labs are going to be better? Not necessarily.&rdquo;</em> [part 1, 33:27&ndash;38:58]</td><td>The next-best-test answer for acute chest pain is troponin + EKG, with renal function alongside. At follow-up she added hs-CRP, hemoglobin A1C and a repeat EKG.</td></tr>
    <tr><td>Case 3 (slide 48, &ldquo;diagnostic*&rdquo;): <em>&ldquo;This person&rsquo;s fine &hellip; So is this really diagnostic testing? Screening.&rdquo;</em> Order a fasting lipid panel, A1C, and a lipoprotein(a) if never measured. [part 3, 16:53&ndash;17:42]</td><td>The asterisk is the point: the same tests, ordered as <em>screening</em>. Family history of premature disease is also a fasting indication (9.3).</td></tr>
  </table>
  <p class="muted"><b>Where the slide wins.</b> Four spoken statements differ from the deck; the deck is what this guide teaches. (1) She described trending troponin <em>&ldquo;every three hours through nine hours &hellip; zero, three, six, and nine&rdquo;</em> [part 1, 18:19]; slide 7 draws <strong>high-sensitivity</strong> troponin at 0 and 1&ndash;2 hours. (2) She called BNP <em>&ldquo;not super ideal for guiding therapy&rdquo;</em> and not for serial trending [part 1, 19:40&ndash;19:53]; slide 14 lists guiding therapy and monitoring the course as applications. (3) She called type 2 infarction a &ldquo;non-STEMI&rdquo; and &ldquo;injury&rdquo; [part 1, 13:20; 30:38]; the deck&rsquo;s own graph (slide 11) plots it as an <em>infarction</em>, and non-ST elevation is an electrocardiogram category, not a type. (4) For routine labs she would <em>&ldquo;just do fasting&rdquo;</em> [part 3, 15:02]; slide 46 says nonfasting is acceptable for most. Also loose: a high-sensitivity troponin of 22 is <em>at</em>, not under, slide 5&rsquo;s male limit (under 22 ng/L).</p>
  <p class="muted"><b>Coverage.</b> Three segments, about 80 minutes: part 1 (biomarkers and cases 1&ndash;2, from slide 4; the last eleven minutes are the break), part 2 (seven minutes on apolipoproteins and lipoprotein(a)) and part 3 (the lipid panel, the calculation, case 3). The opening minutes on slides 1&ndash;3 and the first lipid slides (32&ndash;33) fall outside the recordings.</p>
  </div>
  ...
  <div class="callout"><p><strong>Worked the way the deck&rsquo;s own practice slide asks.</strong> A panel with total cholesterol 200 mg/dL, HDL-C 50 mg/dL and triglycerides 100 mg/dL: non-HDL-C = 200 &minus; 50 = <strong>150 mg/dL</strong>; Friedewald LDL-C = 200 &minus; 50 &minus; 20 = <strong>130 mg/dL</strong>. <strong>This arithmetic is examinable:</strong> she worked slide 43 in class as <em>&ldquo;two calculations, and then &hellip; interpret&rdquo;</em> (178 &minus; 62 &minus; 18 = 98; 178 &minus; 62 = 116; both in range for a low-risk patient, &ldquo;not even close&rdquo; for a high-risk one). Triglycerides of 400 mg/dL or more: <em>&ldquo;we cannot trust that calculation.&rdquo;</em></p></div>
