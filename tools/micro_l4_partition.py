#!/usr/bin/env python3
"""Partition the Microbiology Lecture 4 pool into two 30s.
...
from micro_l4_pool_a import POOL_A
from micro_l4_pool_b import POOL_B
...
if __name__ == "__main__":
    ...
    json.dump({"set1": s1, "set2": s2}, open(os.path.join(HERE, "micro_l4_sets.json"), "w"),
              ensure_ascii=False, indent=1)
    print("\nwrote micro_l4_sets.json")
