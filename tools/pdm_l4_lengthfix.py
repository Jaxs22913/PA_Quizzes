...
FIXES = {
 ...
 (A + 11, 3): "Pallor, dyspnea on exertion, palpitations, dizziness and cold intolerance",
 ...
 (A + 17, 1): "Immature neutrophils, normally fifteen percent or less, with three or four fully separated nuclear lobes",
...
FIXES.update({
 ...
 (B + 15, 1): "Trauma, acute hemorrhage, iron deficiency and recent orthopedic surgery",
 ...
 (B + 28, 2): "Hemoglobin in grams per deciliter, multiplied by one hundred, divided by the hematocrit percentage",
...
FIXES.update({
 ...
 (C + 5,  2): "Schistocytes, with mean corpuscular hemoglobin concentration above thirty-six grams per deciliter of packed cells",
 ...
 (C + 15, 1): "Under high oxygen tension, when normal adult hemoglobin polymerizes, causing brisk intravascular hemolysis",
