...
CRAM_ROWS = [
 ...
 ("L4 \u00b7 The Studies", "#3f8a55", [
   ...
   ("VIRAL FOMITES (Boone & Gerba 2007)", "1.7M deaths/yr diarrheal, 1.5M respiratory. <b>VIRUSES CAUSE ~60% OF HUMAN INFECTIONS</b> and CANNOT be cured with antibiotics. CROWDED INDOOR SPACES consistently INCREASE morbidity and mortality."),
 ...
 ("L4 \u00b7 Disinfection & History", "#3f8a55", [
   ("FIVE BEST PRACTICES, in order", "1. STANDARDIZE cleaning policy \u00b7 2. Select <b>EPA-REGISTERED</b> disinfectants \u00b7 3. Educate <b>ALL</b> staff INCLUDING environmental services \u00b7 4. MONITOR compliance with feedback \u00b7 5. <b>NO-TOUCH</b> decontamination technology."),
...
CARDS = [
 ...
 ("How does a reservoir differ from a vector?", "The reservoir harbors it; the vector delivers it."),
 ...
 ("What share of human infections are viral?", "About sixty percent."),
 ...
 ("Which organisms grew above 10,000 CFU per milliliter?", "Klebsiella, Pseudomonas and Acinetobacter."),
