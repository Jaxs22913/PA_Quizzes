...
POOL_C = [
 dict(topic="Dermatofibroma", io=IOA, slot="etiology",
   ...
   opts=[
     ["Fibroblasts in the dermis forming small dense clusters, creating a firm nodule of about half a centimeter to one centimeter",
     ...
     ["Eccrine duct cells proliferating near the surface, creating multiple papules of one to two millimeters",
      "That is syringoma."]],
   c=0, cite=c(44)),
 ...
 dict(topic="Dermatofibroma", io=IOA, slot="manifestation",
   ...
   opts=[
     ["A firm nodule with a hyperpigmented brown halo, a pink hue, a raised center and a scaly surface; the most common painful skin tumor",
     ...
     ["A soft skin-colored pedunculated papule on a narrow stalk with a broad tip; asymptomatic unless it is caught and torn",
      "That is the acrochordon."],
     ["A whitish-yellow soft papule of two to nine millimeters with a central umbilication from which sebum can be expressed; asymptomatic",
 ...
 dict(topic="Dermatofibroma", io=IOA, slot="first-line",
   ...
   opts=[
     ...
     ["Immediate wide local excision in every case, because a dermatofibroma cannot reliably be told from a cutaneous melanoma on clinical appearance alone",
      "The dimple sign and firm nodular character distinguish it clinically, so observation is reasonable and excision is reserved for diagnostic doubt or symptoms."],
 ...
 dict(topic="Keratoacanthoma", io=IOA, slot="manifestation",
   ...
   opts=[
     ...
     ["A firm nodule with a hyperpigmented brown halo, a pink hue and a raised scaly center",
 ...
 dict(topic="Keratoacanthoma", io=IOA, slot="first-line",
   ...
   opts=[
     ["Excise or destroy the tumor, preferred because of possible malignancy; ellipse it out with five-millimeter margins",
 ...
 dict(topic="Keratoacanthoma", io=IOA, slot="escalation",
   ...
   opts=[
     ...
     ["For every lesion, because the recurrence rate after simple excision approaches one hundred percent",
 ...
 dict(topic="Epidermoid cyst", io=IOA, slot="etiology",
   ...
   opts=[
     ["Keratin, from epithelium enclosed within the dermis; it is not a sebaceous cyst",
      "Correct — the cyst is lined by epidermis that keeps shedding keratin inward, and the pale greasy contents that look like sebum are in fact macerated keratin."],
 ...
 dict(topic="Epidermoid cyst", io=IOA, slot="manifestation",
   ...
   opts=[
     ["A single firm movable nodule with a central punctum, expressing pasty material that smells of rancid cheese",
      "Correct — a round protruding mass whose central pore communicates with the skin surface. The punctum and the smell of the cream-colored contents are the two giveaways."],
     ["A soft painless subcutaneous nodule of rubbery consistency, usually under five centimeters across, with no overlying pore or punctum at all",
      "That is the lipoma."],
     ["A firm nodule with a hyperpigmented brown halo and a scaly surface, which retracts beneath the skin on lateral compression",
      "That is the dermatofibroma."],
     ["A translucent skin-colored papule sitting over the distal interphalangeal joint, which may groove the nail longitudinally",
      "That is the digital mucous cyst."]],
   c=0, cite=c(54)),
 ...
 dict(topic="Epidermoid cyst", io=IOA, slot="escalation",
   ...
   opts=[
     ...
     ["Excise it immediately, on the basis that inflammation indicates the capsule has already ruptured into the surrounding dermis",
      "Operating on inflamed tissue makes complete removal of the capsule harder and raises the recurrence rate, so the inflammation is settled first."],
 ...
 dict(topic="Epidermoid cyst", io=IOA, slot="first-line",
   ...
   opts=[
     ["Removal of the entire capsule when the cyst is not inflamed; a small one can be punched and emptied",
      "Correct — the capsule is the part that matters, and removing all of it is the standard of care. A cyst of one to three centimeters can instead be treated with a punch incision and removal of the contents."],
     ...
     ["Elliptical excision with five-millimeter margins in every case, with the specimen sent for histopathological analysis",
 ...
 dict(topic="Syringoma", io=IOA, slot="etiology",
   ...
   opts=[
     ...
     ["A benign neoplasm of endothelial cells, appearing in the first weeks of life and more often in females",
      "That is infantile hemangioma."],
     ["A benign nerve sheath tumor, appearing at puberty and increasing with age",
 ...
 dict(topic="Syringoma", io=IOA, slot="manifestation",
   ...
   opts=[
     ["Multiple skin-colored, pink or brown papules of one to two millimeters, most often on the eyelids and upper cheeks",
      "Correct — the periorbital location is the recognizable part."],
     ["Multiple whitish-yellow papules of two to nine millimeters with central umbilication, most often on the face",
      "That is sebaceous hyperplasia."],
     ...
     ["Light tan to brown macules over five millimeters, appearing in the first year of life",
 ...
 dict(topic="Syringoma", io=IOA, slot="first-line",
   ...
   opts=[
     ...
     ["For cosmesis only: intralesional corticosteroid injection flattens the lesions reliably, with local tissue atrophy as the only meaningful risk",
      "Intralesional steroid is used for keloids and inflamed cysts; syringomas are numerous small eccrine tumors where any destructive method risks scarring."],
