...
TESTS = """    ocular: [
      {q:"HORIZONTAL diplopia — images side by side — means a palsy of which cranial nerves?",
       ...
       explain:"Horizontal diplopia (images side by side) means a palsy of cranial nerve III or VI; vertical diplopia (images on top of each other) means III or IV. The third nerve appears in both."},
      ...
      {q:"Which cause of red eye has a DILATED FIXED pupil and a steamy cornea?",
       choices:["Conjunctivitis","Acute iritis","Glaucoma","Subconjunctival hemorrhage"],correct:2,
      ...
      {q:"Which description of the normal blind spot is correct?",
       choices:["15° nasal; enlarged in cataract","15° temporal; enlarged in glaucoma, optic neuritis and papilledema","Central; enlarged in macular degeneration","30° temporal; enlarged in detachment"],correct:1,
      ...
      {q:"Which findings suggest an orbital blow-out fracture?",
       choices:["Proptosis with fever","Sunken eye, infraorbital hypesthesia, diplopia on UPWARD gaze, sometimes an ipsilateral nosebleed","Flattening of the cheek with pain on opening the mouth","A fixed mid-dilated pupil"],correct:1,
       explain:"The cheek flattening with jaw pain is a ZYGOMATIC fracture — temporalis passes medial to the arch."},
      {q:"Which eye complaint is EMERGENT rather than urgent?",
       choices:["Corneal abrasion","Hyphema","Chemical burns","Orbital cellulitis"],correct:2,
       explain:"Emergent: sudden vision loss, retinal artery occlusion, chemical burns, rupture, acute angle closure, vitreous hemorrhage. The rest are urgent — a day or less."}
    ],
"""
