...
EXPL = {
("l10",7,2): "These are general morphological terms rather than features of a pigmented lesion, and none of them describes asymmetry, border, color, diameter, or evolution. A mnemonic built from them would not direct attention to any of the changes that identify a melanoma.",
("l4",41,3): "Those are the predisposing factors for acute paronychia, a localized infection of the soft tissue around a fingernail. None involves the deep fascial planes, and none appears among the trauma, burn, surgical, or immunosuppressive exposures that precede necrotizing fasciitis.",
...
("l7",28,4): "Lipid-laden macrophages form xanthelasma, the soft yellow plaques of the medial eyelids that prompt screening for hyperlipidemia. The contents here are mucin extruded from the adjacent joint, which is why this lesion is translucent rather than yellow.",
("l7",36,2): "Growth in proportion to the child describes café au lait macules, which are flat pigmented lesions rather than tumors. A plexiform neurofibroma is a soft tissue mass in the covering of a nerve and is not a pigmentary change at all.",
("l7",36,3): "Intertriginous freckling under 5 mm is Crowe's sign, another cutaneous marker of neurofibromatosis type 1. It is a pigmentary finding of the axillae and groin rather than a nerve sheath tumor, and it carries no risk of local invasion.",
...
("l7",39,3): "Excising benign lesions prophylactically causes scarring without benefit and does nothing about future ultraviolet exposure. The opportunity this visit creates is counseling, not surgery.",
...
("l8",7,3): "Burrows in the finger webs are the pathognomonic lesion of scabies, produced by a mite tunneling through the stratum corneum. Body lice live in clothing and feed on the skin without burrowing, so they leave linear excoriations rather than tunnels.",
...
("l8",16,4): "That course describes a hobo spider bite, which is painless with induration and paresthesia within 30 minutes and vesicles by 36 hours. A brown recluse bite is painful from the outset and evolves toward necrosis and eschar over days.",
...
("l8",23,1): "Erythema migrans is the stage 1 early localized finding, appearing at the site of the tick bite within days to weeks. By the late persistent stage, months to years later, the skin lesion has long resolved and the disease has moved to the joints.",
