 ...
 dict(topic="Cutaneous T-cell lymphoma", io=IOA, slot="first-line",
   ...
   opts=[
     ...
     ["Immediate aggressive systemic chemotherapy for all stages regardless of extent, because early aggressive treatment reliably cures the disease and prevents progression to systemic involvement",
      "Aggressive systemic chemotherapy has not been shown to cure the disease or prevent progression, and its complications can shorten life in patients who would otherwise live for decades."],
