 ...
 dict(topic="Nuclear medicine", io=IOB, slot="manifestation",
   ...
   opts=[
     ["A particle of roughly the same mass as an electron, but carrying the opposite, positive charge",
      "Correct — it is the electron's antiparticle, and when it meets an electron the two annihilate into paired photons travelling in opposite directions, which is what the scanner detects."],
 ...
 dict(topic="Nuclear medicine", io=IOF, slot="avoid",
   ...
   opts=[
     ["Computed tomography, positron emission tomography and single photon emission tomography",
      "Correct — all three deliver far more ionising radiation than plain films, computed tomography through many projections and the nuclear studies through an injected emitter."],
     ["Conventional radiography, fluoroscopy and the angiographic studies performed with x-rays",
      "These use ionising radiation but at relatively low dose; the highest exposures come from computed tomography and the two nuclear studies."],
