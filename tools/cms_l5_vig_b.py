...
POOL_B = [
 ...
 dict(topic="Hymenoptera", io=IOA,
   q="A 44-year-old woman stung by a wasp develops generalized urticaria, lip swelling and wheeze within ten minutes. Which is the most appropriate immediate treatment?",
   opts=[
     ...
     ["Ice to the sting site with injection of a local anesthetic for control of the pain",
 ...
 dict(topic="Hymenoptera", io=IOA,
   ...
   opts=[
     ["Carry an epinephrine auto-injector and be referred for desensitization therapy",
 ...
 dict(topic="Caterpillars", io=IOA,
   ...
   opts=[
     ...
     ["A processionary caterpillar reaction with urticaria and angioedema",
      "That species produces urticaria, angioedema and anaphylaxis."],
 ...
 dict(topic="Caterpillars", io=IOA,
   ...
   opts=[
     ...
     ["The processionary caterpillar, which causes systemic reactions",
      "That species causes urticaria, angioedema and anaphylaxis."],
 ...
 dict(topic="Caterpillars", io=IOA,
   ...
   opts=[
     ...
     ["Comb the area after applying hair moisturizer",
 ...
 dict(topic="Cutaneous larva migrans", io=IOA,
   ...
   opts=[
     ...
     ["A scabies burrow of the foot",
      "That is 1 to 10 mm long and does not advance centimeters a day."],
 ...
 dict(topic="Cutaneous larva migrans", io=IOA,
   ...
   opts=[
     ...
     ["Surgical excision of the leading edge of the lesion under local anesthetic",
 ...
 dict(topic="Cutaneous larva migrans", io=IOA,
   ...
   opts=[
     ...
     ["Tungiasis with multiple lesions at the site of contact",
      "That favors the feet, web spaces and periungual skin."]],
   c=0, cite=c(51)),
 ...
 dict(topic="Black widow spider", io=IOA,
   ...
   opts=[
     ...
     ["The hobo spider",
      "That produces a painless bite with induration and paresthesia."],
     ["A tarantula",
 ...
 dict(topic="Black widow spider", io=IOA,
   ...
   opts=[
     ["Hospitalize him, since the very old, the very young and those with cardiovascular disease are at increased risk",
 ...
 dict(topic="Brown recluse spider", io=IOA,
   q="A 38-year-old woman in Missouri was bitten while cleaning an attic. The site now shows a dark purple center surrounded by a pale blanched ring, and beyond that a large irregular area of redness. Which is the most likely diagnosis?",
   opts=[
 ...
 dict(topic="Hobo spider", io=IOA,
   ...
   opts=[
     ["The hobo spider",
      "Correct — the Pacific Northwest, a painless bite, induration and paresthesia within thirty minutes, vesicles by thirty-six hours."],
     ["The brown recluse spider",
 ...
 dict(topic="Hobo spider", io=IOA,
   q="A 33-year-old woman with a hobo spider bite asks what to expect. Which is the most appropriate counseling point?",
   opts=[
