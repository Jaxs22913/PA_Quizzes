...
POOL_C = [
 ...
 dict(topic="Basal cell carcinoma", io=IOA, slot="etiology",
   q="Which clinical and histologic subtypes of basal cell carcinoma are listed, and which determines behavior?",
   opts=[
     ["Clinical: superficial, nodular, pigmented, morpheaform. Histologic: superficial, nodular, micronodular, infiltrative. The HISTOLOGIC subtype determines behavior and dictates treatment selection",
      "Correct — histology drives the treatment decision."],
     ["Clinical: superficial, nodular, pigmented, morpheaform. Histologic: superficial, nodular, micronodular, infiltrative. The CLINICAL subtype determines behavior and dictates treatment selection",
      "The lists are right but the roles reversed: it is the histologic subtype, particularly micronodular and infiltrative, that predicts subclinical spread and dictates treatment."],
     ["Clinical: superficial spreading, nodular, lentigo maligna, acral. Histologic: in situ, invasive, metastatic. The histologic subtype determines behavior",
      "Those clinical subtypes belong to melanoma."],
     ["Clinical: classic, endemic, iatrogenic, epidemic. Histologic: patch, plaque, tumor. The clinical form determines behavior",
 ...
 dict(topic="Basal cell carcinoma", io=IOA, slot="agent/regimen",
   ...
   opts=[
     ...
     ["Vismodegib 150 mg orally daily, reducing basal cell carcinoma development by approximately 20%",
      "Vismodegib treats advanced disease rather than preventing new tumors."],
 ...
 dict(topic="Basal cell carcinoma", io=IOA, slot="manifestation",
   q="Describe NODULAR basal cell carcinoma, including the maneuver that accentuates its vessels.",
   opts=[
     ...
     ["A papule or nodule with central erosion, growing rapidly over weeks to 1 to 2 cm or larger, with a pearly quality and telangiectasias accentuated by pressing the lesion firmly",
      "Growth is slow, over years, and the maneuver is stretching."],
 ...
 dict(topic="Basal cell carcinoma", io=IOA, slot="escalation",
   ...
   opts=[
     ["Hedgehog pathway inhibitors — vismodegib or sonidegib",
      "Correct — reserved for advanced disease or extensive tumor burden."],
 ...
 dict(topic="Basal cell carcinoma", io=IOA, slot="prognosis",
   ...
   opts=[
     ...
     ["Excision recurrence rate of about 30%; Mohs cure rate of about 70%",
      "Both are far off: standard excision recurs in a low single-digit percentage and Mohs achieves cure rates around 99 percent."],
 ...
 dict(topic="Basal cell carcinoma", io=IOA, slot="escalation",
   ...
   opts=[
     ["Eyelids, nasolabial folds, canthi, external ear and temple; recurrent tumors; a tissue-sparing or cosmetic need; and aggressive histology — morpheaform, micronodular or infiltrative",
      "Correct — four groupings, with the histologic subtypes named."],
     ["Eyelids, nasolabial folds, canthi, external ear and temple; recurrent tumors; a tissue-sparing or cosmetic need; and low-risk histology — superficial or nodular disease",
     ...
     ["The trunk, back, chest and shoulders; first presentations only; a purely cosmetic need; and any pigmented lesion whatever its histology",
      "None of these predicts subclinical extension; Mohs is used for high-risk sites, aggressive histology, recurrent tumors and where tissue must be conserved."],
