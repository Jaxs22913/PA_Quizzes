...
dict(cond="Stasis dermatitis", img="l2_s111_3.jpg", slide=111, deck=D2, io=ECZ,
     alt="Lower leg above the ankle with brown discoloration, scaling and swelling",
     why="Brown hemosiderin staining with scaling and edema on the LOWER LEG, above the ankle.",
     wrong=[("Cellulitis", "That is acutely hot, tender and spreading, not chronically pigmented."),
            ...
            ("Atopic dermatitis", "That favors the flexures and does not stain the skin brown.")]),
...
dict(cond="Pemphigus vulgaris", img="l2_s127_2.jpg", slide=127, deck=D2, io=PAP,
     ...
     wrong=[("Bullous pemphigoid", "Those blisters are TENSE and stay intact."),
            ("Impetigo — bullous", "That is superficial and crusts over honey-colored, without this denudation."),
...
dict(cond="Lichen planus", img="l2_s175_1.jpg", slide=175, deck=D2, io=PAP,
     ...
     wrong=[("Psoriasis — plaque", "That is salmon-pink with silvery scale, and its surface is not flat-topped."),
            ("Granuloma annulare", "That forms a ring of firm skin-colored papules with no scale."),
...
dict(cond="Xeroderma", img="l2_s151_2.jpg", slide=151, deck=D2, io=PAP,
     ...
     wrong=[("Psoriasis — plaque", "That has thick silvery scale on a sharply bounded red plaque."),
            ...
            ("Tinea pedis — hyperkeratotic", "That thickens the sole with scaling in a shoe distribution, rather than cracking dry skin into fine plates.")]),

# ------------------------------------------ reactive and immune-mediated ----
dict(cond="Erythema multiforme", img="l3_s006_3.jpg", slide=6, deck=D3, io=IMM,
     alt="Fingers with round lesions showing concentric rings and a dusky center",
     why="TARGET lesions — concentric rings around a dusky center, typically on the hands.",
     wrong=[("Urticaria", "Wheals are uniformly raised and pale-centered only from pressure, and they move within hours."),
            ("Granuloma annulare", "That is a ring of firm papules with a normal center, not a bullseye."),
...
dict(cond="Granuloma annulare", img="l3_s047_1.jpg", slide=47, deck=D3, io=IMM,
     alt="Back of the hand with a ring of firm skin-colored papules and no scale",
     ...
     wrong=[("Tinea corporis", "Ringworm's advancing edge is SCALY; run a finger over it and you feel it."),
            ("Erythema multiforme", "That is a bullseye with a dusky center, not a raised papular ring."),
...
dict(cond="Folliculitis", img="l4_s041_1.jpg", slide=41, deck=D4, io=BAC,
     ...
     why="Small pustules each with a HAIR THROUGH THE CENTER — inflammation of the follicle itself.",
...
dict(cond="Impetigo — non-bullous", img="l4_s087_1.jpg", slide=87, deck=D4, io=BAC,
     ...
     why="Thick HONEY-COLORED crust around the nose and mouth.",
...
dict(cond="Acute paronychia", img="l4_s117_1.jpg", slide=117, deck=D4, io=BAC,
     ...
     wrong=[("Chronic paronychia", "That has lost its cuticle and ridged the nail over months, without this acute swelling."),
            ...
            ("Onychomycosis", "That thickens and discolors the nail plate, leaving the fold alone.")]),
...
dict(cond="Chronic paronychia", img="ext-chronic-paronychia.jpg", slide=0, deck=EXT, io=BAC,
     ...
     wrong=[("Acute paronychia", "That is hot, exquisitely tender and days old, with a normal nail."),
            ("Onychomycosis", "That discolors and crumbles the nail plate but leaves the cuticle intact."),
...
dict(cond="Scabies", img="l5_s009_1.jpg", slide=9, deck=D5, io=INF,
     ...
     wrong=[("Cutaneous larva migrans", "That track is raised, serpiginous and moves centimeters a day."),
...
dict(cond="Crusted scabies", img="l5_s011_4.jpg", slide=11, deck=D5, io=INF,
     ...
     wrong=[("Scabies", "Ordinary scabies is a few burrows and excoriations, not confluent crusting."),
            ("Tinea pedis — hyperkeratotic", "That is dry plantar scaling in a shoe distribution, without the thick heaped crusts seen here."),
...
dict(cond="Pediculosis capitis", img="l5_s027_2.jpg", slide=27, deck=D5, io=INF,
     ...
     wrong=[("Seborrheic dermatitis", "That scale flakes free from the scalp; it is not glued to the hair."),
            ...
            ("Xeroderma", "That is generalized dry skin, not an infestation of the hair.")]),

dict(cond="Bedbugs", img="l5_s034_2.jpg", slide=34, deck=D5, io=INF,
     alt="Thigh with a row of red bite papules each with a darker center",
...
dict(cond="Cutaneous larva migrans", img="l5_s052_1.jpg", slide=52, deck=D5, io=INF,
     ...
     why="A raised SERPIGINOUS track that advances a few centimeters a day — hookworm larvae in the wrong host.",
     wrong=[("Scabies", "The burrow is much finer, only millimeters, and favors the web spaces."),
...
dict(cond="Lyme disease", img="l5_s073_5.jpg", slide=73, deck=D5, io=INF,
     ...
     wrong=[("Tinea corporis", "That ring is scaly at its edge and grows over weeks, not days."),
            ...
            ("Cellulitis", "That is hot, tender and spreading, without a clearing center.")]),
...
dict(cond="Tinea corporis", img="l6_s024_2.jpg", slide=24, deck=D6, io=FUN,
     ...
     why="An annular plaque with a SCALY ACTIVE BORDER and a clearing center.",
...
dict(cond="Tinea pedis — interdigital", img="l6_s038_2.jpg", slide=38, deck=D6, io=FUN,
     ...
     wrong=[("Tinea pedis — hyperkeratotic", "That thickens and scales the sole in a shoe distribution rather than macerating the toe web spaces."),
...
dict(cond="Tinea pedis — hyperkeratotic", img="l6_s040_2.jpg", slide=40, deck=D6, io=FUN,
     ...
     why="Dry scaling covering the sole and running up the sides of the foot — hyperkeratosis that resembles a SHOE distribution.",
     wrong=[("Tinea pedis — interdigital", "That is confined to the soggy web spaces."),
            ("Xeroderma", "That is generalized dryness, not a sole thickened and scaled in a shoe distribution."),
...
dict(cond="Onychomycosis", img="l6_s048_1.jpg", slide=48, deck=D6, io=FUN,
     ...
     why="Nails thickened, discolored and CRUMBLING from the free edge back, with debris underneath.",
...
dict(cond="Herpes zoster ophthalmicus", img="l6_s103_1.jpg", slide=103, deck=D6, io=VIR,
     alt="Forehead, upper eyelid and nose on one side crusted with hemorrhagic vesicles",
...
dict(cond="Molluscum contagiosum", img="l6_s131_1.jpg", slide=131, deck=D6, io=VIR,
     alt="Skin with several firm dome-shaped papules dimpled in the center",
...
dict(cond="Verruca plana", img="l6_s144_2.jpg", slide=144, deck=D6, io=VIR,
     alt="Child's cheek with many small flat-topped skin-colored papules",
...
dict(cond="Acrochordon", img="l7_s029_1.jpg", slide=29, deck=D7, io=BEN,
     alt="Neck with many small soft skin-colored tags on narrow stalks",
     why="Soft skin-colored tags hanging on NARROW STALKS in a flexure.",
...
dict(cond="Syringoma", img="l7_s058_1.jpg", slide=58, deck=D7, io=BEN,
     alt="Lower eyelid with many small firm skin-colored papules",
     why="Crops of small firm SKIN-COLORED papules on the lower eyelids.",
...
dict(cond="Nevus araneus", img="l7_s089_2.jpg", slide=89, deck=D7, io=BEN,
     ...
     why="A central arteriole with vessels RADIATING out like legs; press the center and the whole thing blanches.",
...
dict(cond="Neurofibromatosis type 1", img="l7_s100_1.jpg", slide=100, deck=D7, io=BEN,
     alt="Trunk with many soft skin-colored nodules of varying size",
...
dict(cond="Xanthelasma", img="l7_s104_1.jpg", slide=104, deck=D7, io=BEN,
     ...
     wrong=[("Syringoma", "Those are skin-colored firm papules on the lower lid, not yellow plaques."),
...
dict(cond="Sebaceous hyperplasia", img="l7_s110_2.jpg", slide=110, deck=D7, io=BEN,
     alt="Cheek with a soft yellowish papule dimpled in the center",
     ...
     wrong=[("Basal cell carcinoma — nodular", "That is pearly with a rolled border and telangiectasia running over it."),
            ("Molluscum contagiosum", "That is firm, skin-colored and infectious."),
            ("Syringoma", "Those are skin-colored and cluster on the lower eyelids.")]),
...
dict(cond="Seborrheic keratosis", img="l8_s017_2.jpg", slide=17, deck=D8, io=BEN,
     ...
     wrong=[("Malignant melanoma", "That is asymmetric with an irregular border and varied color, and it is flat or nodular, not waxy."),
...
dict(cond="Dermatosis papulosa nigrans", img="l8_s019_2.jpg", slide=19, deck=D8, io=BEN,
     ...
     wrong=[("Acrochordon", "Those hang on stalks and are skin-colored."),
            ("Molluscum contagiosum", "Those are umbilicated and skin-colored."),
...
dict(cond="Congenital melanocytic naevus", img="l8_s029_2.jpg", slide=29, deck=D8, io=BEN,
     ...
     wrong=[("Malignant melanoma", "That is an acquired, asymmetric, changing lesion, not a birthmark of this size."),
            ...
            ("Common acquired melanocytic naevus", "Those appear in childhood and stay a few millimeters across.")]),
...
dict(cond="Malignant melanoma", img="l9_s044_2.jpg", slide=44, deck=D9, io=MAL,
     ...
     why="Asymmetric, irregularly bordered and unevenly colored — and on the sole, which demands more suspicion.",
     wrong=[("Common acquired melanocytic naevus", "That is small, round, evenly colored and symmetrical."),
...
dict(cond="Nail unit melanoma", img="l9_s045_1.jpg", slide=45, deck=D9, io=MAL,
     ...
     wrong=[("Onychomycosis", "That thickens and crumbles the nail yellow-brown; it does not draw a longitudinal band."),
            ...
            ("Glomus tumor", "That is exquisitely painful with cold, and shows a small red-blue spot.")]),
...
dict(cond="Kaposi sarcoma", img="l9_s062_4.jpg", slide=62, deck=D9, io=MAL,
     ...
     why="Violaceous nodular plaques, here filling the PALATE — a vascular tumor tied to immunosuppression.",
