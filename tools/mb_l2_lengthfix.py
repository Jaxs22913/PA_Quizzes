...
FIXES = {
 ...
 2:  (0, "Penicillin, from moldy bread stored alongside the remains in the burial chambers"),
 ...
 4:  (3, "That Streptomyces produced over twenty antibiotics; Selman Waksman commercialized them, coined the term antibiotic, and won the Nobel prize in 1952"),
 ...
 18: (0, "The zone diameter in millimeters, corrected for the molecular weight and diffusion rate of the agent tested"),
 ...
 22: (0, "Carbapenems have a single ring; monobactams substitute a carbon for a sulfur and add a double bond"),
 ...
 61: (1, "Esophageal ulcerations following oral dosing without water"),
