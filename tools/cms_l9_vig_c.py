...
VIG_C = [
 dict(topic="Kaposi sarcoma", io=IOA, lead="diagnosis",
   q="A 34-year-old man newly diagnosed with human immunodeficiency virus has several red-purple plaques on his legs. Which examination is essential, and what might you find?",
   opts=[
     ...
     ["Nail examination — subungual lesions are common and may be the presenting site",
      "The oral cavity is the site that matters here."],
     ["Ocular examination — eyelid lesions are common and may be the presenting site",
      "The oral mucosa, not the eyelid, is the site to check."],
 ...
 dict(topic="Kaposi sarcoma", io=IOB, lead="treatment",
   ...
   opts=[
     ["Begin or optimize antiretroviral therapy, since immune restoration is the cornerstone of treatment for epidemic disease",
 ...
 dict(topic="Kaposi sarcoma", io=IOA, lead="test",
   q="A patient with known Kaposi sarcoma has marked lower limb edema but only three visible skin lesions. How should the edema be interpreted?",
   opts=[
     ["Marked edema can occur even with few or no visible lesions, so its severity must not be used to gauge disease burden",
      "Correct — the skin can look almost clear while disease is extensive."],
     ["Marked edema indicates a correspondingly low disease burden, consistent with the small number of visible skin lesions",
      "Edema severity does not track lesion count."],
     ["Marked edema is not a feature of Kaposi sarcoma at any stage and points instead to venous thrombosis",
      "It is an explicit feature of the disease."],
     ["Marked edema indicates the classic rather than the epidemic form, and its severity gauges the disease burden",
 ...
 dict(topic="Kaposi sarcoma", io=IOB, lead="next step",
   ...
   opts=[
     ...
     ["Reduce immunosuppressive medication doses immediately without involving the transplant team, since the malignancy takes priority",
      "This requires coordination with the transplant team."],
     ["Begin or optimize antiretroviral therapy, since immune restoration is the cornerstone of treatment",
 ...
 dict(topic="Cutaneous T-cell lymphoma", io=IOA, lead="treatment",
   ...
   opts=[
     ...
     ["Early aggressive systemic chemotherapy reliably cures the disease and prevents progression, so it should begin immediately",
      "Early aggressive systemic chemotherapy does not cure it."],
 ...
 dict(topic="Nail unit neoplasms", io=IOA, lead="diagnosis",
   q="A 55-year-old has a brown band running the length of the left thumbnail. Over eight months it has widened, the lines within it vary in color and spacing, and pigment now extends onto the skin of the proximal nail fold. Which finding is most concerning, and what is it called?",
   opts=[
     ...
     ["The variation in line color and spacing — the Hutchinson sign, concerning for a benign melanonychia",
      "That variation is concerning, but it is not the Hutchinson sign."],
     ["The eight-month duration — the Hutchinson sign, concerning for a subungual hematoma",
      "Duration is not the sign, and a hematoma would grow out."]],
   c=0, cite=c(84)),
 ...
 dict(topic="Nail unit neoplasms", io=IOA, lead="next step",
   ...
   opts=[
     ...
     ["Reassure, because the complete absence of a pigmented band reliably excludes melanoma",
      "Absence of pigment does not exclude it."],
     ["Treat empirically for onychomycosis and review in six months",
      "A repeatedly mislabelled nail lesion is precisely the trap here."],
     ["Treat as a chronic paronychia with oral antibiotics and review in six weeks",
      "That is another label wrongly applied to these lesions."]],
   c=0, cite=c(84)),
 ...
 dict(topic="Nail unit neoplasms", io=IOA, lead="diagnosis",
   ...
   opts=[
     ["Glomus tumor", "Correct — the triad of paroxysmal pain, point tenderness and cold sensitivity."],
     ...
     ["Subungual hematoma", "That follows trauma and grows out with the nail."]],
   c=0, cite=c(86)),
 ...
 dict(topic="Nail unit neoplasms", io=IOA, lead="diagnosis",
   ...
   opts=[
     ["Nail unit squamous cell carcinoma",
      "Correct — this is the commonest malignant nail tumor, called Bowen disease while confined to the epithelium, and a lesion repeatedly relabelled wart, paronychia or fungus is the classic history."],
     ["Nail unit melanoma",
     ...
     ["Nail unit basal cell carcinoma",
      "Nail unit basal cell carcinoma is exceptionally uncommon, since the nail unit receives little ultraviolet exposure; squamous cell carcinoma is the common malignant nail tumor."],
     ["Onychomatricoma",
      "Onychomatricoma is a benign tumor of the nail matrix, producing a thickened yellow nail with longitudinal ridging rather than destruction and bleeding."]],
   c=0, cite=c(79)),
