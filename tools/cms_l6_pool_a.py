 ...
 dict(topic="Antifungal classes", io=IOB, slot="agent/regimen",
   ...
   opts=[
     ...
     ["It inhibits mitosis in dividing fungal cells; the names end in -fulvin",
      "Griseofulvin does inhibit mitosis but belongs to a separate class; the allylamines disrupt the membrane and end in -fine."],
     ["It blocks cell wall glucan synthesis; the names end in -fungin",
      "Glucan synthase inhibition with names ending in -fungin describes the echinocandins, which are systemic agents outside this pair."]],
   c=0, cite=c(5)),
 ...
 dict(topic="Antifungal classes", io=IOB, slot="agent/regimen",
   ...
   opts=[
     ...
     ["It inhibits fungal deoxyribonucleic acid synthesis; griseofulvin and fluconazole",
      "Neither half fits: the imidazoles block ergosterol synthesis, and griseofulvin works by a different mechanism entirely."]],
   c=0, cite=c(5)),
 ...
 dict(topic="Dermatophytes", io=IOB, slot="etiology",
   ...
   opts=[
     ...
     ["Candida, Malassezia, Trichophyton",
      "Candida and Malassezia are yeasts rather than dermatophytes; the three keratin-digesting genera are Microsporum, Trichophyton and Epidermophyton."],
 ...
 dict(topic="Tinea capitis", io=IOB, slot="etiology",
   ...
   opts=[
     ...
     ["Candida and Malassezia, with Candida albicans most common in the United States",
      "Candida and Malassezia are yeasts causing intertrigo and pityriasis versicolor; tinea capitis is caused by Trichophyton and Microsporum."],
 ...
 dict(topic="Tinea capitis", io=IOB, slot="agent/regimen",
   ...
   opts=[
     ...
     ["Ketoconazole orally for both, at weight-based dosing",
      "Oral ketoconazole carries hepatotoxicity risk and is avoided for superficial infection; terbinafine and griseofulvin are matched to the organism instead."]],
   c=0, cite=c(15)),
 ...
 dict(topic="Tinea capitis", io=IOC, slot="education",
   ...
   opts=[
     ...
     ["The child must be excluded until fungal culture is negative",
      "Culture takes weeks and transmissibility falls rapidly once treatment starts, so keeping the child out until a negative culture is unnecessary."],
