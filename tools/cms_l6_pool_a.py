...
POOL_A = [
 dict(topic="Antifungal classes", io=IOB, slot="agent/regimen",
   ...
   opts=[
     ...
     ["It inhibits mitosis in dividing fungal cells; the names end in -fulvin",
      "That is griseofulvin's mechanism, not the allylamine class."],
     ["It blocks cell wall glucan synthesis; the names end in -fungin",
      "Cell wall glucan is not the target: allylamines such as terbinafine destroy the fungal cell membrane, and their names end in -fine rather than -fungin."]],
   c=0, cite=c(5)),

 dict(topic="Antifungal classes", io=IOB, slot="agent/regimen",
   q="How does the imidazole class work, and what are two examples?",
   opts=[
     ...
     ["It inhibits fungal deoxyribonucleic acid synthesis; griseofulvin and fluconazole",
      "Neither the mechanism nor the pairing is right."]],
   c=0, cite=c(5)),
 ...
 dict(topic="Dermatophytes", io=IOB, slot="etiology",
   ...
   opts=[
     ...
     ["Candida, Malassezia, Trichophyton",
      "Candida and Malassezia are yeasts, not dermatophytes."],
 ...
 dict(topic="Tinea capitis", io=IOC, slot="education",
   q="What is the position on school exclusion in tinea capitis?",
   opts=[
