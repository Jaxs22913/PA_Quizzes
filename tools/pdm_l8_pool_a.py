...
{"topic": "Chest radiography", "io": IOA, "slot": "anatomy",
 ...
 "opts": [
  ["The cardiac silhouette",
   "Correct. Note what is absent from the list: the chambers, the valves and the coronary arteries are not among them. Great vessels, pulmonary vasculature, lungs and pleura."],
  ["The coronary arteries and cardiac valves",
...
{"topic": "Echocardiography", "io": IOD, "slot": "modality choice",
 ...
 "opts": [
  ["The left atrium",
   "Correct. The probe sits directly behind the heart, so the structures that gain are the posterior ones. Mitral valve, pulmonary artery, aorta and coronary arteries."],
