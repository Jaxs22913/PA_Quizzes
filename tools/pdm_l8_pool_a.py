...
{"topic": "Chest radiography", "io": IOC, "slot": "modality choice",
 ...
 "opts": [
  ...
  ["It has no role in cardiac assessment",
   "It visualizes the cardiac silhouette, the great vessels and the pulmonary vasculature, all of which carry cardiac information."],
...
{"topic": "Chest radiography", "io": IOA, "slot": "anatomy",
 ...
 "opts": [
  ...
  ["The coronary arteries and the cardiac valves",
   "Neither is visualized on a plain radiograph; calcification of a valve may be seen, but not the valve's structure."],
...
{"topic": "Chest radiography", "io": IOA, "slot": "finding",
 ...
 "opts": [
  ["Edema, effusion, cardiomegaly, cephalization and calcification",
...
{"topic": "Cardiothoracic ratio", "io": IOB, "slot": "interpretation",
 "q": "A properly performed posteroanterior chest radiograph shows the cardiac silhouette occupying 58 percent of the internal thoracic diameter. What does that suggest?",
 "opts": [
  ["Cardiomegaly",
...
{"topic": "Cephalization", "io": IOA, "slot": "finding",
 "q": "What is cephalization on a chest radiograph?",
 "opts": [
  ...
  ["Fluid tracking into the interlobar fissures",
   "That would be described as effusion or fissural fluid rather than cephalization."],
  ["The trachea deviating toward the apex",
   "Tracheal deviation is a different sign entirely. Cephalization is enlargement of the upper zone vessels."],
  ["Calcification of the aortic arch",
   "Great vessel calcification is listed separately from cephalization."]],
 "c": 0, "cite": c(9)},

{"topic": "Cephalization", "io": IOA, "slot": "finding",
 "q": "In which patients is cephalization seen?",
 "opts": [
  ...
  ["Pneumothorax and pleural effusion",
   "Neither is given as a cause. Cephalization is seen in heart failure and pulmonary hypertension."],
  ...
  ["Pericardial calcification",
   "Calcification is listed as a separate radiographic finding rather than as a form of cephalization."]],
 "c": 0, "cite": c(9)},
...
{"topic": "Vascular ultrasound", "io": IOC, "slot": "mechanism",
 ...
 "opts": [
  ...
  ["Ionizing radiation is absorbed differently by tissues of differing density",
   "That describes radiography; ultrasound uses no ionizing radiation."],
...
{"topic": "Vascular ultrasound", "io": IOA, "slot": "interpretation",
 ...
 "opts": [
  ["Veins collapse when compressed and arteries pulsate",
   "Correct. Compression is the maneuver the whole deep vein thrombosis study rests on, because a vein that will not collapse has something in it."],
  ["Veins pulsate and arteries collapse when compressed",
   "The behaviors are the other way round: veins collapse under compression and arteries pulsate."],
  ...
  ["Only Doppler can distinguish them",
   "Compression and pulsatility distinguish them on gray scale alone."]],
 "c": 0, "cite": c(15)},
...
{"topic": "Vascular ultrasound", "io": IOC, "slot": "indication",
 ...
 "opts": [
  ...
  ["Carotid evaluation after stroke, transient ischemic attack or myocardial infarction",
...
{"topic": "Vascular ultrasound", "io": IOC, "slot": "advantage",
 ...
 "opts": [
  ["Fast, portable, repeatable, no ionizing radiation",
...
{"topic": "Vascular ultrasound", "io": IOC, "slot": "limitation",
 ...
 "opts": [
  ...
  ["Ionizing radiation dose and contrast nephrotoxicity",
   "Neither applies: ultrasound uses no ionizing radiation and no iodinated contrast."],
...
{"topic": "Vascular ultrasound", "io": IOC, "slot": "limitation",
 ...
 "opts": [
  ...
  ["It absorbs the ionizing radiation before it reaches the vessel",
   "No ionizing radiation is involved in ultrasound. Calcification blocks sound, casting an acoustic shadow behind it."],
  ["It produces a blooming artifact that exaggerates the lesion",
   "Blooming from calcification is a computed tomography artifact."],
...
{"topic": "Echocardiography", "io": IOD, "slot": "modality choice",
 "q": "What distinguishes a transthoracic from a transesophageal echocardiogram?",
 "opts": [
  ...
  ["One uses ionizing radiation while the other does not",
   "Neither uses ionizing radiation. The difference is the position of the transducer, outside the body or within it."],
...
{"topic": "Echocardiography", "io": IOD, "slot": "modality choice",
 ...
 "opts": [
  ...
  ["It gives better detail of the posterior structures",
   "Posterior and inferior detail is exactly where it is weaker than the transesophageal study."],
...
{"topic": "Echocardiography", "io": IOD, "slot": "modality choice",
 "q": "Which structures does a transesophageal study show in more detail than a transthoracic one?",
 "opts": [
...
{"topic": "Echocardiography", "io": IOD, "slot": "indication",
 "q": "For which of these is a transesophageal study specifically useful?",
 "opts": [
  ["Valve vegetations",
   "Correct. All are small, posterior, or both, which is precisely where the transthoracic view falls short. Prosthetic valve function, cardiac tumors and left atrial appendage thrombus."],
  ["Coronary artery calcium scoring",
   "That is a non-contrast computed tomography study. The transesophageal study excels at posterior structures."],
...
{"topic": "Echocardiography", "io": IOD, "slot": "indication",
 "q": "Why is a transesophageal study used in a patient presenting with cerebral ischemia?",
 "opts": [
  ...
  ["It assesses the carotid arteries",
   "The carotids are assessed by vascular ultrasound. The transesophageal study looks for a cardiac source of embolus."],
...
{"topic": "Echocardiography", "io": IOD, "slot": "procedure",
 "q": "What does a transesophageal study require that a transthoracic one does not?",
 "opts": [
  ["Throat anesthesia, sedation and monitoring",
  ...
  ["Iodinated contrast given intravenously",
   "No iodinated contrast is used in echocardiography; the transesophageal study needs anesthesia, sedation and monitoring."],
  ["Electrocardiographic gating of the images",
   "Gating belongs to cardiac computed tomography. The transesophageal study requires sedation and airway monitoring."],
  ["A period of fasting from fluids only",
   "The requirements described are anesthesia, sedation and monitoring."]],
 "c": 0, "cite": c(25)},

{"topic": "Echocardiography", "io": IOD, "slot": "contraindication",
 "q": "Which esophageal conditions contraindicate a transesophageal echocardiogram?",
 "opts": [
  ["Stricture, malignancy or bleeding varices",
   "Correct. All three mean passing a probe risks perforation or hemorrhage, which is the hazard the contraindication list exists to avoid."],
  ["Gastroesophageal reflux disease",
   "Reflux alone is not listed. Stricture, malignancy and bleeding varices are the esophageal contraindications."],
  ["A history of esophageal candidiasis",
  ...
  ["Recent barium swallow",
   "Not among the listed contraindications; stricture, malignancy and bleeding varices are the esophageal ones."]],
 "c": 0, "cite": c(26)},

{"topic": "Echocardiography", "io": IOD, "slot": "contraindication",
 "q": "Why must a Zenker's diverticulum be identified before a transesophageal study?",
 "opts": [
  ...
  ["It causes a false positive for vegetations",
   "It is a procedural hazard rather than an imaging artifact: the probe risks entering and perforating the pouch."],
  ["It makes the patient unable to swallow the local anesthetic",
   "The concern is perforation rather than anesthetic administration."]],
 "c": 0, "cite": c(26)},

{"topic": "Echocardiography", "io": IOD, "slot": "contraindication",
 "q": "Which patient factors, other than esophageal disease, contraindicate a transesophageal study?",
 "opts": [
  ["An uncooperative patient, restricted neck movement, airway risk",
   "Correct. Two are about whether the patient can be positioned and kept still, and one is about whether the airway can be protected under sedation. In full: altered mental status or an uncooperative patient, cervical spine arthritis with reduced range of motion, and obstructive sleep apnea or other risk of airway compromise."],
