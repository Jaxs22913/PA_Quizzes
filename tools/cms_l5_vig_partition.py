...
LEAD = {
 ...
 "education": r"counseling point|most appropriate response|most appropriate advice|most appropriate explanation|which referrals|most important consequence|most appropriate consideration",
}
def lead_of(q):
