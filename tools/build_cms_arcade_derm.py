...
DECKS = [
 dict(id="cms-general-derm-1", name="General Dermatology I", color="accent", icon=ICON_SKIN, cards=[
  ...
  ("Under which wavelength does skin synthesize vitamin D?", "Ultraviolet B."),
  ...
  ("Which dermatitis is bilateral on the lower legs with hemosiderin pigmentation?", "Stasis dermatitis."),
  ...
  ("Which alopecia shows exclamation point hairs at the patch edge?", "Alopecia areata."),
 ...
 dict(id="cms-derm-2", name="Dermatology II", color="accent2", icon=ICON_SUN, cards=[
  ...
  ("What should be screened for in generalized granuloma annulare in an adult?", "Diabetes, thyroid disease, dyslipidemia and lymphoma."),
  ...
  ("What must every patient with dermatitis herpetiformis be screened for?", "Celiac disease."),
  ...
  ("Which drug is the commonest cause of toxic epidermal necrolysis in Asia?", "Allopurinol."),
  ...
  ("Which ultraviolet wavelength range causes sunburn?", "Ultraviolet B, 290 to 320 nanometers."),
  ...
  ("Which mechanism requires prior sensitization?", "Photoallergy."),
 ...
 dict(id="cms-cutaneous-bacterial", name="Cutaneous Bacterial Infections", color="accent3", icon=ICON_BACT, cards=[
  ("Which four factors underlie acne vulgaris?", "Follicular hyperkeratinization, increased sebum, Cutibacterium acnes and inflammation."),
  ...
  ("Which program must isotretinoin prescribers join?", "iPledge."),
  ...
  ("When does a single furuncle need no antibiotic?", "When the patient is afebrile and the lesion is under five millimeters."),
  ...
  ("What color does erythrasma fluoresce under a Wood's lamp?", "Coral-red."),
  ...
  ("Why does devitalized tissue need debridement?", "It is not perfused, so antibiotics cannot reach it."),
 ...
 dict(id="cms-derm-infestations", name="Dermatological Infestations", color="accent4", icon=ICON_BUG, cards=[
  ...
  ("What is the pathognomonic lesion of scabies?", "A thread-like linear or J-shaped burrow one to ten millimeters long."),
  ...
  ("What characterizes crusted scabies?", "Thick flaking scale with millions of mites and often no itch."),
  ...
  ("What are maculae caerulae?", "Slate-gray macules about one centimeter across representing hemorrhage in pubic lice."),
  ...
  ("How is tungiasis diagnosed?", "Dermoscopy visualizing ovoid eggs."),
  ...
  ("What proportion of Hymenoptera stings cause a generalized systemic reaction?", "Between 0.4 and three percent."),
  ("Which caterpillar is the most poisonous?", "The asp or puss caterpillar."),
  ...
  ("How fast does a cutaneous larva migrans trail advance?", "Two to three centimeters a day."),
  ...
  ("What is the stage 1 lesion of Lyme disease?", "Erythema migrans, over five centimeters with central clearing."),
 ...
 dict(id="cms-pigmented-lesions", name="Pigmented Skin Lesions", color="accent5", icon=ICON_DOT, cards=[
  ...
  ("How large are ephelides?", "Three to five millimeters."),
  ...
  ("How large is a lentigo simplex?", "Less than five millimeters."),
  ...
  ("When should an inherited disorder be considered with lentigines?", "When a partial or generalized lentigo is present."),
  ...
  ("How large are seborrheic keratoses?", "Two to twenty millimeters."),
  ...
  ("How large is a typical common acquired naevus?", "Less than six millimeters."),
  ("Which color in a naevus on light skin is suspicious?", "Very dark brown or black."),
  ("What is a blue naevus composed of?", "Deeply pigmented spindle or epithelioid melanocytes in the dermis."),
  ("How large is a common blue naevus?", "Less than one centimeter."),
  ...
  ("What color is a Spitz naevus?", "Pink or red."),
  ...
  ("What is the minimum size of a dysplastic melanocytic naevus?", "Five millimeters."),
