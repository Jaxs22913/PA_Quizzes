...
DECKS = [
 dict(id="cms-neuro-ophthalmology", name="Neuro-Ophthalmology", color="accent3", icon=NERVE, cards=[
  ...
  ["Parasympathetic pupillary fibers travel along which cranial nerve?", "Cranial nerve III."],
  ["Parasympathetic stimulation of the iris produces what?", "Miosis."],
  ["Sympathetic stimulation of the iris produces what?", "Mydriasis."],
  ["Where do first-order sympathetic neurons synapse?", "The ciliospinal center of Budge, C8 to T2."],
  ...
  ["Physiologic anisocoria is usually under how many millimeters?", "0.4 millimeters."],
  ["An anticholinergic pupil is usually how large?", "8 millimeters or more."],
  ["A Marcus Gunn pupil indicates a defect in which limb?", "The afferent limb."],
  ["Marcus Gunn pupil localizes the lesion where?", "The retina or the optic nerve."],
  ...
  ["First-order Horner causes?", "Brainstem stroke or tumor, and cord lesions above T1."],
  ["Second-order Horner causes?", "Pancoast tumor and thyroid cancer."],
  ...
  ["Most common cause of a sixth nerve palsy in children?", "Intracranial tumors."],
  ...
  ["Muller's muscle is supplied by what, and gives how much lift?", "The sympathetic system, giving 1 to 2 millimeters."],
  ...
  ["A monocular field defect localizes where?", "Pre-chiasmal."],
  ["A homonymous field defect localizes where?", "Post-chiasmal."],
 ]),
 ...
 dict(id="cms-acute-vision-loss", name="Acute Vision Loss", color="accent4", icon=EYE, cards=[
  ...
  ["Symptoms of acute angle-closure glaucoma?", "Severe eye pain, headache, nausea, vomiting and colored halos."],
  ["Corneal finding in acute angle closure?", "A hazy cornea."],
  ["Intraocular pressure range in acute angle closure?", "40 to 80 millimeters of mercury."],
  ...
  ["Color finding in optic neuritis?", "Loss of color vision."],
  ...
  ["Risk factors for retinal detachment?", "Myopia, trauma, cataract extraction, diabetes, tumor and connective tissue disease."],
  ...
  ["Fundus appearance of a detached retina?", "Elevated and gray, with folds."],
  ...
  ["Fundus findings in central retinal vein occlusion?", "Disc swelling, venous dilation, cotton wool spots and retinal hemorrhages."],
  ...
  ["Confirmatory tests for the retinal occlusions?", "Color fundus photography and fluorescein angiography."],
  ...
  ["Causes of papilledema?", "Tumor, trauma, intracranial infection, hemorrhage and vitamin A toxicity."],
  ...
  ["Findings that mark acute rather than chronic papilledema?", "Hemorrhages and cotton wool spots."],
