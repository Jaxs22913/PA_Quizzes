...
DECKS = [
 ...
 dict(id="pharm-antivirals", name="Antivirals", color="accent3", icon=ICON_AVR, cards=[
  ...
  ["What is acyclovir's characteristic renal effect?", "It crystallizes in the renal tubule, so hydration must be maintained."],
  ...
  ["Which hematologic effects limit ganciclovir?", "Neutropenia and thrombocytopenia."],
 ...
 dict(id="pharm-antifungals", name="Antifungals", color="accent4", icon=ICON_AFG, cards=[
  ...
  ["Which electrolyte disturbances does amphotericin B cause?", "Hypokalemia and hypomagnesemia."],
