...
DECKS = [
 ("cms-htn-definitions", "Hypertension &mdash; Definitions &amp; Causes", "accent1", GAUGE_ICON, [
  ...
  ("Examples of that acute injury?", "Encephalopathy, acute pulmonary oedema, acute kidney injury, aortic dissection, acute coronary syndrome."),
  ...
  ("What characterises primary hypertension?", "No single identifiable underlying cause; the vast majority of adult cases."),
  ("Risk factors for primary hypertension?", "Advancing age, family history, excess adiposity, high dietary sodium, inactivity, excess alcohol, dyslipidaemia, insulin resistance."),
  ...
  ("Common contributors to secondary hypertension?", "Chronic kidney disease, primary aldosteronism, obstructive sleep apnoea, renovascular disease, drugs."),
  ...
  ("Creatinine rises sharply after starting an ACE inhibitor &mdash; suspect?", "Bilateral or haemodynamically significant renal artery stenosis."),
  ("Warning features for renovascular disease?", "Resistant or abrupt elevation, abdominal bruit, asymmetric kidneys, recurrent flash pulmonary oedema."),
  ("When is renovascular disease referred early?", "Recurrent flash pulmonary oedema, progressive renal decline despite optimal therapy, truly refractory control."),
  ("Underlying abnormality in primary aldosteronism?", "Autonomous aldosterone production independent of renin."),
  ("When to screen for primary aldosteronism?", "Resistant pressure, unexplained hypokalaemia, adrenal incidentaloma, early or familial hypertension."),
  ...
  ("How does obstructive sleep apnoea raise pressure?", "Intermittent hypoxaemia and arousal drive sustained sympathetic activation."),
  ("How is sleep apnoea confirmed?", "Polysomnography or validated home sleep apnoea testing."),
 ...
 ("cms-htn-organ-damage", "Hypertension &mdash; Organ Damage &amp; Assessment", "accent3", ORGAN_ICON, [
  ...
  ("Which strokes does hypertension predispose to?", "Both ischaemic and intracerebral haemorrhagic."),
  ...
  ("Why perform fundoscopy in every new hypertensive?", "It allows direct visualisation of the microvasculature."),
  ("Which retinal findings relate to CURRENT pressure only?", "Focal narrowing, haemorrhages, exudates."),
  ("Which relate to current AND previous pressure?", "Generalised narrowing and arteriovenous nicking."),
  ...
  ("When is chest radiography appropriate?", "Suspected pulmonary oedema, cardiomegaly, or widened mediastinum &mdash; not routinely."),
  ("When is echocardiography appropriate?", "Suspected heart failure, significant murmur, hypertrophy on ECG, unexplained dyspnoea."),
 ...
 ("cms-htn-treatment", "Hypertension &mdash; Treatment", "accent2", PILL_ICON, [
  ...
  ("Thiazide adverse effects?", "Hyponatraemia, hypokalaemia, hyperuricaemia (may precipitate gout), volume depletion."),
  ("Thiazide caution at 65 and over?", "Check sodium, especially in women and those with low-normal sodium."),
  ("ACE inhibitor adverse effects?", "Dry cough, hyperkalaemia, creatinine rise, angioedema."),
  ...
  ("Why never combine an ACE inhibitor with an ARB?", "Dual blockade raises hyperkalaemia and kidney injury risk with no added benefit."),
  ("Commonest dihydropyridine adverse effect?", "Dependent ankle oedema (also flushing, headache, gingival enlargement)."),
  ...
  ("Standing of beta blockers in uncomplicated hypertension?", "NOT first-line &mdash; preferred for reduced ejection fraction heart failure, recent infarction, ischaemic disease."),
  ...
  ("Other causes of apparent resistance?", "Measurement error, white coat effect, high sodium or alcohol, interfering drugs, sleep apnoea, secondary hypertension."),
  ("First step in confirmed resistant hypertension?", "Optimise the diuretic &mdash; chlorthalidone preferred, class matched to renal function."),
  ...
  ("First-hour target in a hypertensive emergency?", "Reduce mean arterial pressure by no more than about 20&ndash;25 per cent."),
  ("Then what?", "Around 160/100&ndash;110 over two to six hours, gradual normalisation over a day or two."),
  ("Why is rapid reduction harmful?", "Autoregulation has adapted; rapid reduction can cause ischaemic stroke, myocardial injury or renal failure."),
