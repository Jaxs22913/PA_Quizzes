...
POOL_B = [
 ...
 dict(topic="Congenital melanocytic naevi", io=IOA,
   ...
   opts=[
     ...
     ["Sharply circumscribed jet-black papules under 7 mm across, sometimes with shades of blue, gray or brown",
      "That describes pigmented spindle cell naevus."],
     ["Solitary pink or red hairless dome-shaped firm papules that grow and then stabilize over time",
 ...
 dict(topic="Naevus spilus", io=IOA,
   ...
   opts=[
     ...
     ["Anomalies of the gastrointestinal tract with malabsorption and celiac disease",
      "That association belongs to dermatitis herpetiformis."],
     ["Anomalies of the hematologic system with monoclonal gammopathy and myeloma",
 ...
 dict(topic="Common acquired naevus", io=IOA,
   ...
   opts=[
     ["They develop slowly after birth, enlarge symmetrically, stabilize and regress, peaking in number in the thirties then declining",
 ...
 dict(topic="Common acquired naevus", io=IOA,
   ...
   opts=[
     ["Usually under 6 mm with homogenous surface and color, round to oval and sharply demarcated; very dark brown or black on light skin is suspicious",
      "Correct — they can occur anywhere on the body."],
     ["Usually over 10 mm with heterogeneous surface and color, irregular and poorly demarcated; a uniform tan color is suspicious",
      "That inverts the typical appearance and the suspicious feature."],
     ["Usually under 1 cm, deeply blue-black and confined to the dorsal hands, scalp or sacral region; any pink color is suspicious",
      "That describes blue naevus."],
     ["Usually several millimeters to centimeters, pink or red, hairless and dome-shaped; rapid growth is suspicious",
      "That describes Spitz naevus."]],
   c=0, cite=c(36)),
 ...
 dict(topic="Common acquired naevus", io=IOB,
   ...
   opts=[
     ["Clinically, with observation, removal for cosmetic or symptomatic reasons, and counseling on sun protection",
 ...
 dict(topic="Pigmented spindle cell naevus", io=IOA,
   ...
   opts=[
     ["A sharply circumscribed darkly pigmented papule usually under 7 mm, jet-black with shades of blue, gray or brown, on the extremities and mainly the thigh",
      "Correct — commonest in the thirties, with females affected more than males, and it is benign."],
     ["A solitary pink or red hairless firm dome-shaped papule several millimeters to centimeters across, on face, neck, trunk or extremities",
      "That describes Spitz naevus."],
 ...
 dict(topic="Dysplastic naevus", io=IOA,
   ...
   opts=[
     ...
     ["Under 6 mm in diameter with sharp demarcation and homogenous color, round to oval in shape",
