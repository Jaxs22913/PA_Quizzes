...
POOL_B = [
 dict(topic="Comparisons", io=IO5,
   ...
   opts=[
     ["Acyclovir's indications are herpes simplex and varicella-zoster; cytomegalovirus requires ganciclovir or valganciclovir",
      "Correct. All are guanine analogs, but the indications are drawn along virus lines rather than by drug family."],
 ...
 dict(topic="Comparisons", io=IO5,
   ...
   opts=[
     ...
     ["Oseltamivir with acyclovir, valacyclovir with penciclovir, and famciclovir with ganciclovir",
      "Oseltamivir is a prodrug of its own carboxylate form, unrelated to the guanine analogs."],
 ...
 dict(topic="Comparisons", io=IO5,
   ...
   opts=[
     ["Oseltamivir, which inhibits neuraminidase to block viral release",
      "Correct. The guanine analogs all terminate the nucleic acid chain; oseltamivir works at a completely different stage."],
 ...
 dict(topic="Acyclovir", io=IO6,
   ...
   opts=[
     ["The drug crystallizes in the renal tubule, so hydration must be maintained",
 ...
 dict(topic="Ganciclovir", io=IO7,
   ...
   opts=[
     ...
     ["Crystallization in the renal tubule requiring aggressive hydration",
 ...
 dict(topic="Oseltamivir", io=IO8,
   ...
   opts=[
     ...
     ["Their nucleic acid cannot be replicated",
      "Nucleic acid inhibition is the guanine analogs' approach."]],
   c=0, cite=c(126)),
 ...
 dict(topic="Herpesviruses", io=IO6,
   ...
   opts=[
     ["Type 2",
      "Correct. Type 2 covers genitals, rectum, hands or meninges; type 1 covers mouth, face, skin, esophagus or brain."],
     ["Type 1",
      "Type 1 travels from the trigeminal ganglion and is associated with encephalitis of the brain; type 2 is the one linked to meningitis."],
     ["Neither type; meningitis is a cytomegalovirus manifestation",
      "Cytomegalovirus is associated with retinitis, esophagitis and colitis."],
 ...
 dict(topic="Herpesviruses", io=IO6,
   ...
   opts=[
     ["Type 1",
      "Correct — type 1 covers mouth, face, skin, esophagus or brain."],
     ["Type 2",
      "Type 2 is associated with the meninges rather than the brain in this split."],
     ["Both types equally",
      "The two are not equivalent here: type 1 is associated with brain involvement and type 2 with the meninges."],
     ["Neither; encephalitis is a cytomegalovirus manifestation",
      "Cytomegalovirus manifestations given are retinitis, esophagitis and colitis."]],
   c=0, cite=c(119)),
