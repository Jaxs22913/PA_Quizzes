...
Q("Thyroglossal duct cyst", IO,
  ...
  [["Thyroglossal duct cyst",
    "Correct. The thyroid descends from the foramen cecum through the hyoid during development, and "
   ...
   ["Branchial cleft cyst",
    ...
    "alone separates it, before any maneuver is performed."],
   ["Reactive lymph node",
...
Q("Branchial cleft cyst", IO,
  ...
  [["Control the infection, then excise the cyst and its tract",
   ...
   ["Excise it during the acute infection",
    "Operating on acutely inflamed edematous tissue makes the tract hard to define and follow, "
    "raising the chance of leaving part of it behind."]], C(22)),

Q("Neck mass red flags", IO,
  "A 61-year-old man who smokes and drinks daily has a firm 3 centimeter neck mass present for six "
  ...
  [["Fine needle aspiration biopsy",
    ...
    "over 1.5 centimeters, firm and non-tender with little mobility, age over 40, and tobacco with "
    "alcohol. Aspiration separates neoplasm from inflammation and carcinoma from lymphoma without "
    "spilling tumor into the neck."],
...
Q("Haemangioma", IO,
  ...
  [["Observation",
    "Correct. Hemangiomas proliferate through the first year and then involute from 18 to 24 "
    "months, with about 90 percent resolving without any therapy. Enlargement on crying reflects "
   ...
   ["Sclerotherapy",
    ...
    "approach to a hemangioma that will resolve on its own."]], C(27)),
...
Q("Sternocleidomastoid tumor of infancy", IO,
  ...
  [["Physical therapy, since most resolve spontaneously",
    ...
    "enlarges for two to three months and then regresses over four to eight, with about 80 percent "
   ...
   ["Immediate surgical excision",
    "Operating on a lesion with an 80 percent spontaneous resolution rate commits an infant to an "
...
Q("Reactive lymphadenopathy", IO,
  "A 5-year-old has a 2 centimeter cervical node that appeared with a cold five weeks ago and has "
  "not changed since.",
  [["Investigate further, as it has passed the size and duration thresholds",
    "Correct. A node over 1 centimeter is abnormal, and reactive nodes regress within one to two "
...
Q("Atypical mycobacteria", IO,
  ...
  [["Atypical mycobacterial infection",
   ...
   ["Suppurative bacterial lymphadenitis",
    ...
    "throat or skin source over days. The indolent course and skin color here do not fit."],
   ["Cat scratch disease",
...
Q("Cat scratch disease", IO,
  ...
  [["Serology with indirect fluorescent antibodies",
   ...
   ["Toxoplasma serology",
    ...
    "oocysts in feces or undercooked meat, and it gives more generalized adenopathy with sore "
...
Q("Thyroid nodule", IO,
  ...
  [["Radionuclide scan before any biopsy",
   ...
   ["Start antithyroid medication and review in six months",
    ...
    "long time to leave a nodule uncharacterized."]], C(41)),
...
Q("Papillary carcinoma", IO,
  ...
  [["Papillary carcinoma",
    "Correct. Papillary carcinoma is about 75 percent of thyroid cancers, arises from thyroid "
   ...
   ["Follicular carcinoma",
    "Follicular carcinoma is second at about 16 percent and also epithelial, but it spreads by "
   ...
   ["Anaplastic carcinoma",
    "Anaplastic carcinoma is about 1 percent, occurs in the elderly, and is the most aggressive "
...
Q("Anaplastic carcinoma", IO,
  ...
  [["Anaplastic carcinoma",
   ...
   ["Primary thyroid lymphoma",
    ...
    "but it is a non-Hodgkin B cell tumor on a Hashimoto background and responds to chemotherapy "
    "and radiation."],
   ["Medullary carcinoma",
...
Q("Medullary carcinoma", IO,
  ...
  [["Screen relatives for multiple endocrine neoplasia",
   ...
   ["No family screening, as thyroid cancer is sporadic",
    "Most thyroid cancer is sporadic, which makes this a reasonable generalization, but medullary "
...
Q("Thyroid lymphoma", IO,
  ...
  [["Proceed to open biopsy",
    "Correct. Primary thyroid lymphoma is usually a non-Hodgkin B cell tumor arising on a "
