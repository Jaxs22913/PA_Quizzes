...
Guards, in the order this content could have failed them:
  ...
  CMS I at mechanism against management. A cardiac deck is full of conditions
...
from clinpath_cardiac_pool_a import QUESTIONS as POOL_A
from clinpath_cardiac_pool_b import QUESTIONS as POOL_B
POOL = POOL_A + POOL_B
...
# as venous and lymphatic drainage, and it misses everything a cardiac lecture
...
def main():
    ...
    out = os.path.join(HERE, "clinpath_cardiac_sets.json")
