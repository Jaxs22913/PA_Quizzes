...
DECK = dict(
  ...
  ["What does the external ear do?", "Captures and concentrates acoustic waves, and localizes sound."],
  ...
  ["What does the Eustachian tube do?", "Equalizes pressure across the tympanic membrane."],
  ...
  ["What depolarizes the cochlear hair cell?", "Rapid ion influx from the endolymph through the opened tip-link channels."],
  ["What does the hair cell release, and onto what?", "Glutamate, onto cranial nerve VIII fibers."],
  ...
  ["What is the defect in sensorineural loss?", "Destruction of hair cells or auditory nerve fibers."],
  ["Which way does Weber lateralize in CONDUCTIVE loss?", "To the AFFECTED ear."],
  ["Which way does Weber lateralize in SENSORINEURAL loss?", "To the UNAFFECTED ear."],
  ...
  ["Which bacteria cause 80 to 90 percent of otitis externa?", "Pseudomonas aeruginosa and Staphylococcus aureus."],
  ...
  ["Name the central vertigo causes.", "Brainstem stroke, multiple sclerosis and cerebellar tumor."],
  ...
  ["What separates vestibular neuritis from labyrinthitis?", "Neuritis inflames the nerve fibers only, so hearing is spared. That is the only difference."],
  ...
  ["What does allergic rhinitis look like?", "CLEAR rhinorrhea, nasal itching, sneezing, boggy turbinates and allergic 'shiners'."],
  ["Clear discharge or purulent — which is allergic?", "Clear. Purulent points to acute bacterial sinusitis."],
  ["What are nasal polyps made of?", "Non-neoplastic, benign edematous masses from the mucous membranes of the sinus ostia or ethmoid air cells."],
  ...
  ["What enlarges the inferior turbinates?", "Venous sinusoid engorgement, mucosal edema, or bony hypertrophy."],
  ["What is rhinitis medicamentosa?", "Rebound hyperemia from overuse of topical decongestant sprays."],
  ["Which physical law governs a deviated septum?", "Poiseuille's law — small narrowing raises resistance dramatically."],
  ["Why does a deviated septum cause epistaxis?", "Turbulent air currents dry the mucosa, causing localized crusting and fragile vessel breakdown."],
  ...
  ["Which plexus bleeds in ANTERIOR epistaxis, and how often?", "Kiesselbach's plexus on the anterior septum — about 90 percent of cases."],
  ["Which plexus bleeds in POSTERIOR epistaxis, and how often?", "Woodruff's plexus on the posterolateral wall — about 10 percent."],
  ["What causes anterior epistaxis?", "Digital trauma, low humidity, localized mucosal erosion and mild rhinitis — all local."],
  ...
  ["What causes vocal cord polyps?", "Acute severe voice strain or vocal cord hemorrhage."],
  ...
  ["Vestibular neuritis", "Nerve fibers only; hearing spared"],
  ...
  ["Allergic rhinitis", "IgE type 1 hypersensitivity; CLEAR rhinorrhea"],
  ...
  ["Rhinitis medicamentosa", "Rebound hyperemia from topical decongestants"],
