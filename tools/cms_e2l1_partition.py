...
REFUSES TO OVERWRITE cms_e2l1_sets.json (added 2026-09-24). The shipped pages
(ophthalmology-i-quiz.html and
ophthalmology-i-quiz-version-2.html) were hand-edited after this script last
...
2026-09-24 cms_e2l1_sets.json was set to the pages' exact QUESTIONS (they are
...
if __name__ == "__main__":
    print("pool size:", len(POOL), "  (held out as NOT examinable: %d "
          "red-eye triage questions, slides 66-71)" % len(_EXTRA))
    ...
    _guarded_write(os.path.join(HERE, "cms_e2l1_sets.json"), {"set1": s1, "set2": s2})
