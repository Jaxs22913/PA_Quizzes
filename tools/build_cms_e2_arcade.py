...
DECK = dict(
  ...
  ["What is the one exception to the red-eye sequence?", "Chemical exposure — irrigate copiously first, before history or examination, then check the surface pH has normalized."],
  ...
  ["Xanthelasma: what workup does it warrant?", "Serum lipid profile, plus fasting glucose and hemoglobin A1C for diabetes, plus liver function tests."],
  ["What should a patient be told about treated xanthelasma?", "Recurrences are common even after effective local treatment."],
  ["Blepharitis: which three associations?", "Rosacea, seborrheic dermatitis, and Staphylococcus aureus colonization."],
  ...
  ["A lacrimal mass ABOVE the medial canthal tendon suggests what?", "A lacrimal sac tumor, which is rare."],
  ...
  ["Subconjunctival hemorrhage: which four risk factors?", "Valsalva, bleeding disorder, antiplatelet or anticoagulant medication, and hypertension."],
  ["Subconjunctival hemorrhage: what is the workup?", "History above all — and check the blood pressure if there is no explanation."],
  ["How long does an atraumatic subconjunctival hemorrhage take to clear?", "Two to four weeks, with reassurance as the treatment."],
  ...
  ["Which single agent blocks histamine AND stabilizes mast cells?", "Olopatadine."],
  ...
  ["Suspected gonococcal conjunctivitis in a newborn?", "An emergency — hospitalize for systemic ceftriaxone, cultures and Gram stain, testing for chlamydia and dissemination. Untreated risks corneal perforation."],
  ...
  ["Trachoma: mass treatment regimen and threshold?", "Azithromycin one gram orally as a single dose, where prevalence is five percent or above."],
  ["Episcleritis: the confirmatory bedside test?", "A drop of 2.5 percent phenylephrine — after 15 minutes the episcleral vessels blanch."],
  ...
  ["The contact lens case: what are the four next steps?", "Remove the lenses without patching, no take-home anesthetic or steroid, same-day ophthalmology, and preserve the lenses and case for culture."],
  ["Why is a take-home topical anesthetic prohibited?", "It delays healing and masks progression."],
