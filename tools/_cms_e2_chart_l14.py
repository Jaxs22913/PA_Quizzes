...
ROWS_L14 = [
 ...
 ("Full-thickness eye wall laceration", TRA,
  ...
  "<b>CT orbit.</b> Fundoscopy matters: a cut lens capsule leaves the lens <b>hydrated, edematous and opaque</b>, and a fragment can extrude into the anterior chamber and inflame it.",
 ...
 ("Globe rupture", TRA,
  ...
  "Suspect it whenever blunt trauma produces <b>massive hemorrhagic chemosis or a soft eye</b>. CT to look for a foreign body.",
 ...
 ("Corneal or conjunctival foreign body", TRA,
  ...
  "Topical anesthetic, then removal with a <b>sterile 27-gauge needle</b>. A <b>rust ring</b> (iron or copper) comes out with a battery-operated burr. Broad-spectrum antibiotic plus abrasion care.",
  "Urgent",
 ...
 ("Hyphema", TRA,
  ...
  "Emergent",
  "<b>Most rebleeding happens in the first 72 hours</b>, and a secondary hemorrhage can cost the vision permanently. Avoid aspirin and antiplatelets; <b>sickle cell disease raises the risk</b>.",
  "24&ndash;25", D14),
 ...
 ("Lid laceration", TRA,
  ...
  "Emergent",
  "A missed <b>canalicular</b> injury in the medial third leaves the patient with <b>chronic tearing for life</b>. Facial lacerations may be left open 24 hours before closure because the face is so well vascularized.",
  "26&ndash;27", D14),

 ("Orbital contusion", TRA,
  "Peri-orbital <b>swelling without hemorrhage</b>",
  "Soft tissue swelling inside the orbit <b>without hemorrhage</b>. Preseptal ecchymosis or hematoma &mdash; the tarsal plate and septal margin act as a wall holding blood in the anterior tissues.",
 ...
 ("Retinal detachment &mdash; traction", TRA,
  "<b>Proliferative diabetic retinopathy</b> &middot; <b>concave</b> and localized",
  "Fibrovascular tissue pulls the retina off. <b>Most commonly from proliferative diabetic retinopathy.</b> More localized and <b>concave</b> in shape than a rhegmatogenous detachment; starts along the vasculature then spreads to retina and macula.",
  "Dilated examination; the diabetic history is the context.",
  "<b>Surgical.</b>",
  "Emergent",
  "This is the one that follows from years of uncontrolled diabetes &mdash; the argument for glycemic control has an endpoint the patient can picture.",
  "39", D14),

 ("Retinal detachment &mdash; exudative", TRA,
  "<b>No break and no traction</b> &middot; systemic disease or a tumor behind it",
  "Fluid collects under the retina with <b>neither a retinal break nor vitreoretinal traction</b>. Associated with systemic vascular or inflammatory disease, or an intraocular tumor.",
 ...
 ("Orbital floor (blowout) fracture", TRA,
  ...
  "Two mechanisms: a true blowout, where a blunt object raises orbital pressure and blows out the <b>floor</b> (commonest) or medial wall; or force on the infraorbital rim buckling the floor. Periorbital ecchymosis, lid edema, chemosis, subconjunctival hemorrhage, <b>infraorbital numbness</b>, subcutaneous emphysema. <b>Diplopia on upward gaze = inferior rectus entrapment; on lateral gaze = medial rectus.</b>",
...
DIFF_L14 = {
 ...
 "Globe rupture": ("<b>YES</b>", "Unilateral",
   "<b>Massive hemorrhagic chemosis</b> with a soft eye after blunt force"),
 ...
 "Orbital contusion": ("<b>YES</b>", "Unilateral",
   "Preseptal ecchymosis or hematoma, <b>no hemorrhage within the orbit</b>"),
 "Periorbital hematoma": ("<b>YES</b>", "Unilateral",
 ...
 "Retinal detachment &mdash; traction": ("<b>NO</b>", "Often bilateral disease",
   "<b>Concave, localized</b> detachment with fibrovascular tissue"),
 ...
 "Basilar skull fracture": ("Variable", "Often bilateral raccoon eyes",
   "<b>Battle sign</b>, hemotympanum, <b>halo sign</b> on the bedsheet"),
}
...
IMGS_L14 = {
 ...
 "Periorbital hematoma": ("l14-s034_pos1.jpg", 34),
