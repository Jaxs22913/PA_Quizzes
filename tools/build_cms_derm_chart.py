...
ROWS = [
 ...
 ("l2_s136_2.jpg", "Alopecia areata",
  "Discrete smooth round patches of complete hair loss, with <b>exclamation-mark hairs</b> at the edge. Non-scarring.<br><span class=pt>&ldquo;A round bald patch appeared out of nowhere.&rdquo;</span>",
...
ROWS += [
 ...
 ("l5_s027_4.jpg", "Pediculosis pubis (crabs)",
  "Often asymptomatic or mild to moderate pruritus for months. <b>Maculae caeruleae</b> &mdash; slate-grey to bluish irregular macules about 1&nbsp;cm, representing haemorrhage. Papular urticaria at feeding sites, commonly periumbilical. <b>Phthiriasis palpebrarum</b> is infestation of the eyelashes.<br><span class=pt>&ldquo;I've been itching down there for weeks and there are odd bluish marks.&rdquo;</span>",
...
def render(mapping):
    ...
    for row in ROWS:
        if row[0] == "SECTION":
            ...
            body.append('<tr class="sec" data-label="%s"><td colspan="6">%s</td></tr>'
        ...
        body.append(
            ...
            '<td>%s</td>'
            '<td>%s</td>'
            '</tr>' % (pic, name, manif, tests, tx, edu))
        n_rows += 1
