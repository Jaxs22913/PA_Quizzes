...
ROWS = [
 ...
 ("l2_s097_1.jpg", "Perioral dermatitis",
  ...
  "<b>1st:</b> <span class=warn>stop facial topical corticosteroids</span> &mdash; continued exposure perpetuates it. Stop non-essential cosmetics and occlusive moisturizers; simplify the routine. Mild disease: topical metronidazole, erythromycin, pimecrolimus or azelaic acid.<br><b>2nd:</b> oral tetracycline or doxycycline for extensive or persistent disease.",
 ...
 ("l2_s111_3.jpg", "Stasis dermatitis",
  "Pruritic erythematous, violaceous or hyperpigmented patches in the <b>gaiter region</b>, with edema and signs of chronic venous disease. Usually <b>bilateral</b>.<br><span class=pt>&ldquo;Both my ankles are swollen, itchy and discolored, and it has been going on for months.&rdquo;</span><br><span class=warn>On darker skin the erythema reads violaceous, gray or deep brown &mdash; palpate for warmth and edema.</span>",
  "<b>Clinical</b> &mdash; lower-leg dermatitis with edema and chronic venous disease.<br><b>Ankle-brachial index or toe pressure</b> before substantial compression, to clarify arterial status. <b>Venous duplex ultrasound</b> if reflux, obstruction or deep vein thrombosis suspected.",
 ...
 ("l2_s121_1.jpg", "Bullous pemphigoid",
  "<b>Elderly.</b> Subepidermal split, so <b>tense</b> bullae that do not rupture easily. <b>Nikolsky negative.</b> Mucosal involvement uncommon. May begin with urticarial or edematous lesions before blistering.<br><span class=pt>&ldquo;I came up in big tight blisters that don't burst easily.&rdquo;</span>",
 ...
 ("l2_s181_1.jpg", "Lichen simplex chronicus",
  ...
  "<b>Clinical.</b> <b>Biopsy</b> atypical, unilateral, nodular, ulcerated or treatment-resistant plaques to exclude neoplasia.<br><span class=warn>Generalized or unexplained pruritus &rarr; targeted systemic evaluation.</span>",
  "<b>1st:</b> break the itch-scratch cycle &mdash; education, treat the trigger, emollients, behavioral substitution, nail care, safe physical occlusion. Appropriate potent topical corticosteroid for a limited course.<br><b>2nd:</b> calcineurin inhibitor for sensitive sites or maintenance.",
 ...
 ("l2_s151_2.jpg", "Xeroderma (xerosis)",
  ...
  "<span class=warn>Keratolytics may sting fissured skin.</span> Most improve with consistent barrier care, but <b>recurrence is expected while environmental exposure, aging or systemic risk persists</b>."),
]
...
ROWS += [
 ...
 ("l3_s006_3.jpg", "Erythema multiforme",
  "<b>Target lesions</b> with three concentric zones &mdash; central dusky or necrotic area, pale edematous ring, outer erythematous rim. Acral distribution, beginning on the extremities.<br><span class=pt>&ldquo;I have these bullseye-looking spots on my hands and arms.&rdquo;</span>",
  ...
  "<b>1st:</b> supportive &mdash; analgesia, antihistamines, wound care. <b>Discontinue the offending drug immediately.</b> Topical corticosteroids for localized lesions. Oral aciclovir or valaciclovir if herpes-triggered.<br><b>2nd (recurrent):</b> suppressive antiviral therapy, aciclovir 400&nbsp;mg twice daily.",
  "<b>Herpes simplex virus triggers over 50% of cases.</b> Hospitalize if erythema multiforme major with poor oral intake or extensive mucosal disease."),

 ("l3_s014_1.jpg", "Dermatitis herpetiformis",
  "Intensely pruritic papules, vesicles and urticarial plaques, <b>symmetrically</b> on knees, elbows, buttocks and back, grouped in a herpetiform pattern. Often bloating and diarrhea.<br><span class=pt>&ldquo;Unbelievably itchy blisters on my elbows and knees, both sides, and my stomach has been off.&rdquo;</span>",
  ...
  "<b>Screen every patient for celiac disease.</b> Also autoimmune thyroid disease and T-cell lymphoma. Rare &mdash; 11 to 75 per 100,000, northern European descent, ages 30 to 40."),
 ...
 ("l3_s021_2.jpg", "Acanthosis nigricans",
  ...
  "<b>Clinical diagnosis.</b> Then <b>hemoglobin A1c, fasting insulin, lipid panel</b>, polycystic ovarian syndrome workup.",
 ...
 ("l3_s027_2.jpg", "Epidermolysis bullosa",
  ...
  "<b>Referral to essentially every specialty</b> given the multisystem burden. Early palliative care integration, genetics counseling and family support in severe forms such as Herlitz junctional disease."),

 ("l3_s035_1.jpg", "Urticaria",
  "Transient pruritic wheals, with or without angioedema. <b>An individual wheal resolves within 24 hours</b>, blanches fully and migrates.<br><span class=pt>&ldquo;Itchy welts come up and move around, and each one is gone by the next day.&rdquo;</span>",
 ...
 ("l3_s047_1.jpg", "Granuloma annulare",
  "Annular ring of flesh-colored or erythematous papules, commonly dorsal hands and feet. <b>No scale on the border</b> &mdash; which is what separates it from tinea.<br><span class=pt>&ldquo;A ring of little bumps on the back of my hand. It doesn't itch.&rdquo;</span>",
  ...
  "Localized disease is benign and about <b>half resolve within two years</b>; no malignant potential. <span class=warn>Generalized disease in an adult over fifty &rarr; screen for diabetes, thyroid disease, dyslipidemia and lymphoma.</span>"),
 ...
 ("l3_s056_2.jpg", "Pyoderma gangrenosum",
  ...
  "<span class=warn>Do not debride.</span> Screen for inflammatory bowel disease (25&ndash;50%), hematologic malignancy, monoclonal gammopathy, rheumatoid arthritis. The bullous variant associates with acute myeloid leukemia."),
 ...
 ("l3_s071_1.jpg", "Hyperhidrosis",
  "<b>Primary focal:</b> bilateral, focal (palms, soles, axillae), adolescent onset, <b>absent during sleep</b>.<br><b>Secondary:</b> generalized, may be asymmetric, can occur at night.<br><span class=pt>&ldquo;My hands drip so much I smudge everything I write.&rdquo;</span>",
  "<b>Clinical + Hyperhidrosis Disease Severity Score.</b> Minor's starch-iodine test maps the distribution; gravimetric measurement quantifies it.<br><span class=warn>Generalized or nocturnal &rarr; secondary workup: 24-hour urine metanephrines and catecholamines, thyroid-stimulating hormone.</span>",
  "<b>1st:</b> aluminum chloride topically at night.<br><b>2nd:</b> glycopyrronium 2.4% cloth once daily (axillary), or an oral anticholinergic.<br><b>3rd:</b> botulinum toxin A; microwave thermolysis.<br><b>Last resort:</b> endoscopic thoracic sympathectomy for refractory palmar disease.",
 ...
 ("l3_s092_1.jpg", "Sunburn",
  "<b>First degree:</b> erythema, warmth, tenderness, no blistering, resolving in 3&ndash;5 days with desquamation.<br><b>Second degree:</b> blistering, intense pain, edema, 1&ndash;2 weeks.<br>Onset 3&ndash;5 hours after exposure, peaking at 12&ndash;24 hours. &ldquo;Sun poisoning&rdquo; &mdash; fever, chills, nausea, dehydration &mdash; with large body surface involvement.",
  "<b>Clinical.</b>",
  "<b>1st:</b> cool compresses and cool (not cold) water immersion. <b>Nonsteroidal anti-inflammatory drugs started early</b> reduce prostaglandin-mediated pain. Oral hydration; intravenous fluids if severe.<br><b>2nd:</b> topical moisturizers &mdash; aloe vera, soy &mdash; soothing but do not alter healing. Topical steroid has limited evidence, possibly if within 6 hours.",
  "<span class=warn>Do not pop blisters &mdash; intact blisters are protective.</span> Hospitalize for severe blistering over 20% body surface, systemic toxicity, or extremes of age. Broad-spectrum SPF 30+, reapply every 2 hours; avoid 10&nbsp;AM&ndash;4&nbsp;PM; <b>tanning beds are Group 1 carcinogens</b>."),

 ("l3_s097_1.jpg", "Drug-induced photosensitivity",
  "<b>Phototoxicity:</b> non-immunologic, dose-dependent, occurs on <b>first</b> exposure, within hours, looks like an exaggerated sunburn confined to exposed skin.<br><b>Photoallergy:</b> immunologic type IV, dose-independent, needs sensitization, eczematous and pruritic, <b>extends beyond sun-exposed skin</b>, can persist after the drug stops.<br><span class=pt>&ldquo;I burned badly after barely any sun since starting that antibiotic.&rdquo;</span>",
 ...
 (None, "Photodermatitis (phytophotodermatitis)",
  ...
  "Detailed exposure history &mdash; plants, topicals, fragrances, medications. <b>Photopatch testing</b> for photocontact allergy. Antinuclear antibody panel if lupus suspected. Biopsy if uncertain.<br><span class=warn>Photodermatitis spares the nasolabial folds; seborrheic dermatitis involves them.</span>",
  ...
  "Recognize photosensitising plants, especially in landscaping, gardening and food preparation. <b>Wash skin immediately after plant contact before sun exposure.</b> Year-round sun protection prevents the pigment darkening further."),
 ...
 ("l3_s103_1.jpg", "Polymorphous light eruption",
  ...
  "<b>Largely clinical</b> &mdash; history and morphology.<br><b>Antinuclear antibody panel is MANDATORY to exclude lupus</b>, especially anti-Ro/SSA and anti-La/SSB. Phototesting reproduces the eruption in 50&ndash;60%. Biopsy shows a perivascular lymphocytic infiltrate with dermal edema &mdash; supportive, not pathognomonic.",
  "<b>1st (acute):</b> avoid further ultraviolet exposure, cool compresses, moderate-potency topical corticosteroid, oral antihistamine. Short prednisolone 0.5&nbsp;mg/kg/day &times;4&ndash;5 days for severe episodes.<br><b>1st (preventive):</b> prophylactic narrowband ultraviolet B, 3&times;/week for 5 weeks in spring &mdash; induces tolerance and is the most effective preventive strategy.<br><b>2nd:</b> hydroxychloroquine 200&nbsp;mg twice daily for refractory cases.",
 ...
 ("l3_s108_1.jpg", "Solar lentigo <span class=\"dup\">also Lecture 8</span>",
  "Well-defined light-to-dark brown macules with <b>irregular borders that coalesce at sites of severe sunburn</b>, from under 1&nbsp;mm to several centimeters, on chronically exposed skin. <b>90% of people by age 50.</b><br><span class=pt>&ldquo;Age spots on the backs of my hands and my shoulders.&rdquo;</span>",
  "<b>Dermoscopy</b> &mdash; finger-like projections and a &ldquo;moth-eaten&rdquo; border.<br><span class=warn>Biopsy if atypical or uncertain on dermoscopy, to exclude lentigo maligna</span> (asymmetric, irregular border and color, structureless pigment). Reflectance confocal microscopy where biopsy is deferred.",
 ...
 ("l3_s117_3.jpg", "Actinic keratosis",
  "Rough, scaly, erythematous papules and plaques on sun-exposed skin &mdash; face, scalp, dorsal hands, forearms. Skin-colored to red-brown, <b>&ldquo;sandpaper&rdquo; texture on palpation</b>, typically 2&ndash;10&nbsp;mm.<br><span class=pt>&ldquo;Rough scaly spots I can feel better than I can see.&rdquo;</span>",
...
ROWS += [
 ...
 ("l4_s041_1.jpg", "Folliculitis",
  ...
  "<b>History and clinical manifestations.</b><br><b>Resistant cases:</b> culture and Gram stain from an unroofed pustule; potassium hydroxide wet mount using a <b>plucked hair</b> to exclude dermatophyte folliculitis; nasal swab of patient and family for Staphylococcus aureus colonization; biopsy.",
  "<b>1st:</b> moist heat, antibacterial soaps, good glycemic control, good skin hygiene, loose clean clothing. Mild infection &mdash; topical mupirocin, clindamycin or erythromycin.<br><b>Recurrent (carrier state):</b> mupirocin ointment in the nasal vestibule twice daily &times;5 days.<br><b>Extensive:</b> oral cephalexin or dicloxacillin. <b>If MRSA:</b> trimethoprim-sulfamethoxazole, ciprofloxacin or linezolid.",
 ...
 ("l4_s083_1.jpg", "Erythrasma",
  ...
  "<b>1st (localized):</b> topical erythromycin or clindamycin.<br><b>Widespread:</b> oral erythromycin or clarithromycin.<br><b>If yeast also present:</b> add an antifungal cream (miconazole).",
 ...
 ("l4_s087_1.jpg", "Impetigo &mdash; non-bullous",
  "The more common form. A macule rapidly becomes a vesicle or pustule and ruptures; serous contents dry to a <b>honey-colored adherent crust</b> over an erosion. Face and extremities. Spreads by extension and self-inoculation from scratching. <b>Regional lymphadenopathy common.</b> <b>VERY contagious.</b><br><span class=pt>&ldquo;Golden crusty sores around his nose and mouth that keep spreading.&rdquo;</span>",
 ...
 ("l4_s105_1.jpg", "Cellulitis",
  "Acute inflammation of the <b>deeper dermis and subcutaneous tissue</b>. Group A beta-hemolytic streptococci or Staphylococcus aureus. <b>All four cardinal signs</b> &mdash; erythema, warmth, edema, tenderness. Most common site the lower leg, <b>almost never bilateral</b>. <b>Borders are NOT elevated or demarcated</b> &mdash; which rules out erysipelas. May be purulent or non-purulent.<br><span class=pt>&ldquo;My leg is hot, red, swollen and sore, and the edge just fades out.&rdquo;</span>",
 ...
 ("l4_s117_1.jpg", "Acute paronychia",
  "Infection of the soft tissue around the fingernail (perionychium), starting as cellulitis and progressing to abscess. <b>Usually 2&ndash;5 days after trauma.</b> Rapid onset of an erythematous edematous area; advanced cases collect purulent fluid under the nail folds. Staphylococcus aureus, Streptococcus pyogenes.<br><span class=pt>&ldquo;My finger went red and throbbing a couple of days after a manicure.&rdquo;</span>",
 ...
 ("l4_s124_2.jpg", "Necrotizing fasciitis",
  "Bacterial infection of the tissue surrounding muscle, nerve, fat and vessels, leading to necrosis. Polymicrobial; Group A streptococcus common. <b>Difficult to recognize early but rapidly progressive.</b><br><span class=warn>The clue: unrelenting pain OUT OF PROPORTION to the physical examination.</span> Later: skin changes red-purple to blue-gray, bullae with thick pink or purple fluid, cutaneous gangrene, and <b>the area stops being tender because the superficial nerves have been destroyed</b>. Fever 38.9&ndash;40.5&deg;C, tachycardia, hypotension, septic shock.<br><span class=pt>&ldquo;The pain is far worse than it looks &mdash; and now it's gone numb.&rdquo;</span>",
  "<b>A surgical emergency with high mortality.</b> <span class=warn>Laboratory tests and imaging must NOT delay surgical intervention.</span><br>Complete blood count with differential, chemistry, arterial blood gas, urinalysis, blood and tissue cultures.<br>Ultrasound demonstrates air bubbles in soft tissue; magnetic resonance or computed tomography localizes site and depth. <b>Gas may be present with Clostridium perfringens; it is NOT present with Group A streptococcus.</b>",
  "<b>1st: aggressive surgical debridement of necrotic tissue.</b> Admit to a surgical intensive care unit (burn or trauma center). Team approach with consultations.<br><b>Antibiotics:</b> broad-based, covering aerobic Gram-positive and Gram-negative organisms and anaerobes.",
...
ROWS += [
 ...
 ("l5_s011_4.jpg", "Crusted (hyperkeratotic) scabies",
  "<b>Thick flaking scale containing millions of mites.</b> Nails thickened or discolored, patches poorly defined, and patients <b>may be asymptomatic &mdash; not itchy at all</b>.<br><span class=pt>&ldquo;My skin has gone thick and scaly, but honestly it doesn't itch.&rdquo;</span>",
 ...
 ("l5_s027_4.jpg", "Pediculosis pubis (crabs)",
  "Often asymptomatic or mild to moderate pruritus for months. <b>Maculae caerulae</b> &mdash; slate-gray to bluish irregular macules about 1&nbsp;cm, representing hemorrhage. Papular urticaria at feeding sites, commonly periumbilical. <b>Phthiriasis palpebrarum</b> is infestation of the eyelashes.<br><span class=pt>&ldquo;I've been itching down there for weeks and there are odd bluish marks.&rdquo;</span>",
 ...
 ("l5_s034_2.jpg", "Bedbugs",
  ...
  "Bedbugs need a blood meal every 5&ndash;10 days but <b>can survive up to a year</b> without one &mdash; leaving a room empty does not clear them. Spread in clothing and baggage of travelers and visitors, second-hand mattresses, and laundry. <b>Not a marker of poor hygiene.</b>"),
 ...
 ("l5_s039_2.jpg", "Tungiasis (fleas)",
  ...
  "<b>Dermoscopy to visualize the ovoid eggs.</b>",
 ...
 ("l5_s047_1.jpg", "Caterpillars (lepidopterism)",
  "About 100&ndash;150 species. Mechanisms: mechanical irritation by pointed hairs, toxin injection through hollow hairs, cell-mediated hypersensitivity to hairs.<br><b>Gypsy moth:</b> erucism &mdash; pruritic dermatitis with multiple erythematous papules in <b>linear streaks</b>.<br><b>Processionary:</b> urticaria, angioedema, anaphylaxis.<br><b>Asp or puss caterpillar (most poisonous):</b> intense painful sting with a <b>train-track pattern of purpura</b>.",
 ...
 ("l5_s056_1.jpg", "Black widow spider",
  "<i>Latrodectus mactans</i> &mdash; characteristic <b>red hourglass on the underside of the abdomen</b>. Venom contains the neurotoxin <b>alpha-latrotoxin</b>.<br>Painful bite with mild dermatologic findings. <b>Within 30 minutes:</b> localized erythema, piloerection and sweating around the bite. Then <b>agonizing crampy abdominal pain and muscle spasms</b>; headache, paresthesia, nausea, vomiting, hypertension, lacrimation, salivation, seizures, tremors, acute renal failure, paralysis.<br><span class=pt>&ldquo;It bit me and within half an hour my stomach was cramping so badly I thought something had ruptured.&rdquo;</span>",
  "<b>Clinical</b>, from the exposure and the systemic picture.",
  "<b>Local wound care versus hospitalization depending on symptoms.</b><br><b>Envenomation:</b> calcium gluconate 10%; narcotic analgesics; muscle relaxants; benzodiazepines.<br><b>Ensure tetanus vaccination is up to date.</b>",
 ...
 ("l5_s063_1.jpg", "Hobo spider",
  "<i>Tegenaria agrestis</i>, the aggressive house spider &mdash; brown with a <b>gray herringbone pattern on the abdomen</b>. <b>Often mistaken for the brown recluse.</b> The predominant cause of necrotic arachnidism in the Pacific Northwest. Bites <b>July to September</b> during mating season; webs in basements, wood piles, bushes.<br><b>Painless bite</b>; induration and paresthesia within 30 minutes; a large erythematous area; <b>vesicle formation during the first 36 hours</b>; sometimes eschar. Systemic: headaches, fatigue, nausea, vomiting, diarrhea, paresthesia, <b>memory impairment</b>.",
  "<b>Clinical</b>, from geography, season and the appearance.",
  "<b>Supportive measures.</b>",
  "Wounds heal within several weeks; headaches may last up to a week. <span class=warn>Rare: death from severe systemic effects, including aplastic anemia.</span>"),

 ("l5_s073_5.jpg", "Lyme disease",
  "<i>Borrelia burgdorferi</i>, a spirochete.<br><b>Stage 1 &mdash; early localized:</b> <b>erythema migrans</b> &mdash; a large (&gt;5&nbsp;cm) expanding erythematous round or oval lesion with <b>central clearing</b> and often a darker punctate center at the bite site &mdash; the &ldquo;bull's eye&rdquo;. Occurs <b>1 week</b> after the bite, with fever, myalgia, arthralgia, fatigue, lymphadenopathy.<br><b>Stage 2 &mdash; early disseminated (days to weeks):</b> skin, central nervous system, cardiac, musculoskeletal, eyes &mdash; cranial nerve palsies, meningitis, radiculopathies, arthralgias, headache, stiff neck.<br><b>Stage 3 &mdash; late persistent (months to years):</b> <b>monoarticular or oligoarticular arthritis</b> of the knee or weight-bearing joints; subacute encephalopathy with memory loss, mood change and sleep disturbance; <b>acrodermatitis chronica atrophicans</b>.",
 ...
 ("l5_s090_1.jpg", "Cercarial dermatitis (swimmer's itch)",
  "Acute pruritic eruption from penetration of the skin by the <b>cercarial</b> forms of parasitic flatworms. Host (waterfowl, marsh bird, finch, muskrat, mouse, deer) passes eggs in feces into water; eggs hatch and infect a snail within 12 hours; in 5 weeks cercariae are released and carried to the shore.<br><b>Urticaria-like lesions and a prickling sensation lasting about 30 minutes</b> after exposure &rarr; <b>severe pruritus at 10&ndash;12 hours</b> &rarr; <b>erythematous papules within 24 hours</b> &rarr; vesicles &rarr; pustules. Pain and swelling with pruritus <b>peaking at 48&ndash;72 hours</b>. Sometimes headaches, fever, lymphangitis.<br><span class=pt>&ldquo;After the lake my legs prickled, then that night they itched like fire and came up in spots.&rdquo;</span>",
...
ROWS += [
 ...
 ("l6_s009_1.jpg", "Tinea capitis (scalp)",
  "<b>Predominantly preadolescent children</b> &mdash; after puberty, changes in the fatty acid content of sebum are believed to inhibit growth. The commonest fungal infection in children; <i>Trichophyton tonsurans</i> is commonest in the United States. Red papules progressing to <b>grayish ring-formed patches with perifollicular papules</b>, scaly patches, and <b>lymphadenopathy is often present</b>.<br><span class=pt>&ldquo;He has a scaly bald patch on his head and he keeps scratching it.&rdquo;</span>",
 ...
 ("l6_s024_2.jpg", "Tinea corporis (body) &mdash; &ldquo;ringworm&rdquo;",
  ...
  "<b>Potassium hydroxide from the ACTIVE BORDER</b> &mdash; not the cleared center. <b>Culture</b> where clinical suspicion is high and the preparation is negative, and for refractory cases.",
 ...
 ("l6_s054_1.jpg", "Tinea manuum (hand)",
  ...
  "<b>Patients are often unaware they have an infection</b>, believing the change is dry skin or hard physical labor. Check both feet and both palms."),
 ...
 ("l6_s131_1.jpg", "Molluscum contagiosum",
  "<b>Benign POXVIRUS infection.</b> <b>Discrete, smooth-surfaced, firm, flesh-colored, dome-shaped pearly papules averaging 3&ndash;5&nbsp;mm</b>; <b>CENTRAL UMBILICATION is characteristic</b>. Asymptomatic, or tender or pruritic.<br><span class=pt>&ldquo;He's got little pearly bumps with a dimple in the middle.&rdquo;</span>",
 ...
 ("l6_s144_2.jpg", "Verruca plana (flat warts)",
  "<b>Multiple smooth, slightly elevated, FLAT-TOPPED, skin-colored to light-brown papules.</b> Common on the <b>face, forehead, dorsal hands and shins</b>.<br><span class=pt>&ldquo;Lots of small flat bumps across my forehead and shins.&rdquo;</span>",
  "<b>Clinical diagnosis.</b>",
...
ROWS += [
 ...
 ("l9_s019_1.jpg", "Squamous cell carcinoma",
  "<b>The second most common skin cancer.</b> Prolonged CUMULATIVE sun exposure; may arise from an actinic keratosis. Small <b>red, conical, hard nodule that may ulcerate</b>; also a <b>non-healing ulcer</b>, warty nodule, or irregular pink plaque with hemorrhagic crust.<br><span class=pt>&ldquo;A sore on my lip that just won&rsquo;t heal.&rdquo;</span>",
  ...
  "<b>In situ</b> (no high-risk features): imiquimod, topical fluorouracil, or curettage and electrodesiccation.<br><b>Invasive:</b> surgical excision or <b>Mohs</b>.<br><b>Advanced/metastatic:</b> programmed death 1 blockade; cetuximab.<br><b>Mohs indications:</b> lips, temples, ears, nose, genitalia; recurrent; perineural or perivascular invasion; <b>&gt;1&nbsp;cm on face or &gt;2&nbsp;cm on trunk/extremities</b>; immunosuppression; tumors in scars; genetic disease.",
  "<b>High-risk sites:</b> mucosal surfaces, lip, ear, scalp, temple, nose, genitalia. <b>&gt;10 tumors</b> means higher local recurrence and nodal metastasis. Common and often aggressive after transplant, with multiple tumors typically at <b>~5 years</b>. <b>Nicotinamide 500&nbsp;mg twice daily cuts new tumors by ~30%.</b> At least <b>annual skin AND node examination</b>. Metastatic rate <b>3&ndash;7%</b>."),
 ...
 ("l9_s029_1.jpg", "Basal cell carcinoma &mdash; nodular",
  ...
  "<b>Shave or punch biopsy.</b> The <b>HISTOLOGIC</b> subtype determines behavior and dictates treatment.<br>Clinical subtypes: superficial, nodular, pigmented, morpheaform. Histologic: superficial, nodular, micronodular, infiltrative.<br><b>Differential:</b> intradermal naevus, sebaceous hyperplasia, squamous cell carcinoma, actinic keratosis, scar/morphea, pigmented melanoma or seborrheic keratosis.",
  ...
  "<b>A second basal cell carcinoma develops in up to 50%</b> &mdash; at least annual full-skin examination is mandatory. <b>Nicotinamide 500&nbsp;mg twice daily cuts new tumors by ~20%</b> (the squamous figure is 30%). Slow-growing and highly curable early; morbidity comes from <b>local destruction</b>, recurrence and delayed diagnosis. <b>Mohs</b> for eyelids, nasolabial folds, canthi, external ear, temple; recurrence; tissue-sparing need; aggressive histology."),
 ...
 ("l9_s030_2.jpg", "Basal cell carcinoma &mdash; pigmented and morpheaform",
  ...
  "<b>Mohs</b> for aggressive histology &mdash; morpheaform, micronodular or infiltrative &mdash; and for recurrent tumors or where tissue sparing matters.",
 ...
 ("l9_s044_2.jpg", "Malignant melanoma",
  "<b>4th most common cancer in the United States</b> and the <b>leading cause of death due to skin disease</b>; incidence doubled over 30 years. 2023: ~97,610 new invasive melanomas, ~7,990 deaths, <b>two-thirds of deaths in men</b>. Lifetime risk <b>~2% in white individuals; 0.1&ndash;0.5% in persons of color</b>.<br><b>Subtypes:</b> superficial spreading (~2/3, radial then vertical growth); lentigo maligna (chronically sun-exposed skin, older adults); <b>nodular &mdash; rapid, often amelanotic, may LACK the classic features</b>; acral lentiginous.<br><span class=pt>&ldquo;This mole has changed shape and color this year.&rdquo;</span>",
  "<b>ABCDE:</b> Asymmetry &middot; Border irregular, notched or poorly defined &middot; Color variegation &middot; Diameter &gt;6&nbsp;mm &mdash; <b>though smaller lesions can be melanoma</b> &middot; Evolution.<br><b>Initial test: biopsy or excision.</b><br><b>Sentinel node biopsy</b> offered/discussed at <b>&ge;1.0&nbsp;mm</b> Breslow, or <b>&ge;0.8&nbsp;mm</b> with ulceration, high mitotic rate or lymphovascular invasion. It is a <b>STAGING</b> procedure and <b>may not itself improve overall survival</b>.<br><b>Level of invasion</b> is the anatomic layer reached (I epidermis &rarr; V subcutis) &mdash; the deck labels these only &ldquo;Level I&rdquo; to &ldquo;Level V&rdquo; and never says <i>Clark</i>, which is the conventional name for the same system; <b>Breslow thickness is the dominant prognostic variable</b>.",
  "<b>Re-excision margins:</b> in situ <b>0.5&ndash;1&nbsp;cm</b>; <b>&lt;1&nbsp;mm &rarr; 1&nbsp;cm</b>; <b>&gt;1&nbsp;mm &rarr; 1&ndash;2&nbsp;cm</b>.<br><b>Refer to an expert center</b> for melanoma deeper than 1&nbsp;mm or with nodal/other-site spread.",
 ...
 ("l9_s045_1.jpg", "Nail unit melanoma",
  "Rare acral melanoma arising most often in the <b>MATRIX</b>. <b>Not clearly ultraviolet-driven; may occur in any skin tone.</b> <b>Thumb and great toe</b> are high-yield sites.<br><b>Signs:</b> new or evolving <b>longitudinal melanonychia in ONE digit</b>; increasing width; irregular color, thickness or spacing of lines; <b>proximal widening or triangular shape</b>; blurred borders; nail splitting or dystrophy; ulceration or a subungual mass.<br><span class=pt>&ldquo;A dark stripe in one nail that&rsquo;s getting wider.&rdquo;</span>",
  ...
  "Coordinate dermatology, nail surgery and surgical oncology.<br><b>Digit-sparing wide excision or Mohs with immunostaining</b> for in situ and selected invasive tumors when margins can be reliably assessed.<br><b>Amputation is NOT automatic</b> &mdash; reserved for deep, extensive or bone-involving disease. Sentinel node discussion and systemic therapy follow melanoma stage and Breslow principles.",
 ...
 ("l9_s082_1.jpg", "Nail unit squamous cell carcinoma / Bowen disease",
  "<b>The most common malignant nail tumor.</b> Chronic <b>unilateral verrucous periungual papule or plaque</b>, subungual hyperkeratosis, onycholysis, oozing, bleeding, ulceration, nail-plate destruction, longitudinal erythronychia, or pain &mdash; often <b>repeatedly labeled a wart, paronychia or fungal infection</b>.<br><span class=pt>&ldquo;They&rsquo;ve treated this as a wart three times and it&rsquo;s still there.&rdquo;</span>",
 ...
 ("l9_s087_1.jpg", "Glomus tumor and the benign nail tumors",
  "<b>Glomus tumor:</b> small <b>red-blue subungual focus</b> with <b>severe paroxysmal pain, exquisite point tenderness and cold sensitivity</b> &mdash; the nail may look nearly normal.<br><b>Onychopapilloma / onychomatricoma:</b> a single nail with <b>longitudinal erythronychia or leukonychia</b>, distal subungual hyperkeratosis, splinter hemorrhages or localized plate abnormality.<br><span class=pt>&ldquo;It&rsquo;s agony in cold water and I can point to the exact spot.&rdquo;</span>",
  "The glomus <b>triad strongly suggests</b> the diagnosis but <b>does not replace imaging or specialist evaluation</b>.<br>Other benign tumors that mimic malignancy: acquired digital fibrokeratoma, melanocytic naevus or lentigo, pyogenic granuloma, digital myxoid cyst, subungual exostosis.",
 ...
 ("l9_s062_4.jpg", "Kaposi sarcoma",
  ...
  "<b>ORAL EXAMINATION IS ESSENTIAL</b> when Kaposi sarcoma is suspected &mdash; <b>hard palate lesions are common and may be the presenting site</b>.<br><b>Marked edema may occur with few or no visible skin lesions &mdash; do not use edema severity to gauge disease burden.</b><br><b>Differential:</b> bacillary angiomatosis, angioma/hemangioma, purpura, venous stasis, pyogenic granuloma, lymphoma, metastatic disease.",
  "<b>Epidemic (AIDS-associated) &mdash; FIRST PRIORITY: begin or optimize antiretroviral therapy.</b> Immune restoration is the cornerstone.<br><b>Classic/older adult:</b> palliative local therapy &mdash; intralesional vincristine, vinblastine or bleomycin, or radiation.<br><b>Iatrogenic:</b> reduce immunosuppressive doses where feasible &mdash; <b>coordinate with the transplant team first</b>.<br><b>Systemic first-line:</b> liposomal doxorubicin and paclitaxel. <b>Antiretroviral therapy plus chemotherapy beats antiretroviral therapy alone in advanced disease.</b>",
 ...
 ("l9_s072_1.jpg", "Cutaneous T-cell lymphoma (mycosis fungoides)",
  "A cutaneous T-cell lymphoma that <b>begins in the skin and may remain confined there for years or decades</b>. Early: localized or generalized <b>erythematous patches or scaly plaques, usually on the trunk</b>, <b>frequently &gt;5&nbsp;cm</b>. <b>May resemble psoriasis, eczema or tinea</b>, which is why diagnosis is often delayed.<br><span class=pt>&ldquo;They&rsquo;ve called it eczema for four years and nothing works.&rdquo;</span>",
  ...
  "Diagnosis may take repeated biopsies over time. Referral: dermatology/dermatopathology early for persistent suspicious disease; a cutaneous lymphoma center once blood, node, tumor or erythrodermic involvement is suspected."),
]
...
ROWS += [
 ...
 ("l8_s029_2.jpg", "Congenital melanocytic naevus",
  ...
  "<b>Risk: neurofibromatosis type I.</b> Neurocutaneous melanosis affects patients with naevi on head, neck or posterior midline &mdash; seizures, hydrocephalus, neurological deficits and vomiting within the first few years of life, and <b>the prognosis is poor once neurological symptoms appear</b>. <b>Counseling and support groups</b> assist families and patients with large naevi."),
 ...
 ("l8_s033_1.jpg", "Naevus spilus",
  ...
  "<b>Rarely progresses to melanoma.</b> Sun protection counseling. Associated with other anomalies of <b>vascular, central nervous system or connective tissue</b> origin."),

 ("l8_s036_1.jpg", "Common acquired melanocytic naevus (mole)",
  "Develops slowly after birth, enlarges symmetrically, stabilizes and regresses. <b>Numbers peak in the thirties and decline afterwards.</b> Usually <b>under 6&nbsp;mm</b>, homogenous surface and color (skin colored, brown, pink), round to oval with sharp demarcation. Can be anywhere.<br><span class=warn>Very dark brown or black on a light-skinned individual is suspicious.</span>",
  "<b>Clinical diagnosis.</b>",
  "<b>Observation.</b><br><b>Remove for cosmetic reasons or symptomatic relief.</b>",
  "<b>Proper counseling on sun protection.</b> Melanoma risk increases with the number of naevi. Increased numbers in patients with light skin tone and those who tend to sunburn. Risk factors: ultraviolet exposure, male sex, and a genetic component."),

 ("l8_s039_1.jpg", "Blue naevus",
  "A group of lesions composed of <b>deeply pigmented spindle or epithelioid melanocytes in the DERMIS</b>. Affects women more than men, most commonly in their <b>twenties</b>. Blue, blue-gray or blue-black. On the <b>dorsal hands and feet, scalp, buttocks or sacral region</b>.<br><b>Common blue:</b> deeply pigmented, under 1&nbsp;cm, arising in adolescence.<br><b>Cellular blue:</b> larger plaques or nodules over 1&nbsp;cm, arising before age 40.",
 ...
 ("l8_s041_1.jpg", "Pigmented spindle cell naevus (Reed)",
  "Commonly in the <b>thirties</b>; <b>females more than males</b>. Found on the extremities, <b>mainly the lower extremities and especially the thigh</b>. A <b>sharply circumscribed darkly pigmented papule, usually under 7&nbsp;mm, JET-BLACK</b> but may have shades of blue, gray or brown. <b>Benign.</b>",
 ...
 ("l8_s042_1.jpg", "Spitz naevus",
  "Usually benign, with a <b>phase of growth (fast or slow) followed by a stable period</b>. <b>Solitary, asymptomatic, pink or red, hairless, firm and dome-shaped.</b> Several millimeters to centimeters. Located on face, neck, trunk and extremities; <b>SPARES palms, soles and mucous membranes</b>.<br><span class=warn>Sometimes resembles melanoma.</span>",
...
LABS = {
 ...
 "Actinic keratosis": "<b>None.</b> Usually a clinical diagnosis; <b>shave or punch biopsy</b> when behavior or morphology raises concern for squamous cell carcinoma, or when a lesion persists or recurs after therapy.",
 "Squamous cell carcinoma": "<b>No routine bloods.</b> Diagnosis is by <b>biopsy</b>. Investigate the HOST where relevant &mdash; transplant, chronic lymphocytic leukemia, or human immunodeficiency virus status all raise risk and aggressiveness, and coordinate transplant, hematology or HIV care.",
 "Basal cell carcinoma &mdash; nodular": "<b>None.</b> <b>Shave or punch biopsy</b>; the histologic subtype determines behavior and dictates treatment.",
 ...
 "Glomus tumor and the benign nail tumors": "<b>None.</b> The clinical triad suggests it; <b>imaging and specialist evaluation</b> are still required, and the triad does not replace them.",
 "Kaposi sarcoma": "<b>Human immunodeficiency virus testing and staging matter here</b> &mdash; immune status defines the clinical form and drives treatment. Diagnosis itself is by <b>biopsy</b>. In epidemic disease the first priority is starting or optimizing <b>antiretroviral therapy</b>.",
 ...
 "Lichen simplex chronicus": "<b>None for the plaque itself.</b> <span class=warn>Generalized or unexplained pruritus triggers a targeted systemic evaluation</span> guided by history, medications and review of systems.",
 ...
 "Acanthosis nigricans": "<b>Hemoglobin A1c, fasting insulin and a lipid panel</b>, plus a polycystic ovarian syndrome workup.",
 ...
 "Granuloma annulare": "<b>Screen for diabetes (hemoglobin A1c), thyroid disease and dyslipidemia</b> &mdash; and in generalized disease in an adult over fifty, workup for lymphoma.",
 ...
 "Hyperhidrosis": "<b>Only in suspected SECONDARY disease</b> &mdash; generalized or nocturnal sweating: <b>24-hour urine metanephrines and catecholamines, thyroid-stimulating hormone</b>, glucose.",
 ...
 # ---- Lecture 5
 "Scabies": "<b>None</b> &mdash; microscopic identification of the organism, ova or feces is the diagnosis.",
 "Crusted (hyperkeratotic) scabies": "<b>None</b> &mdash; as for scabies, but scrapings are strongly positive given the mite burden.",
 "Pediculosis capitis (head lice)": "<b>None</b> &mdash; visualizing nits or live lice.",
 ...
 "Tungiasis (fleas)": "<b>None</b> &mdash; dermoscopy visualizes the ovoid eggs.",
 ...
 "Rocky Mountain spotted fever": "<b>Complete blood count (thrombocytopenia, anemia, normal white count with increased bands), chemistry (mild hyponatremia), liver function (mild transaminitis).</b> Cerebrospinal fluid: leukocytosis, moderately raised protein, normal glucose. <b>Gold standard: indirect immunofluorescence assay</b> &mdash; rarely diagnostic before day 7, so <span class=warn>treat by day 5 while waiting.</span>",
 "Cercarial dermatitis (swimmer's itch)": "<b>None</b> &mdash; clinical, from the freshwater exposure and the time course.",
 # ---- Lecture 7
 "Clavus (corn) &mdash; hard": "<b>None.</b> Purely clinical. In a diabetic patient the relevant work-up is a foot risk assessment &mdash; sensation, pulses, glycemic control &mdash; not blood tests for the lesion.",
 ...
 "Neurofibromatosis type 1": "<b>No routine bloods.</b> Diagnosis is clinical on the recognized criteria. Genetic testing exists but is not what this lecture asks for; surveillance is by cutaneous examination at every visit.",
...
ROWS += [
 ...
 ("l7_s005_1.png", "Clavus (corn) &mdash; hard",
  "<b>Focal</b> mechanical trauma (ill-fitting shoes) &rarr; hyperkeratosis with a <b>cone-shaped central core of hard keratin pointing into the skin</b>. Well defined, <b>&lt;1.5&nbsp;cm</b>, <b>painful on direct downward pressure</b>. Skin lines <b>run through</b> it. Clavus durum favors the <b>dorsal and lateral fifth toe</b>.<br><span class=pt>&ldquo;It's like walking on a pebble &mdash; right on this one spot.&rdquo;</span>",
  "<b>Clinical diagnosis.</b> No testing needed.<br><b>Differential: callus</b> (larger, irregular, painless, no core) and <b>verruca vulgaris</b> (interrupts skin lines, blackened center, hurts on <em>side</em> pressure, not confined to pressure areas).",
 ...
 ("l7_s006_1.png", "Callus",
  ...
  "<b>Clinical diagnosis.</b><br>The three-way differential is corn (cored, tender, small), callus (diffuse, painless, large) and wart (skin lines interrupted, blackened center).",
 ...
 ("l7_s025_1.png", "Cutaneous horn",
  ...
  "<b>Depends entirely on the underlying etiology.</b> An underlying malignancy frequently requires <b>excision to the standard practice for that tumor type and location</b>. Removing the horn alone treats nothing.",
 ...
 ("l7_s029_1.png", "Acrochordon (skin tag)",
  "A <b>fibroepithelial pedunculated papilloma</b> &mdash; a <b>narrow stalk with a broad tip</b>. Soft, skin-colored papules from about <b>1&nbsp;mm to 10&nbsp;mm</b>. Asymptomatic. Increased in <b>females and obese patients</b>, in <b>areas of friction</b> &mdash; neck, axilla, groin. Very common: present in <b>60% of people by age 70</b>.<br><span class=pt>&ldquo;I've got these little flaps of skin under my arms and they catch on my clothes.&rdquo;</span>",
 ...
 ("l7_s033_1.png", "Pressure injury (pressure ulcer)",
  "<b>Unrelieved pressure</b> damaging underlying tissue, generally soft tissue compressed <b>between a bony prominence and an external surface</b> for a prolonged time. Extent ranges from non-blanchable intact skin to deep ulcers reaching bone.<br><b>STAGING (from the slide's images):</b><br><b>1</b> &mdash; localized <b>non-blanchable erythema of intact skin</b>.<br><b>2</b> &mdash; <b>partial-thickness</b> loss with <b>exposed dermis</b>; bed viable, pink/red, moist, shiny or dry.<br><b>3</b> &mdash; <b>full thickness</b>; <b>adipose tissue visible</b>.<br><b>4</b> &mdash; full thickness skin AND tissue loss; <b>fascia, muscle, tendon, ligament, cartilage or bone exposed</b>.<br><b>Unstageable</b> &mdash; obscured by <b>slough or eschar</b>, extent cannot be determined.<br><b>Deep tissue</b> &mdash; persistent <b>non-blanchable deep red/purple discoloration</b>; skin intact or not.",
 ...
 ("l7_s045_1.png", "Dermatofibroma",
  ...
  "Benign. The dimple sign is what distinguishes it from the pigmented lesions it can resemble. Return if it changes in size, color or shape."),
 ...
 ("l7_s092_1.png", "Pyogenic granuloma",
  "<b>Acquired vascular lesion &mdash; MISNAMED: neither infectious nor granulomatous.</b> Exact cause unknown; a response to <b>injury or hormonal factors</b>. Common in <b>children, young adults and pregnancy</b>. A benign vascular tumor of skin and mucous membrane appearing as a <b>rapidly growing vascular papule or nodule</b>, from overgrowth of blood vessels in response to <b>irritation, trauma or hormonal change</b>. Most common on <b>head, neck and fingers</b>. <b>Bright red exophytic papule or nodule with a MOIST surface and an EPITHELIAL COLLARETTE at the base.</b> Bleeding, erosion, ulceration, purulence and crusting all possible. Average <b>6.5&nbsp;mm</b>; may reach several centimeters.<br><span class=pt>&ldquo;It came up really fast after I cut my finger, and it bleeds every time I knock it.&rdquo;</span>",
 ...
 ("l7_s100_1.jpg", "Neurofibromatosis type 1",
  "Also <b>von Recklinghausen disease</b>. A common <b>neurocutaneous genetic disorder</b> causing tumors to form on nerve tissue. <b>NF1: NF1 gene, chromosome 17. NF2: NF2 gene, chromosome 22. Schwannomatosis (NF3): SMARCB1 and LZTR1, chromosome 22.</b><br><b>NF1 skin manifestations, all four:</b><br><b>Caf&eacute; au lait spots</b> &mdash; light tan to brown macules, <b>&gt;5&nbsp;mm prepubertal, &gt;15&nbsp;mm postpubertal</b>; often the first manifestation; usually present at birth or in the first year; grow in proportion with the child. <b>Six or more are diagnostic &mdash; but the macules alone do not establish the diagnosis.</b><br><b>Cutaneous neurofibromas</b> &mdash; benign nerve sheath tumors from peripheral nerves; well-circumscribed, sessile or pedunculated; protrude just above the skin or lie just under it with a violaceous hue; <b>begin at puberty and increase in number and size with age</b>; a few to hundreds.<br><b>Plexiform neurofibromas</b> &mdash; tumor in the tissue covering nerves; anywhere except brain and spinal cord; large and extensive; may be locally invasive.<br><b>Intertriginous freckling (Crowe's sign)</b> &mdash; freckles <b>&lt;5&nbsp;mm</b>, smaller than caf&eacute; au lait spots, grouped, more prominent with sun exposure; <b>axillary and inguinal</b> (may be seen under the breasts, but that site is not a diagnostic criterion).",
  "<b>Clinical diagnosis</b> on the recognized criteria. Six or more caf&eacute; au lait macules of the size threshold, plus the other features.",
