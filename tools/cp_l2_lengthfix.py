...
FIXES = {
 ...
 14: (1, "Size — a macule is greater than 5 millimeters and a patch is up to 5 millimeters — and both of them are readily palpable on examination"),
 ...
 19: (1, "A vesicle is greater than 5 millimeters and a bulla is up to 5 millimeters in diameter, and the two share an identical mechanism of fluid accumulation entirely within the epidermis rather than beneath it"),
 ...
 32: (2, "Type I collagen laid down in parallel bundles, over days 21 to one year of remodeling"),
 ...
 35: (2, "The inflammatory phase never resolves, so granulation tissue never forms at all and the wound remains open indefinitely without ever progressing to the proliferative or remodeling phases that normally follow"),
 ...
 39: (1, "Permanent dilatation of the superficial dermal vessels, measuring 1 to 2 millimeters across the surface of the skin"),
 ...
 62: (1, "The tp53 tumor suppressor pathway, acting in the differentiated keratinocytes of the epidermis"),
 ...
 65: (1, "Vertical growth down into the dermis first, then radial spread within the epidermis afterwards once the tumor has thickened sufficiently to invade"),
