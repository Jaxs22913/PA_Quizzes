...
asking anyone to memorize ranges and that any range needed will be supplied, so
...
DECK = dict(
  ...
  ["Pale yellow, almost colorless urine suggests what?", "Dilute urine."],
  ...
  ["What should you tell a patient starting a medication that discolors urine?", "Warn them in advance so the color does not alarm them."],
  ["What is the transparency scale?", "Clear, then hazy, then cloudy, then turbid."],
  ["Foamy urine points to what?", "Protein."],
  ["What is the normal odor of urine called?", "Aromatic."],
  ["An ammonia odor means what?", "The sample stood long enough for bacteria to decompose its urea."],
  ["How should a specimen be held if it cannot be read within one to two hours?", "Refrigerated, with no preservative added."],
  ["A fecal odor in urine suggests what?", "An enterovesical fistula."],
  ["A fruity or sweet odor points to what?", "Ketones."],
  ...
  ["How are uric acid stones managed?", "Alkalinize the urine."],
  ...
  ["What does ketonuria indicate?", "Cells are metabolizing fatty acids instead of glucose."],
  ...
  ["Name causes of hematuria.", "Infection, inflammation, trauma, tumor, calculus, over-aggressive anticoagulation."],
  ...
  ["When are bacteria in urine likely significant?", "From straight catheterization, or with raised white cells and a positive leukocyte esterase."],
  ["More than twenty squamous epithelial cells per high power field means what?", "The specimen is likely contaminated."],
  ["Bacteria from a longstanding indwelling catheter usually mean what?", "Colonization rather than acute infection."],
  ...
  ["Foamy urine", "Protein"],
  ["Ammonia odor", "Sample stood; urea decomposed"],
