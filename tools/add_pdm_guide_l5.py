...
TY = """    "chemistry-panels": [
      ...
      {q:"A urea nitrogen to creatinine ratio above 20 to 1 points to which kind of cause?",
       ...
       why:"A urea nitrogen to creatinine ratio above 20 to 1 suggests a prerenal cause, such as hypovolemia or poor perfusion."},
      {q:"In an elderly or cachectic patient, a normal creatinine can mask a reduction in which value?",
