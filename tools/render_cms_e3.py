...
SPEC = {
 ...
 "l18io": dict(sets="cms_e3l18_sets.json",
   files=["neck-masses-neoplasms-quiz.html", "neck-masses-neoplasms-quiz-version-2.html"],
   title="Neck Masses and Neoplasms Quiz %d — CMS I Exam 3",
   h1="Neoplasms and Neck Masses &mdash; Quiz %d",
   sub="Clinical Medicine and Surgery I &middot; Exam 3 &middot; Lecture 18",
   chips=["Neck triangles", "Lymphatic drainage", "Congenital masses",
          "Inflammatory masses", "Thyroid cancer"]),
 "l18vig": dict(sets="cms_e3l18_vig_sets.json",
   files=["neck-masses-neoplasms-vignettes.html",
          "neck-masses-neoplasms-vignettes-version-2.html"],
   title="Neck Masses and Neoplasms Vignettes %d — CMS I Exam 3",
   h1="Neoplasms and Neck Masses &mdash; Vignettes %d",
   sub="Clinical Medicine and Surgery I &middot; Exam 3 &middot; Lecture 18",
   chips=["Midline vs lateral", "Red flags", "Fine needle aspiration",
          "Thyroid nodules", "Lymphadenopathy"]),
 "l19io": dict(sets="cms_e3l19_sets.json",
   files=["oral-cavity-salivary-quiz.html", "oral-cavity-salivary-quiz-version-2.html"],
   title="Oral Cavity and Salivary Glands Quiz %d — CMS I Exam 3",
   h1="Oral Cavity, Salivary Glands and Neck &mdash; Quiz %d",
   sub="Clinical Medicine and Surgery I &middot; Exam 3 &middot; Lecture 19",
   chips=["Oral ulcers", "Salivary glands", "Vocal cords",
          "Pharyngitis", "Deep neck infection"]),
 "l19vig": dict(sets="cms_e3l19_vig_sets.json",
   files=["oral-cavity-salivary-vignettes.html",
          "oral-cavity-salivary-vignettes-version-2.html"],
   title="Oral Cavity and Salivary Glands Vignettes %d — CMS I Exam 3",
   h1="Oral Cavity, Salivary Glands and Neck &mdash; Vignettes %d",
   sub="Clinical Medicine and Surgery I &middot; Exam 3 &middot; Lecture 19",
   chips=["The scrape test", "Epiglottitis", "Peritonsillar abscess",
          "Ludwig angina", "Oral cancer"]),
