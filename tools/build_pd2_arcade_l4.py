...
DECK = dict(
  ...
  ["What is the Weber test for?", "Evaluating UNILATERAL hearing loss, by which way the sound lateralizes."],
  ["What is a normal Weber result?", "Midline, or heard equally in both ears."],
  ["Which way does Weber lateralize in CONDUCTIVE loss?", "To the IMPAIRED ear."],
  ...
  ["Which way does Weber lateralize in SENSORINEURAL loss?", "To the GOOD ear."],
  ...
  ["Rinne on the right is normal and Weber lateralizes right. Which ear has sensorineural loss?", "The LEFT. A normal Rinne rules out conductive loss on the right, and Weber goes away from a sensorineural lesion."],
  ...
  ["Name the conductive causes of hearing loss.", "Cerumen, foreign bodies, effusions, exostoses and osteomas, tumors, and tympanic membrane perforation."],
  ...
  ["Name the causes of central vertigo.", "Brainstem lesion, atherosclerosis, multiple sclerosis, vertebrobasilar migraine and transient ischemic attack."],
  ...
  ["What is bullous myringitis?", "Painful hemorrhagic vesicles on the tympanic membrane or canal. It may be viral or bacterial."],
  ...
  ["What does UNILATERAL nasal obstruction suggest?", "A foreign body, a tumor, or a deviated septum."],
  ...
  ["Is the COLOR of nasal discharge diagnostic?", "No. Purulent discharge is suggestive, but color settles nothing."],
  ["Under what duration is acute BACTERIAL sinusitis unlikely?", "Less than seven days."],
  ["How does a septal hematoma form?", "Injury disrupts the vessels and pulls the lining away from the cartilage, so blood collects between the two."],
  ["Why does a septal hematoma need URGENT drainage?", "To prevent necrosis of the septal cartilage, which has no blood supply of its own and depends on the lining that was stripped away."],
  # --- oral ---
  ...
  ["What does a Centor score of zero or less mean?", "A one to two and a half percent risk, and no further testing or antibiotics indicated."],
  ["What does a Centor score of four or more mean?", "A fifty-one to fifty-three percent risk, where empiric treatment is considered."],
  ["The uvula deviates to one side and the palate fails to rise. Which nerve?", "Cranial nerve X — and the uvula deviates AWAY from the paralyzed side."],
  ...
  ["What does GENERALIZED lymphadenopathy raise?", "Human immunodeficiency virus, Epstein-Barr virus, lymphoma, leukemia and sarcoidosis."],
  ...
  ["What is endemic goiter associated with?", "Iodine deficiency."],
  ...
  ["A sudden, severe headache raises what?", "Subarachnoid hemorrhage."],
  ...
  ["An abnormally enlarged head raises which two conditions?", "Hydrocephalus and Paget disease."],
    ...
    matchCards=[
  ["Weber in conductive loss", "Lateralizes to the IMPAIRED ear"],
  ["Weber in sensorineural loss", "Lateralizes to the GOOD ear"],
  ...
  ["Bullous myringitis", "Painful hemorrhagic vesicles on the drum"],
  ["Viral rhinitis", "Mucosa red and swollen"],
  ["Allergic rhinitis", "Mucosa pale, bluish or red"],
  ["Septal hematoma", "Urgent drainage or the cartilage necroses"],
  ...
  ["Subarachnoid hemorrhage", "Sudden and severe headache"],
    ])
