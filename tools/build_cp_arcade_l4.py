...
DECK = dict(
  ...
  ["What share of refraction depends on the cornea?", "About seventy percent."],
  ...
  ["Where is aqueous humor produced?", "By the non-pigmented epithelium of the ciliary body, into the posterior chamber."],
  ...
  ["How does a cataract present?", "Gradual, painless, bilateral blurring with glare around headlights at night, monocular diplopia and altered color perception."],
  ...
  ["WET macular degeneration: what is the mechanism?", "Hypoxia and inflammation trigger choroidal neovascularization beneath the pigment epithelium into the subretinal space."],
  ["What share of severe blindness does wet macular degeneration cause?", "About ninety percent."],
  ["What is known about the pathogenesis of macular degeneration?", "It is unknown, for both forms."],
  ...
  ["What initiates the diabetic retinopathy cascade?", "Chronic hyperglycemia damages capillaries and endothelial basement membranes, causing occlusion and hypoxia."],
  ["What drives non-proliferative to proliferative retinopathy?", "Severe ischemia upregulates vascular endothelial growth factor, producing neovascularization."],
  ["Where do hard exudates sit and what are they?", "Lipid deposits in the outer plexiform layer."],
  ["Where do cotton-wool spots sit and what are they?", "Nerve fiber layer ischemia or infarction."],
  ["Which retinal fibers cross at the chiasm?", "The NASAL fibers — and they carry the TEMPORAL visual fields."],
  ...
  ["What damages the optic nerve to cause monocular blindness?", "Trauma, optic neuritis or ischemic optic neuropathy."],
  ...
  ["What causes a subconjunctival hemorrhage?", "Rupture of delicate episcleral or conjunctival capillaries beneath the conjunctiva."],
  ...
  ["Wet macular degeneration", "Choroidal neovascularization; ~90% of blindness"],
  ...
  ["Cotton-wool spots", "Nerve fiber layer ischemia"],
    ])
