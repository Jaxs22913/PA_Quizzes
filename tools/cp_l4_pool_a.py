...
POOL_A = [
 ...
 dict(topic="Unique features of the eye", io=IO1, slot="etiology",
   ...
   opts=[
     ["About seventy percent of refraction depends on it",
      "Correct — the greatest change in refractive index in the whole eye occurs at the air-to-cornea interface, so the cornea supplies around seventy percent of total refraction."],
     ["About thirty percent of refraction depends on it",
      "Thirty percent understates it; the air-to-cornea interface provides about seventy percent of the eye's refractive power."],
 ...
 dict(topic="Unique features of the eye", io=IO1, slot="etiology",
   ...
   opts=[
     ["About eighty-three percent", "Correct — around eighty-three percent of what people learn arrives visually, which is why visual loss is so disabling."],
     ["About fifty percent", "Half understates the visual share, which is estimated at around eighty-three percent."],
     ["About sixty-five percent", "Sixty-five percent is short of the estimate, which is around eighty-three percent."],
     ["About ninety-five percent", "Ninety-five percent overstates it; the estimate is around eighty-three percent."]],
   c=0, cite=c(4)),
