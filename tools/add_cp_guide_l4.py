...
TESTS = """    ophthalmic: [
      {q:"What is the pathophysiological explanation for vision loss in glaucoma?",
       ...
       why:"Elevated intraocular pressure compresses retinal ganglion cell axons, the ganglion cells undergo apoptosis, and the optic disc cups progressively (cup-to-disc ratio above 0.5)."},
      {q:"Which globe geometry and focal point define myopia?",
      ...
      {q:"Which visual field defect does a central optic chiasm lesion produce?",
       ...
       why:"A central chiasm lesion cuts the crossing nasal retinal fibers, which carry the temporal visual fields, giving bitemporal hemianopsia; pituitary adenoma compression is the typical cause."},
      {q:"Which three of the visual field lesion sites lie between the globe and the lateral geniculate nucleus?",
       ...
       why:"The optic nerve, optic chiasm and optic tract all come before the lateral geniculate nucleus; the optic radiations and occipital cortex lie beyond it, on the route to the primary visual cortex."},
      {q:"Why does presbyopia stop accommodation?",
       ...
       why:"Presbyopia is loss of lens elasticity and ciliary muscle accommodation due to sclerosis, so near objects can no longer be brought into focus."},
