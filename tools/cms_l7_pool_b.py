...
POOL_B = [
 ...
 dict(topic="Cutaneous horn", io=IOA, slot="gold standard",
   ...
   opts=[
     ...
     ["Clinically, because the shape of the horn indicates the underlying process",
      "The horn is compacted keratin and its shape says nothing about what lies beneath, which may be benign, premalignant or malignant; only biopsy of the base distinguishes them."],
 ...
 dict(topic="Cutaneous horn", io=IOA, slot="first-line",
   ...
   opts=[
     ["The underlying etiology, with excision to the standard for the tumor type and location if malignant",
      "Correct — you treat what is at the base, not the horn."],
     ["The height of the horn itself, with excision reserved for any projection measuring over one centimeter",
 ...
 dict(topic="Acrochordon", io=IOA, slot="etiology",
   ...
   opts=[
     ...
     ["A localized overgrowth of fat cells within the subcutaneous tissue",
      "That is a lipoma."]],
   c=0, cite=c(29)),
 ...
 dict(topic="Acrochordon", io=IOA, slot="epidemiology",
   ...
   opts=[
     ["Increased in females and obese patients, in areas of friction such as the neck, axilla and groin; present in sixty percent of people by age seventy",
 ...
 dict(topic="Acrochordon", io=IOA, slot="manifestation",
   ...
   opts=[
     ["Soft pedunculated skin-colored papules on a thin stalk, ranging from about one millimeter up to ten millimeters",
      "Correct — and the history is that they are asymptomatic."],
     ["Firm brown nodules half a centimeter to one centimeter across, with a pink hue and a scaly surface",
      "That is the dermatofibroma."],
     ["Whitish-yellow soft papules two to nine millimeters across, with a central umbilication",
      "That is sebaceous hyperplasia."],
     ["Smooth firm deep-red papules under five millimeters across, which blanch with pressure",
 ...
 dict(topic="Acrochordon", io=IOA, slot="first-line",
   ...
   opts=[
     ...
     ["Elliptical excision with five-millimeter margins; local anesthesia is required",
 ...
 dict(topic="Pressure injury", io=IOA, slot="manifestation",
   ...
   opts=[
     ["A localized area of non-blanchable erythema of intact skin",
     ...
     ["Full thickness skin loss with adipose tissue visible in the wound bed",
      "That is stage 3."],
     ["Persistent non-blanchable deep red or purple discoloration, with skin intact or not",
 ...
 dict(topic="Pressure injury", io=IOA, slot="manifestation",
   ...
   opts=[
     ...
     ["A localized area of non-blanchable erythema over completely intact skin, with no loss of epidermis anywhere in it",
 ...
 dict(topic="Pressure injury", io=IOA, slot="differential",
   ...
   opts=[
     ...
     ["Stage 3 is wholly covered by slough or eschar; stage 4 is a persistent deep red or purple discoloration of intact skin",
 ...
 dict(topic="Pressure injury", io=IOA, slot="manifestation",
   ...
   opts=[
     ...
     ["Persistent non-blanchable deep red or purple discoloration of skin that may be either intact or non-intact",
      "That is a deep tissue pressure injury, a separate category."],
     ["A localized area of non-blanchable erythema over skin that is otherwise entirely intact and undamaged",
      "That is stage 1."]],
   c=0, cite=c(34)),
 ...
 dict(topic="Pressure injury", io=IOA, slot="manifestation",
   ...
   opts=[
     ["Persistent non-blanchable deep red or purple discoloration; the skin can be intact or non-intact",
      "Correct — the color is the finding, and intact skin does not exclude it."],
     ["Obscured full thickness loss whose extent cannot be determined because of slough or eschar",
      "That is unstageable."],
     ["A localized area of non-blanchable erythema of intact skin, without discoloration in depth",
 ...
 dict(topic="Pressure injury", io=IOB, slot="education",
   q="What is the best measure against pressure injury, and what does it include?",
   opts=[
     ...
     ["Occlusive dressings: silicone gel sheeting worn twelve to twenty-four hours a day over every bony prominence at risk",
      "Silicone sheeting treats scars, not pressure injury."]],
   c=0, cite=c(35)),
 ...
 dict(topic="Pressure injury", io=IOA, slot="referral",
   ...
   opts=[
     ...
     ["A vascular anomalies specialist, and pediatrics for growth monitoring",
 ...
 dict(topic="Pressure injury", io=IOA, slot="agent/regimen",
   ...
   opts=[
     ...
     ["Wet-to-dry gauze changed three times daily",
      "Wet-to-dry gauze debrides non-selectively and damages new granulation tissue with each change, which is why moisture-retentive dressings are used instead."],
     ["Silver sulfadiazine cream under an occlusive film",
      "No topical antimicrobial is specified here."],
     ["Compression bandaging at twenty-five millimeters of mercury",
 ...
 dict(topic="Pilonidal cyst", io=IOA, slot="etiology",
   ...
   opts=[
     ...
     ["Soft tissue compressed between a bony prominence and an external surface for a prolonged period, with unrelieved pressure damaging the tissue beneath",
      "That is a pressure injury, which also favors the sacrum."],
