...
VIG_B = [
 dict(topic="Malignant melanoma", io=IOA, lead="diagnosis",
   ...
   opts=[
     ["Asymmetry, border irregularity, color variegation, diameter over 6 mm, and evolution — all five",
      "Correct — every element of the mnemonic is present."],
     ["Asymmetry, border irregularity and color variegation only, since 8 mm is below the diameter threshold",
      "The threshold is 6 mm, so 8 mm exceeds it."],
     ["Border irregularity and evolution only, since color variation within a lesion is a benign feature",
      "Color variegation is one of the criteria."],
 ...
 dict(topic="Malignant melanoma", io=IOA, lead="test",
   q="A melanoma is excised and reported at 1.3 mm Breslow thickness with no ulceration. What is the position on sentinel lymph node biopsy here, and what should the patient be told it achieves?",
   opts=[
 ...
 dict(topic="Malignant melanoma", io=IOA, lead="treatment",
   q="A 55-year-old man has a melanoma in situ confirmed on his forearm. Which re-excision margin applies?",
   opts=[
     ...
     ["3 to 5 cm", "Far wider than any margin used for melanoma in situ."]],
   c=0, cite=c(52)),
 ...
 dict(topic="Malignant melanoma", io=IOA, lead="treatment",
   ...
   opts=[
     ["A 1 to 2 cm margin, and referral to an expert center because the lesion is deeper than 1 mm",
      "Correct — the same threshold governs both."],
     ["A 1 cm margin, and referral to an expert center because the lesion is deeper than 1 mm",
      "A 1 cm margin applies to lesions under 1 mm."],
     ["A 0.5 to 1 cm margin, and routine dermatology follow-up without expert-center referral",
 ...
 dict(topic="Malignant melanoma", io=IOA, lead="education",
   ...
   opts=[
     ...
     ["Annual self-examination using the recognition mnemonic and ugly-duckling principles, since more frequent checking causes anxiety",
      "Self-examination should be monthly, not annual."],
 ...
 dict(topic="Malignant melanoma", io=IOA, lead="diagnosis",
   ...
   opts=[
     ...
     ["None of them; the anatomic site of the primary is the dominant prognostic variable",
      "Site contributes, but depth of invasion dominates because it determines access to lymphatics and vessels; Breslow thickness is the dominant variable."]],
   c=0, cite=c(55)),
 ...
 dict(topic="Malignant melanoma", io=IOB, lead="next step",
   ...
   opts=[
     ["Refer to an expert center, since nodal spread is an explicit referral trigger and coordinated dermatology and surgical oncology care is warranted",
     ...
     ["Repeat the sentinel node biopsy to confirm the finding before any referral to an expert center is made",
 ...
 dict(topic="Malignant melanoma", io=IOB, lead="education",
   q="A 30-year-old Black patient asks whether she needs to worry about melanoma. What is the most accurate response?",
   opts=[
     ["Lifetime risk is lower but not zero — about 0.1 to 0.5% in persons of color against about 2% in white individuals",
      "Correct — lower risk, and acral and nail sites still need checking."],
     ["Lifetime risk is effectively zero in persons of color, so routine skin checks are unnecessary",
      "The risk is lower but real."],
     ["Lifetime risk is the same in all skin tones, at about 2%",
      "Lifetime risk differs markedly between skin tones."],
     ["Lifetime risk is higher in persons of color, at about 2% against 0.1 to 0.5% in white individuals",
