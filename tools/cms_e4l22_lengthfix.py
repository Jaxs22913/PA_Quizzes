#!/usr/bin/env python3
"""Lecture 22 length fixes -- and a standalone before/after report.

    python3 cms_e4l22_lengthfix.py          # per-pool gameable%, raw and fixed
...
if __name__ == "__main__":
    mods = sorted(os.path.basename(p)[:-3] for pat in ("cms_e4l22_pool_*.py", "cms_e4l22_vig_*.py")
