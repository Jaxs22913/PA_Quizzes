...
dict(topic="General Microbiology", io="1.6 — The bacterial growth curve",
  ...
  opts=[["Death phase", "The survivors in death phase are typically the most resistant members of the population."],
        ["Lag phase", "In lag phase the cells are synthesising enzymes but not yet dividing, so the usual drug targets are not active."],
...
dict(topic="General Microbiology", io="1.7 — Lytic versus lysogenic replication",
  ...
  opts=[["Loss of its plasmids", "Lysogeny adds genetic material rather than removing it; plasmids are unaffected by prophage integration."],
        ["Immediate lysis of neighbouring cells", "Lysis of the host is the lytic outcome; lysogeny is defined by the genome integrating quietly instead."],
...
dict(topic="Antibiotics and Resistance", io="2.8 — Other problems with antimicrobial therapy",
  q="A patient develops profuse diarrhoea after a broad-spectrum antibiotic course. What has occurred?",
...
dict(topic="Antibiotics and Resistance", io="2.1 — Major historical events and names",
  q="Who first observed the inhibition of bacterial growth by a contaminating mould?",
  opts=[["Fleming", "Correct. He noticed the zone of inhibition around the mould on a culture plate, which is the observation that opened the way to penicillin."],
...
dict(topic="Microbe-Human Interactions", io="1 — Define resident flora",
  ...
  opts=[["When it is exposed to an antibiotic", "Antibiotic exposure may select it but the disease still requires compromised defences or an unnatural site."],
        ...
        ["When host defences are compromised", "Correct. An organism that is harmless as resident flora becomes pathogenic once the defences holding it in check fail, or once it reaches a site it does not belong in."]],
...
dict(topic="Nonspecific Host Defenses", io="3.2 — First line barriers",
  ...
  opts=[["Chemical", "A chemical barrier is a substance such as lysozyme or gastric acid rather than a population of organisms."],
        ...
        ["Genetic", "The genetic barrier refers to inherited resistance rather than colonisation."]],
...
dict(topic="Nonspecific Host Defenses", io="3.3 — Recognition: receptors and patterns",
  ...
  opts=[["A conserved microbial structure", "Correct. Because these structures are shared across whole classes of organism and absent from us, a small set of receptors can detect almost any invader."],
        ...
        ["A specific antigen unique to one organism", "Recognising a unique antigen is the job of the adaptive system rather than these receptors."],
...
dict(topic="Nonspecific Host Defenses", io="3.3 — Recognition: receptors and patterns",
  ...
  opts=[["Successful clearance of an infection", "These patterns initiate a response rather than signalling its resolution."],
        ...
        ["Antibody production by plasma cells", "Antibody belongs to the specific response and is unrelated to damage signalling."]],
...
dict(topic="Nonspecific Host Defenses", io="3.4 — The leukocytes",
  ...
  opts=[["Antibody production", "Antibody is secreted by plasma cells derived from B lymphocytes."],
        ...
        ["Defence against parasites", "Correct. Its granules carry proteins toxic to organisms far too large to phagocytose, particularly helminths, which are released into the surrounding space."]],
  c=3, cite=L5 + ", Slides 66-70"),

dict(topic="Nonspecific Host Defenses", io="3.4 — The leukocytes",
  q="What is the basophil's principal role?",
  opts=[["Defence against helminths", "Antiparasitic defence is the eosinophil's role; the basophil releases histamine and related mediators."],
...
dict(topic="Nonspecific Host Defenses", io="3.7 — Inflammation",
  ...
  opts=[["Vasoconstriction concentrating blood in the area", "Constriction would reduce flow, leaving the area paler and cooler rather than red and warm."],
        ["Vasodilation increasing blood flow to the area", "Correct. Widening the supplying arterioles brings more warm blood into the injured region, which accounts for both the colour and the temperature."],
...
dict(topic="Nonspecific Host Defenses", io="3.8 — Fever",
  ...
  opts=[["It kills all pathogens outright", "Fever inhibits growth rather than sterilising; it does not eliminate the organism by itself."],
