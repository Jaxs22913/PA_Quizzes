...
ROWS_L16 = [
 ("Conductive hearing loss", PATTERN,
  "<b>Weber lateralizes TO the bad ear</b> &middot; <b>BC &ge; AC</b> &middot; hearing better in noise",
  ...
  "<b>Weber lateralizes to the impaired ear.</b> <b>Rinne: BC = AC or BC &gt; AC.</b> Audiometry for the degree; tympanometry for the middle ear.",
 ...
 ("Sensorineural hearing loss", PATTERN,
  "<b>Weber lateralizes AWAY to the good ear</b> &middot; <b>AC &gt; BC</b> &middot; <b>worse</b> in noise",
 ...
 ("Presbycusis", PATTERN,
  ...
  "<b>The commonest sensorineural hearing loss.</b> Progressive age-related loss from <b>hair cell loss in the organ of Corti and cochlear nerve degeneration</b>. <b>Bilateral, symmetrical, gradual.</b> <b>High frequencies go first</b>, progressing to mid and low. Patients <b>hear speech but cannot make out the words</b>, miss the doorbell and the phone, may have tinnitus, and <b>lip-read more than they realize</b>. It is common enough that <b>primary care screens everyone aged 65 and over</b> for it as a matter of routine. <i>The prevalence percentages on the slide are explicitly not to be memorized &mdash; &ldquo;you don&rsquo;t have to memorize these statistics&rdquo;.</i>",
 ...
 ("Glomus tumor", MASSL,
  ...
  "<b>Benign but highly vascular</b> tumor derived from the normal glomus formations of the middle ear and jugular bulb. Produces a <b>middle ear mass effect</b>, can present with <b>spontaneous hemorrhage and paralysis of cranial nerves IX, X and XI</b>, and may <b>erode the skull base</b>.",
 ...
 ("Autoimmune sensorineural loss", SNHL,
  "<b>Bilateral, progressive</b>, in periods of deterioration and stabilization",
  "Sensorineural loss that is <b>most often bilateral and progressive</b>, with <b>periods of deterioration and stabilization</b>, and <b>may be accompanied by vestibular dysfunction</b>. Uncommon: <b>Cogan's syndrome, polyarteritis nodosa, relapsing polychondritis, granulomatosis with polyangiitis</b>. Even less common: scleroderma, temporal arteritis, systemic lupus erythematosus, sarcoidosis.",
 ...
 ("Sudden sensorineural hearing loss", SNHL,
  ...
  "<b>Unilateral.</b> Described explicitly as <b>a syndrome, not a disease</b>. <b>Viral or vascular</b> etiology; <b>rarely retrocochlear pathology &mdash; horses not zebras</b>. <b>The exact cause is rarely certain.</b>",
 ...
 ("Benign paroxysmal positional vertigo", INNER,
  ...
  "<b>Diagnosed by the classic eye movements on the Dix-Hallpike maneuver</b> plus a suggestive history. <b>Most cases have no identifiable etiology</b>; <b>canalithiasis of the posterior semicircular canal</b> is thought to be the commonest cause.",
  "<b>The Epley maneuver</b>, which repositions the otoliths in the semicircular canal.",
  "Routine",
 ...
 ("Acoustic neuroma", CENTRAL,
  ...
  "<b>Benign tumor of cranial nerve VIII</b>, <b>rare</b>, and <b>most often unilateral</b>. Symptoms: <b>unilateral hearing loss, which may be sudden</b>; <b>poor speech discrimination compared with what the tone loss would predict</b>; often <b>disequilibrium</b>. <b>Progression may not be so &ldquo;benign&rdquo;.</b> May involve cranial nerves V and VII.",
...
DIFF_L16 = {
 ...
 "Glomus tumor": ("No", "<b>Conductive</b>", "<b>Vascular middle ear mass; pulsatile tinnitus</b>"),
...
IMGS_L16 = {
 ...
 "Glomus tumor": ("l16-s051_pos1.jpg", 51),
