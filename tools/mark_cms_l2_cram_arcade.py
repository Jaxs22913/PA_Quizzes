...
ARCADE_CARDS = [
  ...
  ("How does stasis dermatitis erythema appear on darker skin?", "Violaceous, gray or deep brown."),
  ("What should be relied on when erythema is hard to see on darker skin?", "Palpation for warmth and edema, plus distribution and secondary change."),
