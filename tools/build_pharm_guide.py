...
<section class="deck" id="antimicrobials">
  ...
  <table>
    ...
    <tr><td>Azoles (9c)</td><td><strong>Membrane</strong> &mdash; inhibit fungal cytochrome P450 14-alpha-demethylase, blocking lanosterol &rarr; ergosterol</td><td>Fluconazole: best oral absorption, penetrates the central nervous system, cryptococcal meningitis and candidiasis. Voriconazole: systemic aspergillosis, <strong>vision effects in ~30%</strong>, cyclodextrin vehicle accumulates in renal failure. Posaconazole: the <strong>only azole effective against the Zygomycetes</strong>, QT prolongation. Itraconazole: blastomycosis, histoplasmosis, onychomycosis. Ketoconazole: rarely used &mdash; no central nervous system entry, strong cytochrome P450 3A4 inhibition</td></tr>
