...
VIG_B = [
 ...
 dict(topic="Pressure injury", io=IOB, lead="treatment",
   ...
   opts=[
     ["Prevention, which is the best measure",
     ...
     ["Silicone gel sheeting applied over every bony prominence",
      "Silicone gel sheeting treats established scars; pressure injury is prevented by removing the pressure, through repositioning, offloading and skin care."],
