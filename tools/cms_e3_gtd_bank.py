...
ITEMS = [
    ...
    dict(cond="Otitis media with effusion", img="l15-s016_pos2.jpg", slide=16, deck=D15, io=EAR,
         ...
         wrong=[("Acute otitis media", "That drum is red and bulging outward; this one is neither, and you can see through it."),
                ...
                ("Barotrauma", "That drum is haemorrhagic and dark from blood in the middle ear, not clear serous fluid.")]),
    ...
    dict(cond="Cerumen impaction", img="l15-s026_pos2.jpg", slide=26, deck=D15, io=EAR,
         ...
         wrong=[("Foreign body in the ear canal", "That is a discrete object with manufactured edges and colour; this material is the ear's own secretion."),
                ("Otomycosis", "That shows fine filamentous fungal growth with black or white spores, not a solid homogeneous plug."),
                ("Exostoses", "Those are smooth bony swellings of the canal wall, skin-coloured and hard, not occluding debris.")]),
    ...
    dict(cond="Foreign body in the ear canal", img="l15-s049_pos2.jpg", slide=49, deck=D15, io=EAR,
         ...
         why="A smooth, round, manufactured blue object — colour and shape no biological material has.",
         wrong=[("Cerumen impaction", "Wax is brown to black and irregular; nothing the body makes is this colour or this smoothly spherical."),
    ...
    dict(cond="Otitis externa", img="l15-s058_pos2.jpg", slide=58, deck=D15, io=EAR,
         ...
         why="Erythema and oedema of the external canal with visible discharge — the disease is in the canal, not behind the drum.",
         wrong=[("Acute otitis media", "That is a red bulging drum seen through a clear canal; here the canal itself is inflamed."),
                ...
                ("Auricular cellulitis", "That would redden the whole auricle including the lobule; here the change centres on the canal.")]),
    ...
    dict(cond="Necrotizing otitis externa", img="l15-s061_pos1.jpg", slide=61, deck=D15, io=EAR,
         ...
         wrong=[("Otitis externa", "The ordinary form stays in the canal; it does not ulcerate through into the surrounding tissue."),
                ("Auricular haematoma", "That is a smooth purple fluctuant swelling under intact skin, not ulceration."),
                ("Keloid", "That is a firm smooth overgrowth of scar tissue with intact skin over it.")]),

    dict(cond="Auricular haematoma", img="l15-s040_pos1.jpg", slide=40, deck=D15, io=EAR,
    ...
    dict(cond="Auricular laceration", img="l15-s043_pos2.jpg", slide=43, deck=D15, io=EAR,
         ...
         wrong=[("Auricular haematoma", "That is a closed injury; the skin stays intact and the blood collects beneath it."),
    ...
    dict(cond="Keloid", img="l15-s069_pos2.jpg", slide=69, deck=D15, io=EAR,
         ...
         wrong=[("Auricular haematoma", "That is a fluctuant collection of blood appearing within hours of blunt trauma, not firm scar."),
    ...
    dict(cond="Exostoses", img="l16-s049_pos2.jpg", slide=49, deck=D16, io=EAR,
         alt="Otoscopic view of the canal narrowed by several smooth skin-covered bony swellings, labelled with the letter e, around a central tympanic membrane labelled tm",
         ...
         wrong=[("Cerumen impaction", "That is soft brown occluding debris; these swellings are part of the canal wall itself."),
                ("Otitis externa", "That canal is red and oedematous with discharge; this one is pale and structurally narrowed."),
    ...
    dict(cond="Barotrauma", img="l16-s059_pos1.jpg", slide=59, deck=D16, io=EAR,
         ...
         why="Blood in the middle ear behind an intact drum, giving it the dark blue colour — the haemotympanum that follows unequalized pressure.",
         wrong=[("Acute otitis media", "That drum is red and bulging with pus behind it; this one is blue-black with blood."),
                ("Glomus tumour", "That is a discrete red vascular mass, not uniform discolouration of the whole drum."),
                ("Otitis media with effusion", "That fluid is clear or amber with visible bubbles, not blood.")]),

    # --------------------------------------------------------------- nose
    dict(cond="Septal haematoma", img="l17-s042_pos2.jpg", slide=42, deck=D17, io=NOSE,
    ...
    dict(cond="Septal perforation", img="l17-s038_pos1.jpg", slide=38, deck=D17, io=NOSE,
         ...
         wrong=[("Septal haematoma", "That bulges into the airway from the septum; this one is an absence of septum."),
    ...
    dict(cond="Epistaxis", img="l17-s044_pos2.jpg", slide=44, deck=D17, io=NOSE,
         ...
         wrong=[("Nasal fracture", "That shows deviation, swelling and periorbital bruising; bleeding alone does not make a fracture."),
                ("Septal haematoma", "That is a swelling inside the nose seen on examination, not blood running out of it."),
    ...
    dict(cond="Nasal fracture", img="l17-s058_pos3.jpg", slide=58, deck=D17, io=NOSE,
         ...
         wrong=[("Epistaxis", "Bleeding on its own says nothing about the bones; here the bridge is visibly displaced."),
                ("Septal haematoma", "That is an internal finding seen on examination; it does not deviate the external nose."),
    ...
    dict(cond="Leukoedema", img="l19-s009_pos1.jpg", slide=9, deck=D19, io=ORAL,
         alt="Buccal mucosa with a diffuse greyish-white translucent film and faint surface wrinkling, fading toward the commissure",
         why="A diffuse, greyish-white, semitransparent change of the buccal mucosa — a normal variant, not a discrete lesion.",
    ...
    dict(cond="Fordyce granules", img="l19-s010_pos2.jpg", slide=10, deck=D19, io=ORAL,
         ...
         why="Multiple small, discrete, white to yellow papules a millimetre or two across — ectopic sebaceous glands.",
         wrong=[("Oral candidiasis", "Those are confluent creamy plaques on red mucosa, and they can be scraped off."),
                ("Aphthous stomatitis", "Those are painful ulcers with a yellow-grey base and a red rim, not intact papules."),
    ...
    dict(cond="Physiologic pigmentation", img="l19-s011_pos2.jpg", slide=11, deck=D19, io=ORAL,
         ...
         wrong=[("Amalgam tattoo", "That is a single localized grey-blue patch next to a restored tooth, not a symmetrical band."),
    ...
    dict(cond="Erythroplakia", img="l19-s135_pos2.jpg", slide=135, deck=D19, io=ORAL,
         ...
         wrong=[("Oral leukoplakia", "That is white; the colour is the whole distinction being drawn here."),
                ("Oral candidiasis", "That is white plaque on red mucosa, and the plaque is the finding rather than the redness."),
                ("Aphthous stomatitis", "That is an ulcer with a yellow-grey base, not an intact red patch.")]),
    ...
    dict(cond="Hairy leukoplakia", img="l19-s136_pos1.jpg", slide=136, deck=D19, io=ORAL,
         ...
         wrong=[("Oral candidiasis", "That is creamy curd-like plaque that can be wiped away, and it favours the dorsum and palate."),
    ...
    dict(cond="Gingivitis", img="l19-s122_pos2.jpg", slide=122, deck=D19, io=ORAL,
         ...
         why="Erythematous and oedematous gingival margins with the teeth still well seated — inflammation without attachment loss.",
    ...
    dict(cond="Infectious mononucleosis", img="l19-s083_pos4.jpg", slide=83, deck=D19, io=THROAT,
         alt="Throat with markedly enlarged tonsils almost meeting in the midline, covered by a thick grey-white membranous exudate",
         why="Tonsils so enlarged that they nearly meet, under a thick grey-white membranous exudate.",
