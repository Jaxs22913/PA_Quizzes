#!/usr/bin/env python3
"""Partition CMS I Lecture 8 Set 1 (Pigmented Skin Lesions) into two 30s.
...
the same compound shape as the answer beside it, and came out at 26% and 0%.

The lecture carries two objectives: the main compare-and-contrast one and care
strategies for adult and elderly populations.
...
from cms_l8_pool_d import POOL_D
from cms_l8_lengthfix import SLOT_FIXES
...
if __name__ == "__main__":
    ...
    json.dump({"set1": s1, "set2": s2},
              open(os.path.join(HERE, "cms_l8_set1.json"), "w"), ensure_ascii=False, indent=1)
    print("wrote cms_l8_set1.json")
