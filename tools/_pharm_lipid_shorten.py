#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Shorten over-long correct answers in the lipid pools (Pharmacology Exam 2).
...
import glob as _g
FILES = ['pharm_lipid_pool_statin.py', 'pharm_lipid_pool_ldl.py', 'pharm_lipid_pool_tg.py']
SEPS = [" — ", "; ", ", and ", ", "]
