...
BLOCK = '''%s
  ...
  <table>
    ...
    <tr><td><em>&ldquo;Contrast media&hellip; They are also radiation. The contrast media itself can also increase cancer risk. <mark class="prof-highlight">It&rsquo;s all carcinogenic.</mark>&rdquo;</em> [27:38]</td><td>She stated the deck&rsquo;s carcinogenicity point flatly and then tied it straight back to the diagnostic approach: &ldquo;that&rsquo;s why one of the questions&hellip; is, can we do this without contrast?&rdquo; Note that iodinated and gadolinium agents are not themselves radioactive; only nuclear medicine tracers such as technetium-99 are.</td></tr>
    <tr><td><em>&ldquo;Neoplastic agents make more blood vessels grow in that site&hellip; they become more vascularized compared to the surrounding tissues. So you inject intravenous contrast, and <mark class="prof-highlight">that tumor&rsquo;s gonna light up when it&rsquo;s malignant.</mark>&rdquo;</em> [1:27:54]</td><td><b>The mechanism the slide only implies.</b> Contrast delineates a neoplastic from a benign mass because malignancy recruits its own vasculature. The same logic explains why an abscess enhances &mdash; inflammation, edema and increased blood flow to the area.</td></tr>
...
CRAM_ROWS = [
 ...
 ("Why contrast shows a malignancy", "Neoplasms GROW THEIR OWN VESSELS and become more vascularized than surrounding tissue, so “that tumor's gonna light up when it's malignant.” Same logic for an abscess: inflammation, edema and increased blood flow."),
 ("Choosing a modality when you are not sure", "Reason from the TISSUE, not from a memorized protocol. BONE → x-ray or CT. SOFT TISSUE → often start with ultrasound."),
