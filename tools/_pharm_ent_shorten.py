#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Shorten over-long correct answers in the four ENT pools.
...
import glob as _g
FILES = ["pharm_ent_pool_anti.py", "pharm_ent_pool_inflam.py",
         "pharm_ent_pool_hist.py", "pharm_ent_pool_cough.py"]
SEPS = [" — ", "; ", ", and ", ", "]
