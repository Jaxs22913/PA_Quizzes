...
<section class="deck" id="transmission">
  ...
  <button type="button" class="test-yourself-btn" onclick="window.openTestYourself('Test yourself &mdash; Transmission of Microorganisms', TEST_YOURSELF.transmission)">Test yourself! &rarr;</button>
</section>"""
...
TEST = """    transmission: [
      ...
      {q:"Which zoonosis spreads from a mammal reservoir by bite or saliva, and only rarely from human to human, through organ transplantation?",
       ...
       why:"Rabies spreads from mammals by bite or saliva and only rarely between humans, by organ transplantation; malaria spreads by mosquito bite and never person to person."},
      {q:"What did the birthday-cake authors NOT do?",
       ...
       why:"The authors reported plate counts as colony-forming units but never identified the bacteria they cultured, though they mentioned several pathogenic genera."},
