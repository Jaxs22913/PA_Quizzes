...
FILES = [("set1", "dermatology-medications-quiz.html"),
         ("set2", "dermatology-medications-quiz-version-2.html")]
guard([(os.path.join(OUT, f), SETS[k]) for k, f in FILES], force="--force" in sys.argv)
