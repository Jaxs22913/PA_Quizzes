...
QUESTIONS = [
 ...
 dict(topic="Weber and Rinne", io=IO_C, lead="diagnostic technique", cite=D % 42,
  ...
  opts=[["Weber to the right; right bone conduction at least equal to air",
         "Correct. A right middle ear effusion is a conductive loss, so Weber lateralizes to it and Rinne becomes abnormal there."],
        ...
        ["No lateralization; air conduction greater than bone bilaterally",
 ...
 dict(topic="Weber and Rinne", io=IO_C, lead="diagnosis", cite=D % 42,
  ...
  opts=[["Acoustic neuroma", "Correct. These findings are sensorineural, and this is a sensorineural cause."],
        ["Cerumen impaction", "That is conductive; Weber would lateralize to the blocked ear."],
 ...
 dict(topic="Weber and Rinne", io=IO_C, lead="diagnostic technique", cite=D % 42,
  ...
  opts=[["Weber to the left; left bone conduction at least equal to air",
        ...
        ["Weber to the right; left bone conduction greater than air",
         "Weber lateralizes toward a conductive loss, not away."],
 ...
 dict(topic="Glomus tumor", io=IO_A, lead="diagnosis", cite=D % 50,
  ...
  opts=[["Glomus tumor", "Correct — a vascular middle ear mass with pulsatile tinnitus."],
