...
POOL_C = [
 ...
 dict(topic="Carcinogenesis", io=IOG,
   ...
   opts=[
     ...
     ["It is always inherited through the germline and never acquired during life",
      "Most cancers arise from damage acquired during life, through chemicals, radiation or microbes; inherited mutation accounts for a minority."],
     ...
     ["It arises only from errors during deoxyribonucleic acid replication",
      "Replication error contributes background mutation, but the named sources are inheritance plus chemical carcinogens, radiation and microbial organisms."]],
   c=0, cite=c(28)),
 ...
 dict(topic="Chemical carcinogens", io=IOH,
   ...
   opts=[
     ...
     ["Nitrosamines, causing gastric and oesophageal cancer",
      "Nitrosamines are associated with cured foods and gastric cancer; tobacco combustion produces polycyclic aromatic hydrocarbons."],
 ...
 dict(topic="Chemical carcinogens", io=IOH,
   ...
   opts=[
     ...
     ["Alkylating agents",
      "Alkylating agents are chemotherapeutic carcinogens associated with secondary leukaemia rather than occupational bladder cancer."],
     ["Asbestos fibres",
      "Asbestos causes mesothelioma and lung cancer through fibre-driven chronic inflammation, not occupational bladder cancer."]],
   c=0, cite=c(31)),
 ...
 dict(topic="Human papillomavirus", io=IOI,
   ...
   opts=[
     ...
     ["Types 1 and 2",
      "Types 1 and 2 cause common cutaneous warts and are not oncogenic; 16 and 18 cause most cervical cancer."],
     ["Types 31 and 33",
      "Types 31 and 33 are high-risk but account for far fewer cases; 16 and 18 cause the majority."]],
   c=0, cite=c(32)),
 ...
 dict(topic="Epstein Barr virus", io=IOI,
   ...
   opts=[
     ...
     ["They clear the virus completely and cannot be reinfected",
      "The virus persists latently for life rather than being cleared; what normal immunity prevents is the immortalised B cells progressing to lymphoma."]],
   c=0, cite=c(33)),
 ...
 dict(topic="Helicobacter pylori", io=IOI,
   ...
   opts=[
     ["A Gram-negative bacterium causing chronic gastritis",
      "Correct — it is the one bacterium among these carcinogens, and it works indirectly: decades of chronic inflammation drive atrophic gastritis and intestinal metaplasia, which is the field from which cancer arises."],
 ...
 dict(topic="Helicobacter pylori", io=IOI,
   ...
   opts=[
     ...
     ["It has no effect on cancer risk once colonization has occurred",
      "Eradication does lower risk, which is itself the evidence that the chronic inflammation rather than the organism's direct effect drives the transformation."],
 ...
 dict(topic="Heredity", io=IOJ,
   ...
   opts=[
     ["p16, also called INK4a",
      "Correct — p16, also called INK4a, normally brakes the cell cycle at the G1 checkpoint, so losing it removes a restraint on melanocyte proliferation."],
 ...
 dict(topic="Heredity", io=IOJ,
   ...
   opts=[
     ["A minority of breast cancer patients",
      "Correct — most breast cancer is sporadic; only a minority carries an inherited BRCA mutation, which is why family history rather than incidence drives testing."],
     ["The majority of breast cancer patients",
      "Most breast cancer is sporadic; inherited BRCA mutations account for a minority of cases."],
 ...
 dict(topic="TNM", io=IOL,
   ...
   opts=[
     ["They are cancer-specific; for some cancers depth of invasion matters more than size",
      "Correct — what T2 means differs by cancer, because what predicts behaviour differs: in some organs it is tumour size, in others how deep the tumour has invaded the wall."],
     ["They are identical across every cancer, which is what makes the system universal",
      "The framework is universal but its definitions are not; what counts as T2 is set separately for each cancer according to what predicts its behaviour."],
