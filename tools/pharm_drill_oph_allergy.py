...
dict(q="Which ophthalmic antihistamine is available over the counter?",
     ...
     wrong=[("Azelastine", "An ophthalmic antihistamine, but not the one marked over the counter."),
            ("Bepotastine", "An ophthalmic antihistamine, prescription."),
            ("Emedastine", "An ophthalmic antihistamine, prescription.")]),
...
dict(q="Which class works within MINUTES and is typically preferred for ocular allergy?",
     ...
     wrong=[("Cromolyn", "A mast cell stabiliser, needing 5 to 14 days and four-times-daily dosing."),
            ("Lodoxamide", "A mast cell stabiliser, same slow onset."),
            ("Nedocromil", "A mast cell stabiliser, same slow onset.")]),
...
dict(q="Which class is NOT useful for acute allergy symptoms?",
     ...
     wrong=[("Ketotifen", "An antihistamine, working within minutes."),
            ("Naphazoline", "A vasoconstrictor, acting quickly."),
            ("Epinastine", "An antihistamine, working within minutes.")]),
...
dict(q="Which glucocorticoid is a SOFT steroid with a lower risk of raising intraocular pressure?",
     ...
     wrong=[("Dexamethasone", "A conventional ophthalmic glucocorticoid."),
            ("Prednisolone", "A conventional ophthalmic glucocorticoid."),
            ("Difluprednate", "A conventional ophthalmic glucocorticoid.")]),
...
dict(q="Which ocular glucocorticoid is given by INTRAVITREAL injection?",
     ...
     wrong=[("Fluorometholone", "A soft steroid given topically."),
            ("Rimexolone", "A soft steroid given topically."),
            ("Loteprednol", "A soft steroid given topically.")]),
