...
dict(q="Which class works within MINUTES and is typically preferred for ocular allergy?",
     ...
     why="Antihistamines have an onset within minutes, are dosed once or twice daily, and are preferred over mast cell stabilizers.",
     wrong=[("Cromolyn", "A mast cell stabilizer, needing 5 to 14 days and four-times-daily dosing."),
