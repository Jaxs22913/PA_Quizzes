...
NECK_ICON = ('<path d="M8 3v4a4 4 0 0 0 8 0V3"/><path d="M5 21c0-4 3-6 7-6s7 2 7 6"/>'
             '<circle cx="15" cy="10" r="2"/>')
MOUTH_ICON = ('<path d="M4 10h16"/><path d="M6 10c0 4 2.7 7 6 7s6-3 6-7"/>'
              '<path d="M9 10v2"/><path d="M15 10v2"/>')
THROAT_ICON = ('<path d="M12 3v6"/><path d="M8 9h8l-1.5 7a2.5 2.5 0 0 1-5 0z"/>'
               '<path d="M7 21h10"/>')
...
DECKS = [
 ("cms-external-ear", "External Ear &amp; Canal", "accent1", EAR_ICON, [
  ...
  ("How is a live insect in the canal managed first?", "Fill the canal with lidocaine to immobilize it."),
  ("Otitis externa that will not respond, with bloody discharge?", "Carcinoma of the ear canal &mdash; biopsy it."),
  ("Where does blood collect in an auricular hematoma?", "The sub-perichondrial space."),
  ("Within how long should an auricular hematoma be drained?", "Within seven days."),
  ("Why re-examine a blunt ear injury at 12 to 24 hours?", "The hematoma can develop hours later."),
  ("What prevents re-accumulation after draining an ear hematoma?", "Ear splinting."),
  ("Consequence of not draining an auricular hematoma?", "Cauliflower ear."),
 ...
 ("cms-middle-ear", "Middle Ear", "accent2", EAR_ICON, [
  ...
  ("Which history point changes the likely organism in a child?", "Immunization status."),
  ...
  ("Function of the eustachian tube?", "Equalizing middle ear pressure."),
  ...
  ("What is a cholesteatoma made of?", "Keratinized squamous epithelium."),
 ...
 ("cms-ear-tests", "Weber, Rinne &amp; the Tracings", "accent3", FORK_ICON, [
  ...
  ("Weber in a unilateral conductive loss?", "Lateralizes to the affected ear."),
  ("Weber in a unilateral sensorineural loss?", "Lateralizes to the unaffected ear."),
  ...
  ("Which maneuver diagnoses positional vertigo?", "Dix-Hallpike."),
  ("Which maneuver treats positional vertigo?", "Epley."),
 ...
 ("cms-hearing-vertigo", "Hearing Loss &amp; Vertigo", "accent4", SPIN_ICON, [
  ...
  ("Commonest non-vestibular cause of dizziness in the elderly?", "Small vessel ischemic disease."),
  ...
  ("Conductive loss with pulsatile tinnitus and a vascular mass?", "Glomus tumor."),
 ...
 ("cms-nose-sinuses", "Nose &amp; Sinuses", "accent1", NOSE_ICON, [
  ...
  ("What share of acute rhinosinusitis is viral?", "Ninety to ninety-eight percent."),
  ("What share of viral episodes superinfect with bacteria?", "Half a percent to two percent."),
  ...
  ("Which discharge color is least helpful?", "Yellow or green."),
  ("What does black nasal discharge suggest?", "A fungus."),
  ("What does rust-colored discharge suggest?", "Possibly Streptococcus pneumoniae."),
  ...
  ("Two common causes of a perforated septum?", "Intranasal steroid use and cocaine, both by chronic ischemia."),
  ...
  ("Where does a septal hematoma collect?", "Between the septum and the perichondrium."),
  ("Treatment of a septal hematoma?", "Drainage by intranasal incision under general anesthesia."),
  ("Where do ninety percent of nosebleeds arise?", "Kiesselbach's plexus, on the nasal septum."),
  ...
  ("Four criteria letting you skip nasal fracture x-rays?", "Swelling isolated to the bony bridge, breathing through each naris, a straight nose, and no septal hematoma."),
  ("Initial treatment of a nasal fracture?", "Ice and head of bed elevated."),
  ("What do nasal polyps look like?", "Gray, glistening masses."),
  ...
  ("Nasal findings in allergic rhinitis?", "Clear discharge from both nostrils and a bluish, edematous mucosa."),
  ("How many allergic rhinitis patients need two or more medicines?", "About eighty percent."),
 ...
 ("cms-neck-masses", "Neck Masses &amp; Neoplasms", "accent1", NECK_ICON, [
  ("Which muscle divides the neck into anterior and posterior triangles?", "Sternocleidomastoid."),
  ("Which muscle divides the posterior triangle?", "Omohyoid."),
  ("What lies deep to the contents of the supraclavicular triangle?", "The cupola of the pleura."),
  ("Which nerve crosses the floor of the occipital triangle?", "The spinal accessory nerve."),
  ("Which triangle holds the carotid arteries and vagus?", "The carotid triangle."),
  ("Which node drains the palatine tonsil?", "The jugulodigastric node."),
  ("Which node drains the tongue?", "The juguloomohyoid node."),
  ("Deep cervical nodes on the LEFT drain into what?", "The thoracic duct."),
  ("Most neck masses under 40 are what?", "Inflammatory."),
  ("Which malignancy is the exception to that rule?", "Hodgkin lymphoma."),
  ("Duration threshold that suggests malignancy?", "Over 2 weeks."),
  ("Size threshold that suggests malignancy?", "Over 1.5 cm."),
  ("A pulsatile mass or a bruit means what?", "Vascular &mdash; think paraganglioma."),
  ("Fluctuance means what?", "Cystic."),
  ("Rapid growth with NO infective symptoms suggests?", "Lymphoma."),
  ("A mass present for years is usually what?", "Benign &mdash; lipoma or cyst."),
  ("Standard of care investigation for a persistent neck mass?", "Fine needle aspiration biopsy."),
  ("How many needle passes for an adequate aspiration?", "A minimum of four."),
  ("Why avoid excisional biopsy first?", "It spills tumor and complicates treatment."),
  ("Which contrast is avoided if thyroid cancer is suspected?", "Iodine-containing contrast."),
  ("Where does a branchial cleft cyst sit?", "Laterally, at the anterior sternocleidomastoid border."),
  ("Pathognomonic sign of a thyroglossal duct cyst?", "It moves with tongue protrusion."),
  ("Which operation treats a thyroglossal duct cyst?", "The Sistrunk operation."),
  ("What does Sistrunk remove besides the cyst?", "The center of the hyoid bone."),
  ("Why is every thyroglossal specimen sent to histology?", "To rule out thyroid carcinoma."),
  ("Which congenital neck mass transilluminates?", "Lymphangioma (cystic hygroma)."),
  ("Which congenital mass enlarges with crying?", "Haemangioma."),
  ("What proportion of hemangiomas self-resolve?", "About 90 percent."),
  ("First-line drug if a hemangioma needs treating?", "Propranolol."),
  ("Which neonatal neck mass shows calcification?", "Teratoma."),
  ("Hassall corpuscles on biopsy indicate what?", "A thymic cyst."),
  ("Commonest cause of cervical adenopathy in children?", "Reactive viral lymphadenopathy."),
  ("Node persisting beyond what interval needs investigation?", "Four to six weeks."),
  ("Brawny reddish-brown skin over a child\u2019s neck node?", "Atypical mycobacterial infection."),
  ("Cervical tuberculosis is called what?", "Scrofula."),
  ("Which is bilateral and diffuse, TB or atypical mycobacteria?", "Tuberculosis."),
  ("Which infection follows unpasteurized milk?", "Brucellosis."),
  ("Which follows rabbits, ticks or contaminated water?", "Tularemia."),
  ("Treatment for tularemia?", "Streptomycin."),
  ("Painless fluctuant submandibular mass with filaments?", "Actinomycosis."),
  ("Commonest metastatic lesion to the neck?", "Squamous cell carcinoma."),
  ("Immobile midline mass that elevates with swallowing?", "Thyroid."),
  ("A HOT thyroid nodule needs a biopsy &mdash; true or false?", "False &mdash; low malignant risk."),
  ("Commonest thyroid cancer, and its prognosis?", "Papillary, 75 percent, best prognosis."),
  ("Which thyroid cancer spreads by blood to bone and lung?", "Follicular."),
  ("Medullary carcinoma arises from which cells?", "Parafollicular C cells."),
  ("Which hormone marks medullary carcinoma?", "Calcitonin."),
  ("Which syndrome do you screen relatives for?", "Multiple endocrine neoplasia."),
  ("Which thyroid cancer kills in 6 to 36 months?", "Anaplastic."),
  ("Primary thyroid lymphoma arises on what background?", "Hashimoto thyroiditis."),
  ("How is thyroid lymphoma treated?", "Chemotherapy and radiation, not surgery."),
 ]),
 ("cms-oral-lesions", "Mouth &amp; Oral Lesions", "accent2", MOUTH_ICON, [
  ("A white change that disappears when stretched?", "Leukoedema &mdash; a normal variant."),
  ("Yellow-white papules on lip and buccal mucosa?", "Fordyce granules &mdash; ectopic sebaceous glands."),
  ("A white patch that WIPES OFF?", "Oral candidiasis."),
  ("A white patch that will NOT scrape off?", "Leukoplakia."),
  ("Lacy white lines on the buccal mucosa?", "Wickham striae &mdash; oral lichen planus."),
  ("Transformation risk of leukoplakia?", "5 to 20 percent."),
  ("Transformation risk of oral lichen planus?", "1 to 4 percent."),
  ("What proportion of erythroplakia is dysplastic or malignant?", "About 90 percent."),
  ("Which is more dangerous, leukoplakia or erythroplakia?", "Erythroplakia."),
  ("How is leukoplakia diagnosed?", "Excisional biopsy."),
  ("Painless lateral tongue lesion that waxes and wanes?", "Hairy leukoplakia."),
  ("Hairy leukoplakia is associated with which virus?", "Epstein-Barr virus."),
  ("Hairy leukoplakia should prompt testing for what?", "HIV."),
  ("Where do aphthous ulcers occur?", "Freely moving, NON-keratinized mucosa."),
  ("Appearance of an aphthous ulcer?", "Yellow-gray center with a red halo."),
  ("How long do MINOR aphthous ulcers last?", "7 to 10 days."),
  ("Size dividing minor from major aphthae?", "1 cm."),
  ("Recurrent aphthous stomatitis is also called?", "Sutton disease."),
  ("Oral ulcers affect what share of Behcet patients?", "Up to 100 percent."),
  ("Genital ulcers affect what share of Behcet patients?", "About 75 percent."),
  ("Mucous membrane involvement in lupus?", "About 40 percent."),
  ("Where does herpes simplex lie dormant?", "The trigeminal ganglion."),
  ("How long before a herpes lesion does the prodrome start?", "About 24 hours."),
  ("Most sensitive and specific test for herpes simplex?", "PCR for HSV DNA."),
  ("What does a Tzanck smear show, and why is it limited?", "Multinucleated giant cells &mdash; also seen in varicella zoster."),
  ("Commonest manifestation of PRIMARY herpes simplex?", "Herpetic gingivostomatitis."),
  ("Treatment of oral candidiasis?", "Topical antifungals such as nystatin."),
  ("What does a KOH prep show in candidiasis?", "Spores and pseudohyphae."),
  ("Commonest cancer of the oral cavity?", "Squamous cell carcinoma."),
  ("What share of oropharyngeal cancer is HPV related?", "60 to 80 percent."),
  ("Classic presenting sign of oral cancer?", "A non-healing ulcer."),
  ("Oral cavity cancer treatment?", "Surgical resection alone."),
  ("Oropharyngeal cancer treatment?", "Resection plus radiotherapy."),
  ("Which nerve involvement causes referred otalgia?", "Cranial nerve involvement by the tumor."),
 ]),
 ("cms-salivary-voice", "Salivary Glands &amp; Voice", "accent3", SPIN_ICON, [
  ("Which duct drains the parotid?", "Stensen duct."),
  ("Which duct drains the submandibular gland?", "Wharton duct."),
  ("Which gland produces a ranula?", "The sublingual gland."),
  ("Commonest organism in acute suppurative sialadenitis?", "Staphylococcus aureus."),
  ("Which gland does suppurative sialadenitis usually affect?", "The parotid."),
  ("What initiates suppurative sialadenitis?", "Salivary stasis."),
  ("What is presumed after 48 hours without improvement?", "An abscess."),
  ("What share of salivary stones are submandibular?", "80 to 90 percent."),
  ("Why does the submandibular gland form most stones?", "Long uphill duct, alkaline mucin-rich saliva."),
  ("Characteristic symptom of sialolithiasis?", "Pain and swelling with eating &mdash; salivary colic."),
  ("Most SENSITIVE test for a salivary stone?", "Computed tomography."),
  ("Most ACCURATE test for salivary calculi?", "Digital subtraction sialography."),
  ("Minimally invasive option that can save the gland?", "Sialoendoscopy."),
  ("Classic viral cause of parotitis?", "Mumps &mdash; paramyxovirus."),
  ("What share of salivary tumors arise in the parotid?", "64 to 80 percent."),
  ("What share of parotid tumors are benign?", "75 to 80 percent."),
  ("What share of MINOR gland tumors are benign?", "About 35 percent."),
  ("Commonest benign minor salivary tumor?", "Pleomorphic adenoma."),
  ("Commonest malignant salivary tumor?", "Mucoepidermoid carcinoma."),
  ("Which features make a salivary tumor prognosis poor?", "Pain and facial nerve involvement."),
  ("Where do vocal cord nodules form?", "Anterior third / posterior two thirds junction."),
  ("Are nodules unilateral or bilateral?", "Bilateral and symmetric."),
  ("First-line treatment for vocal cord nodules?", "Speech therapy."),
  ("Are vocal cord polyps unilateral or bilateral?", "Unilateral."),
  ("Why is a vocal cord polyp excised?", "It may conceal an occult laryngeal carcinoma."),
  ("Which HPV subtypes cause respiratory papillomatosis?", "6 and 11, rarely 16."),
  ("Why avoid tracheostomy in papillomatosis?", "It creates another squamociliary junction."),
  ("Malignant transformation risk in papillomatosis?", "3 to 7 percent."),
  ("Unilateral vocal cord paralysis gives what voice?", "Breathy and hoarse."),
  ("Bilateral vocal cord paralysis gives what?", "Stridor."),
  ("Which test predicts recovery of a paralyzed cord?", "Laryngeal electromyography."),
  ("How long may a stretched nerve take to recover?", "6 months to a year."),
  ("Commonest cause of hoarseness?", "Acute laryngitis."),
  ("Commonest viral pathogen in acute laryngitis?", "Rhinovirus."),
  ("Are antibiotics indicated in acute laryngitis?", "No, unless bacterial superinfection is suspected."),
  ("Hoarseness beyond what interval is chronic?", "2 weeks."),
  ("What must chronic laryngitis prompt?", "Referral for laryngoscopy."),
  ("Two diagnoses chronic laryngitis must exclude?", "Laryngeal cancer and vocal cord polyps."),
 ]),
 ("cms-throat-deep-neck", "Throat &amp; Deep Neck", "accent1", THROAT_ICON, [
  ("Epiglottitis is more correctly called what?", "Supraglottitis."),
  ("Commonest pediatric pathogen in epiglottitis?", "Haemophilus influenzae type B."),
  ("The four Ds of pediatric epiglottitis?", "Drooling, dysphagia, dysphonia, distress."),
  ("Classic posture in epiglottitis?", "Tripod &mdash; leaning forward, chin thrust out."),
  ("Which examination must NOT be done in epiglottitis?", "Intraoral examination."),
  ("What is the thumbprint sign, and is it required?", "Swollen epiglottis on lateral X-ray &mdash; not required."),
  ("Gold standard for diagnosing epiglottitis?", "Mirror or fiberoptic laryngoscopy."),
  ("Is stridor early or late in epiglottitis?", "Late &mdash; the airway is nearly obstructed."),
  ("Antibiotics for epiglottitis?", "Third-generation cephalosporin plus vancomycin."),
  ("What share of pharyngitis is viral?", "About 70 percent."),
  ("Commonest bacterial cause of pharyngitis?", "Group A beta-hemolytic Streptococcus."),
  ("Which symptom argues AGAINST streptococcal pharyngitis?", "Cough."),
  ("Name the four one-point Centor criteria.", "No cough, exudate, fever, tender anterior nodes."),
  ("Centor age scoring?", "3-14 plus one, 15-44 zero, 45+ minus one."),
  ("What follows a NEGATIVE rapid strep test?", "A throat culture."),
  ("Definitive test for streptococcal infection?", "Antistreptolysin O."),
  ("First-line antibiotic for strep pharyngitis?", "Penicillin VK for 10 days."),
  ("Rheumatic fever appears how long after infection?", "2 to 3 weeks."),
  ("Peak age for rheumatic fever?", "5 to 15 years."),
  ("Mechanism of rheumatic carditis?", "Cross-reactive antibodies attacking heart muscle."),
  ("Triad of infectious mononucleosis?", "Fever, tonsillar pharyngitis, cervical lymphadenopathy."),
  ("Which virus causes 90 percent of mononucleosis?", "Epstein-Barr virus."),
  ("When is the monospot falsely negative?", "In the first week."),
  ("IgM positive means what?", "Current infection."),
  ("Why avoid contact sport for a month after mono?", "Risk of splenic rupture."),
  ("What happens if penicillin is given in mononucleosis?", "A widespread rash develops."),
  ("Classic triad of peritonsillar abscess?", "Trismus, uvular deviation, dysphonia."),
  ("Which is the most reliable symptom?", "Trismus."),
  ("Peritonsillar abscess is also called?", "Quinsy."),
  ("First priority in a peritonsillar abscess?", "Secure the airway."),
  ("Commonest age for retropharyngeal abscess?", "Under 5 years."),
  ("Plain film sign of retropharyngeal abscess?", "Widened prevertebral soft tissue."),
  ("Gold standard imaging for retropharyngeal abscess?", "Lateral neck computed tomography."),
  ("Mortality of mediastinitis from a retropharyngeal abscess?", "50 percent."),
  ("Which spaces does Ludwig angina involve?", "Submental, sublingual and submandibular."),
  ("Key physical sign in Ludwig angina?", "Tongue displaced upward and backward."),
  ("Usual source of Ludwig angina?", "Odontogenic &mdash; a tooth."),
  ("Antibiotics for Ludwig angina?", "Penicillin with metronidazole, or ampicillin-sulbactam."),
  ("Pharyngeal finding in diphtheria?", "A tenacious gray membrane."),
  ("Essential treatment for diphtheria beyond antibiotics?", "Antitoxin from the CDC."),
  ("Two lethal complications of diphtheria?", "Myocarditis and cranial neuropathy."),
  ("When is Tdap given in pregnancy?", "Between 27 and 36 weeks, every pregnancy."),
  ("What share of anterior cervical adenitis is strep?", "About 70 percent."),
  ("Mildest form of periodontal disease?", "Gingivitis &mdash; and it is reversible."),
  ("Commonest cause of pulpitis?", "Tooth decay."),
  ("Which teeth are usually impacted?", "Wisdom teeth."),
  ("Malocclusion classes?", "Class I normal, II distal, III mesial."),
  ("TMJ disorders rank where among musculoskeletal pain?", "Second commonest."),
  ("Three categories of TMJ disorder?", "Myofascial pain, internal derangement, arthritis."),
  ("Why do TMJ disorders mimic ear disease?", "The joint sits just in front of the ear canal."),
 ]),
]
