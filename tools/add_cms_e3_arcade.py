...
DECKS = [
 ...
 ("cms-neck-masses", "Neck Masses &amp; Neoplasms", "accent1", NECK_ICON, [
  ...
  ("Why avoid excisional biopsy first?", "It spills tumour and complicates treatment."),
  ...
  ("What does Sistrunk remove besides the cyst?", "The centre of the hyoid bone."),
  ...
  ("What proportion of haemangiomas self-resolve?", "About 90 percent."),
  ("First-line drug if a haemangioma needs treating?", "Propranolol."),
  ...
  ("Which infection follows unpasteurised milk?", "Brucellosis."),
 ...
 ("cms-oral-lesions", "Mouth &amp; Oral Lesions", "accent2", MOUTH_ICON, [
  ...
  ("Where do aphthous ulcers occur?", "Freely moving, NON-keratinised mucosa."),
  ("Appearance of an aphthous ulcer?", "Yellow-grey centre with a red halo."),
  ...
  ("Which nerve involvement causes referred otalgia?", "Cranial nerve involvement by the tumour."),
 ]),
 ("cms-salivary-voice", "Salivary Glands &amp; Voice", "accent3", SPIN_ICON, [
  ...
  ("What share of salivary tumours arise in the parotid?", "64 to 80 percent."),
  ("What share of parotid tumours are benign?", "75 to 80 percent."),
  ("What share of MINOR gland tumours are benign?", "About 35 percent."),
  ("Commonest benign minor salivary tumour?", "Pleomorphic adenoma."),
  ("Commonest malignant salivary tumour?", "Mucoepidermoid carcinoma."),
  ("Which features make a salivary tumour prognosis poor?", "Pain and facial nerve involvement."),
  ...
  ("Which test predicts recovery of a paralysed cord?", "Laryngeal electromyography."),
 ...
 ("cms-throat-deep-neck", "Throat &amp; Deep Neck", "accent1", THROAT_ICON, [
  ...
  ("Commonest paediatric pathogen in epiglottitis?", "Haemophilus influenzae type B."),
  ("The four Ds of paediatric epiglottitis?", "Drooling, dysphagia, dysphonia, distress."),
  ...
  ("Commonest bacterial cause of pharyngitis?", "Group A beta-haemolytic Streptococcus."),
  ...
  ("Pharyngeal finding in diphtheria?", "A tenacious grey membrane."),
