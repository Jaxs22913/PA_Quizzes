...
TY = '''    dermentophtho: [
      ...
      {q:"Which imaging is FIRST for a deep neck infection?",
       ...
       expl:"Ultrasound is NOT helpful for a deep neck infection, the opposite of the neck MASS pathway where ultrasound is first-line. Contrast computed tomography answers three questions: drainable abscess, airway compromise, spread toward the mediastinum."},
    ...
    cbchematology: [
      ...
      {q:"An absolute neutrophil count of 400/uL is which grade of neutropenia?",
       ...
       expl:"Severe is under 500, moderate 500 to under 1,000, mild 1,000 to under 1,500, so an absolute neutrophil count of 400 is severe neutropenia."},
      ...
      {q:"Which stain is required to see Heinz bodies?",
       ...
       expl:"Heinz bodies are inclusions of denatured hemoglobin, seen in G6PD (glucose-6-phosphate dehydrogenase) deficiency. They are invisible on the routine Wright stain, so nobody reports them unless a supravital stain is asked for."},
      ...
      {q:"Why do steroids raise the neutrophil count?",
       ...
       expl:"Demargination: steroids cause neutrophils to detach from the blood vessel wall and go into the main bloodstream, which raises the count."},
