...
POOL_E = [
 dict(topic="Acne rosacea", io=IOA, slot="first-line",
   ...
   opts=[
     ["Topical metronidazole",
      "Correct — topical metronidazole is first-line for papulopustular rosacea; ivermectin cream is superior where Demodex is implicated."],
 ...
 dict(topic="Acne rosacea", io=IOA, slot="avoid",
   q="Which forms of rosacea does topical azelaic acid treat?",
   opts=[
     ["Papulopustular and erythematotelangiectatic",
      "Correct — azelaic acid 15 to 20% is anti-inflammatory and anti-keratinizing, and it is effective for both papulopustular and erythematotelangiectatic rosacea."],
     ["Phymatous rosacea, including rhinophyma",
      "Rhinophyma of phymatous rosacea is treated with carbon dioxide laser or surgical excision, and off-label isotretinoin, rather than topical azelaic acid."],
     ["Flushing that has failed other agents",
      "Refractory flushing is treated with carvedilol or propranolol; azelaic acid is a topical anti-inflammatory for papulopustular and erythematotelangiectatic disease."],
     ["Demodex-associated disease only",
      "Ivermectin cream is superior to metronidazole for Demodex-associated papulopustular disease; azelaic acid covers papulopustular and erythematotelangiectatic forms."]],
   c=0, cite=c(69)),
 ...
 dict(topic="Acne rosacea", io=IOA, slot="initial test",
   ...
   opts=[
     ...
     ["A skin biopsy of the malar area, which distinguishes the two definitively",
      "A malar skin biopsy is rarely needed here; an antinuclear antibody test is what helps exclude lupus when the rash is atypical."],
 ...
 dict(topic="Dermatitis herpetiformis", io=IOA, slot="gold standard",
   q="Why does the diagnostic test for dermatitis herpetiformis stand out among skin conditions?",
   opts=[
     ["Because most of these conditions are clinical diagnoses, so a disease with a distinctive test stands out",
      "Correct — most skin conditions are clinical diagnoses, whereas dermatitis herpetiformis has a gold-standard test: granular immunoglobulin A in the dermal papillae."],
 ...
 dict(topic="Dermatitis herpetiformis", io=IOA, slot="manifestation",
   ...
   opts=[
     ...
     ["On the face in the central third, sparing the nasolabial folds",
      "A central facial rash sparing the nasolabial folds is the malar rash of lupus; dermatitis herpetiformis favors the knees, elbows, buttocks and back."],
 ...
 dict(topic="Dermatitis herpetiformis", io=IOA, slot="complication",
   ...
   opts=[
     ["Bloating and diarrhea, which can wax and wane in intensity",
      "Correct — the condition is linked to gluten sensitivity and celiac disease."],
 ...
 dict(topic="Hyperhidrosis", io=IOA, slot="education",
   ...
   opts=[
     ["That it is not about poor hygiene or anxiety, with moisture-wicking clothing suggested and realistic expectations set",
      "Correct — hyperhidrosis is a medical condition, moisture-wicking clothing reduces impairment, and realistic expectations include botulinum toxin retreatment every three to six months."],
     ["That improved washing and a reduction in stress will resolve all of the sweating within a few months",
      "Primary hyperhidrosis is not caused by poor hygiene or anxiety; it is a medical condition, so washing more and reducing stress will not resolve it."],
 ...
 dict(topic="Hyperhidrosis", io=IOA, slot="risk factors",
   ...
   opts=[
     ["The family history, alongside whether the sweating is focal or generalized",
      "Correct — generalized sweating for no reason requires additional workup."],
