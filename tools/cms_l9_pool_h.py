...
POOL_H = [
 dict(topic="Squamous cell carcinoma", io=IO, slot="initial test",
   ...
   opts=[
     ...
     ["Shave biopsy only, since deeper sampling risks seeding the tumor",
 ...
 dict(topic="Squamous cell carcinoma", io=IO, slot="initial test",
   ...
   opts=[
     ["Palpate the draining lymph-node basins, considering imaging or nodal evaluation for high-risk tumors",
     ...
     ["Sentinel lymph node biopsy in every case over one centimeter",
     ...
     ["No regional assessment, since actinically induced disease rarely spreads",
      "The metastatic rate is three to seven percent, and the nodes are examined."]],
   c=0, cite=c(23)),
 ...
 dict(topic="Kaposi sarcoma", io=IO, slot="initial test",
   ...
   opts=[
     ...
     ["Clinical appearance alone, since the violaceous color is characteristic",
      "Color alone is not enough to discriminate it."],
 ...
 dict(topic="Kaposi sarcoma", io=IO, slot="differential",
   ...
   opts=[
     ["Immune status, distribution, oral lesions, edema, visceral symptoms and biopsy — not color alone",
     ...
     ["Color, size and symmetry of the lesions",
      "Color alone is exactly what must not be relied on."],
 ...
 dict(topic="Cutaneous T-cell lymphoma", io=IO, slot="differential",
   ...
   opts=[
     ["Chronicity, treatment resistance, large or oddly distributed patches, severe pruritus, follicular hair loss, tumors or erythroderma, nodes, and histology over time",
      "Correct — no single one settles it, which is why longitudinal reassessment is stressed."],
     ["The color and symmetry of the lesions alone",
 ...
 dict(topic="Actinic keratosis", io=IO, slot="initial test",
   ...
   opts=[
     ["Morphology or behavior raising concern for squamous cell carcinoma, or persistence or recurrence after therapy; shave or punch biopsy",
     ...
     ["Any lesion over one centimeter, using a punch biopsy",
 ...
 dict(topic="Actinic keratosis", io=IO, slot="test finding",
   ...
   opts=[
     ...
     ["Actinic keratosis versus seborrheic keratosis, because the treatments differ",
      "Seborrheic keratosis is on the differential but is not the interpretation question."],
