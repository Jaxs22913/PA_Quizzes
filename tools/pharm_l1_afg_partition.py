#!/usr/bin/env python3
"""Partition the Pharmacology I Lecture 1 antifungal pool into two 30s.
...
import difflib
from pharm_l1_afg_lengthfix import FIXES
...
if __name__ == "__main__":
    ...
    json.dump({"set1": s1, "set2": s2},
              open(os.path.join(HERE, "pharm_l1_afg_sets.json"), "w"),
              ensure_ascii=False, indent=1)
    print("wrote pharm_l1_afg_sets.json")
