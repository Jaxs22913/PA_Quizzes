...
TESTS = '''    benignskin: [
      ...
      {q:"What is actually inside an 'epidermoid cyst', often miscalled a sebaceous cyst?",
       ...
       expl:"It is called sebaceous because the contents look like sebum, but the substance is keratin and it is not a sebaceous cyst. Standard of care is removal of the ENTIRE capsule, when the cyst is not inflamed."},
      ...
      {q:"Which keratolytic agent do the common over-the-counter corn and callus removers contain?",
       choices:["Salicylic acid","Urea","Trichloroacetic acid","Ammonium lactate"],correct:0,
       expl:"The common over-the-counter corn and callus removers all rely on salicylic acid, at 12.6 to 40%; a diabetic patient is referred to podiatry instead."}
    ],
'''
