...
CARDS = [
 ["Define infection.", "Pathogenic microbes penetrate host defenses, enter tissues and multiply."],
 ...
 ["What share of fecal volume is bacteria?", "10 to 30 percent."],
 ...
 ["Which two organisms can live as flora of the respiratory tract?", "Staphylococcus aureus and Neisseria meningitidis."],
 ...
 ["What is a true, or frank, pathogen?", "One capable of causing disease in healthy people with normal defenses."],
 ["Give examples of true pathogens.", "Influenza and rabies viruses, the plague bacterium, and the malarial protozoan."],
 ["What is an opportunistic pathogen?", "One that causes disease when defenses are compromised, or when it grows somewhere unnatural to it."],
 ["Which factor that weakens host defenses matters most?", "Immune status."],
 ["Which ages weaken host defenses?", "The elderly, young children and premature infants."],
 ...
 ["What do exoenzymes do?", "Attack host defenses to allow deeper invasion."],
 ...
 ["Which four types of toxin can toxigenic microbes produce?", "Neurotoxins, enterotoxins, hemotoxins and nephrotoxins."],
 ...
 ["In strep throat, which finding is the sign and which the symptom?", "An inflamed pharynx is the sign; a sore throat is the symptom."],
 ...
 ["Name six vectors that transmit disease.", "Mosquitoes, fleas, ticks, flies, fruit flies and cockroaches."],
 ...
 ["Which two bacteria are important exceptions to Koch's postulates?", "Mycobacterium leprae and Legionella pneumophila."],
