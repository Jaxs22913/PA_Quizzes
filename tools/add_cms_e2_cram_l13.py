...
the commonest pediatric type, and the liver as the commonest metastatic site
for ocular melanoma.
"""
import io, os, re
...
SECTIONS = "".join([
 ...
 sec("cvl-cataract", "CATARACT &mdash; TELL THE TYPES APART", CVL, CVLBG, CVLZ, CVLINK, [
  ...
  ("PEDIATRIC &mdash; ZONULAR", "COMMONEST pediatric type. White opacity round the nucleus."),
  ("PEDIATRIC &mdash; POLAR", "Less common but CENTRAL, so caught earlier."),
 ...
 sec("cvl-amd", "MACULAR DEGENERATION", CVL, CVLBG, CVLZ, CVLINK, [
  ...
  ("WET (exudative)", "20%. CHOROIDAL NEOVASCULARIZATION bleeds into retina &rarr; DISCIFORM SCAR."),
