...
Q("Pre-septal cellulitis", IO,
  ...
  [["Staphylococcus and Streptococcus",
    "Correct. Coverage is aimed at Staphylococcus, with or without resistant strains, and Streptococcus; at five years or younger she is admitted for intravenous antibiotics."],
...
Q("Pre-septal cellulitis", IO,
  "Which examination findings are expected in pre-septal cellulitis?",
  [["Diffuse balloon-like edema, erythema and tenderness of the lids",
   ...
   ["A bright red painless patch", "That is a subconjunctival hemorrhage."]],
  "two-step", D, 52),
...
Q("Corneal ulcer", IO,
  ...
  [["A hypopyon", "Correct — layered white cells in the anterior chamber."],
   ...
   ["Ciliary flush alone", "Ciliary flush signals inflammation of the cornea, iris or ciliary body; the hypopyon marks significant intraocular inflammation."]],
  "two-step", D, 61),
...
Q("Chemosis", IO,
  "Which of these can cause chemosis?",
  [["Allergy, infection, thyroid eye disease, angioedema and trauma",
    "Correct. Chemosis also occurs with thyroid eye disease, orbital cellulitis and impaired orbital venous drainage."],
   ["Cataract and macular degeneration", "Causes of gradual painless vision loss."],
   ["Myopia and astigmatism", "Refractive errors."],
   ["Retinoblastoma and uveal melanoma", "Tumors that do not present with chemosis."]],
  "two-step", D, 31),

Q("Ectropion", IO,
  "Which of these can cause ectropion?",
  [["Aging, scarring and congenital causes, plus seventh nerve palsy",
    "Correct — and seventh nerve palsy causes ectropion ONLY."],
   ["Chronic steroid drops", "Associated with cataract and raised pressure."],
   ["Diabetes alone", "Diabetes is not a cause; lid malposition follows aging, scarring, congenital causes or, for ectropion only, seventh nerve palsy."],
...
Q("Trachoma", IO,
  ...
  [["Follicles, tarsal scarring, entropion with trichiasis, then corneal opacity",
    "Correct."],
   ["Drusen, pigment change, atrophy, then neovascularization",
...
Q("Xanthelasma", IO,
  "Which local treatments are used for xanthelasma?",
...
Q("Bacterial conjunctivitis", IO,
  "Which patients are at particular risk of bacterial conjunctivitis?",
...
Q("Red eye disposition", IO,
  ...
  [["Keratitis or corneal ulcer, anterior uveitis, scleritis and ocular herpes zoster",
   ...
   ["Subconjunctival hemorrhage", "Routine, and it resolves in two to four weeks."]],
  "two-step", D, 66),
]
