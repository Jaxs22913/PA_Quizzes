...
POOL_C = [
 ...
 dict(topic="Seborrheic dermatitis", io=IOC,
   ...
   opts=[
     ...
     ["Atopic dermatitis",
      "The infantile pattern favors weeping patches on cheeks and extensor surfaces rather than greasy adherent scalp scale."],
     ["Tinea capitis",
 ...
 dict(topic="Pityriasis rosea", io=IOC,
   ...
   opts=[
     ...
     ["Serum rapid plasma reagin",
      "A herald patch with a spreading trunk eruption does not call for syphilis serology first."]],
   c=0, cite=c(171)),
 ...
 dict(topic="Bullous pemphigoid", io=IOC,
   ...
   opts=[
     ["The prodromal phase of bullous pemphigoid, which may precede bullae by weeks to months",
      "Correct — the prodrome presents as pruritic urticarial or edematous lesions before the blistering phase."],
     ...
     ["Lichen simplex chronicus",
      "This produces a localized lichenified plaque from scratching."]],
   c=0, cite=c(123)),
 ...
 dict(topic="Allergic contact dermatitis", io=IOC,
   ...
   opts=[
     ...
     ["Urushiol",
      "Urushiol causes linear vesicles from plant contact rather than jewelry-shaped eruptions."],
     ["Neomycin",
 ...
 dict(topic="Dyshidrotic eczema", io=IOC,
   q="A 31-year-old woman with recurrent palmar vesicles asks how to reduce flares. Which is the most appropriate counseling point?",
   opts=[
