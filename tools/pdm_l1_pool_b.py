...
POOL_B = [
 ...
 dict(topic="Collection tubes", io=IOE,
   q="A complete blood count is ordered. Which tube color corresponds to it?",
   opts=[
     ["Lavender",
 ...
 dict(topic="Stool studies", io=IOF,
   ...
   opts=[
     ...
     ["No color change occurs",
      "Absence of color change is a negative result."]],
   c=0, cite=c(21)),
 ...
 dict(topic="Stool studies", io=IOF,
   ...
   opts=[
     ...
     ["A large sample, to maximize sensitivity",
      "A large sample obscures results."],
     ["Enough to fill the window completely",
      "Filling the window obscures the color change."],
 ...
 dict(topic="Throat culture", io=IOF,
   ...
   opts=[
     ...
     ["Swab a single tonsil to minimize the gag reflex",
 ...
 dict(topic="Point-of-care testing", io=IOH,
   ...
   opts=[
     ...
     ["Bench top chemistry analyzers only",
