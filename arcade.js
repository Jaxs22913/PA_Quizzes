...
var DEMO_DECKS = [
  ...
  { id: "mb-general-microbiology", name: "Review of General Microbiology", color: "accent1",
    ...
    cards: [
      ...
      ["What does the lecture say about temperature as a control?", "High temperature can kill; low temperature will NOT — it only slows the rate of growth."],
  ...
  { id: "cp-inflammation", name: "Inflammation", color: "accent3",
    ...
    cards: [
      ...
      ["Which autoimmune diseases are given as causes of chronic inflammation?", "Rheumatoid arthritis and lupus."],
      ...
      ["Which two opsonins are named?", "Immunoglobulin G (IgG) and complement fragment C3b."],
  ...
  { id: "cp-dermatology", name: "Dermatology: Pathophysiology", color: "accent3",
    ...
    cards: [
      ...
      ["Can a pustule be sterile?", "Yes — rosacea is the example given."],
...
/*/CPL4*/
  ...
  { id: "derm-disease-processes", name: "Dermatology \u2014 All Disease Processes", color: "accent1",
    ...
    cards: [
      ...
      ["Solar lentigo also Lecture 8", "Well-defined light-to-dark brown macules with irregular borders that coalesce at sites of severe sunburn, from under 1 mm to several centimetres, on chronically exposed skin."],
      ...
      ["Solar lentigo also Lecture 3", "Arises from proliferation of basal melanocytes with increased melanin production. Well-defined but with irregular borders, tending to coalesce at sites of severe sunburn; from under 1…"],
...
/*/PDML5*/
  ...
  { id: "pdm-cardiac-imaging", name: "Cardiac Imaging &amp; Vascular Studies", color: "accent3",
    ...
    cards: [
      ...
      ["Which types of stress test are described?", "Exercise, echocardiographic, nuclear, pharmacological"],
      ...
      ["Which is a listed indication for coronary angiography?", "Severe angina despite medical therapy"],
      ["What does RIGHT heart catheterisation assess?", "Right-sided pressures, pulmonary resistance, valves and shunts"],
      ["Which chest radiograph findings are given as indicators of cardiac pathology?", "Oedema, effusion, cardiomegaly, cephalisation and calcification"],
      ...
      ["Which is a stated indication for coronary computed tomography angiography?", "Evaluating an equivocal or non-diagnostic stress test"],
    ]},
  // <!--/PDME2-DECKS-->
  ...
  { id: "micro-immunity-disorders", name: "Disorders in Immunity", color: "accent2",
    icon: '<path d="M12 3l7 3v6c0 4.5-3 7.5-7 9-4-1.5-7-4.5-7-9V6z"/><path d="M9 12l2 2 4-4"/>',
    cards: [
      ["Which four categories of immunopathology are described?", "Allergy, autoimmunity, immunodeficiency and cancer"],
      ...
      ["Which conditions are given as type II examples?", "Transfusion reactions and Rh incompatibility"],
  ...
  { id: "micro-diagnosing-infections", name: "Diagnosing Infections", color: "accent4",
    ...
    cards: [
      ...
      ["Which stains are named for immediate direct examination?", "Gram stain and acid-fast stain"],
  ...
  { id: "cp-cardiac-pathophys", name: "Cardiac Pathophysiology", color: "accent1",
    ...
    cards: [
      ...
      ["Which are listed as PROBABLE rather than major risk factors?", "Male sex, homocysteine and high sensitivity C reactive protein"],
