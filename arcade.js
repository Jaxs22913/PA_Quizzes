...
var DEMO_DECKS = [
  ...
  { id: "mb-antibiotics-resistance", name: "Antibiotics and Resistance", color: "accent1",
    ...
    cards: [
      ...
      ["What is the direct toxicity of chloramphenicol?", "Aplastic anaemia."],
  ...
  { id: "mb-general-microbiology", name: "Review of General Microbiology", color: "accent1",
    ...
    cards: [
      ...
      ["What is an enriched medium?", "One containing complex organic substances such as blood, serum or haemoglobin, required by fastidious microbes."],
      ...
      ["What characterises the lytic cycle?", "Rapid takeover of bacterial metabolism, production of multiple virus copies, destruction of the host cell, and generalized transduction."],
      ["What characterises the lysogenic cycle?", "Integration of viral genes as prophage, possible acquisition of new traits such as toxin production, immunity to reinfection, and specialized transduction."],
  ...
  { id: "cp-inflammation", name: "Inflammation", color: "accent3",
    ...
    cards: [
      ...
      ["What are the five main processes of the inflammatory response?", "Increased blood flow, increased permeability, migration of neutrophils, chemotaxis, and leucocyte recruitment and activation."],
      ...
      ["Describe the eosinophil's nucleus and granules.", "Bi-lobed nucleus with granules of a characteristic pink-orange colour."],
      ...
      ["What do CD8+ cytotoxic T cells target?", "Virus-infected and tumour cells."],
      ...
      ["List the vascular events of acute inflammation in order.", "Vasoconstriction, vasodilation, increased vascular permeability, then haemoconcentration and stasis."],
      ...
      ["What is an opsonin?", "A protein that adheres to foreign material and makes it easier for immune cells to recognise and attach."],
      ["Which two molecules act as opsonins?", "Immunoglobulin G (IgG) and complement fragment C3b."],
      ["How is immunoglobulin G recognised by phagocytes?", "Through Fc receptors that recognise the Fc portion of the antibody."],
      ["How is C3b recognised?", "Through complement receptors on immune cells."],
      ["Why can a sterile implanted device cause inflammation?", "It becomes coated with immunoglobulin G and C3b, and immune cells recognise that coating and attach."]
    ],
    matchCards: [
  ...
  { id: "cp-dermatology", name: "Dermatology: Pathophysiology", color: "accent3",
    ...
    cards: [
      ...
      ["What produces body odour?", "Bacterial degradation of apocrine sweat."],
      ...
      ["Which cytokines drive psoriasis?", "Tumour necrosis factor alpha, interferon gamma and interleukin-12."],
      ...
      ["Which pathway does basal cell carcinoma overactivate?", "The Hedgehog signalling pathway."],
      ["Which gene is mutated in squamous cell carcinoma?", "The tp53 tumour suppressor gene."],
    ...
    matchCards: [
      ...
      ["tp53", "Tumour suppressor mutated in squamous cell carcinoma"],
...
/*/CPL4*/
  ...
  { id: "derm-disease-processes", name: "Dermatology \u2014 All Disease Processes", color: "accent1",
    ...
    cards: [
      ...
      ["Stasis dermatitis", "Pruritic erythematous, violaceous or hyperpigmented patches in the gaiter region, with oedema and signs of chronic venous disease."],
      ...
      ["Pityriasis rosea", "Herald patch first — one large salmon-coloured oval, present a week or two alone — then smaller ovals with a collarette of scale in a Christmas-tree…"],
      ...
      ["Erythema multiforme", "Target lesions with three concentric zones — central dusky or necrotic area, pale oedematous ring, outer erythematous rim."],
      ...
      ["Urticaria", "Transient pruritic wheals, with or without angio-oedema. An individual wheal resolves within 24 hours, blanches fully and migrates."],
      ["Erythema nodosum", "Tender erythematous nodules, bilateral on the anterior shins, that do not ulcerate."],
      ["Granuloma annulare", "Annular ring of flesh-coloured or erythematous papules, commonly dorsal hands and feet."],
      ...
      ["Solar lentigo (photodermatology)", "Well-defined light-to-dark brown macules with irregular borders that coalesce at sites of severe sunburn, from under 1 mm to several centimetres, on chronically exposed skin."],
      ...
      ["Impetigo — non-bullous", "A macule rapidly becomes a vesicle or pustule and ruptures; serous contents dry to a honey-coloured adherent crust over an erosion."],
      ...
      ["Ecthyma", "Not common. Begins as a vesicle or pustule over inflamed skin and deepens into dermal ulceration with a thicker grey-yellow crust."],
      ["Erysipelas", "Infection of the upper dermis extending to superficial cutaneous lymphatics — a superficial cellulitis."],
      ["Cellulitis", "Acute inflammation of the deeper dermis and subcutaneous tissue. Group A beta-haemolytic streptococci or Staphylococcus aureus."],
      ...
      ["Crusted (hyperkeratotic) scabies", "Thick flaking scale containing millions of mites. Nails thickened or discoloured, patches poorly defined, and patients may be asymptomatic — not itchy at all."],
      ...
      ["Pediculosis pubis (crabs)", "Often asymptomatic or mild to moderate pruritus for months. Maculae caeruleae — slate-grey to bluish irregular macules about 1 cm, representing haemorrhage."],
      ...
      ["Hobo spider", "Tegenaria agrestis, the aggressive house spider — brown with a grey herringbone pattern on the abdomen."],
      ["Lyme disease", "Borrelia burgdorferi, a spirochete. Stage 1 — early localised: erythema migrans — a large (>5 cm) expanding erythematous round or oval lesion with central clearing and…"],
      ...
      ["Molluscum contagiosum", "Benign POXVIRUS infection. Discrete, smooth-surfaced, firm, flesh-coloured, dome-shaped pearly papules averaging 3–5 mm; CENTRAL UMBILICATION is characteristic."],
      ...
      ["Verruca plana (flat warts)", "Multiple smooth, slightly elevated, FLAT-TOPPED, skin-coloured to light-brown papules. Common on the face, forehead, dorsal hands and shins."],
      ...
      ["Common acquired melanocytic naevus (mole)", "Develops slowly after birth, enlarges symmetrically, stabilises and regresses. Numbers peak in the thirties and decline afterwards."],
      ...
      ["Infantile hemangioma", "Congenital vascular lesion; the most common tumour of infancy, and most are medically insignificant."],
      ...
      ["Neurofibromatosis type 1", "Also von Recklinghausen disease. A common neurocutaneous genetic disorder causing tumours to form on nerve tissue."],
      ["Xanthelasma", "Soft, yellow cholesterol plaques — a collection of lipid-laden macrophages. Associated with lipid disorders."],
      ["Lipoma", "The most common soft tissue tumour. A benign localised overgrowth of fat cells in the subcutaneous tissue; single or multiple."],
...
/*/PDML5*/
  ...
  { id: "cms-hf-stages-peptides", name: "Heart Failure &mdash; Stages, Classes &amp; Natriuretic Peptides", color: "accent2",
    ...
    cards: [
      ...
      ["B-type natriuretic peptide grey zone?", "100&ndash;400."],
  ...
  { id: "pdm-ecg", name: "Electrocardiography &mdash; Basics", color: "accent1",
    ...
    cards: [
      ...
      ["What does depolarisation represent, and what is its relationship to contraction?", "Activation of cardiac tissue, and it precedes contraction"],
      ...
      ["What characterises phase 1, early repolarisation?", "Sodium channels close and potassium channels reopen"],
      ...
      ["What does the P wave represent, and how should it appear in lead II?", "Atrial depolarisation, appearing as a positive deflection"],
      ...
      ["What does the QRS complex represent, and what should it look like?", "Ventricular depolarisation, narrow with sharp points"],
      ["What does the R wave represent?", "Depolarisation of the anterior left ventricle"],
  ...
  { id: "pdm-cardiac-imaging", name: "Cardiac Imaging &amp; Vascular Studies", color: "accent3",
    ...
    cards: [
      ...
      ["How does an exercise stress test detect myocardial ischaemia?", "Indirectly, by continuous electrocardiographic monitoring"],
      ...
      ["What does cardiovascular magnetic resonance avoid that computed tomography does not?", "Both ionising radiation and iodinated contrast"],
      ...
      ["What does LEFT heart catheterisation assess?", "Coronary anatomy, aortic pressure and left ventricular function"],
      ...
      ["What distinguishes a transthoracic from a transoesophageal echocardiogram?", "The transducer is outside the body in one, inside in the other"],
      ["Which electrocardiographic changes during an exercise stress test suggest ischaemia?", "ST depression"],
      ...
      ["What does RIGHT heart catheterisation assess?", "Right-sided pressures, pulmonary resistance, valves and shunts"],
      ["Which chest radiograph findings indicate cardiac pathology?", "Oedema, effusion, cardiomegaly, cephalisation and calcification"],
  ...
  { id: "micro-immunity-disorders", name: "Disorders in Immunity", color: "accent2",
    ...
    cards: [
      ...
      ["Why do allergic reactions use the same machinery as antiparasitic defence?", "Many allergens resemble parasitic antigens"],
      ["How many people are heavily and persistently infected with helminths?", "About one billion"],
      ["What is familial about allergy?", "A generalised predisposition"],
      ...
      ["What happens on the sensitising dose in type I allergy?", "B cells form IgE, which arms mast cells"],
      ...
      ["What characterises systemic anaphylaxis?", "Sudden respiratory and circulatory disruption"],
      ...
      ["What are the three general methods of managing type I hypersensitivity?", "Prevention, pharmacology, desensitisation"],
      ["What does prevention of allergy involve?", "Modifying environment and behaviour"],
      ...
      ["When does an Rh negative person produce anti-Rh antibodies?", "Only after sensitisation"],
      ["Which combination produces haemolytic disease of the newborn?", "An Rh negative mother with an Rh positive fetus"],
  ...
  { id: "micro-diagnosing-infections", name: "Diagnosing Infections", color: "accent4",
    ...
    cards: [
      ...
      ["What is blood agar used to detect?", "Haemolytic activity"],
      ...
      ["Which four components does the complement fixation test use?", "Antigen, antibody, complement and sensitised sheep red cells"],
      ["What is used in fluorescent antibody testing?", "A dye-labelled monoclonal antibody"],
      ...
      ["What kind of technique are the colour-changing rapid strep tests?", "A modified agglutination technique"],
  ...
  { id: "cp-cardiac-pathophys", name: "Cardiac Pathophysiology", color: "accent1",
    ...
    cards: [
      ["At what point does myocardium become ischaemic?", "When metabolic demand for oxygen exceeds supply"],
      ["How can abnormalities of the microcirculation produce cardiac ischaemia?", "Endothelial cells in small vessels regulate the vasculature abnormally"],
      ...
      ["What is the molecular defect in familial hypercholesterolaemia?", "A defective low density lipoprotein receptor on liver cells"],
      ...
      ["What distinguishes angina pectoris from infarction at the cellular level?", "The ischaemia is intermittent and insufficient to kill cardiac cells"],
      ["What is the mechanism of stable, typical angina?", "Stenotic vessels reduce flow to a critical level"],
      ["Why is unstable angina included among the acute coronary syndromes?", "It may progress to acute ischaemia"],
      ...
      ["What is the most common cause of aortic valve stenosis?", "Calcification occurring with ageing"],
      ...
      ["What characterises myocarditis pathologically?", "Inflammation, leukocyte infiltration and necrosis"],
  ...
  { id: "cp-vascular-pathophys", name: "Vascular Pathophysiology", color: "accent3",
    ...
    cards: [
      ...
      ["What characterises the arteries?", "High pressure, strong walls, high flow velocity"],
      ...
      ["What kind of epithelium lines the vessel lumen?", "Specialised simple squamous epithelium"],
      ...
      ["What proportion of hypertension is idiopathic?", "About 90 to 95 per cent"],
      ...
      ["What is an aneurysm?", "Localised abnormal dilation of a blood vessel"],
      ...
      ["What characterises a saccular cerebral aneurysm?", "A thin-walled protrusion lacking elastic lamina"],
      ...
      ["What proportion of the body's total blood volume do the veins contain?", "About 66 per cent"],
      ...
      ["Why does the capillary bed favour exchange?", "Thin walls combined with slow flow"],
  ...
  { id: "pd2-cardiovascular-exam", name: "Cardiovascular &amp; Peripheral Vascular Exam", color: "accent2",
    ...
    cards: [
      ...
      ["How is dyspnoea defined?", "Awareness of breathing out of proportion to exertion"],
      ["How is orthopnoea quantified?", "By the number of pillows used for sleeping"],
      ["When does paroxysmal nocturnal dyspnoea typically occur?", "One to two hours after going to bed"],
      ["How is oedema defined?", "Excess fluid in the extravascular interstitial space"],
