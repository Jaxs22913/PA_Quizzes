...
var DEMO_CLASSES = [
  ...
  { id: "pdm-1", name: "Principles of Diagnostic Medicine I", exams: [
    { id: "exam1", name: "Exam 1", deckIds: ["pdm-lab-diagnostics", "pdm-medical-imaging", "pdm-derm-ent-ophtho", "pdm-cbc-hematology"] }
  ]},
  ...
  { id: "clin-path-1", name: "Clinical Pathophysiology I", exams: [
    { id: "exam1", name: "Exam 1", deckIds: ["cp-inflammation", "cp-dermatology", "cp-abnormal-cell-growth"] }
  ]},
